...
class Bucket(Construct):
    ...
    The FAO CDK Bucket Construct incapsulates different AWS S3 configurations and it is used, for example, when as a hosting server for static websites or to create auxiliary buckets to host static objects. 
