"""
    ...
    The version of the OpenAPI document: 4.47.0
...
class AuditLogApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_audit_log_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/audit-log/{workspaceId}',
    ...
    def get_audit_log(
        ...
        **kwargs
        ...
        """Retrieves a list of audit logs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_audit_log(workspace_id, async_req=True)
        >>> result = thread.get()

        Args:
            workspace_id (str): The id of the workspace fow which the audit log events are requested
