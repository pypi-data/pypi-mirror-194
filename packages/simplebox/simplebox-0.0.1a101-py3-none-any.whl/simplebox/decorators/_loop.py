...
def retry(frequency: int = 1, interval: int = 1, increasing: int = 0, check: Callable[[_T], bool] = lambda r: True,
          ignored_exception: Union[Type[Exception], Tuple[Type[Exception]]] = None,
          post: Callable[[_T, _T], None] = None):
    """
...
def retrying(func: Callable, args: Tuple = None, kwargs: Dict = None,
             ...
             post: Callable[[_T, _T], None] = None) -> Any:
    """
...
def __do_retry(func: Callable = None, args: Tuple = None, kwargs: Dict = None, opts: Dict = None):
    ...
    post: Callable[[_T, _T], None] = opts.get("post")
    check: Callable[[_T], bool] = opts.get("check")
