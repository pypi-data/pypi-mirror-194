...
class _AbstractList(List[_T]):
    ...
    def chain(self, *iterable: Iterable) -> '_AbstractList':
        """
        A series of iterables are broken down into atomic units and returned by iterators.
        """
        return _AbstractList(itertools.chain(self, *iterable))
