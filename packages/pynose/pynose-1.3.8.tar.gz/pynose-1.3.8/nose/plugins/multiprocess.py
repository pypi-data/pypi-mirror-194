...
class MultiProcessTestRunner(TextTestRunner):
    # max time to wait to terminate a process that does not
    # respond to SIGILL
    waitkilltime = 5.0
                    ...
                    for iworker, w in enumerate(workers):
                        if w.is_alive():
                            ...
                            if (
                                ...
                                # If the process is in C++ code,
                                # sending a SIGILL might not send a python
                                # KeybordInterrupt exception,
                                # therefore, send multiple signals until an
                                # exception is caught. If this takes too long,
                                ...
                                while (
                                    ...
                                    if (
                                        ...
                                        # terminated process might send result,
