...
class Command(BaseCommand):
    ...
    def handle(self, *app_labels, **options):
        ...
        d_c_m.print_base_info()
        d_c_m_app_labels = d_c_m.app_labels()
        check_cache_table = d_c_m.check_cache_table_is_exist()
        # 缓存表存在，则更新本地文件
        if check_cache_table is True:
            for d_dcm_app_label in d_c_m_app_labels:
                d_c_m.get_app_migrations_from_db_cache(name=d_dcm_app_label)
