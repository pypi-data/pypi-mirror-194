...
def set_credentials_secret_path(project="emart-datafabric", mount_point="datafabric", path="gcp/emart-datafabric/datafabric"):
    global PROJECT_ID
    PROJECT_ID = project
...
def _bq_table_to_df(
    ...
    if not spark_session:
        spark_session = get_spark(key_mount=CREDENTIALS_SECRET_MOUNT_POINT, key_path=CREDENTIALS_SECRET_PATH)
