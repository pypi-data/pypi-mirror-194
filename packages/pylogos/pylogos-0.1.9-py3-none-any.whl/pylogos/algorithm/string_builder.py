...
class SStrChar:
    ...
    def __init__(
        self, text: str, table_node: str, column_node: Optional[str] = None, op_type: Optional[OperationType] = None
    ):
        self.ori_label = text
        self.text: str = text
    ...
    def __eq__(self, other):
        if type(other) == SStrChar:
            return (
                ...
                and self.column_node == other.column_node
            )
        return False
    ...
    def is_same_root(self, other):
        return (
            ...
            and remove_number_in_string(self.column_node) == remove_number_in_string(other.column_node)
        )
...
class StringBuilder:
    ...
    def add_selection(
        ...
        if type(operand) == SStrSen:
            ...
            operand_parent_sstr = (
                SStrChar(operand_parent.label, operand_parent.name, op_type=OperationType.Selection)
                if operand_parent
                else None
            )
