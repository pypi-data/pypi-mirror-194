...
class AiqClient(PendingOperationClient):
    ...
    def get_wrapped_segmentations(
        ...
        for segmentation in resp.segmentations:
            ...
            for segment in segmentation.segments:
                ...
                segment = self._convert_nan_features_in_filter(segment)
    ...
    def _convert_nan_features_in_filter(self, segment: Segment) -> Segment:
        """wrapper for util that converts nans in segment's filter_expression
        """
        return segment.filter_expression.CopyFrom(
            FilterProcessor._convert_nan_features_in_filter_expression(
