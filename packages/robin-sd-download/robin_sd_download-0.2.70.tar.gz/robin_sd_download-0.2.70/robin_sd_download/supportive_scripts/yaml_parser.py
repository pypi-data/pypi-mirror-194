...
def parse_config():
    config_files = [
        os.path.join(os.path.expanduser("/opt/robin/config/sd-download"), "sd-download-config.yml"),
        os.path.join(os.path.expanduser("/opt/robin/config/sd-download"), "sd-download-config.yaml"),
