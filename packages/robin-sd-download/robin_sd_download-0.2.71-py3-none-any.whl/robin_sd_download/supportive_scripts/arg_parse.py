...
def arg_parser():
    ...
    parser.add_argument('-i', '--info', action='store_true', help='info about the software version')
    ...
    if args.check:
        ...
        logger.log(message="Software info: " + str(software_info), log_level="info", to_file=True, to_terminal=True)
        sys.exit(0)
