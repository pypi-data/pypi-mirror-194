...
function register_task_definition() {
    ...
    # Remove tags
    cat ${TEMP_FILE} | jq 'del(.tags)' >${TEMP_FILE}.new
    mv ${TEMP_FILE}.new ${TEMP_FILE}
    ...
    def init_resource(self):
        ...
        if self.resource.configuration.disable_codepipeline == False:
            ...
            notification_rules_stack = self.stack_group.add_new_stack(
                ...
                extra_context={'env_name': env_name, 'rules_arn_ref_list': rules_arn_ref_list}
            )
...
"""
    ...
    def init_stage_action_codedeploy_deploy(self, action_config):
        ...
        if action_config.paco_service_hook != None and registry.CODEPIPELINE_CODEDEPLOY_INIT_STAGE_HOOK != None:
            ...
            codedeploy_delegate_role_arn = action_config._stack.template.get_tools_delegate_role_arn()
            self.artifacts_bucket_policy_resource_arns.append(codedeploy_delegate_role_arn)
