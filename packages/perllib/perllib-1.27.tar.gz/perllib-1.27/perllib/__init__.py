# perllib module for pythonizer, generated by makelib.py on Thu Feb 23 22:12:10 2023
#
...
_TIE_MAP = {'FETCH': '__getitem__','UNTIE': '__untie__','STORE': '__setitem__','PUSH': 'append','DESTROY': '__del__','CLEAR': 'clear','FETCHSIZE': '__len__','SCALAR': '__len__','DELETE': '__delitem__','EXISTS': '__contains__'}
...
LIST_SEPARATOR = ' '
AUTODIE = 0
_PYTHONIZER_KEYWORDS = {'try','any','getopt','await','types','abs','builtins','set','print','eval','float','compile','lambda','collections.abc','exec','itertools','fcntl','os','sys','and','nonlocal','map','bin','struct','hex','import','iter','extend','pdb','bool','dict','object','with','get','while','zip','input','finally','re','aiter','True','as','callable','or','complex','update','break','inspect','find','all','close','tuple','type','signal','rfind','yield','round','in','sorted','help','abc','warnings','isinstance','del','calendar','bytes','breakpoint','not','min','Hash','open','range','tempfile','copy','format','chr','return','insert','getattr','hash','issubclass','dataclasses','int','None','repr','lower','frozenset','property','argparse','casefold','random','keys','assert','for','list','filter','oct','continue','glob','class','max','ArrayHash','hasattr','fileinput','classmethod','values','else','False','memoryview','if','enumerate','elif','ord','subprocess','vars','Array','from','dir','perllib','setattr','locals','io','delattr','globals','stat','reversed','bytearray','is','super','staticmethod','except','anext','global','str','upper','divmod','def','raise','math','len','tm_py','pow','atexit','slice','codecs','id','rstrip','async','traceback','pop','ascii','next','functools','pass','sum','wantarray'}
