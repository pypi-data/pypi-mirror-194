...
def extract_linked_libraries(library_name: str, prefix: str) -> tuple[str, str | None, list[Any]]:
    lib = None
...
def extract_library_include_dirs(library_name: str, prefix: str) -> tuple[list, str]:
...
def find_ns3_from_search() -> (str, list, str):
    ...
    def filter_in_newest_ns3_libraries(libraries_to_filter: list, modules_to_filter: list) -> tuple[list, str | None]:
