...
class NoticeType(models.Model):
    ...
    id = models.AutoField("ID", primary_key=True)
    name = models.CharField(max_length=255, null=False, blank=False, verbose_name='提醒类型名称', )
    description = models.CharField(max_length=255, null=False, blank=False, verbose_name='类型描述', )
...
class Notice(models.Model):
    ...
    content = models.CharField(max_length=1250, null=False, blank=False, verbose_name='内容', default="")
    link_format = models.CharField(max_length=500, null=False, blank=False, verbose_name='不带参跳转链接', default="", help_text="跳转链接参数使用{}包含")
    link_params = models.JSONField(null=False, blank=False, verbose_name='链接json参数', default={})
