...
class KerasJsonModelImport:
    def __init__(self, custom_layers: Optional[Dict[str, Type[tf.keras.layers.Layer]]] = None) -> None:
        ...
        self.seen_inputs: List[InputInfo] = []
    ...
    def prepare_model_to_import(self, model_schema) -> None:
        ...
        self.ui_components = {layer['name']
            : layer for layer in ui_component_json}
    ...
    def generate_graph(
            self, model_schema: Dict, layer_name_to_inbound_nodes: Dict[str, List[Node]]) -> Tuple[Dict[str, NodeResponse], List[InputInfo]]:
    ...
    def _handle_input_layer(self, layer: Dict[str, Any]):
        ...
        self.seen_inputs.append(input_info)
        input_copy = {
            'type': 'Input',
