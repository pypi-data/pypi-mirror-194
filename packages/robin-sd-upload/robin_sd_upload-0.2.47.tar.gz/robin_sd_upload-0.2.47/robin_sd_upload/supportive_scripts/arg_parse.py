...
def arg_parser():
    ...
    parser.add_argument('-t', "--type", help="radar type")
    parser.add_argument('-n', "--number", help="version number of the software")
    parser.add_argument('-p', "--path", help="upload file absolute path")
