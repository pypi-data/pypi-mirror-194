...
def parse_config():
    config_files = [
        os.path.join(os.path.expanduser("/opt/robin/config/sd-upload"), "sd-upload-config.yml"),
        os.path.join(os.path.expanduser("/opt/robin/config/sd-upload"), "sd-upload-config.yaml"),
...
def used_config_file(cfg_file):
    # do not print it out multiple times
    if cfg_file == used_config_file.last_cfg_file:
        return
    used_config_file.last_cfg_file = cfg_file
    print(f"Config file found at {cfg_file}")
used_config_file.last_cfg_file = None
