...
def swinir(
    ...
    if os.path.getsize(os.path.join(package_dir, "002_lightweightSR_DIV2K_s64w8_SwinIR-S_x2.pth")) == 0:
    ...
    match model:
        case 0:
            model_name = "002_lightweightSR_DIV2K_s64w8_SwinIR-S_x2.pth"
            module = SwinIR(
                upscale=2,
                img_size=64,
                window_size=8,
            ...
            scale = 2
        case 1:
            model_name = "002_lightweightSR_DIV2K_s64w8_SwinIR-S_x3.pth"
            module = SwinIR(
                upscale=3,
                img_size=64,
                window_size=8,
