...
class Wire(BaseModel):
    ...
    __properties = ["amount", "bank_message", "creation_time", "currency", "customer_id", "direction", "effective_date", "id", "last_updated_time", "originating_account_id", "receiving_account_id", "recipient_message", "sender_reference_id", "status", "transaction_id"]
