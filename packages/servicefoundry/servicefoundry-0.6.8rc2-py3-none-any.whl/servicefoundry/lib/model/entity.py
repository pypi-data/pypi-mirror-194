...
class Workspace(Entity):
    ...
    # used in ./tests/unit_tests/test_internal_utils.py, can we change this to normal .to_dict() instead?
    def to_dict_for_session(
        self,
    ) -> Dict[str, Any]:
        return self.dict()
...
class DeploymentManifest(Base):
    ...
    type: str
    image: Optional[Dict[str, Any]]  # Change to Image pydantic class
    ports: Optional[List[PortMetadata]]
    resources: Optional[WorkspaceResources]
