...
class PrepareClusterBlock:
    ...
    def _start_or_create_cluster(  # noqa: C901, PLR0913
        self,
        project_id: str,
        build_id: str,
    ...
    def _start_cluster_if_required(  # noqa: PLR0913
        self,
        cluster: Session,
        start_required: bool,
        project_id: str,
    ...
    def _build_cluster_env_if_needed(  # noqa: PLR0913
        self,
        project_id: str,
        build_pr: Optional[int],
        build_commit: Optional[str],
    ...
    def _register_compute_template(
        ...
        created_template = self.api_client.create_compute_template_api_v2_compute_templates_post(
            create_compute_template=CreateComputeTemplate(
                name=f"autogenerated-config-{datetime.now().isoformat()}",
                project_id=project_id,
