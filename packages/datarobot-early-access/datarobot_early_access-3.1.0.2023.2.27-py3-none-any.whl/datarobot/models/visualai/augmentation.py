...
from datarobot.utils import deprecated, deprecation_warning, from_api
...
class ImageAugmentationSample(APIObject):
    ...
    def compute(cls, augmentation_list: "ImageAugmentationList", number_of_rows: int = 5) -> Any:
    ...
    @classmethod
    def list(
        cls, sample_id: Optional[str] = None, auglist_id: Optional[str] = None
