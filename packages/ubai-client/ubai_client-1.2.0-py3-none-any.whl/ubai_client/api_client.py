...
from ubai_client import rest
from ubai_client.configuration import Configuration
from ubai_client.exceptions import ApiTypeError, ApiValueError, ApiException
from ubai_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_artifact  # this is an instance of the class Endpoint
        api_instance.delete_artifact()  # this invokes api_instance.delete_artifact.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_artifact.callable or self.callable in this class
