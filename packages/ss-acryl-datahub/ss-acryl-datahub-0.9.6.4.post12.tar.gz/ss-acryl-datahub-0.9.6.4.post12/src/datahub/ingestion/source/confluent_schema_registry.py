...
class ConfluentSchemaRegistry(KafkaSchemaRegistryBase):
    ...
    def get_schema_str_replace_confluent_ref_avro(
        ...
        for schema_ref in schema.references:
            ...
            logger.info(f"Regference Schema ID: {reference_schema.schema_id}")
    ...
    def _get_schema_and_fields(
        ...
        if topic_subject is not None:
            ...
            try:
                ...
                logger.info(f"Latest version for topic-subject '{topic_subject}' is => {schema.version}")
                logger.info(f"Registered Schema ID: {schema.schema_id}")
            except Exception as e:
                logger.warning(
