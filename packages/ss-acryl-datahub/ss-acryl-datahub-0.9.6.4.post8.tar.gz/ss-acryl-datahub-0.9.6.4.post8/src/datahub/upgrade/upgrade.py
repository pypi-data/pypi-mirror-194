    ...
    if client_server_compat < 0:
        with contextlib.suppress(Exception):
            ...
            print(
                ...
                colored(
                    f"➡️ Downgrade via `\"pip install 'ss-acryl-datahub=={version_stats.server.current.version}'\"",
                    "cyan",
                ),
            )
        ...
        with contextlib.suppress(Exception):
            ...
            print(
                ...
                colored(
                    f"➡️  Upgrade via \"pip install 'ss-acryl-datahub=={version_stats.server.current.version}'\"",
                    "cyan",
                ),
            )
