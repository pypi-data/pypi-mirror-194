 ...
 *   Axis [ label="Axis" URL="\ref cqasm::v1::types::Axis"];
 *   Bool [ label="Bool" URL="\ref cqasm::v1::types::Bool"];
 *   Complex [ label="Complex" URL="\ref cqasm::v1::types::Complex"];
 *   ComplexMatrix [ label="ComplexMatrix" URL="\ref cqasm::v1::types::ComplexMatrix"];
 *   Int [ label="Int" URL="\ref cqasm::v1::types::Int"];
 *   Json [ label="Json" URL="\ref cqasm::v1::types::Json"];
 *   Qubit [ label="Qubit" URL="\ref cqasm::v1::types::Qubit"];
 *   Real [ label="Real" URL="\ref cqasm::v1::types::Real"];
 *   RealMatrix [ label="RealMatrix" URL="\ref cqasm::v1::types::RealMatrix"];
 *   String [ label="String" URL="\ref cqasm::v1::types::String"];
 *   TypeBase [ label="TypeBase" URL="\ref cqasm::v1::types::TypeBase", style=dotted];
 ...
 *   prim0 [ label="primitives::Int" URL="\ref cqasm::v1::primitives::Int"];
 *   ComplexMatrix -> prim0 [ label="num_rows", arrowhead=normal, style=solid, fontname=Helvetica, fontsize=10];
 *   prim1 [ label="primitives::Int" URL="\ref cqasm::v1::primitives::Int"];
 ...
 *   prim3 [ label="primitives::Int" URL="\ref cqasm::v1::primitives::Int"];
 *   RealMatrix -> prim3 [ label="num_cols", arrowhead=normal, style=solid, fontname=Helvetica, fontsize=10];
 *   prim4 [ label="primitives::Bool" URL="\ref cqasm::v1::primitives::Bool"];
