 ...
 *   BitRefs [ label="BitRefs" URL="\ref cqasm::v1::values::BitRefs"];
 *   ConstAxis [ label="ConstAxis" URL="\ref cqasm::v1::values::ConstAxis"];
 *   ConstBool [ label="ConstBool" URL="\ref cqasm::v1::values::ConstBool"];
 *   ConstComplex [ label="ConstComplex" URL="\ref cqasm::v1::values::ConstComplex"];
 *   ConstComplexMatrix [ label="ConstComplexMatrix" URL="\ref cqasm::v1::values::ConstComplexMatrix"];
 *   ConstInt [ label="ConstInt" URL="\ref cqasm::v1::values::ConstInt"];
 *   ConstJson [ label="ConstJson" URL="\ref cqasm::v1::values::ConstJson"];
 *   ConstReal [ label="ConstReal" URL="\ref cqasm::v1::values::ConstReal"];
 *   ConstRealMatrix [ label="ConstRealMatrix" URL="\ref cqasm::v1::values::ConstRealMatrix"];
 *   ConstString [ label="ConstString" URL="\ref cqasm::v1::values::ConstString"];
 *   Constant [ label="Constant" URL="\ref cqasm::v1::values::Constant", style=dotted];
 *   Function [ label="Function" URL="\ref cqasm::v1::values::Function"];
 *   QubitRefs [ label="QubitRefs" URL="\ref cqasm::v1::values::QubitRefs"];
 *   Reference [ label="Reference" URL="\ref cqasm::v1::values::Reference", style=dotted];
 *   VariableRef [ label="VariableRef" URL="\ref cqasm::v1::values::VariableRef"];
 ...
 *   prim11 [ label="types::Node" URL="\ref cqasm::v1::types::Node"];
 ...
 *   prim12 [ label="semantic::Variable" URL="\ref cqasm::v1::semantic::Variable"];
