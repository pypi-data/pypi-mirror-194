...
sys.path.extend([r"D:\Documents\Projets\SmartPowerManager"])
...
def lspm_command() -> None:
    ...
    start_parser = subparsers.add_parser("start", description="Start the Laptop Smart Power Manager.")
    start_parser.set_defaults(action=_start)

    config_parser = subparsers.add_parser("config", description="Launch the Smart Plug configuration interface.")
    ...
    compile_parser = subparsers.add_parser("compile", description="Create an executable version of LSPM.")
