...
class JobApi(object):
    ...
    def cancel(self, cancel_request, **kwargs):  # noqa: E501
        ...
        :param CancelRequest cancel_request:   (required)
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.cancel_with_http_info(cancel_request, **kwargs)  # noqa: E501
            return data

    def cancel_with_http_info(self, cancel_request, **kwargs):  # noqa: E501
        """Cancels the job with the job-id specified in the body payload.  # noqa: E501
        ...
        all_params = ['cancel_request']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('cancel_request' not in params or
                                                       params['cancel_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `cancel_request` when calling `cancel`")  # noqa: E501
