...
This tutorial takes you through the steps to run the xchembku back-end and gui from a conda environment.
...
1. start the conda environment
    ...
    ::
        ...
        module load xchem/xchembku/edge/conda

    you should see something like this::

        Xchembku is loaded.  Components are...
        {
            "versions": {
                "xchembku_cli": "1.4.1",
                "xchembku_lib": "1.4.1",
...
#. get tutorial configuration file
    ...
    ::
        ...
        curl --silent https://gitlab.diamond.ac.uk/xchem/xchembku/-/raw/main/configurations/tutorial.yaml >tutorial.yaml

#. start the services

    ::

        export XCHEMBKU_CONFIGFILE=tutorial.yaml
        xchembku_start
...
#. provide some images to be automatically collected
    ...
    ::
        ...
        cp -rv /dls_sw/apps/xchem/example_data/xchembku/example_images <some_scratch_directory> (the same as above)
