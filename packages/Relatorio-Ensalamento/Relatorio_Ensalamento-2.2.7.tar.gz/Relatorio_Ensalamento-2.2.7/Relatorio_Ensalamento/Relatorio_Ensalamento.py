...
def main(arquivo_carga_horaria, arquivo_capacidade, arquivo_xml, file_name,caminho_auxiliar):
    ...
    with open(f'{caminho_auxiliar}/Arquivos_Auxiliares/siglas.json', 'r', encoding="utf-8") as j:
        file_json_sigla = json.loads(j.read())

    with open(f'{caminho_auxiliar}/arquivos_Auxiliares/turmasfic.json', 'r', encoding="utf-8") as j:
        file_json_turmasfic = json.loads(j.read())

    with open(f'{caminho_auxiliar}/Arquivos_Auxiliares/escolas.json', 'r', encoding="utf-8") as j:
        file_json_escolas = json.loads(j.read())

    with open(f'{caminho_auxiliar}/Arquivos_Auxiliares/tipos.json', 'r', encoding="utf-8") as j:
