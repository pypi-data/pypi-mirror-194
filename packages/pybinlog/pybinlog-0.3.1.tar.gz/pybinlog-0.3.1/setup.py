...
#long_descr = "Contains file converter from Ardupilot's log files in bin format to CSV files for each message. Supports command line operation and gui as well."
