...
''',
    ...
    parser.add_argument('-v', "--version",    action="version", version="bandplot 0.1.0.1")
    ...
    parser.add_argument('-y', "--vertical",   type=float, nargs=2, help="energy range (eV)")
    ...
    parser.add_argument('-p', "--partial",    type=str,   nargs='+', default=[], help='the partial DOS to plot')
