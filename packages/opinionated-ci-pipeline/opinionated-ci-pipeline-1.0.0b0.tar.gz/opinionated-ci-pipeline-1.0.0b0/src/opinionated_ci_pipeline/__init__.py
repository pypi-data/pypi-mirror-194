...
class ApplicationProps:
    def __init__(
        ...
        *,
        ...
        :param project_name: (experimental) Short name identyfing the project. It will be used as a prefix for deployed resource names.
        :param repository: 
    ...
    def project_name(self) -> builtins.str:
        '''(experimental) Short name identyfing the project.
...
class _IStacksCreationProxy:
    ...
    def create(
        ...
        return typing.cast(None, jsii.invoke(self, "create", [scope, env_name]))
