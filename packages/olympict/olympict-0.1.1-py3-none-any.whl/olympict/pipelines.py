...
class ImagePipeline(OPipeline[OlympImage]):
    ...
    def draw_segmentation_maps(
        self, heatmap_func: Callable[[OlympImage], Img]
    ) -> "ImagePipeline":
...
class VideoPipeline(OPipeline[OlympVid]):
    ...
    def draw_relative_polygons(
        self, polygons: List[List[PointRelative]]
    ) -> "VideoPipeline":
        raise NotImplementedError()

    def draw_polygons(self, polygons: List[List[PointAbsolute]]) -> "VideoPipeline":
        raise NotImplementedError()

    def draw_relative_polygon(self, polygon: List[PointRelative]) -> "VideoPipeline":
        raise NotImplementedError()

    def draw_polygon(self, polygon: List[PointAbsolute]) -> "VideoPipeline":
        raise NotImplementedError()

    def draw_relative_bboxes(self, bboxes: List[BBoxRelative]) -> "VideoPipeline":
        raise NotImplementedError()

    def draw_bboxes(self, bboxes: List[BBoxAbsolute]) -> "VideoPipeline":
        raise NotImplementedError()

    def draw_heatmap(self, heatmap_func: Callable[[OlympVid], Img]) -> "VideoPipeline":
        raise NotImplementedError()
