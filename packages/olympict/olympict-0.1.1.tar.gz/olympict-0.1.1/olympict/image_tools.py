...
class ImTools:
    ...
    @staticmethod
    def draw_bbox(image: Img, bbox: BBoxAbsolute, color: Color) -> Img:
    ...
    @staticmethod
    def draw_relative_bbox(image: Img, bbox: BBoxRelative, color: Color) -> Img:
        h, w, _ = image.shape

        abs_bbox = ImTools.convert_bbox_relative_to_absolute(bbox, w, h)

        return ImTools.draw_bbox(image, abs_bbox, color)
