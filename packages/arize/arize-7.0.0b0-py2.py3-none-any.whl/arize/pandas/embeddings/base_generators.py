...
try:
    ...
    from transformers import AutoFeatureExtractor, AutoModel, AutoTokenizer  # type: ignore
...
class NLPEmbeddingGenerator(BaseEmbeddingGenerator):
    ...
    def tokenize(self, batch: Dict[str, List[str]], text_feat_name: str) -> Dict[str, torch.Tensor]:
