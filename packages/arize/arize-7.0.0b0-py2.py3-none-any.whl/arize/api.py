...
class Client:
    ...
    def log(
        ...
        prediction_label: Union[
            str, bool, int, float, Tuple[str, float], ObjectDetectionLabel
        ] = None,
        actual_label: Union[str, bool, int, float, Tuple[str, float], ObjectDetectionLabel] = None,
        ...
        :param prediction_label (bool, int, float, str, Tuple(str, float), or ObjectDetectionLabel;
        optional): The predicted value for a given model input. Defaults to None.
        :param actual_label (bool, int, float, str, Tuple[str, float], or ObjectDetectionLabel;
        optional):
        ...
        if actual_label is not None:
            ...
            a = pb2.Actual(
                actual_label=_get_label(
                    prediction_or_actual="actual", value=actual_label, model_type=model_type
                )
            )
...
def _validate_label(
    ...
    model_type: ModelTypes,
    label: Union[str, bool, int, float, Tuple[Union[str, bool], float], ObjectDetectionLabel],
