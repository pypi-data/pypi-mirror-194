...
@LastEditTime: 2023-02-24 10:40:12
...
class OrderBaseModel(FrameBaseModel):
    ...
    def update_prize_order_status(self,app_id,act_id,prize_order_id,order_status,express_company="",express_no="",prize_roster_sub_table=None):
        ...
        try:
            ...
            if order_status == 1:
                ...
                if order_status == 0:
                    prize_roster_model.update_table("logistics_status=0", "act_id=%s and order_no=%s", [prize_order.act_id,prize_order.order_no])
    ...
    def select_prize_order(self,app_id,act_id,user_id,login_token,prize_ids,real_name,telephone,province,city,county,street,address):
        ...
        if len(prize_ids_list)>0:
            prize_roster_list = prize_roster_model.get_list("act_id=%s and user_id=%s and id in (" + prize_ids + ") and prize_status=0",params=[act_id, user_id])
            ...
            prize_roster_list = prize_roster_model.get_list("act_id=%s and user_id=%s and prize_status=0",params=[act_id, user_id])
