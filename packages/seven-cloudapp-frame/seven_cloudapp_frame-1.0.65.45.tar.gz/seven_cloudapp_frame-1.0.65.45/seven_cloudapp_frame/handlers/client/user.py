...
@LastEditTime: 2023-02-15 13:33:05
...
class AssetLogListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        page_list = asset_base_model.get_asset_log_list(app_id, act_id, asset_type, page_size, page_index, user_id, asset_object_id, field=field, is_cache=True, operate_type=operate_type, page_count_mode=page_count_mode)
