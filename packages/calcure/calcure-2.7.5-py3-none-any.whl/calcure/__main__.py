...
from calcure.loaders import TaskLoaderCSV, TaskLoaderICS, EventLoaderCSV, EventLoaderICS, HolidayLoader, BirthdayLoader
...
def main(stdscr):
    """Main function that loads the data, runs and switches screens"""
