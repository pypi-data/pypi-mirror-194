...
class CloudWatchLogSet(Named):
    ...
    log_group_app_name = FieldProperty(schemas.ICloudWatchLogSet["log_group_app_name"])
    create_log_group = FieldProperty(schemas.ICloudWatchLogSet["create_log_group"])
