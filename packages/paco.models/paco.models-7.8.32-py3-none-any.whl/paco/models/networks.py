...
class VPCPeering(Named, Deployable):
    ...
    associate_private_hosted_zone = FieldProperty(schemas.IVPCPeering["associate_private_hosted_zone"])

@implementer(schemas.IVPCEIPs)
class VPCEIPs(Named, dict):
    pass

@implementer(schemas.IVPCEIPRegions)
class VPCEIPRegions(Named, dict):
    pass
@implementer(schemas.IVPCEIPAccounts)
class VPCEIPAccounts(Named, dict):
    pass
...
@implementer(schemas.IVPNClientEndpoint)
class VPNClientEndpoint(Named, Deployable):
    availability_zone = FieldProperty(schemas.IVPNClientEndpoint["availability_zone"])
    segment = FieldProperty(schemas.IVPNClientEndpoint["segment"])
    self_service_portal = FieldProperty(schemas.IVPNClientEndpoint["self_service_portal"])
    session_timeout_hours = FieldProperty(schemas.IVPNClientEndpoint["session_timeout_hours"])
    split_tunnel = FieldProperty(schemas.IVPNClientEndpoint["split_tunnel"])
    transport_protocol = FieldProperty(schemas.IVPNClientEndpoint["transport_protocol"])
    vpn_port = FieldProperty(schemas.IVPNClientEndpoint["vpn_port"])
    client_cidr_block = FieldProperty(schemas.IVPNClientEndpoint["client_cidr_block"])
    security_groups = FieldProperty(schemas.IVPNClientEndpoint["security_groups"])
    server_certificate_arn = FieldProperty(schemas.IVPNClientEndpoint["server_certificate_arn"])
...
class VPC(Named, Deployable):
    ...
    eip = FieldProperty(schemas.IVPC["eip"])
    ...
    vpn_client_endpoint = FieldProperty(schemas.IVPC["vpn_client_endpoint"])
...
@implementer(schemas.IVPCEIP)
class VPCEIP(Named, Deployable):
    allocation_id = FieldProperty(schemas.IVPCEIP["allocation_id"])
    ip_address = FieldProperty(schemas.IVPCEIP["ip_address"])
...
class NATGateway(Named, Deployable):
    ...
    ec2_instance_ami = FieldProperty(schemas.INATGateway["ec2_instance_ami"])
    eips = FieldProperty(schemas.INATGateway["eips"])
