...
# General parameters
name = 'floodgb'
main_package = 'floodgb'
version = '0.0.2'
descrip = 'A flood model'
...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['numpy', 'pandas', 'scipy', 'scikit-learn', 'booklet', 'skops', 'matplotlib', 'orjson']
