...
class Coomer(Common):
    ...
    async def content_page_download(self, url_dictionary: UrlDictionary) -> None:
        ...
        album_name = re_content_page.match(url_dictionary['url']).group(12)
        url_to_record = url_dictionary['url']
        ...
        for href in all_content:
            ...
            url_dictionary['album_name'] = album_name
            url_dictionary['count'] = count
            url_dictionary['description'] = description
