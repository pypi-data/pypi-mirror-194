...
async def update_one_with_changes(self, patch: {node_name}Patch, *, client: AsyncIOClient | None = None, {params_fields_str}) -> tuple[{node_name}, CHANGES]:
{indent_lines(validation_str)}
...
async def build_nodes_and_resolvers(
    ...
    object_types = await introspect_objects(client, db_config.global_objects)
