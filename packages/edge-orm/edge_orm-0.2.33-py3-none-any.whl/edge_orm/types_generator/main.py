...
async def update_one_with_changes(self, patch: {node_name}Patch, *, client: AsyncIOClient | None = None, {params_fields_str}) -> tuple[{node_name}, dict[str, tuple[T.Any, T.Any]]]:
{indent_lines(validation_str)}
