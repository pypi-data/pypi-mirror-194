...
const ReactWidget = (props) => {
    ...
    const [data, setData] = react_1.useState((_a = props.model.get("data")) !== null && _a !== void 0 ? _a : "");
    const [error, setError] = react_1.useState((_b = props.model.get("error")) !== null && _b !== void 0 ? _b : "");
    ...
    const [execTime, setExecTime] = react_1.useState((_c = props.model.get("exec_time")) !== null && _c !== void 0 ? _c : "");
    ...
    (_g = props.model) === null || _g === void 0 ? void 0 : _g.on("sort", (msg) => {
        var _a, _b;
        (_a = props.model) === null || _a === void 0 ? void 0 : _a.set("index_sort", msg, "");
        (_b = props.model) === null || _b === void 0 ? void 0 : _b.save_changes();
    });
    (_h = props.model) === null || _h === void 0 ? void 0 : _h.on("setRange", (msg) => {
        var _a, _b;
        (_a = props.model) === null || _a === void 0 ? void 0 : _a.set("data_range", msg, "");
        (_b = props.model) === null || _b === void 0 ? void 0 : _b.save_changes();
    });
    (_j = props.model) === null || _j === void 0 ? void 0 : _j.on("hist", (msg) => {
        setHist(msg);
    });
    (_k = props.model) === null || _k === void 0 ? void 0 : _k.on("execTime", (msg) => {
    ...
    return (react_1.default.createElement("div", { className: "Widget" },
        react_1.default.createElement(core_1.Stack, { spacing: 0, align: "center" },
            show ?
                react_1.default.createElement(input_1.WidgetInputArea, { model: props.model, page: page, setPage: setPage })
                :
            ...
            react_1.default.createElement(core_1.Group, { sx: { width: "95%" }, position: "center" }, data ?
                react_1.default.createElement(table_1.DataTable, { data: data, model: props.model, page: page, setPage: setPage, rowNumber: rowNumber, setRowNumber: setRowNumber, hist: hist, execTime: execTime })
                :
...
__exportStar(__webpack_require__(/*! ./outname */ "./lib/input/outname.js"), exports);
...
const outname_1 = __webpack_require__(/*! ./outname */ "./lib/input/outname.js");
...
const WidgetInputArea = ({ model, page, setPage }) => {
    var _a;
    ...
    const [sqlContent, setSqlContent] = react_1.useState((_a = model.get("value")) !== null && _a !== void 0 ? _a : "");
    model === null || model === void 0 ? void 0 : model.on("importData", (msg) => {
        setSqlContent("select * from " + msg);
    });
    model === null || model === void 0 ? void 0 : model.on("error", (msg) => {
        setOpenTimer(false);
    });
    model === null || model === void 0 ? void 0 : model.on("hist", (msg) => {
        setOpenTimer(false);
    });
    react_1.useEffect(() => {
    ...
    return (react_2.default.createElement(react_2.default.Fragment, null,
        react_2.default.createElement(core_1.Group, { position: "apart", align: "center", sx: {
            ...
            react_2.default.createElement(dataimport_1.DataImport, { model: model }),
            react_2.default.createElement(outname_1.NameOutput, { model: model })),
        ...
        react_2.default.createElement(core_1.Group, { sx: { width: "95%" } },
...
//# sourceMappingURL=outname.js.map
...
const DataframeHeader = ({ headerContent, header, model, data }) => {
    const Order = {
        Increasing: 1,
        Descending: -1,
        None: 0,
    };
    const [order, setOrder] = react_1.useState(model.get("index_sort")[1]);
    let currentOrder = Order.None;
    const [col, setColName] = react_1.useState(model.get("index_sort")[0]);
...
const DataTable = ({ data, model, page, setPage, rowNumber, setRowNumber, hist, execTime }) => {
    ...
    return (react_2.default.createElement(core_1.Stack, { align: "center", spacing: 10, sx: {
        ...
        react_2.default.createElement(core_1.ScrollArea, { scrollbarSize: 3, style: { width: "100%" } },
            react_2.default.createElement(core_1.Table, { withBorder: true, withColumnBorders: true, striped: true, sx: {
                ...
                react_2.default.createElement(header_1.DataframeHeader, { headerContent: headerContent, header: header, model: model, data: data }),
...
//# sourceMappingURL=lib_WidgetModel_js.fcd14466372df70c1ee9.js.map