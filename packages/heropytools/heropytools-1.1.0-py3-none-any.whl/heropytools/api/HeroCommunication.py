...
class HeroCommunication:
    ...
    """
    _type_dict: dict = {str: "HeroString", np.ndarray: "HeroArray", pd.DataFrame: "HeroTable",
                        pd.Series: "HeroColumn", float: "HeroArray", int: "HeroArray", bool: "HeroArray",
                        complex: "HeroArray", dict: "HeroStruct", list: "HeroList"}
    ...
    def set_output(self, data, path: str, sub_path: str):
        ...
        if isinstance(data, HeroData):
            ...
            if type(data) in HeroCommunication._type_dict:
                type_str = HeroCommunication._type_dict[type(data)]
    ...
    _io_name_to_enum = {'Text': NodeIOType.String, 'Numeric Array': NodeIOType.NumericArray, 
                        ...
                        'Column': NodeIOType.Column, 'Contour': NodeIOType.Contour, 'Text List': NodeIOType.StringList,
                        'Mask List': NodeIOType.MaskList, 'Structure List': NodeIOType.StructList, 'List of Lists':NodeIOType.ListOfLists,
                        'Table List': NodeIOType.TableList, 'Column List': NodeIOType.ColumnList, 
                        'Numeric Array List': NodeIOType.NumericArrayList, 'Boolean Array List': NodeIOType.BooleanArrayList,
...
class NodeStatus:
    ...
    def __init__(self, hero_communication: HeroCommunication):
        self._hero_communication = hero_communication
