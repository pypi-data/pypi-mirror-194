...
from eigenapi_client.endpoints.schema import LatestBlock, Token, Pool, SandwichDetail, LiquidationDetail, LendingDetail, Transaction, LatestBlock, PoolSandwiched, ERROR_CODE