...
class Dataset():
    ...
    def edit_dataset_readme(self, readme):

        url = "{}/smartdataset/datasets/{}/metadata".format(self._base_url_askdata, self._dataset_id)
        ...
        r = s.put(url=url, headers=self._headers, verify=True, json=data)
        r.raise_for_status()
