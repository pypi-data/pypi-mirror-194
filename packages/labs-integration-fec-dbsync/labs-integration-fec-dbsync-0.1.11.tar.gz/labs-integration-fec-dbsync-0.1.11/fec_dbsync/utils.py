...
def get_registration_and_act_hi_var_from_dwh(appId):
    SQL = "SELECT * DWROBOWLBL.LOS_USER_REGISTRATION_DATA s WHERE s.REGISTRATION_ID = '{}' OR s.EX_APPLICATION_ID = '{}'"
    ...
    if not cursorRegis:
        ...
        SQL = "SELECT * DWROBOLENDING.LOS_USER_REGISTRATION_DATA s WHERE s.REGISTRATION_ID = '{}'"
