...
def print_error_list(limit=None):
    ...
    utils.printFormated(res['records'],"Id:LastModifiedDate:vlocity_cmt__ActionContainerComponent__c:vlocity_cmt__TrackingService__c:Name:Error",rename="vlocity_cmt__ActionContainerComponent__c%acc:LastModifiedDate%Time")
