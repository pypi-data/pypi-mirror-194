...
class App(object):
    ...
    def get_custom_executable_files(self, local=None):
        executable_files = []
    ...
    def get_non_distributed_files(self):
        return self.distsearch_conf().get_replication_blacklist_files()

    def get_transforms_executable_files(self):
        return self.transforms_conf().get_external_executable_file_path_list()
    ...
    def distsearch_conf(self, dir="default"):
        return self.get_config(
            "distsearch.conf",
            dir=dir,
            config_file=distsearch_configuration_file.DistsearchConfigurationFile(self),
        )
    ...
    def transforms_conf(self, dir="default"):
        return self.get_config(
            "transforms.conf",
            dir=dir,
            config_file=transforms_configuration_file.TransformsConfigurationFile(self),
        )
