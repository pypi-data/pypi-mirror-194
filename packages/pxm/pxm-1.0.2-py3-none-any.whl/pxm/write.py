...
from pxm.exists import _exists
...
class Write:
	...
	def Set(self, max_save=500, add=True, head=True, line=None, speed_sum=100, serial_number=False):
		"""
		设置写入参数
		:param max_save: 需要保存的最大间隔数量(默认500)
