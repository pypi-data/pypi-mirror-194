...
class S3Dataset(Dataset):
    ...
    def __init__(self) -> None:
        ...
        self.default_secret_access_key = os.environ.get(
    ...
    def _download_file(
        self, bucket: str, service_client, remote_file_path: str, local_path: str
    ):
            ...
            if err.response["Error"]["Code"] == "404":
                ...
                try:
                    ...
                    self._download_folder(
                        bucket, service_client, remote_folder_path, local_path
                    )
                    ...
                    raise S3ObjectNotFound(
                        path=remote_file_path, bucket=bucket
                    )  # attempt of search as a folder failed
            else:
                raise err
    ...
    def set_data(
        ...
        *,
        ...
        service_client = client(
            ...
            else self.default_access_key_id,
            aws_secret_access_key=aws_secret_access_key
            if aws_secret_access_key
            else self.default_secret_access_key,
