...
def upload_files(dat, unfold=True):
    ...
    try:
        ...
        segmentation_file = dat[dat["channel"]=="Trans"]["file_name"].iloc[0]
...
files = glob(r"D:\DFP Data\100223_ConorDFP_Plate2_NR+DAPI\Agarose Pillar_001\data\*.xml")  
# files = glob(r"D:\DFP Data\080223_ConorDFP_Plate1_NR+DAPI\Agarose Pillar_001\data\*.xml")  
...
for file_name,data in file_data.items():
    ...
    if data["time_index"]==0:
        ...
        file_data[file_name]["usermeta2"] = "Plate2"
...
upload_data = upload_data.sort_values(["well_position","position_index"])
...
user_metadata["file_list"] = user_metadata["file_list"].apply(lambda data: extract_list(data))
user_metadata["channel_list"] = user_metadata["channel_list"].apply(lambda data: extract_list(data, mode="channel"))
...
user_metadata = user_metadata.drop_duplicates(["segmentation_file", "folder", "content"])

# user_metadata = user_metadata[user_metadata["user_meta1"]!="Direct From Plate"]
