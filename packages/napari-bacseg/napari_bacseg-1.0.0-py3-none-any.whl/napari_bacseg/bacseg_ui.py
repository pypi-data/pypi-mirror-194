...
class Ui_tab_widget:
    def setupUi(self, tab_widget):
        ...
        self.import_mode.addItem("")
        self.formLayout_8.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.import_mode
        )
        ...
        self.image_metadata_controls.setWidget(
            4, QtWidgets.QFormLayout.LabelRole, self.label_76
        )
        ...
        self.image_metadata_controls.setWidget(
            4, QtWidgets.QFormLayout.FieldRole, self.upload_antibiotic
        )
        self.label_77 = QtWidgets.QLabel(self.experiment_metadata)
        self.label_77.setObjectName("label_77")
        self.image_metadata_controls.setWidget(
            5, QtWidgets.QFormLayout.LabelRole, self.label_77
        )
        ...
        self.image_metadata_controls.setWidget(
            5, QtWidgets.QFormLayout.FieldRole, self.upload_treatmenttime
        )
        self.label_78 = QtWidgets.QLabel(self.experiment_metadata)
        self.label_78.setObjectName("label_78")
        self.image_metadata_controls.setWidget(
            6, QtWidgets.QFormLayout.LabelRole, self.label_78
        )
        ...
        self.image_metadata_controls.setWidget(
            6, QtWidgets.QFormLayout.FieldRole, self.upload_abxconcentration
        )
        self.label_79 = QtWidgets.QLabel(self.experiment_metadata)
        self.label_79.setObjectName("label_79")
        self.image_metadata_controls.setWidget(
            7, QtWidgets.QFormLayout.LabelRole, self.label_79
        )
        ...
        self.upload_mount.addItem("")
        self.image_metadata_controls.setWidget(
            7, QtWidgets.QFormLayout.FieldRole, self.upload_mount
        )
        self.label_80 = QtWidgets.QLabel(self.experiment_metadata)
        self.label_80.setObjectName("label_80")
        self.image_metadata_controls.setWidget(
            8, QtWidgets.QFormLayout.LabelRole, self.label_80
        )
        ...
        self.image_metadata_controls.setWidget(
            8, QtWidgets.QFormLayout.FieldRole, self.upload_protocol
        )
        ...
        self.database_download_buttons_2.addWidget(
            self.download_sort_order, 0, 1, 1, 1
        )
        ...
        self.database_download_limit.addItem("")
        self.database_download_buttons_2.addWidget(
            self.database_download_limit, 1, 1, 1, 1
        )
        ...
        self.database_upload_options_2.setObjectName(
            "database_upload_options_2"
        )
        ...
        self.database_upload_options_2.addWidget(
            self.overwrite_all_metadata, 1, 1, 1, 1
        )
        ...
        self.database_upload_options_2.addWidget(
            self.upload_overwrite_images, 0, 0, 1, 1
        )
        ...
        self.database_upload_options_2.addWidget(
            self.upload_overwrite_masks, 0, 1, 1, 1
        )
        ...
        self.database_upload_options_2.addWidget(
            self.overwrite_selected_metadata, 1, 0, 1, 1
        )
    ...
    def retranslateUi(self, tab_widget):
        ...
        self.import_mode.setItemText(
            3, _translate("tab_widget", "ImageJ files(s)")
        )
        self.import_mode.setItemText(
            4, _translate("tab_widget", "Mask (.tif) Segmentation(s)")
        )
        self.import_mode.setItemText(
            5, _translate("tab_widget", "Cellpose (.npy) Segmentation(s)")
        )
        self.import_mode.setItemText(
            6, _translate("tab_widget", "Oufti (.mat) Segmentation(s)")
        )
        self.import_mode.setItemText(
            7, _translate("tab_widget", "JSON (.txt) Segmentation(s)")
        )
        ...
        self.import_multiframe_mode.setItemText(
            0, _translate("tab_widget", "Keep First Frame")
        )
        self.import_multiframe_mode.setItemText(
            1, _translate("tab_widget", "Keep Brightest Frame")
        )
        self.import_multiframe_mode.setItemText(
            2, _translate("tab_widget", "Average Frames")
        )
        self.import_multiframe_mode.setItemText(
            3, _translate("tab_widget", "Sum Frames")
        )
        ...
        self.import_clear_previous.setText(
            _translate("tab_widget", "Clear previous images")
        )
        ...
        tab_widget.setTabText(
            ...
            _translate("tab_widget", "Cellpose"),
        )
        ...
        tab_widget.setTabText(
            tab_widget.indexOf(self.tab_3), _translate("tab_widget", "Edit")
        )
        ...
        self.download_sort_order.setItemText(
            0, _translate("tab_widget", "Random")
        )
        self.download_sort_order.setItemText(
            1, _translate("tab_widget", "Date Uploaded (Ascending)")
        )
        self.download_sort_order.setItemText(
            2, _translate("tab_widget", "Date Uploaded (Descending)")
        )
        self.download_sort_order.setItemText(
            3, _translate("tab_widget", "Date Modifed (Ascending)")
        )
        self.download_sort_order.setItemText(
            4, _translate("tab_widget", "Date Modifed (Descending)")
        )
        ...
        self.export_active.setText(
            _translate("tab_widget", "Export Data From Active Image")
        )
        self.export_all.setText(
            _translate("tab_widget", "Export Data From All Images")
        )
        ...
        tab_widget.setTabText(
            tab_widget.indexOf(self.tab_14), _translate("tab_widget", "Misc")
        )
