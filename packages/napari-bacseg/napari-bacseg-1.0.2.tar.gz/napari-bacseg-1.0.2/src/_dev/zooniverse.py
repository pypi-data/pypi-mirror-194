...
def export_zooniverse_cells(measurement):
    ...
    try:
        ...
        if strain in ["64017","48480"]:
            resistantance = "susceptible"
        else:
            resistantance = "resistant"
        
        file_index = 0
        
        export_directory = os.path.join(zooniverse_path,resistantance)
...
zooniverse_path = r"\\physics\dfs\DAQ\CondensedMatterGroups\AKGroup\Piers\Zooniverse\dataset2022"
zooniverse_path = r"C:\Users\turnerp\Documents\ZooniverseTest_treated"
...
user_metadata = user_metadata[(user_metadata["content"]is"E.Coli Clinical") &
                              (user_metadata["user_meta1"]is"Zooniverse") &
                              (user_metadata["antibiotic"]is"Ciprofloxacin")]
...
export_zooniverse_cells(measurements[0].copy())
