...
=== railway.one.to.many.delete.secondary
...
The type of data that the reader is reading. This is the reader version of `ogr.output.format`
This is used to pass the input format (OSM or OGR) to translation scripts to
enable format specific translations.
The OGR Reader changes this to be 'OGR'. All of the other readers use the default value.
