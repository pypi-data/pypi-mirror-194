...
from cortex_cli.core._cortex_data import CortexData
from cortex_cli.core._ethics_checks import EthicsManager, EthicsTypeEnum
from cortex_cli.core._drift_checks import DriftManager, DriftTypeEnum
...
class CortexModel(mlflow.pyfunc.PythonModel):
    ...
    def predict(self, context, model_input):
        """Predicts using a TBD model
            ...
            Parameters:
            context: (mlflow.pyfunc.PythonModelContext): Provided automatically during deployment, can be None during training
