#!/usr/bin/env python
"""
Package metadata for openedx_course_export.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_course_export', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""A django app plugin to add a new API to Open edX to export courses to S3 buckets""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/openedx_course_export',
    packages=find_packages(
        include=['openedx_course_export', 'openedx_course_export.*'],
        exclude=["*tests"],
    ),
