...
from ..models.account_identifier_country_specific_details_request_bank_code_type import (
    AccountIdentifierCountrySpecificDetailsRequestBankCodeType,
)
from ..models.account_identifier_country_specific_details_request_bank_country import (
    AccountIdentifierCountrySpecificDetailsRequestBankCountry,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AccountIdentifierCountrySpecificDetailsRequest")


@attr.s(auto_attribs=True)
class AccountIdentifierCountrySpecificDetailsRequest:
    """
    Example:
    ...
    Attributes:
        ...
        bank_code (Union[Unset, str]): The code identifying the target bank on its respective national network. This is
            ...
            Canada, and so on.
        bank_code_type (Union[Unset, AccountIdentifierCountrySpecificDetailsRequestBankCodeType]): The code type
            ...
            ABA.
        bank_country (Union[Unset, AccountIdentifierCountrySpecificDetailsRequestBankCountry]): The country in which the
    ...
    bank_code_type: Union[
        Unset, AccountIdentifierCountrySpecificDetailsRequestBankCodeType
    ] = UNSET
    bank_country: Union[Unset, AccountIdentifierCountrySpecificDetailsRequestBankCountry] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bank_code_type: Union[Unset, AccountIdentifierCountrySpecificDetailsRequestBankCodeType]
        if isinstance(_bank_code_type, Unset):
            bank_code_type = UNSET
        else:
            bank_code_type = AccountIdentifierCountrySpecificDetailsRequestBankCodeType(
                _bank_code_type
            )

        _bank_country = d.pop("bankCountry", UNSET)
        bank_country: Union[Unset, AccountIdentifierCountrySpecificDetailsRequestBankCountry]
        if isinstance(_bank_country, Unset):
            bank_country = UNSET
        else:
            bank_country = AccountIdentifierCountrySpecificDetailsRequestBankCountry(_bank_country)
        ...
        account_identifier_country_specific_details_request = cls(
        ...
        account_identifier_country_specific_details_request.additional_properties = d
        return account_identifier_country_specific_details_request
