...
def _get_kwargs(
    *,
    ...
    name_type: Union[Unset, None, GetAccountsNameType] = UNSET,
    name_value: Union[Unset, None, str] = UNSET,
    ...
    json_name_type: Union[Unset, None, str] = UNSET
    if not isinstance(name_type, Unset):
        json_name_type = name_type.value if name_type else None
    ...
    *,
    ...
    Args:
        ...
        identifier_type (Union[Unset, None, str]): Accounts that contain this identifier type
            Example: SCAN.
        name_type (Union[Unset, None, GetAccountsNameType]):
        name_value (Union[Unset, None, str]):
