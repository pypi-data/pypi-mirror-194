...
T = TypeVar("T", bound="AccountCustomerTaxProfileResponse")


@attr.s(auto_attribs=True)
class AccountCustomerTaxProfileResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        account_customer_tax_profile_response = cls(
            tax_identifier=tax_identifier,
        )

        account_customer_tax_profile_response.additional_properties = d
        return account_customer_tax_profile_response
