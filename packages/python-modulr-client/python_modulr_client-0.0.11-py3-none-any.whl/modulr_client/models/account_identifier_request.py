...
from ..models.account_identifier_request_type import AccountIdentifierRequestType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.account_identifier_country_specific_details_request import (
        AccountIdentifierCountrySpecificDetailsRequest,
    )


T = TypeVar("T", bound="AccountIdentifierRequest")


@attr.s(auto_attribs=True)
class AccountIdentifierRequest:
    """
    Attributes:
        account_number (Union[Unset, str]):  Example: 12345678.
        bic (Union[Unset, str]):  Example: MODRGB21.
        country_specific_details (Union[Unset, AccountIdentifierCountrySpecificDetailsRequest]):  Example:
            {'branchCode': '123456789'}.
        currency (Union[Unset, str]):  Example: GBP.
        iban (Union[Unset, str]):  Example: GB20MODR00000000000001.
        sort_code (Union[Unset, str]):  Example: 000000.
        type (Union[Unset, AccountIdentifierRequestType]):
    """

    account_number: Union[Unset, str] = UNSET
    bic: Union[Unset, str] = UNSET
    country_specific_details: Union[
        Unset, "AccountIdentifierCountrySpecificDetailsRequest"
    ] = UNSET
    currency: Union[Unset, str] = UNSET
    iban: Union[Unset, str] = UNSET
    sort_code: Union[Unset, str] = UNSET
    type: Union[Unset, AccountIdentifierRequestType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        country_specific_details: Union[Unset, AccountIdentifierCountrySpecificDetailsRequest]
        if isinstance(_country_specific_details, Unset):
            country_specific_details = UNSET
        else:
            country_specific_details = AccountIdentifierCountrySpecificDetailsRequest.from_dict(
        ...
        if isinstance(_type, Unset):
            ...
            type = AccountIdentifierRequestType(_type)

        account_identifier_request = cls(
        ...
        account_identifier_request.additional_properties = d
        return account_identifier_request
