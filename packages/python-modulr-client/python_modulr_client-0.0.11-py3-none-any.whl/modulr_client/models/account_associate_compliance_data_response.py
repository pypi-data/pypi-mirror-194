...
T = TypeVar("T", bound="AccountAssociateComplianceDataResponse")


@attr.s(auto_attribs=True)
class AccountAssociateComplianceDataResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        account_associate_compliance_data_response = cls(
            relationship=relationship,
        )

        account_associate_compliance_data_response.additional_properties = d
        return account_associate_compliance_data_response
