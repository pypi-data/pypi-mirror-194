...
from ..models.account_address_request_country import AccountAddressRequestCountry
from ..types import UNSET, Unset

T = TypeVar("T", bound="AccountAddressRequest")
...
class AccountAddressRequest:
    ...
    Attributes:
        ...
        country (Union[Unset, AccountAddressRequestCountry]):
    ...
    country: Union[Unset, AccountAddressRequestCountry] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        account_address_request.additional_properties = d
        return account_address_request
