...
from ..models.account_identifier_country_specific_details_response_bank_code_type import (
    AccountIdentifierCountrySpecificDetailsResponseBankCodeType,
)
from ..models.account_identifier_country_specific_details_response_bank_country import (
    AccountIdentifierCountrySpecificDetailsResponseBankCountry,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AccountIdentifierCountrySpecificDetailsResponse")


@attr.s(auto_attribs=True)
class AccountIdentifierCountrySpecificDetailsResponse:
    """
    Example:
    ...
    Attributes:
        ...
        bank_code (Union[Unset, str]): The code identifying the target bank on its respective national network. This is
            ...
            Canada, and so on.
        bank_code_type (Union[Unset, AccountIdentifierCountrySpecificDetailsResponseBankCodeType]): The code type
            identifying the target bank on its respective national network.
            This is known as the 'ABA code' in the U.S., 'ISFC' in India, 'routing number' in Canada, and so on. Example:
            ABA.
        bank_country (Union[Unset, AccountIdentifierCountrySpecificDetailsResponseBankCountry]): The country in which
            the destination bank resides. Example: US.
    ...
    bank_code_type: Union[
        Unset, AccountIdentifierCountrySpecificDetailsResponseBankCodeType
    ] = UNSET
    bank_country: Union[Unset, AccountIdentifierCountrySpecificDetailsResponseBankCountry] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bank_code_type: Union[Unset, AccountIdentifierCountrySpecificDetailsResponseBankCodeType]
        if isinstance(_bank_code_type, Unset):
            bank_code_type = UNSET
        else:
            bank_code_type = AccountIdentifierCountrySpecificDetailsResponseBankCodeType(
                _bank_code_type
            )

        _bank_country = d.pop("bankCountry", UNSET)
        bank_country: Union[Unset, AccountIdentifierCountrySpecificDetailsResponseBankCountry]
        if isinstance(_bank_country, Unset):
            bank_country = UNSET
        else:
            bank_country = AccountIdentifierCountrySpecificDetailsResponseBankCountry(
                _bank_country
            )
        ...
        account_identifier_country_specific_details_response = cls(
        ...
        account_identifier_country_specific_details_response.additional_properties = d
        return account_identifier_country_specific_details_response
