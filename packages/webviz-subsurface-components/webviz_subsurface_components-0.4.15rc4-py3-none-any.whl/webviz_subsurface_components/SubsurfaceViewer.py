...
- legend (dict; optional):
    @deprecated Legends should be added as annotations. This prop has
    no function.
...
- toolbar (dict; optional):
    @deprecated Toolbar should be added as annotation. This prop has
    no function.
...
- views (boolean | number | string | dict | list; default {    layout: [1, 1],    showLabel: False,    viewports: [{ id: "main-view", show3D: False, layerIds: [] }],}):
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, resources=Component.UNDEFINED, layers=Component.UNDEFINED, bounds=Component.UNDEFINED, views=Component.UNDEFINED, coords=Component.UNDEFINED, scale=Component.UNDEFINED, coordinateUnit=Component.UNDEFINED, toolbar=Component.UNDEFINED, legend=Component.UNDEFINED, colorTables=Component.UNDEFINED, editedData=Component.UNDEFINED, checkDatafileSchema=Component.UNDEFINED, onMouseEvent=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'bounds', 'checkDatafileSchema', 'colorTables', 'coordinateUnit', 'coords', 'editedData', 'layers', 'legend', 'resources', 'scale', 'toolbar', 'views']
        self._type = 'SubsurfaceViewer'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'bounds', 'checkDatafileSchema', 'colorTables', 'coordinateUnit', 'coords', 'editedData', 'layers', 'legend', 'resources', 'scale', 'toolbar', 'views']
        ...
        super(SubsurfaceViewer, self).__init__(**args)
