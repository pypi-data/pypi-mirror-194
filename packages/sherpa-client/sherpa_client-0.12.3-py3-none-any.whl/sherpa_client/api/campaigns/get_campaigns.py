...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["Campaign"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_campaign_array_item_data in _response_200:
            componentsschemas_campaign_array_item = Campaign.from_dict(componentsschemas_campaign_array_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["Campaign"]]:
    return Response(
