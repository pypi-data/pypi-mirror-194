...
class Control:
    ...
    def __init__(self, cntl_filename: Path) -> None:

        self.cntl_filename: Path = cntl_filename
    ...
    def content_to_file(self) -> None:
        """write content to file"""
        content: list[str] = self.beginning + self.middle + self.ending
        self.__list_to_file(self.cntl_filename, content)
