          ...
          ${this._step?i.dy`${"abort"===this._step.type?i.dy` <ha-markdown
                  ...
                  ></ha-markdown>`:"create_entry"===this._step.type?i.dy`<p>
                    ...
                    <ha-form
                      .hass=${this.hass}
                      .data=${this._stepData}
                      .schema=${(0,o.oT)(this._step.data_schema)}
