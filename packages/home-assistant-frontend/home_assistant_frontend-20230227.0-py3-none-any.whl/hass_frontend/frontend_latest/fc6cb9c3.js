        ...
        <div>
          ...
          ${this._params.selectedDomain&&!this._description?r.dy`<p>
                ...
                ${null!==(e=this._manifest)&&void 0!==e&&e.is_built_in||null!==(t=this._manifest)&&void 0!==t&&t.documentation?r.dy`<a
                      href=${this._manifest.is_built_in?(0,c.R)(this.hass,`/integrations/${this._domain}`):this._manifest.documentation}
                      target="_blank"
                      rel="noreferrer"
                    >
          ...
          ${this._params.selectedDomain&&this._description?"":r.dy`<p>
                ...
                <a
                  href=${(0,c.R)(this.hass,"/integrations/application_credentials")}
                  target="_blank"
                  rel="noreferrer"
                >
...
//# sourceMappingURL=fc6cb9c3.js.map