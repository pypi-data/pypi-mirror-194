      ...
      <hui-generic-entity-row .hass=${this.hass} .config=${this._config}>
        ${"slider"===e.attributes.mode?n.dy`
              <div class="flex">
                ...
                ></ha-slider>
                <span class="state">
                  ${(0,a.D)(this.hass.localize,e,this.hass.locale,this.hass.entities,e.state)}
                </span>
              </div>
            `:n.dy`
