...
def mop_init(model_root, dynamic_batch_args: None):
    ...
    os.environ["PYRAISDK_MAX_BATCH_SIZE"] = dynamic_batch_args.get('max_batch_size')
    os.environ["PYRAISDK_IDLE_BATCH_SIZE"] = dynamic_batch_args.get('idle_batch_size')
    os.environ["PYRAISDK_MAX_BATCH_INTERVAL"] = dynamic_batch_args.get('max_batch_interval')
