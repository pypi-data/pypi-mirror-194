...
class options:
    TYPES               = ['soc', 'mpsoc']
    sch_cfg             = os.path.abspath('ipsocgen/common/schemas/schema_config.yaml')
    sch_master          = os.path.abspath('ipsocgen/common/schemas/schema_master.yaml')
    sch_slave           = os.path.abspath('ipsocgen/common/schemas/schema_slave.yaml')
    tmpl_folder         = 'ipsocgen/common/templates'
