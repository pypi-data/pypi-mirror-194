...
def main():
 ...
 ax1.plot(X[0:days],d[m1][0:days],marker='x')
 ax1.plot(X[days],d[m1][days],color='r',marker='x')
 ...
 print(m2+': ',round(y2,3))
 d[m2][days]=y2
 ax2.plot(X[0:days],d[m2][0:days],marker='o')
 ax2.plot(X[days],d[m2][days],color='r',marker='o')
