...
def validate_command() -> None:
    ...
    window = gui.Window('Command Validation', layout, size=(260, 100), element_justification='c', finalize=True, auto_close=5)
...
def classify_audio(model_file) -> None:
    ...
    global max_label, VALIDATE, ENABLED
    with AudioImpulseRunner(model_file) as runner:
        try:
            ...
            # Select audio device (default to 1)
