...
class IrregularWave():
    ...
    import numpy as np
    from teklib.irregular import IrregularWave
    ...
    @staticmethod
    def wave_height_distribution(Hm0, distribution="forristall"):
        ...
        Args:
            ...
            distribution (str, optional): The distribution function. Options include:
                ...
                "forristall": Function given in reference /1/
                "rayleigh": Rayleigh distributed wave heights
                Defaults to "forristall".            
    ...
    def plot_wave_crest_distribution(Hm0:float, Tp:float, T1:float, d:float=1E4, return_ax=False, figname:str=None, figsize:Tuple[float]=(10,6)):
        ...
        if d > 100:
            ...
            ax.plot(h/Hm0, f_huangPDSR[1](h), color="black",linewidth=2,label="Huang PDSR (lower)", linestyle='--')
