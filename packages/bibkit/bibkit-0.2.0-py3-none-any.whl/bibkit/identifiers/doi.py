...
class DoiFormat(Enum):
    ...
    CROSSREF = 1  #: ``https://doi.org/10.1000/123`` URL form, recommended by Crossref
    HANDBOOK = 2  #: ``doi:10.1000/123`` short form, but prefixed with "``doi:``", recommended by the DOI Handbook
    HANDLE = 3  #: ``info:doi/10.1000/123`` URI format in the Handle system
    SHORT = 4  #: ``10.1000/123`` short form consisting only of prefix and suffix


def normalize(doi: str, format: DoiFormat) -> Union[str, None]:
    """
    Normalizes DOI to specified format

    :param str doi: DOI to normalize
    :param format: Format to use
    :type format: DoiFormat

    :return: Normalized DOI or None if normalization was not possible
    :rtype: `Optional[str]`
