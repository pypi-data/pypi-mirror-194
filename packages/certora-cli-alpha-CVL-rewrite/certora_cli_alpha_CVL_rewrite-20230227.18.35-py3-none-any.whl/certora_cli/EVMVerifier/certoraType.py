...
class Type(ABC):
    ...
    def get_non_primitive_elementary_type(type_name: Dict[str, Any]) -> 'Type':
        return PackedBytes1Array(type_name["name"])
...
class PackedBytes1Array(Type):
    ...
    def __init__(self, name: str) -> None:
        ...
        self.type = PackedBytes1Array.Name(name)  # Will raise [ValueError] if name isn't in the enum

    def as_dict(self) -> Dict[str, Any]:
        return {
            "type": "PackedBytes1Array",
...
class StructType(UserDefinedType):
    ...
    def get_source_str(self) -> str:
        return self.type_string  # again, flailing here
