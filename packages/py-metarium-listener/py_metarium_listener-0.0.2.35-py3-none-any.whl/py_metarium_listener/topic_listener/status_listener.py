    ...
    def __processed_block(self, block):
        ...
        for extrinsic in block["extrinsics"]:
            ...
            if extrinsic["call"]["call_module"] == METARIUM_EXTRINSIC:
                ...
                topic_id, status_value, rff_value = None, None, None
                if call.call_function == OPERATION.self_update:
                    topic_id = extrinsic["call"]["call_args"][0]["value"]
                    status_value = extrinsic["call"]["call_args"][1]["value"]
                    rff_value = extrinsic["call"]["call_args"][2]["value"]
