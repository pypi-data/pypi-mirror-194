...
class MPS(Generic[T]):
    ...
    def __init__(self, fn: T = None, name='', version='', proto='grpc', codec='json', asyncable=True,
...
def mps(fn: T = None, *, name='', version='', proto='grpc', codec='json', asyncable=True, timeout=10000,
        encrypt=False) -> T:
    """
    Multi Provider Service. Mesh provider service.
    """
    return MPS(fn, name, version, proto, codec, asyncable, timeout, encrypt)
