...
['aenum>=3.1.11,<4.0.0',
 'aiohttp>=3.8.3,<4.0.0',
 'asynctest[dev-dependencies]>=0.13.0,<0.14.0',
 'click>=8.0.1',
 'httpx>=0.23.0,<0.24.0',
 'pydantic>=1.10.2,<2.0.0',
 'pytest-asyncio[dev-dependencies]>=0.19.0,<0.20.0',
 'pytest-httpx[dev-dependencies]>=0.21.0,<0.22.0',
 'respx[dev-dependencies]>=0.20.0,<0.21.0',
 'rich>=12.6.0,<13.0.0',
 'sphinx-copybutton[dev-dependencies]>=0.5.0,<0.6.0']
