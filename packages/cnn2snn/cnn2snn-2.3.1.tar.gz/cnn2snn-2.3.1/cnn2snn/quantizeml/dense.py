...
def _parse_dense2d(layer):
    ...
    if get_akida_version() == AkidaVersion.v1:
        ...
        # By default, set output bits as buffer bits
        dense_params["output_bits"] = buffer_bits

    if out_quantizer:
        dense_params["output_bits"] = out_quantizer.bitwidth
