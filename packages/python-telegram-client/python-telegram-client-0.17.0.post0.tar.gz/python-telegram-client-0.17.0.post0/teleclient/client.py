...
from teleclient.tdjson import TDJson
from teleclient.worker import BaseWorker, SimpleWorker
from teleclient.text import Element
...
class Telegram:
    def __init__(
        ...
        device_model: str = 'python-telegram-client',
