...
makedocs() {
    sphinx-apidoc -o $PATH_REPO/docs/source/ $PATH_REPO/src/stemplate
...
cleardocs() {
    ...
    find $PATH_REPO/docs/source -type f ! -name 'index.rst' -and ! -name 'readme.rst' -and ! -name 'conf.py' -delete
}
