...
class ScsControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateToken = channel.unary_unary(
                '/control_client.ScsControl/GenerateToken',
                request_serializer=controlclient__pb2._GenerateTokenRequest.SerializeToString,
                response_deserializer=controlclient__pb2._GenerateTokenResponse.FromString,
                )
...
def add_ScsControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=controlclient__pb2._GenerateTokenRequest.FromString,
                    response_serializer=controlclient__pb2._GenerateTokenResponse.SerializeToString,
            ),
    }
...
class ScsControl(object):
    ...
    def GenerateToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/control_client.ScsControl/GenerateToken',
            controlclient__pb2._GenerateTokenRequest.SerializeToString,
            controlclient__pb2._GenerateTokenResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
