...
class MIDIResponderPatternMatcher(BaseProperty):
    unknown_properties: typing.Dict[int, bytes] = dataclasses.field(default_factory=dict)
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MIDIResponderPatternMatcher]:
    if property_count != 0:
        return None
