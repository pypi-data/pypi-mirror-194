...
class SearchString(Generic[Data]):
    ...
    def _preprocess_string(self, string: str) -> Tuple[Union[None, re.Pattern, str], bool]:
        """
    ...
    def _any_match(self, text: str, re_pattern: Union[re.Pattern, None, str],
    ...
    def _pattern_to_str(self, re_pattern: Union[None, re.Pattern, str],
                        is_global: bool) -> str:
        """
