...
def main():
    ...
    X_train, X_test, y_train, y_test = preprocess_data(data.frame, target_variable='target', test_size=0.25,
                                                       data_scaling_strategy=None,
                                                          categorical_features=['sex'],
                                                       categorical_encoder='OrdinalEncoder')

    train_test_evaluate(X_train, X_test, y_train, y_test, tune_models=None, metrics='default', target_scaling_strategy=None)
