...
from rest_collection_client.typing import (
...
class RestCollectionDeserializeMap(
    Map[str, Callable[[SequenceOfMapping], SequenceOfMapping]],
):
    ...
    def deserialize_response(
        ...
        return {
            key: self.deserialize(data[key], key) for key in self if key in data
        }
