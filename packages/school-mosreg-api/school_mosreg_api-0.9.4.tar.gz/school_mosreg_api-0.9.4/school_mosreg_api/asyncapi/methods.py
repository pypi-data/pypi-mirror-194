...
class AsyncSchoolMosregRUAPI(AsyncBaseAPI):
    ...
    async def get_me_organizations(self) -> list[int] | None:
    ...
    async def get_person_avg_marks(self, person: int | str, period) -> str | None:
    ...
    async def get_context(self, userId: str | int = "me") -> types.Context:
        ...
        return await self.get(f"users/{userId}/context", model=types.Context)
    ...
    async def get_person_schedules(self, person: int | str, group: int | str, startDate: datetime | date, endDate: datetime | date) -> types.Schedule:
    ...
    async def get_person(self, person: int | str = "me") -> types.Person:
        ...
        return await self.get(f"persons/{await self.check_person(person)}", model=types.Person)
    ...
    async def get_user_feed(self, date: datetime | date, childPersonId: int | str = None, limit: int | str = None) -> types.UserFeed:
        ...
        return await self.get('users/me/feed', model=types.UserFeed, params=params)
    
    async def get_my_children_relatives(self) -> list[types.UserRelatives | None] | None:
    ...
    async def get_user(self, user: str | int = "me") -> types.User:
        ...
        return await self.get(f"users/{user}", model=types.User)
