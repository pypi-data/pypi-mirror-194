...
import wa-cdk-lite as _wa-cdk-lite_597004ae
...
class X8WebSiteProps:
    def __init__(
        ...
        *,
        ...
        wa_bucket_props: typing.Optional[typing.Union[_wa-cdk-lite_597004ae.WaBucketProps, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        if isinstance(wa_bucket_props, dict):
            wa_bucket_props = _wa-cdk-lite_597004ae.WaBucketProps(**wa_bucket_props)
    ...
    @builtins.property
    def wa_bucket_props(self) -> typing.Optional[_wa-cdk-lite_597004ae.WaBucketProps]:
        ...
        return typing.cast(typing.Optional[_wa-cdk-lite_597004ae.WaBucketProps], result)
...
class X8Website(
    ...
    def website_bucket(self) -> _wa-cdk-lite_597004ae.WaBucket:
        '''Bucket hosting website content.'''
        return typing.cast(_wa-cdk-lite_597004ae.WaBucket, jsii.get(self, "websiteBucket"))
