...
class MapFunctions(object):
    def __init__(self, pdb_code, mobj, interp_method):
        # PUBLIC INTERFACE
    ...
    def get_slice(self,central, linear, planar, width, samples, interp_method, log_level=0):
        ...
        vals = self.interp.get_val_slice(crs_coords)
        return vals
