...
class DistMult(Model):
    ...
    def score_embedding(self, head_emb, relation_emb, tail_emb):
        ...
        The formula for calculating the triple embedding is :math:`h^{\top} \operatorname{diag}(r) t`
        ...
        """
        embedding = head_emb * relation_emb * tail_emb
        return embedding

    def mapping_embedding(self, head_emb, relation_emb):
        """Calculating the head and relation mapping embedding.

        The formula for calculating the mapping embedding is :math:`h * r`
        ...
        """
        embedding = head_emb * relation_emb
        return embedding
