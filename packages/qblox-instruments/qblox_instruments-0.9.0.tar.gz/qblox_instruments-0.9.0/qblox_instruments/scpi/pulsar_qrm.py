...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.9.0 fwBuild=27/02/2023-12:57:17 fwHash=0x242E7F25 fwDirty=0 kmodVersion=0.9.0 kmodBuild=27/02/2023-12:57:17 kmodHash=0x242E7F25 kmodDirty=0 swVersion=0.9.0 swBuild=27/02/2023-12:57:17 swHash=0x242E7F25 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=27/02/2023-12:57:17 cfgManHash=0x242E7F25 cfgManDirty=0"
            if build != build_ref:
