...
from classy_imaginary.training_tools.single_concept import SingleConceptDataset
...
def train_diffusion_model(
    ...
    default_callbacks_cfg = {
        "setup_callback": {
            "target": "classy_imaginary.train.SetupCallback",
            "params": {
                "resume": False,
                "now": now,
                "logdir": logdir,
        ...
        "image_logger": {
            "target": "classy_imaginary.train.ImageLogger",
            "params": {
                "batch_frequency": 10,
                "max_images": 1,
                "clamp": True,
        ...
        "learning_rate_logger": {
            "target": "classy_imaginary.train.LearningRateMonitor",
            "params": {
                "logging_interval": "step",
                # "log_momentum": True
            },
        },
        "cuda_callback": {"target": "classy_imaginary.train.CUDACallback"},
    }
    ...
    data_module_config = {
        ...
        "train": {
            "target": "classy_imaginary.training_tools.single_concept.SingleConceptDataset",
