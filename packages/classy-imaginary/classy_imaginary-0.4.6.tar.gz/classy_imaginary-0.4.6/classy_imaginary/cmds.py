...
def edit_demo(image_paths, outdir, height, width):
    ...
    from classy_imaginary.log_utils import configure_logging
    from classy_imaginary.surprise_me import create_surprise_me_images
...
def _imagine_cmd(
    ...
    from classy_imaginary import ImaginePrompt, LazyLoadingImage, imagine_image_files
    ...
    from classy_imaginary.enhancers.prompt_expansion import expand_prompts
    ...
    for _ in range(repeats):
        for prompt_text in prompt_texts:
            ...
            for _init_image in init_images:
                ...
                from classy_imaginary.prompt_schedules import (
                    parse_schedule_strs,
                    prompt_mutator,
                )
...
def upscale_cmd(image_filepaths, outdir):
    ...
    from classy_imaginary import LazyLoadingImage
...
def colorize_cmd(image_filepaths, outdir, repeats):
    ...
    from classy_imaginary import LazyLoadingImage
    from classy_imaginary.colorize import colorize_img
    from classy_imaginary.log_utils import configure_logging
...
def train_concept(
    ...
    from classy_imaginary.train import train_diffusion_model
    from classy_imaginary.training_tools.image_prep import (
        create_class_images,
        get_image_filenames,
        prep_images,
    )
...
def prepare_images(images_dir, is_person, target_size):
    ...
    from classy_imaginary.training_tools.image_prep import prep_images
...
def prune_ckpt(ckpt_paths):
    ...
    """
    from classy_imaginary.training_tools.prune_model import prune_diffusion_ckpt
