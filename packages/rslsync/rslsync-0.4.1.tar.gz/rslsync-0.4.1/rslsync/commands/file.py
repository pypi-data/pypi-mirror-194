...
class FileCommands:
    ...
    def add(self, file_path, expire_days):
        ...
        self.client.make_request("setjobttl", id=job_id, ttl=int(expire_days) * 3600 * 24)
        return job_id
    ...
    def set_path(self, path, show_always=True):
        return self.client.make_request("setfilejobpath", path=path, show_always=show_always)
