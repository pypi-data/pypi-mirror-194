...
class CreateHTML:
    def __init__(self, df, vars, y, split_method, min_records, max_integer, max_nr_splits, min_split_values, nr_splits,
                 ...
                 dir_file='F:/MarketingDatabase/Analyse/2.Kennisgebieden/4.DataScience/12. ML/'):
        self.df = df
        self.vars = vars
        self.y = y
    ...
    def build_HTML(self, output_file, title, explanation):
        # dir_file = '/Users/simonteggelaar/Documents/Python/NLO/'
        # # dir_file = 'F:/MarketingDatabase/Analyse/2.Kennisgebieden/4.DataScience/12. ML/'
        input_file = 'zoomable_multi_branch.html'

        if not explanation:
            explanation = 'Er is geen uitleg opgenomen.'

        html = None
        with open(self.dir_file + input_file, 'r') as file:
            html = file.read()
