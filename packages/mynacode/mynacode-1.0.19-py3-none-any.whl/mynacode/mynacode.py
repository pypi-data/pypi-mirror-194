...
def tracefunc(frame, event, arg, indent=[0]):
    ...
    if '__autograph_generated' in frame.f_code.co_filename:
        ...
        pass
    elif os.environ["prev_func"] == frame.f_code.co_name or os.environ["prev_func1"] == frame.f_code.co_name or os.environ["prev_func2"] == frame.f_code.co_name or os.environ["prev_func3"] == frame.f_code.co_name or os.environ["prev_func4"] == frame.f_code.co_name or os.environ["prev_func5"] == frame.f_code.co_name:
        pass
    else:
        save_function = True
