...
#IP = '127.0.0.1:8000'
IP = 'mynacode.com'
prev_func_list = ['a1zqw_9_', 'b1zqw_9_', 'c1zqw_9_', 'd1zqw_9_', 'e1zqw_9_']
prev_node = "-999"
...
def node_log(variables, main_function = False):
  ...
  if main_function == True:
      data = {'run_id':os.environ['run_id'], '_id': prev_node, 'type':'node', 'variables': str(variables), 'username': os.environ['username'], 'key': os.environ['key'], 'main_function':1}
  else:
      data = {'_id': prev_node, 'type':'node', 'variables': str(variables), 'username': os.environ['username'], 'key': os.environ['key'], 'main_function':0}
