...
vocabs_pkl_filepath = os.path.join(os.path.dirname(__file__), 'models', 'vocab_model3.pkl')

pos_h5_filepath = os.path.join(os.path.dirname(__file__), 'models', 'POS_TAG_WORD_validated.h5')
...
postagsindex_pkl_filepath = os.path.join(os.path.dirname(__file__), 'models', 'tagindex_model2.pkl')
