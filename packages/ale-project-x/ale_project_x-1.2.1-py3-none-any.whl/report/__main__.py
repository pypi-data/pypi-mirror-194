...
def main():
    print("Running main")
    print("Run below command: reportx gen --input 'input_path' --output 'output_path'")
    ...
    if (args.command == 'gen'):
        ...
        print(f'Input folder: {os.path.abspath(input_folder_path)}')
        output_folder_path = args.output
        if not os.path.isdir(output_folder_path): 
            create_folder = input("Output folder doesn't exist, create folder? (Y/N)")
