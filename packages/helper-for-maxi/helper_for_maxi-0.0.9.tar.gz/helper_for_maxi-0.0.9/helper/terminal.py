...
class Terminal:
    ...
    class color:
        ...
        class foreground:
            ...
            colorList = [DEFAULT, BOLD, UNDERLINE, SWAPCOLOR, FBLACK, FRED, FGREEN, FYELLOW, FBLUE, FMAGENTA,
        ...
        class background:
            ...
            colorList = [DEFAULT, SWAPCOLOR, BBLACK, BRED, BGREEN, BYELLOW, BBLUE, BMAGENTA, BCYAN, BWHITE,
