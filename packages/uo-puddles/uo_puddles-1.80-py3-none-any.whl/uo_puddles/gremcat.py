...
def branch_loc(project_id, branch, start, stop) -> dict:
  commits_list = [commit for commit in all_commits(project_id)]
  ...
  for commit in branch_commits:
    ...
    diffs = get_diffs_for_commit(commit.id)
...
def plot_timeline(project_id, branch, start, stop):
  loc_by_date = branch_loc(project_id, branch, start, stop)
