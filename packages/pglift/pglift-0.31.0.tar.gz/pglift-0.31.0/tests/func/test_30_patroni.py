...
from . import AuthType, PostgresLogger, check_connect, reconfigure_instance
...
def _make_instance(
    settings: Settings, manifest: interface.Instance, postgres_logger: PostgresLogger
...
def instance1(
    ...
    yield from _make_instance(settings, instance1_manifest, postgres_logger)
...
def instance2(
    ...
    yield from _make_instance(settings, instance2_manifest, postgres_logger)
