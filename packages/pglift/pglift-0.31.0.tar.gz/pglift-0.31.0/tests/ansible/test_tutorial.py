...
def test(call_playbook: Callable[[str], None]) -> None:
    ...
    socket.create_connection(("localhost", 9186), 1).close()
    socket.create_connection(("localhost", 2344), 1).close()
    ...
    socket.create_connection(("localhost", 9188), 1).close()
    socket.create_connection(("localhost", 2346), 1).close()
    ...
    socket.create_connection(("localhost", 9189)).close()
    socket.create_connection(("localhost", 2347)).close()
