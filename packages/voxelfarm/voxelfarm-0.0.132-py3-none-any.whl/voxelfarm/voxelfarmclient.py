...
class mock_workflow_framework:
    ...
    def get_entity(self, id = None):
        return self.vf.get_entity(id, self.project)
...
class rest:
    ...
    def create_python_process_entity(self, project, name, code, type, fields, inputs, files = None, callback = None, update_type = None):
        result = self.creation_result()
