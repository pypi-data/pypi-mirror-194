...
def del_file(file_path: str):
    ...
    if os.path.isdir(file_path):
        ...
        logging.error(f"parameter file_path {file_path} is error")


def check_file(file_path_or_file_dir, create_dir=True):
...
def generate_str_or_file(size: int or str = '48KB', file_path=None):
