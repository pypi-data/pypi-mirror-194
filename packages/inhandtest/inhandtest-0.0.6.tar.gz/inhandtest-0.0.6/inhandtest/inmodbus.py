...
class ModbusMaster:
    ...
    def write_data(self, addr, datatype, write_value):
        """
        都指定寄存器地址写入值
        :param addr: 寄存器地址
...
if __name__ == "__main__":
    ...
    # print(tcpMaster.write_data(40001, datatype='STRING', write_value='ABCDEFR'))
    print(tcpMaster.read_data("40001", datatype='STRING', length=3, decimal=2))
