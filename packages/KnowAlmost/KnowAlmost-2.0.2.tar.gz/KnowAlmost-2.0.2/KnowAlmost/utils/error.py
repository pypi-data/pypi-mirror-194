...
class KnowAlmostException(Exception):
    """Base exception for KnowAlmost

    .. version:: 2.0.2    """
    pass


class HTTPException(KnowAlmostException):
    """HTTPException()
    ...
    response : requests.Response | aiohttp.ClientResponse
        Requests Response from the KnowAlmost API
    api_errors : list[dict[str, int | str]]
        The errors the KnowAlmost API responded with, if any
    api_codes : list[int]
        The error codes the KnowAlmost API responded with, if any
    api_messages : list[str]
        The error messages the KnowAlmost API responded with, if any
    """
...
class KnowAlmostServerError(HTTPException):
    """KnowAlmostServerError()
