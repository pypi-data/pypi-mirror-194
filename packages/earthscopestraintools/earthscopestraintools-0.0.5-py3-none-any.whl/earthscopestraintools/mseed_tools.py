...
def download_mseed(net: str,
    ...
    url = f"https://service.iris.edu/fdsnws/dataselect/1/query?net={net}" \
...
def mseed2pandas(st: Stream):
    ...
    for i, tr in enumerate(st):
        ...
        logger.info(f"Trace {i + 1}. {start}:{stop} mapping {tr.stats.channel} to {channel}")
