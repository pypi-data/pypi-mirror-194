...
class NeighborhoodImputationOptimizer:
    ...
    def optimize_neighborhood_imputation_prior_strength(
        ...
        for rep_i in replicate_indices:
            ...
            res = scipy.optimize.differential_evolution(weighted_objective_function_of_all_guides_p, bounds=[(0.000001, optimizer_upper_bound),(0.000001, optimizer_upper_bound)], callback=store_values) 
