...
class RegistryServiceApi(object):
    ...
    def registry_service_delete_model(self, model_id_uuid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str model_id_uuid: (required)
    ...
    def registry_service_get_dataset(self, dataset_id, **kwargs):  # noqa: E501
        """Get dataset.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.registry_service_get_dataset(dataset_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.registry_service_get_dataset_with_http_info(dataset_id, **kwargs)  # noqa: E501
        else:
            (data) = self.registry_service_get_dataset_with_http_info(dataset_id, **kwargs)  # noqa: E501
            return data

    def registry_service_get_dataset_with_http_info(self, dataset_id, **kwargs):  # noqa: E501
        """Get dataset.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.registry_service_get_dataset_with_http_info(dataset_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('dataset_id' not in params or
                params['dataset_id'] is None):
            raise ValueError("Missing the required parameter `dataset_id` when calling `registry_service_get_dataset`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/registry/dataset/{datasetId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def registry_service_get_model(self, model_id_uuid, **kwargs):  # noqa: E501
        """Get model.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.registry_service_get_model(model_id_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.registry_service_get_model_with_http_info(model_id_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.registry_service_get_model_with_http_info(model_id_uuid, **kwargs)  # noqa: E501
            return data

    def registry_service_get_model_with_http_info(self, model_id_uuid, **kwargs):  # noqa: E501
        """Get model.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.registry_service_get_model_with_http_info(model_id_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('model_id_uuid' not in params or
                params['model_id_uuid'] is None):
            raise ValueError("Missing the required parameter `model_id_uuid` when calling `registry_service_get_model`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/registry/model/{modelId.uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def registry_service_list_datasets(self, project_id_uuid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str project_id_uuid: (required)
        :param str first_page_req_firewall_id:
    ...
    def registry_service_list_prediction_set(self, project_id_uuid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str project_id_uuid: (required)
        :param str first_page_req_dataset_id:
    ...
    def registry_service_list_prediction_set_with_http_info(self, project_id_uuid, **kwargs):  # noqa: E501
        ...
        all_params = ['project_id_uuid', 'first_page_req_dataset_id', 'page_token', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
