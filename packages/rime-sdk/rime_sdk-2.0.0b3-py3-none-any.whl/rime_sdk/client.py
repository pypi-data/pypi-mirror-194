...
class Client:
    ...
    Args:
        ...
        channel_timeout: float
            The amount of time in seconds to wait for responses from the backend.
    ...
    def __init__(
        ...
        Args:
            ...
            disable_tls: Optional[bool]
                Enable/disable tls when connecting to the backend.
            ssl_ca_cert: Optional[Union[Path, str]]
                Set to customize the certificate file used to verify the peer.
    ...
    def list_projects(self,) -> Iterator[Project]:
        ...
        Raises:
            ValueError
                If the request to the ProjectService service fails.
        ...
        while True:
            ...
            for project in res.projects:
                yield Project(self._api_client, project.id.uuid)
    ...
    def start_stress_test(
        ...
        Raises:
            ValueError
                When the request to the ModelTest service fails.
        ...
        .. code-block:: python
           ...
           job = rime_client.start_stress_test_job(test_run_config=config)
        """
        ...
        for data_dict in data_dicts:
            for key in image_features:
                if key not in data_dict:
                    raise ValueError(
                        f"The image feature '{key}' does not exist "
    ...
    def start_file_scan(
        ...
        Returns:
            A Job that provides information about the ML file scan job.
        ...
        Run the job using the specified configuration and the default Docker image in
        the RIME backend. Store the results under project ID ``foo``.
