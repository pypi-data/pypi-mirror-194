...
class NotificationSettingApi(object):
    ...
    def notification_setting_list_notifications(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[str] list_notifications_query_object_types:  - OBJECT_TYPE_PROJECT: Used for notifications associated with an project. The notif object id is the project id.
        :param list[str] list_notifications_query_object_ids:
    ...
    def notification_setting_update_notification(self, body, notification_id_uuid, **kwargs):  # noqa: E501
        ...
        :param str notification_id_uuid: (required)
