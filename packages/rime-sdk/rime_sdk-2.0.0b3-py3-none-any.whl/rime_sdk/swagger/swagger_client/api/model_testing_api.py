...
class ModelTestingApi(object):
    ...
    def model_testing_start_continuous_test(self, body, **kwargs):  # noqa: E501
        """StartContinuousTest starts a continuous test job.  # noqa: E501
    ...
    def model_testing_start_stress_test(self, body, **kwargs):  # noqa: E501
        """StartStressTest starts a stress test job.  # noqa: E501
    ...
    def model_testing_start_stress_test_declarative(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_testing_start_stress_test_declarative(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.model_testing_start_stress_test_declarative_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.model_testing_start_stress_test_declarative_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def model_testing_start_stress_test_declarative_with_http_info(self, body, **kwargs):  # noqa: E501
        """Current StartStressTest will be replaced by this endpoint in 2.0, this endpoint will be changed to new v1. The request and response messages will be the same as StartStressTest.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_testing_start_stress_test_declarative_with_http_info(body, async_req=True)
        >>> result = thread.get()
