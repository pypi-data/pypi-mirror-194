...
class TestrunresultTestRunDetail(object):
    ...
    swagger_types = {
        ...
        'progress': 'str',
        'category_test_ids': 'list[TestrunTestCategoryType]',
        'rime_version': 'str',
        'ref_data_id': 'str',
        'eval_data_id': 'str',
        'model_id': 'RimeUUID'
    ...
    def __init__(self, test_run_id=None, name=None, project_id=None, testing_type=None, model_task=None, upload_time=None, web_app_url=None, model_source_info=None, metrics=None, ct_info=None, status=None, progress=None, category_test_ids=None, rime_version=None, ref_data_id=None, eval_data_id=None, model_id=None):  # noqa: E501
