...
class RimeManagedImage(object):
    ...
    def name(self):
        ...
        The external name of the image used by users to refer to the image. This name must match /^[a-z][a-z0-9]*(?:[_-][a-z0-9]+)*$/ to be valid. See the naming rules in https://docs.docker.com/engine/reference/commandline/tag/#extended-description  protolint:disable:this MAX_LINE_LENGTH https://docs.aws.amazon.com/AmazonECR/latest/userguide/repository-create.html  protolint:disable:this MAX_LINE_LENGTH from which we derived our naming convention. The above names will be valid as either ECR or Docker image names.  # noqa: E501
    ...
    def child_images(self):
        ...
        The set of images for which this image is a source image.  # noqa: E501
    ...
    def package_requirements(self):
        ...
        A list of all system package requirements used in constructing this image.  # noqa: E501
    ...
    def pip_requirements(self):
        ...
        A list of all pip requirements used in constructing this image.  # noqa: E501
