...
class ProjectProject(object):
    ...
    def __init__(self, id=None, name=None, description=None, use_case=None, ethical_consideration=None, creation_time=None, owner_id=None, workspace_id=None, model_task=None, tags=None, firewall_ids=None, project_test_suite_config=None, profiling_config=None, run_time_info=None, is_published=None):  # noqa: E501
    ...
    def firewall_ids(self):
        ...
        Firewall saves CT configurations, including bins size, ref data info and eval data info.  # noqa: E501
