...
class SoPFunction(SoPService):
    ...
    def _wrapper(self, execute_request: SoPExecuteRequest) -> bool:
        ...
        SOPLOG_DEBUG(
            f'[FUNC START] run {self._name} function by {execute_msg._scenario}', 'green')
        ...
        try:
            ...
            SOPLOG_DEBUG(
                f'[FUNC END] function {self._name} finish. -> return value : {self._return_value}, duration: {execute_duration:.4f} Sec', 'green')
