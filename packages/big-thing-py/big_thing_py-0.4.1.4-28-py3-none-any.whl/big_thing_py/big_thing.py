...
class SoPBigThing(SoPThing):
    ...
    def _print_packet(self, topic: str, payload: Union[dict, str], mode: SoPPrintMode = SoPPrintMode.FULL, pretty: bool = False):
        ...
        payload = prune_payload(
            payload=dict_to_json_string(payload=payload, pretty=pretty), mode=mode)
