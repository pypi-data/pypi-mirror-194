...
def fs_item_analysis_1(df,ticker,fsdate,items,title_txt=''):
    """
...
def fs_item_analysis_2(df,ticker,fsdates,items,title_txt=''):
    """
...
def fs_item_analysis_3(df,ticker,fsdates,title_txt=''):
    """
...
def fs_item_analysis_4(df,ticker,fsdates,title_txt=''):
    """
    功能：比较给定财报日期的流动比率、最近几年fsdates
    """
    fsdates1=sorted(fsdates,reverse=True)
...
def fs_item_analysis_5(df,ticker,fsdates,title_txt=''):
    """
    功能：比较给定财报日期的流动比率、最近几年fsdates
    """
...
def fs_item_analysis_6_original(df,ticker,fsdates,items,title_txt=''):
    """
    废弃
...
def fs_item_analysis_6(df,ticker,fsdates,items,title_txt=''):
    """
    功能：比较给定财报日期的应收账款与营业收入增幅、最近几年fsdates
    """
...
def fs_item_analysis_7(df,tickers,fsdate,items,title_txt=''):
    """
    功能：比较给定财报日期fsdate的项目和指标，与同业相比
    """
...
def fs_item_analysis_8(df,tickers,fsdate,items,title_txt=''):
    """
    功能：比较给定财报日期fsdate的项目和指标，与同业相比
    区别：项目不带‘(亿元)’字样，避免行过长
    """
...
def asset_liab_structure_china(tickers,fsdates):
    ...
    dfp2=fs_item_analysis_1(df,ticker,fsdate,items2,title_txt)
    ...
    dfp4=fs_item_analysis_1(df,ticker,fsdate,items4,title_txt)
...
def income_cost_structure_china(tickers,fsdates):
    ...
    #成本变动趋势
    title_txt=title_head+"主要成本费用·及其变动趋势"
    print('')
    ...
    items4=["营业成本","营业总成本"]
    dfp4=fs_item_analysis_2(df,ticker,fsdates1,items4,title_txt)
    ...
    items6=["销售费用","营业总收入"]
    dfp6=fs_item_analysis_2(df,ticker,fsdates1,items6,title_txt)
    #====================================================================
    title_txt=title_head+"管理费用占营业总收入比例情况"
    items7=["管理费用","营业总收入"]
    dfp7=fs_item_analysis_2(df,ticker,fsdates1,items7,title_txt)
    
    title_txt=title_head+"费用率同行对比"
    items14=['营业总收入','销售费用率%','管理费用率%','研发费用率%']
    dfp12=fs_item_analysis_8(df,tickers,fsdate,items14,title_txt)    
    #====================================================================
...
def cash_flow_structure_china(tickers,fsdates):
    ...
    dfp12=fs_item_analysis_8(df,tickers,fsdate,items16,title_txt)  
    ...
    dfp12=fs_item_analysis_8(df,tickers,fsdate,items17,title_txt)
