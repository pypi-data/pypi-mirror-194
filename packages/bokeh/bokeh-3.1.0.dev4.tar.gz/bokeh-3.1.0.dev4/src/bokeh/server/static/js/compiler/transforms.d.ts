...
export declare function remove_use_strict(): (context: ts.TransformationContext) => (root: ts.SourceFile) => ts.SourceFile;
...
export declare function remove_void0(): (context: ts.TransformationContext) => (root: ts.SourceFile) => ts.SourceFile;
export declare function fix_esexports(): (context: ts.TransformationContext) => (root: ts.SourceFile) => ts.SourceFile;
export declare function fix_regl(): (context: ts.TransformationContext) => (root: ts.SourceFile) => ts.SourceFile;
