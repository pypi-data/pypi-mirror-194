...
class WavinSentio():
    ...
    def get_devices(self,ulc):
        endpoint = urljoin("locations",ulc,"devices")
        return self.__request(endpoint, "")

    def turn_on_standby(self,ulc):
        endpoint = urljoin("locations", ulc)
        payload = {"ulc": ulc, "attributes": {"mode": "standby" }}
        return self.__patch(endpoint, payload)
        
    def turn_off_standby(self,ulc):
        endpoint = urljoin("locations", ulc)
        payload = {"ulc": ulc, "attributes": {"mode": "ready" }}
        return self.__patch(endpoint, payload)
