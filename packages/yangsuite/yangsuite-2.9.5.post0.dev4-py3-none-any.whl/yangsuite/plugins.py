...
def check_public_versions() -> list:
    ...
    # To avoid InsecureRequestWarning: Adding certificate
    ...
    for app_name in all_apps_names:
        # resp = http.request("GET", f"https://pypi.org/pypi/{app_name}/json")
...
def check_for_plugin_updates():
    ...
    try:
        ...
        log.error(
            "Unable to find github settings:\n{0}\n{1}\n{2}".format(
    ...
    try:
        ghub = Github(
            base_url=smod.GITHUB_BASE_URL, login_or_token=smod.GITHUB_TOKEN
        )
