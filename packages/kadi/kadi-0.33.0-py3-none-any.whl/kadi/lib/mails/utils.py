...
def send_email_confirmation_mail(identity, email=None):
    ...
    :param identity: The local identity of the user whose email should be confirmed.
    ...
    text_message = render_template("mails/email_confirmation.txt", **render_args)
    html_message = render_template("mails/email_confirmation.html", **render_args)
...
def send_password_reset_mail(identity):
    ...
    text_message = render_template("mails/password_reset.txt", **render_args)
    html_message = render_template("mails/password_reset.html", **render_args)
...
def send_test_mail(user):
    ...
    text_message = render_template(
        "mails/test_email.txt", displayname=user.identity.displayname
    )
    html_message = render_template(
        "mails/test_email.html", displayname=user.identity.displayname
    )
