...
def get_access_token():
    ...
    if has_request_context():
        ...
        if len(parts) == 2 and parts[0].lower() == "bearer":
            ...
            # Fall back to personal tokens. This also makes us stay backwards-compatible
            # with personal tokens without a prefix. For OAuth2 tokens this also means
            # that the prefix is required.
            return PersonalToken.get_by_token(token)
