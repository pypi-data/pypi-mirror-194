...
class setup_shortcuts:
    ...
    def __init__(self, browser='chrome', port=9222, wait_for=10, executable_path='chromedriver', headless=False, use_uc=False, browser_version=None, driver=None):
    ...
    def check(self, css_selector, parent=None, check_visible=True):
        if not parent:
            parent = self.driver
