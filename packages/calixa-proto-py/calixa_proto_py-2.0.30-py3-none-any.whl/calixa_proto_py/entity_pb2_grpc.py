...
class EntityServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCustomEntityDefinitions = channel.unary_unary(
                ...
                response_deserializer=entity__pb2.EntityList.FromString,
                )
...
def add_EntityServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetCustomEntityDefinitions': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=entity__pb2.EntityList.SerializeToString,
            ),
...
class EntityService(object):
    ...
    def GetCustomEntityDefinitions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.entity.EntityService/GetCustomEntityDefinitions',
            entity__pb2.GetCustomEntityDefinitionsRequest.SerializeToString,
            entity__pb2.EntityList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
