...
class _CustomFieldType(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[CustomFieldTypeValue]):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    ACTION_METADATA_FIELD_UNSPECIFIED = typing___cast(CustomFieldTypeValue, 0)
    ACTION_METADATA_FIELD_STATIC = typing___cast(CustomFieldTypeValue, 1)
    ACTION_METADATA_FIELD_DYNAMIC = typing___cast(CustomFieldTypeValue, 2)
    ACTION_METADATA_FIELD_RELATED_DATA = typing___cast(CustomFieldTypeValue, 3)
    ACTION_METADATA_FIELD_CALIXA_CUSTOM = typing___cast(CustomFieldTypeValue, 4)
    ACTION_METADATA_FIELD_CALIXA_SPECIAL = typing___cast(CustomFieldTypeValue, 5)
ACTION_METADATA_FIELD_UNSPECIFIED = typing___cast(CustomFieldTypeValue, 0)
ACTION_METADATA_FIELD_STATIC = typing___cast(CustomFieldTypeValue, 1)
ACTION_METADATA_FIELD_DYNAMIC = typing___cast(CustomFieldTypeValue, 2)
ACTION_METADATA_FIELD_RELATED_DATA = typing___cast(CustomFieldTypeValue, 3)
...
class ActionParams(google___protobuf___message___Message):
    ...
    class ParametersEntry(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> type___ActionParameter: ...

        def __init__(self,
            *,
            key : typing___Optional[typing___Text] = None,
            value : typing___Optional[type___ActionParameter] = None,
            ) -> None: ...
    ...
    @property
    def parameters(self) -> typing___MutableMapping[typing___Text, type___ActionParameter]: ...
    ...
    def __init__(self,
        *,
        ...
        parameters : typing___Optional[typing___Mapping[typing___Text, type___ActionParameter]] = None,
        ) -> None: ...
...
class ActionParameter(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    key: typing___Text = ...
    type: type___CustomFieldTypeValue = ...
    value: typing___Text = ...

    def __init__(self,
        *,
        key : typing___Optional[typing___Text] = None,
        type : typing___Optional[type___CustomFieldTypeValue] = None,
        value : typing___Optional[typing___Text] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"key",b"key",u"type",b"type",u"value",b"value"]) -> None: ...
