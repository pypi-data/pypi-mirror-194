...
static int import_petsc4py__PETSc(void) {
  ...
  __pyx_ptype_8petsc4py_5PETSc_Space = __Pyx_ImportType(module, "petsc4py.PETSc", "Space", sizeof(struct PyPetscSpaceObject), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_8petsc4py_5PETSc_Space) goto bad;
  __pyx_ptype_8petsc4py_5PETSc_DualSpace = __Pyx_ImportType(module, "petsc4py.PETSc", "DualSpace", sizeof(struct PyPetscDualSpaceObject), __Pyx_ImportType_CheckSize_Warn);
  ...
  __pyx_ptype_8petsc4py_5PETSc_MatPartitioning = __Pyx_ImportType(module, "petsc4py.PETSc", "MatPartitioning", sizeof(struct PyPetscMatPartitioningObject), __Pyx_ImportType_CheckSize_Warn);
