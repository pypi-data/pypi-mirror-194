...
class Waveform:
    ...
    def _trim_by_samples(self, s0: int = None, s1: int = None):
        ...
        return Waveform(self.samples[np.arange(s0, s1, dtype=int)].copy(), self.sample_rate, t0, remove_dc_offset=False)
    ...
    def is_calibration(self):
        ...
        Parameters
        ----------
        channel_index: int, default = 0 - the index within the sample array of the channel we want to examine
    ...
    def equivalent_level(self,
        ...
        Parameters
        ----------
        weighting: weighting_function - the enumeration to determine filtering function applied to the waveform
        duration: float - The denominator of the summation - in seconds
        start_sample: int, default = 0 - the start sample of the pressure summation
        stop_sample: int, default = None - the stop sample, if the value is None, then it is replaces with the last
            sample index
        """
