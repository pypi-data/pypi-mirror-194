...
def test_is_asset_id():
    test_asset_id = secrets.token_hex(32)
    assert(is_asset_id(test_asset_id))
    assert(is_asset_id(f'0x{test_asset_id}'))
    assert(not is_asset_id(f'000x{test_asset_id}'))
    assert(not is_asset_id(secrets.token_hex(66)))
    assert(not is_asset_id('is not a valid asset id'))
