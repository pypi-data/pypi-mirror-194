...
- style (dict; optional):
    ...
    _type = 'Card'
    @_explicitize_args
    def __init__(self, children=None, appearance=Component.UNDEFINED, orientation=Component.UNDEFINED, size=Component.UNDEFINED, selected=Component.UNDEFINED, show_loading=Component.UNDEFINED, loading_state=Component.UNDEFINED, header=Component.UNDEFINED, footer=Component.UNDEFINED, id=Component.UNDEFINED, key=Component.UNDEFINED, style=Component.UNDEFINED, class_name=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'appearance', 'class_name', 'footer', 'header', 'key', 'loading_state', 'orientation', 'selected', 'show_loading', 'size', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'appearance', 'class_name', 'footer', 'header', 'key', 'loading_state', 'orientation', 'selected', 'show_loading', 'size', 'style']
