...
class CraftAiSdk:
    ...
    @log_func_result("Deployment result retrieval")
    def retrieve_deployment_results(
        self, deployment_name, execution_id, endpoint_token=None
    ):
        """Get the results of a deployment execution.

        Args:
            deployment_name (str): Name of the endpoint.
        ...
        url = (
            ...
            f"/endpoints/{deployment_name}/executions/{execution_id}"
        )
    ...
    def trigger_endpoint(
        ...
        Args:
            endpoint_name (str): Name of the endpoint.
            endpoint_token (str): Token to access endpoint.
            wait_for_results (bool): Automatically call `retrieve_endpoint_results` and
            returns the execution result. Defaults to `True`
    ...
    def retrieve_endpoint_results(self, endpoint_name, execution_id, endpoint_token):
        ...
        .. warning::
            .. deprecated:: 0.12.0
             This function is deprecated and its usage is not supported.
             Prefer using retrieve_deployment_results instead.
        """
        warnings.warn(
            "retrieve_endpoint_results is deprecated since version 0.12.0",
            DeprecationWarning,
        )
        return self.retrieve_deployment_results(
            endpoint_name, execution_id, endpoint_token
        )
