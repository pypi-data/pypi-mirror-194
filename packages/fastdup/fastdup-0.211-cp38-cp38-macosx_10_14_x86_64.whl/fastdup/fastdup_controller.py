...
def set_fastdup_kwargs(input_kwargs: dict) -> dict:
    ...
    turi_params = {
        ...
        'read_features_parallel': {'map': {True: 1, False: 0}, 'default': False},
        'test_correction_offset': {'map': None, 'default': 0},
        'max_augmentations': {'map': None, 'default': 0},
        ...
        'min_input_image_height': {'map': None, 'default': 0},
        'min_input_image_width': {'map': None, 'default': 0}
    }
