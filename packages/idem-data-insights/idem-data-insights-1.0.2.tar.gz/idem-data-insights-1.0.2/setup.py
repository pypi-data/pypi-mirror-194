...
NAME = "idem_data_insights"
DESC = ""

# Version info -- read without importing
_locals = {}
with pathlib.Path("idem_data_insights", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/vmware/idem/idem-data-insights",
    version=VERSION,
    ...
    entry_points={
        "console_scripts": ["idem_data_insights = idem_data_insights.scripts:start"]
    },
