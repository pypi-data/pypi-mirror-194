...
class ColorLogger:
	...
	def info(self, msg, *arg, **kwarg):
		...
		mess = str(Greet + self.msg1 + RESET_ALL)
		if self.fileinfo and self.txt_mode:
			mess = str(Greet + str(self.file_name) + ' <<-- ' + self.msg1 + RESET_ALL)
	...
	def debug(self, msg, *arg, **kwarg):
		...
		mess = str(Blue + self.msg1 + RESET_ALL)
		if self.fileinfo and self.txt_mode:
			mess = str(Blue + str(self.file_name) + ' <<-- ' + self.msg1 + RESET_ALL)
	...
	def warning(self, msg, *arg, **kwarg):
		...
		mess = str(Yellow + self.msg1 + RESET_ALL)
		if self.fileinfo and self.txt_mode:
			mess = str(Yellow + str(self.file_name) + ' <<-- ' + self.msg1 + RESET_ALL)
	...
	def error(self, msg, *arg, **kwarg):
		...
		mess = str(Red + self.msg1 + RESET_ALL)
		if self.fileinfo and self.txt_mode:
			mess = str(Red + str(self.file_name) + ' <<-- ' + self.msg1 + RESET_ALL)
