...
class Sensor:
    ...
    # finally by sensor i2c address. Only the first two of the three
    # groupings are important, the final one is aesthetic.
...
class Bme680(Sensor):
    ...
    def read(self):
        ...
        with contextlib.suppress(UnboundLocalError, OSError):
            rhum_pc = self._instance.relative_humidity
...
class SmcZse30A01F12(Ads1015):
    """
    Reads from a Ads1015 12-bit ADC.
    """
...
class SmcPfm725SF01F(Ads1015):
    ...
    def _volts_to_flow_rate(adcv):
        ...
        ----------------------------------------------------------------------
        """
        return max(0, 10.425474162729426 * adcv - 6.247711690827281)
