...
@overload
def curry(n: Literal[1], _: Any = ..., /) -> Callable[
    [Callable[P, RT]],
    Callable[P, RT],
]:
    ...
...
@overload
def curry(n: Literal[2], /) -> Callable[
    [Callable[..., RT]],
    Callable[..., Callable[..., RT]],
]:
    ...

@overload
def curry(n: Literal[2], _: Any, /) -> Callable[
    [Callable[Concatenate[T1, P], RT]],
    Callable[[T1], Callable[P, RT]],
]:
    ...

@overload
def curry(n: Literal[3], /) -> Callable[
    [Callable[..., RT]],
    Callable[..., Callable[..., Callable[..., RT]]],
]:
    ...

@overload
def curry(n: Literal[3], _: Any, /) -> Callable[
    [Callable[Concatenate[T1, T2, P], RT]],
    Callable[[T1], Callable[[T2], Callable[P, RT]]],
]:
    ...

@overload
def curry(n: Literal[4], /) -> Callable[
    [Callable[..., RT]],
    Callable[..., Callable[..., Callable[..., Callable[..., RT]]]],
]:
    ...

@overload
def curry(n: Literal[4], _: Any, /) -> Callable[
    [Callable[Concatenate[T1, T2, P], RT]],
    Callable[[T1], Callable[[T2], Callable[[T3], Callable[P, RT]]]],
]:
    ...

@overload
def curry(n: int, _: Any = ..., /) -> Callable[
    [Callable[..., Any]],
    Callable[..., Any],
]:
    ...
