"""This module contains the "docums-autorefs" plugin.
...
It stores them during the [`on_page_content` event hook](https://documsapp.github.io/docums/user-guide/plugins/#on_page_content).

Just before writing the final HTML to the disc, during the
[`on_post_page` event hook](https://documsapp.github.io/docums/user-guide/plugins/#on_post_page),
...
from docums.config import Config
from docums.plugins import BasePlugin
from docums.structure.pages import Page
from docums.structure.toc import AnchorLink
from docums.utils import warning_filter

from docums_autorefs.references import AutorefsExtension, fix_refs, relative_url

log = logging.getLogger(f"docums.plugins.{__name__}")
...
class AutorefsPlugin(BasePlugin):
    ...
    Check the [Developing Plugins](https://documsapp.github.io/docums/user-guide/plugins/#developing-plugins) page of `docums`
    ...
    def on_config(self, config: Config, **kwargs) -> Config:  # noqa: W0613,R0201 (unused arguments, cannot be static)
        ...
        Hook for the [`on_config` event](https://documsapp.github.io/docums/user-guide/plugins/#on_config).
        In this hook, we instantiate our [`AutorefsExtension`][docums_autorefs.references.AutorefsExtension]
        and add it to the list of Markdown extensions used by `docums`.

        Arguments:
            config: The Docums config object.
            kwargs: Additional arguments passed by Docums.
    ...
    def on_page_markdown(self, markdown: str, page: Page, **kwargs) -> str:  # noqa: W0613 (unused arguments)
        ...
        Arguments:
            ...
            page: The related Docums page instance.
            kwargs: Additional arguments passed by Docums.
    ...
    def on_page_content(self, html: str, page: Page, **kwargs) -> str:  # noqa: W0613 (unused arguments)
        ...
        Hook for the [`on_page_content` event](https://documsapp.github.io/docums/user-guide/plugins/#on_page_content).
    ...
    def on_post_page(self, output: str, page: Page, **kwargs) -> str:  # noqa: W0613 (unused arguments)
        ...
        Hook for the [`on_post_page` event](https://documsapp.github.io/docums/user-guide/plugins/#on_post_page).
        ...
        our [`AUTO_REF_RE`][docums_autorefs.references.AUTO_REF_RE] regular expression that did not intend to reference anything).
