...
def derive_materialization_schema_for_feature_view(
    ...
    # Add snowflake specific data types and make column name uppercase.
    for column in materialization_schema.columns:
        # TODO: stop setting raw_snowflake_type once this field is deprecated.
        raw_snowflake_type = snowflake_type_utils.tecton_type_to_snowflake_type(column.offline_data_type, column.name)
        column.raw_snowflake_type = raw_snowflake_type
