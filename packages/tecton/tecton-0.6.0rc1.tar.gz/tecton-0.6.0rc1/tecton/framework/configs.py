...
class EMRJsonClusterConfig:
    """
    Configuration used to specify materialization clusters. This class describes the attributes of the new clusters which are created in EMR during
...
class DatabricksJsonClusterConfig:
    """
    Configuration used to specify materialization clusters. This class describes the attributes of the new clusters which are created in Databricks during
    materialization jobs. This is an alpha feature. Contact Tecton Support before using.
    :param json: A JSON string used to directly configure the cluster used in materialization.
    """
