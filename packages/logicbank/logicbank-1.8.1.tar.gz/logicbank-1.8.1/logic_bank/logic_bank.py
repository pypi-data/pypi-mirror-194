...
class Rule:
    ...
    @staticmethod
    def sum(derive: InstrumentedAttribute | Column, as_sum_of: any, where: any = None, child_role_name: str = ""):
        """
    ...
    @staticmethod
    def count(derive: InstrumentedAttribute | Column, as_count_of: object, where: any = None, child_role_name: str = ""):
        """
    ...
    @staticmethod
    def formula(derive: InstrumentedAttribute | Column,
    ...
    @staticmethod
    def copy(derive: InstrumentedAttribute | Column, from_parent: any):
        """
