...
class Client(object):
    def __init__(self, model, api_key=None, api_secret=None, app_id=None, method="POST"):
        self.init_model(model)
        self.api_key = api_key or os.environ.get("ATPUserAppIdAk")
        self.api_secret = api_secret or os.environ.get("ATPUserAppIdSk")
        self.app_id = app_id or os.environ.get("ATPUserAppId")
        self.method = method
        pass
