...
class Table(BaseTable, BaseModel):
    ...
    # TODO FOR OpenAPI Spec but some errors currently
    # @property
    # def web_endpoint(self):
    #     return self.client.web_endpoints[self.abs_endpoint] if self.abs_endpoint in self.client.web_endpoints else None
    #
    # def _check_reports(self, reports):
    #     if reports is False or (reports is True and self.web_endpoint is None):
    #         return ""
    #     elif reports is True and self.web_endpoint:
    ...
    def fetch(
        ...
        reports: Optional[Union[list, str]] = None,
        sort: Optional[dict] = None,
        limit: Optional[int] = 1000,
        start: Optional[int] = 0,
    ) -> list:
        ...
        return self.client.fetch(
            ...
            # reports=self._check_reports(reports),
            reports=reports,
            sort=sort,
            limit=limit,
            start=start,
