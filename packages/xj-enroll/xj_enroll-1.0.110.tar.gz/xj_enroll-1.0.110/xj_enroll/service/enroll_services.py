...
class EnrollServices:
    ...
    def enroll_own_list(params, need_pagination=True):
        ...
        params = format_params_handle(
            ...
            filter_filed_list=[
                ...
                "amount", "category_id", "thread_id_list", "finance_invoicing_code"
            ],
    ...
    def enroll_undertake_list(params, need_pagination=True):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "enroll_id", "user_id", "enroll_pay_status", "enroll_status_code", "price", "count", "amount", "finance_invoicing_code"
            ],
    ...
    def enroll_edit(params=None, enroll_id=None, search_param=None):
        ...
        search_param = format_params_handle(
            ...
            alias_dict={"enroll_id_list": "enroll_id__in", "thread_id_list": "thread_id__in", "category_id_list": "category_id__in"}
        )
