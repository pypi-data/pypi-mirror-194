...
from ..utils.custom_tool import parse_data, format_params_handle, request_params_wrapper, filter_result_field, flow_service_wrapper
...
class EnrollAPI(APIView):
    ...
    def list(self, *args, request_params=None, user_info=None, **kwargs, ):
        ...
        thread_params = format_params_handle(
            ...
            filter_filed_list=[
                "user_id", "title", "subtitle", "summary", "access_level", "author", "has_enroll", "has_fee", "has_comment", "has_location", "is_original", "finance_invoicing_code"
            ],
            alias_dict={
