...
''',
    ...
    parser.add_argument('-v', "--version",    action="version",    version="pbandplot 0.1.1.1")
    ...
    parser.add_argument('-c', "--color",      type=str,            nargs='+', default=['red'], help="plot colors")
    ...
    if os.path.exists(args.input):
        ...
        if args.dos and os.path.exists(args.dos):
            darr, dele = readdata.dos(args.dos)
            plots.dosfile(args.output, args.size, args.vertical, args.horizontal, darr, dele, elements, legend, args.exchange, color)
