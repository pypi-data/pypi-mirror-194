...
def BrokenWd(arr, fre, ticks, EXPORT, labels, figsize, vertical, broken, height_ratio, darr, dele, elements, horizontal, width_ratios, legend, color):
    ...
    ax4.legend(elements, frameon=False, prop={'size':'x-small'}, loc='best', title="Density of states", title_fontproperties={'size':'x-small'})
...
def dosfile(EXPORT, figsize, vertical, horizontal, darr, dele, elements, legend):
    plt.figure(figsize=figsize)
