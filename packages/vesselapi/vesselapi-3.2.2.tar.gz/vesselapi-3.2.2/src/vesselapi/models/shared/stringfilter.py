...
class StringFilter:
    contains: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contains'), 'exclude': lambda f: f is None }})
    ends_with: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('endsWith'), 'exclude': lambda f: f is None }})
    ...
    starts_with: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('startsWith'), 'exclude': lambda f: f is None }})
