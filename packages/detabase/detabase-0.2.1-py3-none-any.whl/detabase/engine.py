...
class DetaBase:
	...
	async def put(self, data: DetaData, key: DetaKey = None, expire_in: ExpireIn = None, expire_at: ExpireAt = None):
		...
		:param table: table project name
	...
	async def update(self, key: str, sets: Optional[dict] = None, increments: Optional[dict[str, Union[int, float]]] = None, appends: Optional[dict[str, Union[JsonPrimitive, list]]] = None, prepends: Optional[dict[str, Union[JsonPrimitive, list]]] = None, trims: Optional[list[str]] = None):
		base = self.async_base()
		updates = dict()
		if sets:
	...
	async def fetch_all(self, query: DetaQuery = None):
		base = self.async_base()
		try:
	...
	async def insert(self, data: DetaData, key: DetaKey = None, expire_in: ExpireIn = None, expire_at: ExpireAt = None):
		"""
	...
	async def get_first(self, query: DetaQuery = None):
	...
	async def get_last(self, query: DetaQuery = None):
	...
	async def total_count(self, query: DetaQuery = None):
