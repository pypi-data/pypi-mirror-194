...
setup(
    ...
    package_data = {"krpc": ["py.typed","krpc.pyi","spacecenter.pyi","drawing.pyi","infernalrobotics.pyi","kerbalalarmclock.pyi","remotetech.pyi","ui.pyi","lidar.pyi","dockingcamera.pyi"]},
)
