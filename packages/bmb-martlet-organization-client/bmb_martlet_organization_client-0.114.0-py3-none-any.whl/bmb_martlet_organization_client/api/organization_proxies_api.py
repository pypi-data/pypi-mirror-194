...
class OrganizationProxiesApi(object):
    ...
    def get_proxies(self, **kwargs):  # noqa: E501
        """[get_proxies ] Returns the proxies for this organization.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_proxies(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_proxies_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_proxies_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_proxies_with_http_info(self, **kwargs):  # noqa: E501
        """[get_proxies ] Returns the proxies for this organization.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_proxies_with_http_info(async_req=True)
        >>> result = thread.get()
