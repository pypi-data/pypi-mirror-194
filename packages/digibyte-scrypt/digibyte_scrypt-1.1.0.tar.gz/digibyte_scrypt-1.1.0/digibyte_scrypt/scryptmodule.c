...
static PyMethodDef ScryptMethods[] = {
    { "calcPoW", (PyCFunction) scrypt_getpowhash, METH_VARARGS | METH_KEYWORDS, "Returns the proof of work hash using scrypt" },
    { NULL, NULL, 0, NULL }
};
...
PyMODINIT_FUNC PyInit_digibyte_scrypt(void) {
