...
class NestedPTWorkstationsAssignmentSerializer(WritableNestedSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='plugins-api:ptuevents-api:ptworkstations-detail')
...
class PTWorkstationsAssignmentSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='plugins-api:ptuevents-api:ptworkstationsassignment-detail')
    ...
    class Meta:
        ...
        fields = [
            'id', 'url', 'display', 'content_type', 'object_id', 'object', 'pt_workstations', 'created',
            'last_updated',
        ]
