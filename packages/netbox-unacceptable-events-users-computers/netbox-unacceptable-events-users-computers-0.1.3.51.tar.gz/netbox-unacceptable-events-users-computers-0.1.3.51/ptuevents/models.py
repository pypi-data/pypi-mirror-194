...
@receiver(post_delete, sender=ptuevents.models.PTUsers, dispatch_uid='del_PTUEvent_assignment')
def del_assignments(sender, **kwargs):
...
@receiver(post_delete, sender=ptuevents.models.PTWorkstations, dispatch_uid='del_PTUEvent_assignment')
def del_assignments(sender, **kwargs):
