...
class PTUsersAssignment(WebhooksMixin, ChangeLoggedModel):
    content_type = models.ForeignKey(
        to=ContentType,
        on_delete=models.CASCADE
    )
    ...
    def get_absolute_url(self):
        return reverse('plugins:ptuevents:ptusers', args=[self.app_system.pk])
...
class PTWorkstationsAssignment(WebhooksMixin, ChangeLoggedModel):
    content_type = models.ForeignKey(
        to=ContentType,
        on_delete=models.CASCADE
    )
    ...
    def get_absolute_url(self):
        return reverse('plugins:ptuevents:ptworkstations', args=[self.app_system.pk])
