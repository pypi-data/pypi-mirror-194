...
from spins2cpu.ising import p6mmm_update
...
def run(file, init, X, Y, J, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 3:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = p6mmm_update.iteration3(latt, X_s, Y_s, Ja, J0, J1, arrays_values[i], nequilibrium, nworks)
            ...
            latt[0,[2,3]] = -1
            latt[1,[0,1]] = -1
            m_ave0 = functions.Average(latt[0,[0,1]] + latt[1,[2,3]]) / 2.0
            m_ave1 = functions.Average(latt[0,[2,3]] + latt[1,[0,1]]) / 2.0
            logging.info("{:>16} {:>16.6} {:>16.6}".format(0, m_ave0, m_ave1))
            logging.info("{:>16} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
                "Temperature", "magnetism0", "magnetism1", "susceptibility0", "susceptibility1", "specific heat", "time(s)"))
            for i in range(lav):
