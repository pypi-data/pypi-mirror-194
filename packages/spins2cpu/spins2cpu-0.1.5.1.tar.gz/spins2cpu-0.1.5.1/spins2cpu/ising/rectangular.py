...
from spins2cpu.ising import rectangular_update
...
def run(file, init, X, Y, J, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 5:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = rectangular_update.iteration5(latt, X_s, Y_s, Ja, Jb, Jc, Jd, Je, arrays_values[i], nequilibrium, nworks)
            ...
            latt[[0,2],1::2] = -1
            latt[[1,3],::2] = -1
            m_ave0 = functions.Average(latt[[0,2],::2] + latt[[1,3],1::2]) / 2
            m_ave1 = functions.Average(latt[[0,2],1::2] + latt[[1,3],::2]) / 2
            logging.info("{:>16} {:>16.6} {:>16.6}".format(0, m_ave0, m_ave1))
            logging.info("{:>16} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
                "Temperature", "magnetism0", "magnetism1", "susceptibility0", "susceptibility1", "specific heat", "time(s)"))
            for i in range(lav):
