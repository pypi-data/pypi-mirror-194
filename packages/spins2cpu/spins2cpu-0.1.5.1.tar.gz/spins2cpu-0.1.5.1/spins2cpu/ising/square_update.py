        ...
        for k in prange(4):
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = latt[l,k,j,i] * ( -Ja * ( latt[lo,k ,j    ,i    ] + latt[lo,k1,j    ,i_1  ] + latt[lo,k2,j_2  ,i    ] + latt[lo,k3,j_2  ,i_1  ] ) -
                                                Jb * ( latt[l ,k1,j    ,x_ipp] + latt[l ,k1,j    ,x_inn] + latt[l ,k2,y_jpp,i    ] + latt[l ,k2,y_jnn,i    ] ) -
                                                Jc * ( latt[l ,k3,y_jnn,x_inn] + latt[l ,k3,y_jpp,x_ipp] + latt[l ,k3,y_jnn,x_ipp] + latt[l ,k3,y_jpp,x_inn] ) )
