...
from spins2cpu.mae import rectangular_update
...
def run(file, init, X, Y, J, JX, JY, A, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 5:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = rectangular_update.iteration5(latt, X_s, Y_s, Ja, Jb, Jc, Jd, Je, Jax, Jbx, Jcx, Jdx, Jex, Jay, Jby, Jcy, Jdy, Jey, Aa, Ab, arrays_values[i], nequilibrium, nworks)
