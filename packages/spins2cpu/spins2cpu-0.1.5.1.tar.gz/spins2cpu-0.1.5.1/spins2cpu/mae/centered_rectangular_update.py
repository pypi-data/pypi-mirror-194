            ...
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = ( latt[l,k,j,i,0] * ( -Jax * ( latt[l ,k3,j   ,x_l ,0] + latt[l ,k1,j   ,x_r ,0] ) -
                                                    Jbx * ( latt[l3,k ,y_u ,i   ,0] + latt[l1,k ,y_d ,i   ,0] + latt[l3,kb,y_u ,x_b ,0] + latt[l1,kb,y_d ,x_b ,0] ) -
                                                    Jcx * ( latt[l2,k ,y_u2,i   ,0] + latt[l2,k ,y_d2,i   ,0] ) -
                                                    Jdx * ( latt[l ,k2,j   ,x_l2,0] + latt[l ,k2,j   ,x_r2,0] ) -
                                                    Jex * ( latt[l2,k3,y_u2,x_l ,0] + latt[l2,k3,y_d2,x_l ,0] + latt[l2,k1,y_u2,x_r ,0] + latt[l2,k1,y_d2,x_r ,0] ) ) +
                               latt[l,k,j,i,1] * ( -Jay * ( latt[l ,k3,j   ,x_l ,1] + latt[l ,k1,j   ,x_r ,1] ) -
                                                    Jby * ( latt[l3,k ,y_u ,i   ,1] + latt[l1,k ,y_d ,i   ,1] + latt[l3,kb,y_u ,x_b ,1] + latt[l1,kb,y_d ,x_b ,1] ) -
                                                    Jcy * ( latt[l2,k ,y_u2,i   ,1] + latt[l2,k ,y_d2,i   ,1] ) -
                                                    Jdy * ( latt[l ,k2,j   ,x_l2,1] + latt[l ,k2,j   ,x_r2,1] ) -
                                                    Jey * ( latt[l2,k3,y_u2,x_l ,1] + latt[l2,k3,y_d2,x_l ,1] + latt[l2,k1,y_u2,x_r ,1] + latt[l2,k1,y_d2,x_r ,1] ) ) +
