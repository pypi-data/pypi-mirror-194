            ...
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = ( latt[l,k,j,i,0] * ( -Jax * ( latt[lo,k ,j    ,i    ,0] + latt[lo,k1,j    ,i_1  ,0] + latt[lo,k2,j_2  ,i    ,0] + latt[lo,k3,j_2  ,i_1  ,0] +
                                                    ...
                                                    Jbx * ( latt[lo,k ,j    ,ib0  ,0] + latt[lo,k1,j    ,ib1  ,0] + latt[lo,k2,j_2  ,ib0  ,0] + latt[lo,k3,j_2  ,ib1  ,0] +
                                                            latt[l ,k2,y_jpp,i    ,0] + latt[l ,k2,y_jnn,i    ,0] ) -
                                                    Jcx * ( latt[l ,k3,j    ,i    ,0] + latt[l ,k3,j    ,i_c  ,0] + latt[l ,k3,j_c  ,i    ,0] + latt[l ,k3,j_c  ,i_c  ,0] +
                               ...
                               latt[l,k,j,i,1] * ( -Jay * ( latt[lo,k ,j    ,i    ,1] + latt[lo,k1,j    ,i_1  ,1] + latt[lo,k2,j_2  ,i    ,1] + latt[lo,k3,j_2  ,i_1  ,1] +
                                                    ...
                                                    Jby * ( latt[lo,k ,j    ,ib0  ,1] + latt[lo,k1,j    ,ib1  ,1] + latt[lo,k2,j_2  ,ib0  ,1] + latt[lo,k3,j_2  ,ib1  ,1] +
                                                            latt[l ,k2,y_jpp,i    ,1] + latt[l ,k2,y_jnn,i    ,1] ) -
                                                    Jcy * ( latt[l ,k3,j    ,i    ,1] + latt[l ,k3,j    ,i_c  ,1] + latt[l ,k3,j_c  ,i    ,1] + latt[l ,k3,j_c  ,i_c  ,1] +
