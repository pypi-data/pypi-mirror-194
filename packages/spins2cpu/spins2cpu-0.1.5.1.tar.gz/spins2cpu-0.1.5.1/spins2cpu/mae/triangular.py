...
from spins2cpu.mae import triangular_update
...
def run(file, init, X, Y, J, JX, JY, A, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 3:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = triangular_update.iteration3(latt, X_s, Y_s, Ja, Jb, Jc, Jax, Jbx, Jcx, Jay, Jby, Jcy, Aa, Ab, arrays_values[i], nequilibrium, nworks)
