        ...
        for k in prange(4):
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = ( latt[l,k,j,i,0] * ( -Ja * ( latt[lo,k ,j    ,i    ,0] + latt[lo,k1,j    ,i_1  ,0] + latt[lo,k2,j_2,i  ,0] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,0] + latt[l ,k1,j    ,x_inn,0] +
                                                           latt[l ,k2,y_jpp,i    ,0] + latt[l ,k2,y_jnn,i    ,0] +
                                                           latt[l ,k3,y_jnn,x_inn,0] + latt[l ,k3,y_jpp,x_ipp,0] ) -
                                                    Jc * ( latt[lo,k3,y_0  ,x_0  ,0] + latt[lo,k3,y_1  ,x_1  ,0] + latt[lo,k3,y_2,x_2,0] ) ) +
                               latt[l,k,j,i,1] * ( -Ja * ( latt[lo,k ,j    ,i    ,1] + latt[lo,k1,j    ,i_1  ,1] + latt[lo,k2,j_2,i  ,1] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,1] + latt[l ,k1,j    ,x_inn,1] +
                                                           latt[l ,k2,y_jpp,i    ,1] + latt[l ,k2,y_jnn,i    ,1] +
                                                           latt[l ,k3,y_jnn,x_inn,1] + latt[l ,k3,y_jpp,x_ipp,1] ) -
                                                    Jc * ( latt[lo,k3,y_0  ,x_0  ,1] + latt[lo,k3,y_1  ,x_1  ,1] + latt[lo,k3,y_2,x_2,1] ) ) +
                               latt[l,k,j,i,2] * ( -Ja * ( latt[lo,k ,j    ,i    ,2] + latt[lo,k1,j    ,i_1  ,2] + latt[lo,k2,j_2,i  ,2] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,2] + latt[l ,k1,j    ,x_inn,2] +
                                                           latt[l ,k2,y_jpp,i    ,2] + latt[l ,k2,y_jnn,i    ,2] +
                                                           latt[l ,k3,y_jnn,x_inn,2] + latt[l ,k3,y_jpp,x_ipp,2] ) -
                                                    Jc * ( latt[lo,k3,y_0  ,x_0  ,2] + latt[lo,k3,y_1  ,x_1  ,2] + latt[lo,k3,y_2,x_2,2] ) ) )
                    Erandn = ( laRn[l,k,j,i,0] * ( -Ja * ( latt[lo,k ,j    ,i    ,0] + latt[lo,k1,j    ,i_1  ,0] + latt[lo,k2,j_2,i  ,0] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,0] + latt[l ,k1,j    ,x_inn,0] +
                                                           latt[l ,k2,y_jpp,i    ,0] + latt[l ,k2,y_jnn,i    ,0] +
                                                           latt[l ,k3,y_jnn,x_inn,0] + latt[l ,k3,y_jpp,x_ipp,0] ) -
                                                    Jc * ( latt[lo,k3,y_0  ,x_0  ,0] + latt[lo,k3,y_1  ,x_1  ,0] + latt[lo,k3,y_2,x_2,0] ) ) +
                               laRn[l,k,j,i,1] * ( -Ja * ( latt[lo,k ,j    ,i    ,1] + latt[lo,k1,j    ,i_1  ,1] + latt[lo,k2,j_2,i  ,1] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,1] + latt[l ,k1,j    ,x_inn,1] +
                                                           latt[l ,k2,y_jpp,i    ,1] + latt[l ,k2,y_jnn,i    ,1] +
                                                           latt[l ,k3,y_jnn,x_inn,1] + latt[l ,k3,y_jpp,x_ipp,1] ) -
                                                    Jc * ( latt[lo,k3,y_0  ,x_0  ,1] + latt[lo,k3,y_1  ,x_1  ,1] + latt[lo,k3,y_2,x_2,1] ) ) +
                               laRn[l,k,j,i,2] * ( -Ja * ( latt[lo,k ,j    ,i    ,2] + latt[lo,k1,j    ,i_1  ,2] + latt[lo,k2,j_2,i  ,2] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,2] + latt[l ,k1,j    ,x_inn,2] +
                                                           latt[l ,k2,y_jpp,i    ,2] + latt[l ,k2,y_jnn,i    ,2] +
                                                           latt[l ,k3,y_jnn,x_inn,2] + latt[l ,k3,y_jpp,x_ipp,2] ) -
                                                    Jc * ( latt[lo,k3,y_0  ,x_0  ,2] + latt[lo,k3,y_1  ,x_1  ,2] + latt[lo,k3,y_2,x_2,2] ) ) )
