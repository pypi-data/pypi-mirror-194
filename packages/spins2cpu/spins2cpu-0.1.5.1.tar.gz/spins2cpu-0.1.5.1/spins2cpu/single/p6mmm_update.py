            ...
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = ( latt[l,k,j,i,0] * ( -Ja * ( latt[l ,k1,j    ,x_ipp,0] + latt[l ,k1,j    ,x_inn,0] +
                                                    ...
                                                    J0 *   latt[lo,k ,j    ,i    ,0] -
                                                    J1 * ( latt[lo,k1,j    ,x_ipp,0] + latt[lo,k1,j    ,x_inn,0] +
                                                           latt[lo,k2,y_jpp,i    ,0] + latt[lo,k2,y_jnn,i    ,0] +
                                                           latt[lo,k3,y_jnn,x_inn,0] + latt[lo,k3,y_jpp,x_ipp,0] ) ) +
                               latt[l,k,j,i,1] * ( -Ja * ( latt[l ,k1,j    ,x_ipp,1] + latt[l ,k1,j    ,x_inn,1] +
                                                    ...
                                                    J0 *   latt[lo,k ,j    ,i    ,1] -
                                                    J1 * ( latt[lo,k1,j    ,x_ipp,1] + latt[lo,k1,j    ,x_inn,1] +
                                                           latt[lo,k2,y_jpp,i    ,1] + latt[lo,k2,y_jnn,i    ,1] +
                                                           latt[lo,k3,y_jnn,x_inn,1] + latt[lo,k3,y_jpp,x_ipp,1] ) ) +
                               latt[l,k,j,i,2] * ( -Ja * ( latt[l ,k1,j    ,x_ipp,2] + latt[l ,k1,j    ,x_inn,2] +
                                                    ...
                                                    J0 *   latt[lo,k ,j    ,i    ,2] -
                                                    J1 * ( latt[lo,k1,j    ,x_ipp,2] + latt[lo,k1,j    ,x_inn,2] +
                                                           latt[lo,k2,y_jpp,i    ,2] + latt[lo,k2,y_jnn,i    ,2] +
                                                           latt[lo,k3,y_jnn,x_inn,2] + latt[lo,k3,y_jpp,x_ipp,2] ) ) )
