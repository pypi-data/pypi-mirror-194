...
from spins2cpu.single import p6mmm_update
...
def run(file, init, X, Y, J, A, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 3:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = p6mmm_update.iteration3(latt, X_s, Y_s, Ja, J0, J1, Aa, arrays_values[i], nequilibrium, nworks)
            ...
            latt[0,[2,3],:,:,2] = -1
            latt[1,[0,1],:,:,2] = -1
            m_ave0 = functions.Average(latt[0,[0,1],:,:,2] + latt[1,[2,3],:,:,2]) / 2.0
            m_ave1 = functions.Average(latt[0,[2,3],:,:,2] + latt[1,[0,1],:,:,2]) / 2.0
            logging.info("{:>16} {:>16.6} {:>16.6}".format(0, m_ave0, m_ave1))
            logging.info("{:>16} {:>16} {:>16} {:>18} {:>18} {:>16} {:>16}".format(
                "Temperature", "magnetism0(e)", "magnetism1(e)", "susceptibility0(e)", "susceptibility1(e)", "specific heat", "time(s)"))
            for i in range(lav):
