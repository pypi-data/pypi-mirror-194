...
from spins2cpu.single import centered_rectangular_update
...
def run(file, init, X, Y, J, A, arrays_temperatures, nequilibrium, nworks):
    ...
    if p == 5:
        ...
        if init == "fm":
            ...
            for i in range(lav):
                t, Nw, Ew = centered_rectangular_update.iteration5(latt, X_s, Y_s, Ja, Jb, Jc, Jd, Je, Aa, arrays_values[i], nequilibrium, nworks)
