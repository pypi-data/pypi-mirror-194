...
def iteration3(latt, X_s, Y_s, Ja, Jb, Jc, Aa, val, nequilibrium, nworks):
    ...
    if ju > 3:
        ...
        for i in range(nequilibrium):
            ...
            latZ = energy_A(latt, Aa) #Energy of (sz)^2 for origin lattices
            laRZ = energy_A(laRn, Aa) #Energy of (sz)^2 for random lattices
            ...
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = ( latt[l,k,j,i,0] * ( -Ja * ( latt[lo,k ,j    ,i    ,0] + latt[lo,k1,j    ,i_1  ,0] + latt[lo,k2,j_2  ,i    ,0] + latt[lo,k3,j_2  ,i_1  ,0] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,0] + latt[l ,k1,j    ,x_inn,0] + latt[l ,k2,y_jpp,i    ,0] + latt[l ,k2,y_jnn,i    ,0] ) -
                                                    Jc * ( latt[l ,k3,y_jnn,x_inn,0] + latt[l ,k3,y_jpp,x_ipp,0] + latt[l ,k3,y_jnn,x_ipp,0] + latt[l ,k3,y_jpp,x_inn,0] ) ) +
                               latt[l,k,j,i,1] * ( -Ja * ( latt[lo,k ,j    ,i    ,1] + latt[lo,k1,j    ,i_1  ,1] + latt[lo,k2,j_2  ,i    ,1] + latt[lo,k3,j_2  ,i_1  ,1] ) -
                                                    Jb * ( latt[l ,k1,j    ,x_ipp,1] + latt[l ,k1,j    ,x_inn,1] + latt[l ,k2,y_jpp,i    ,1] + latt[l ,k2,y_jnn,i    ,1] ) -
                                                    Jc * ( latt[l ,k3,y_jnn,x_inn,1] + latt[l ,k3,y_jpp,x_ipp,1] + latt[l ,k3,y_jnn,x_ipp,1] + latt[l ,k3,y_jpp,x_inn,1] ) ) +
