...
class BodyComparador:
    ...
    def set_periodo_analise_acumulada(self, data_inicio: datetime, data_fim: datetime, data_prev_base: datetime = None,
                                      data_prev_confrontante: datetime = None):
        """
        ...
        if data_inicio: self.__data_inicial = data_inicio.timestamp()
        if data_fim: self.__data_final = data_fim.timestamp()
        if data_prev_confrontante: self.__data_prev_confrontante = data_prev_confrontante.timestamp()
        if data_prev_base: self.__data_prev_base = data_prev_base.timestamp()
