...
class AddRoutesOptions:
    def __init__(
        self,
        *,
        app_origin: _aws_cdk_aws_cloudfront_ceddda9d.IOrigin,
        app_origin_request_policy: _aws_cdk_aws_cloudfront_ceddda9d.IOriginRequestPolicy,
        bucket_apps_origin: _aws_cdk_aws_cloudfront_origins_ceddda9d.S3Origin,
        ...
        if __debug__:
            ...
            check_type(argname="argument app_origin", value=app_origin, expected_type=type_hints["app_origin"])
            ...
            check_type(argname="argument bucket_apps_origin", value=bucket_apps_origin, expected_type=type_hints["bucket_apps_origin"])
    ...
    @builtins.property
    def app_origin(self) -> _aws_cdk_aws_cloudfront_ceddda9d.IOrigin:
    ...
    @builtins.property
    def bucket_apps_origin(self) -> _aws_cdk_aws_cloudfront_origins_ceddda9d.S3Origin:
...
class _IMicroAppsS3Proxy:
    ...
    def bucket_apps_origin(self) -> _aws_cdk_aws_cloudfront_origins_ceddda9d.S3Origin:
        ...
        :stability: experimental
        '''
        return typing.cast(_aws_cdk_aws_cloudfront_origins_ceddda9d.S3Origin, jsii.get(self, "bucketAppsOrigin"))
