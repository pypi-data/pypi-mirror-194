...
class StorageBackups(object):
    ...
    swagger_types = {
        ...
        'object_name': 'str',
        'object_uuid': 'str',
        'schedules_storages_backups_name': 'str',
        'schedules_storages_backups_uuid': 'str',
        'status': 'str',
        'storage_uuid': 'str'
    }
    ...
    attribute_map = {
        ...
        'schedules_storages_backups_name': 'schedules_storages_backups_name',
        'schedules_storages_backups_uuid': 'schedules_storages_backups_uuid',
        'status': 'status',
        'storage_uuid': 'storage_uuid'
    }

    def __init__(self, create_time=None, last_used_template=None, object_capacity=None, object_name=None, object_uuid=None, schedules_storages_backups_name=None, schedules_storages_backups_uuid=None, status=None, storage_uuid=None):  # noqa: E501
        """StorageBackups - a model defined in Swagger"""  # noqa: E501

        self._create_time = None
        self._last_used_template = None
        self._object_capacity = None
        self._object_name = None
        self._object_uuid = None
        self._schedules_storages_backups_name = None
        self._schedules_storages_backups_uuid = None
        self._status = None
        ...
        if schedules_storages_backups_name is not None:
            self.schedules_storages_backups_name = schedules_storages_backups_name
        if schedules_storages_backups_uuid is not None:
            self.schedules_storages_backups_uuid = schedules_storages_backups_uuid
    ...
    def create_time(self):
        """Gets the create_time of this StorageBackups.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this StorageBackups.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this StorageBackups.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this StorageBackups.  # noqa: E501
        :type: datetime
        """
    ...
    def last_used_template(self):
        """Gets the last_used_template of this StorageBackups.  # noqa: E501

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :return: The last_used_template of this StorageBackups.  # noqa: E501
        :rtype: str
        """
    ...
    def last_used_template(self, last_used_template):
        """Sets the last_used_template of this StorageBackups.

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :param last_used_template: The last_used_template of this StorageBackups.  # noqa: E501
        :type: str
        """
    ...
    def object_capacity(self):
        """Gets the object_capacity of this StorageBackups.  # noqa: E501

        The size of the object in GB  # noqa: E501

        :return: The object_capacity of this StorageBackups.  # noqa: E501
        :rtype: int
        """
        return self._object_capacity

    @object_capacity.setter
    def object_capacity(self, object_capacity):
        """Sets the object_capacity of this StorageBackups.

        The size of the object in GB  # noqa: E501

        :param object_capacity: The object_capacity of this StorageBackups.  # noqa: E501
        :type: int
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this StorageBackups.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this StorageBackups.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this StorageBackups.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this StorageBackups.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this StorageBackups.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this StorageBackups.  # noqa: E501
        :type: str
        """
    ...
    @property
    def schedules_storages_backups_name(self):
        """Gets the schedules_storages_backups_name of this StorageBackups.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The schedules_storages_backups_name of this StorageBackups.  # noqa: E501
        :rtype: str
        """
        return self._schedules_storages_backups_name

    @schedules_storages_backups_name.setter
    def schedules_storages_backups_name(self, schedules_storages_backups_name):
        """Sets the schedules_storages_backups_name of this StorageBackups.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param schedules_storages_backups_name: The schedules_storages_backups_name of this StorageBackups.  # noqa: E501
        :type: str
        """

        self._schedules_storages_backups_name = schedules_storages_backups_name

    @property
    def schedules_storages_backups_uuid(self):
        """Gets the schedules_storages_backups_uuid of this StorageBackups.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The schedules_storages_backups_uuid of this StorageBackups.  # noqa: E501
        :rtype: str
        """
        return self._schedules_storages_backups_uuid

    @schedules_storages_backups_uuid.setter
    def schedules_storages_backups_uuid(self, schedules_storages_backups_uuid):
        """Sets the schedules_storages_backups_uuid of this StorageBackups.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param schedules_storages_backups_uuid: The schedules_storages_backups_uuid of this StorageBackups.  # noqa: E501
        :type: str
        """

        self._schedules_storages_backups_uuid = schedules_storages_backups_uuid

    @property
    def status(self):
        """Gets the status of this StorageBackups.  # noqa: E501

        The status of the object  # noqa: E501

        :return: The status of this StorageBackups.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this StorageBackups.

        The status of the object  # noqa: E501

        :param status: The status of this StorageBackups.  # noqa: E501
        :type: str
        """
    ...
    def storage_uuid(self):
        """Gets the storage_uuid of this StorageBackups.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The storage_uuid of this StorageBackups.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_uuid(self, storage_uuid):
        """Sets the storage_uuid of this StorageBackups.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param storage_uuid: The storage_uuid of this StorageBackups.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackups, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackups):
            return False
