...
class LocationFeatures(object):
    ...
    """
    swagger_types = {
        'hardware_profiles': 'str',
        'has_rocket_storage': 'str',
        'has_server_provisioning': 'str',
        'object_storage_region': 'str',
        'backup_center_location_uuid': 'str'
    }

    attribute_map = {
        'hardware_profiles': 'hardware_profiles',
        'has_rocket_storage': 'has_rocket_storage',
        'has_server_provisioning': 'has_server_provisioning',
        'object_storage_region': 'object_storage_region',
        'backup_center_location_uuid': 'backup_center_location_uuid'
    }

    def __init__(self, hardware_profiles=None, has_rocket_storage=None, has_server_provisioning=None, object_storage_region=None, backup_center_location_uuid=None):  # noqa: E501
        """LocationFeatures - a model defined in Swagger"""  # noqa: E501

        self._hardware_profiles = None
        self._has_rocket_storage = None
        self._has_server_provisioning = None
        self._object_storage_region = None
        self._backup_center_location_uuid = None
        self.discriminator = None

        if hardware_profiles is not None:
            self.hardware_profiles = hardware_profiles
        if has_rocket_storage is not None:
            self.has_rocket_storage = has_rocket_storage
        if has_server_provisioning is not None:
            self.has_server_provisioning = has_server_provisioning
        if object_storage_region is not None:
            self.object_storage_region = object_storage_region
        if backup_center_location_uuid is not None:
            self.backup_center_location_uuid = backup_center_location_uuid

    @property
    def hardware_profiles(self):
        """Gets the hardware_profiles of this LocationFeatures.  # noqa: E501


        :return: The hardware_profiles of this LocationFeatures.  # noqa: E501
        :rtype: str
        """
        return self._hardware_profiles

    @hardware_profiles.setter
    def hardware_profiles(self, hardware_profiles):
        """Sets the hardware_profiles of this LocationFeatures.


        :param hardware_profiles: The hardware_profiles of this LocationFeatures.  # noqa: E501
        :type: str
        """

        self._hardware_profiles = hardware_profiles

    @property
    def has_rocket_storage(self):
        """Gets the has_rocket_storage of this LocationFeatures.  # noqa: E501


        :return: The has_rocket_storage of this LocationFeatures.  # noqa: E501
        :rtype: str
        """
        return self._has_rocket_storage

    @has_rocket_storage.setter
    def has_rocket_storage(self, has_rocket_storage):
        """Sets the has_rocket_storage of this LocationFeatures.


        :param has_rocket_storage: The has_rocket_storage of this LocationFeatures.  # noqa: E501
        :type: str
        """

        self._has_rocket_storage = has_rocket_storage

    @property
    def has_server_provisioning(self):
        """Gets the has_server_provisioning of this LocationFeatures.  # noqa: E501


        :return: The has_server_provisioning of this LocationFeatures.  # noqa: E501
        :rtype: str
        """
        return self._has_server_provisioning

    @has_server_provisioning.setter
    def has_server_provisioning(self, has_server_provisioning):
        """Sets the has_server_provisioning of this LocationFeatures.


        :param has_server_provisioning: The has_server_provisioning of this LocationFeatures.  # noqa: E501
        :type: str
        """

        self._has_server_provisioning = has_server_provisioning

    @property
    def object_storage_region(self):
        """Gets the object_storage_region of this LocationFeatures.  # noqa: E501


        :return: The object_storage_region of this LocationFeatures.  # noqa: E501
        :rtype: str
        """
    ...
    def object_storage_region(self, object_storage_region):
        """Sets the object_storage_region of this LocationFeatures.


        :param object_storage_region: The object_storage_region of this LocationFeatures.  # noqa: E501
        :type: str
        """
    ...
    @property
    def backup_center_location_uuid(self):
        """Gets the backup_center_location_uuid of this LocationFeatures.  # noqa: E501


        :return: The backup_center_location_uuid of this LocationFeatures.  # noqa: E501
        :rtype: str
        """
        return self._backup_center_location_uuid

    @backup_center_location_uuid.setter
    def backup_center_location_uuid(self, backup_center_location_uuid):
        """Sets the backup_center_location_uuid of this LocationFeatures.


        :param backup_center_location_uuid: The backup_center_location_uuid of this LocationFeatures.  # noqa: E501
        :type: str
        """

        self._backup_center_location_uuid = backup_center_location_uuid
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationFeatures, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationFeatures):
            return False
