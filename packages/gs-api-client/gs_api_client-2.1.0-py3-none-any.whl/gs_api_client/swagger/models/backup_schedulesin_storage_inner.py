...
class BackupSchedulesinStorageInner(object):
    ...
    def __init__(self, object_name=None, next_runtime=None, keep_backups=None, create_time=None, run_interval=None, object_uuid=None):  # noqa: E501
        """BackupSchedulesinStorageInner - a model defined in Swagger"""  # noqa: E501
    ...
    def object_name(self):
        """Gets the object_name of this BackupSchedulesinStorageInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The object_name of this BackupSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this BackupSchedulesinStorageInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this BackupSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    def next_runtime(self):
        """Gets the next_runtime of this BackupSchedulesinStorageInner.  # noqa: E501

        The date and time that the backup schedule will be run.  # noqa: E501

        :return: The next_runtime of this BackupSchedulesinStorageInner.  # noqa: E501
        :rtype: datetime
        """
    ...
    def next_runtime(self, next_runtime):
        """Sets the next_runtime of this BackupSchedulesinStorageInner.

        The date and time that the backup schedule will be run.  # noqa: E501

        :param next_runtime: The next_runtime of this BackupSchedulesinStorageInner.  # noqa: E501
        :type: datetime
        """
    ...
    def keep_backups(self):
        """Gets the keep_backups of this BackupSchedulesinStorageInner.  # noqa: E501

        The amount of Backups to keep before overwriting the last created Backup.  # noqa: E501

        :return: The keep_backups of this BackupSchedulesinStorageInner.  # noqa: E501
        :rtype: int
        """
    ...
    def keep_backups(self, keep_backups):
        """Sets the keep_backups of this BackupSchedulesinStorageInner.

        The amount of Backups to keep before overwriting the last created Backup.  # noqa: E501

        :param keep_backups: The keep_backups of this BackupSchedulesinStorageInner.  # noqa: E501
        :type: int
        """
    ...
    def create_time(self):
        """Gets the create_time of this BackupSchedulesinStorageInner.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this BackupSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this BackupSchedulesinStorageInner.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this BackupSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    def run_interval(self):
        """Gets the run_interval of this BackupSchedulesinStorageInner.  # noqa: E501

        The interval at which the schedule will run (in seconds)  # noqa: E501

        :return: The run_interval of this BackupSchedulesinStorageInner.  # noqa: E501
        :rtype: int
        """
    ...
    def run_interval(self, run_interval):
        """Sets the run_interval of this BackupSchedulesinStorageInner.

        The interval at which the schedule will run (in seconds)  # noqa: E501

        :param run_interval: The run_interval of this BackupSchedulesinStorageInner.  # noqa: E501
        :type: int
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this BackupSchedulesinStorageInner.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this BackupSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this BackupSchedulesinStorageInner.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this BackupSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BackupSchedulesinStorageInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupSchedulesinStorageInner):
            return False
