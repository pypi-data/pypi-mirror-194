...
class BucketUsage(object):
    ...
    def __init__(self, size_kb=None, num_objects=None):  # noqa: E501
        """BucketUsage - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def size_kb(self):
        """Gets the size_kb of this BucketUsage.  # noqa: E501

        The size of the the bucket (in kb).  # noqa: E501

        :return: The size_kb of this BucketUsage.  # noqa: E501
        :rtype: int
        """
    ...
    def size_kb(self, size_kb):
        """Sets the size_kb of this BucketUsage.

        The size of the the bucket (in kb).  # noqa: E501

        :param size_kb: The size_kb of this BucketUsage.  # noqa: E501
        :type: int
        """
    ...
    def num_objects(self):
        """Gets the num_objects of this BucketUsage.  # noqa: E501

        The number of files in the bucket.  # noqa: E501

        :return: The num_objects of this BucketUsage.  # noqa: E501
        :rtype: int
        """
    ...
    def num_objects(self, num_objects):
        """Sets the num_objects of this BucketUsage.

        The number of files in the bucket.  # noqa: E501

        :param num_objects: The num_objects of this BucketUsage.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BucketUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BucketUsage):
            return False
