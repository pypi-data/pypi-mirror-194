...
class PinnedServerPayload(object):
    ...
    def __init__(self, ip=None):  # noqa: E501
        """PinnedServerPayload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def ip(self):
        """Gets the ip of this PinnedServerPayload.  # noqa: E501

        IP which is assigned to the server  # noqa: E501

        :return: The ip of this PinnedServerPayload.  # noqa: E501
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        """Sets the ip of this PinnedServerPayload.

        IP which is assigned to the server  # noqa: E501

        :param ip: The ip of this PinnedServerPayload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PinnedServerPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PinnedServerPayload):
            return False
