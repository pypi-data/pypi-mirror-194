...
class EventResponseEvents(object):
    ...
    def __init__(self, object_type=None, request_uuid=None, object_uuid=None, activity=None, request_type=None, request_status=None, change=None, timestamp=None, user_uuid=None, initiator=None):  # noqa: E501
        """EventResponseEvents - a model defined in Swagger"""  # noqa: E501
    ...
    def object_type(self):
        """Gets the object_type of this EventResponseEvents.  # noqa: E501

        Type of object (server, storage, IP) etc.  # noqa: E501

        :return: The object_type of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """Sets the object_type of this EventResponseEvents.

        Type of object (server, storage, IP) etc.  # noqa: E501

        :param object_type: The object_type of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    def request_uuid(self):
        """Gets the request_uuid of this EventResponseEvents.  # noqa: E501

        The UUID of the event.  # noqa: E501

        :return: The request_uuid of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def request_uuid(self, request_uuid):
        """Sets the request_uuid of this EventResponseEvents.

        The UUID of the event.  # noqa: E501

        :param request_uuid: The request_uuid of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this EventResponseEvents.  # noqa: E501

        The UUID of the objects the event was executed on.  # noqa: E501

        :return: The object_uuid of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this EventResponseEvents.

        The UUID of the objects the event was executed on.  # noqa: E501

        :param object_uuid: The object_uuid of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    @property
    def activity(self):
        """Gets the activity of this EventResponseEvents.  # noqa: E501

        The type of change.  # noqa: E501

        :return: The activity of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def activity(self, activity):
        """Sets the activity of this EventResponseEvents.

        The type of change.  # noqa: E501

        :param activity: The activity of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    def request_type(self):
        """Gets the request_type of this EventResponseEvents.  # noqa: E501

        The type of request.  # noqa: E501

        :return: The request_type of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def request_type(self, request_type):
        """Sets the request_type of this EventResponseEvents.

        The type of request.  # noqa: E501

        :param request_type: The request_type of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    def request_status(self):
        """Gets the request_status of this EventResponseEvents.  # noqa: E501

        True or false, whether the request was successful or not.  # noqa: E501

        :return: The request_status of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def request_status(self, request_status):
        """Sets the request_status of this EventResponseEvents.

        True or false, whether the request was successful or not.  # noqa: E501

        :param request_status: The request_status of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    @property
    def change(self):
        """Gets the change of this EventResponseEvents.  # noqa: E501

        A detailed description of the change.  # noqa: E501

        :return: The change of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
        return self._change
    ...
    def change(self, change):
        """Sets the change of this EventResponseEvents.

        A detailed description of the change.  # noqa: E501

        :param change: The change of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this EventResponseEvents.  # noqa: E501

        Time the event was triggered.  # noqa: E501

        :return: The timestamp of this EventResponseEvents.  # noqa: E501
        :rtype: datetime
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this EventResponseEvents.

        Time the event was triggered.  # noqa: E501

        :param timestamp: The timestamp of this EventResponseEvents.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def user_uuid(self):
        """Gets the user_uuid of this EventResponseEvents.  # noqa: E501

        The UUID of the user that triggered the event. Empty in case this event was not initiated by a user.  # noqa: E501

        :return: The user_uuid of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def user_uuid(self, user_uuid):
        """Sets the user_uuid of this EventResponseEvents.

        The UUID of the user that triggered the event. Empty in case this event was not initiated by a user.  # noqa: E501

        :param user_uuid: The user_uuid of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    @property
    def initiator(self):
        """Gets the initiator of this EventResponseEvents.  # noqa: E501

        The user that triggered the event. Usually the user's email if the event was triggered by request of a user, otherwise a short descriptive name of the system component responsible.  # noqa: E501

        :return: The initiator of this EventResponseEvents.  # noqa: E501
        :rtype: str
        """
    ...
    def initiator(self, initiator):
        """Sets the initiator of this EventResponseEvents.

        The user that triggered the event. Usually the user's email if the event was triggered by request of a user, otherwise a short descriptive name of the system component responsible.  # noqa: E501

        :param initiator: The initiator of this EventResponseEvents.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventResponseEvents, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventResponseEvents):
            return False
