...
from gs_api_client.swagger.models.serverin_isoimage import ServerinIsoimage  # noqa: F401,E501


class IsoimageRelation(object):
    ...
    def __init__(self, servers=None):  # noqa: E501
        """IsoimageRelation - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def servers(self):
        """Gets the servers of this IsoimageRelation.  # noqa: E501


        :return: The servers of this IsoimageRelation.  # noqa: E501
        :rtype: ServerinIsoimage
        """
        return self._servers

    @servers.setter
    def servers(self, servers):
        """Sets the servers of this IsoimageRelation.


        :param servers: The servers of this IsoimageRelation.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IsoimageRelation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsoimageRelation):
            return False
