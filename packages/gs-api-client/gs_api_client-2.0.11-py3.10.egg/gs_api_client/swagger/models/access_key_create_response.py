...
from gs_api_client.swagger.models.access_key_create_response_access_key import AccessKeyCreateResponseAccessKey  # noqa: F401,E501


class AccessKeyCreateResponse(object):
    ...
    """
    swagger_types = {
        'access_key': 'AccessKeyCreateResponseAccessKey',
        'request_uuid': 'str'
    }
    ...
    def __init__(self, access_key=None, request_uuid=None):  # noqa: E501
        """AccessKeyCreateResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def access_key(self):
        """Gets the access_key of this AccessKeyCreateResponse.  # noqa: E501


        :return: The access_key of this AccessKeyCreateResponse.  # noqa: E501
        :rtype: AccessKeyCreateResponseAccessKey
        """
        return self._access_key

    @access_key.setter
    def access_key(self, access_key):
        """Sets the access_key of this AccessKeyCreateResponse.


        :param access_key: The access_key of this AccessKeyCreateResponse.  # noqa: E501
        :type: AccessKeyCreateResponseAccessKey
        """
    ...
    def request_uuid(self):
        """Gets the request_uuid of this AccessKeyCreateResponse.  # noqa: E501

        The unique id for the request.  # noqa: E501

        :return: The request_uuid of this AccessKeyCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def request_uuid(self, request_uuid):
        """Sets the request_uuid of this AccessKeyCreateResponse.

        The unique id for the request.  # noqa: E501

        :param request_uuid: The request_uuid of this AccessKeyCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccessKeyCreateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessKeyCreateResponse):
            return False
