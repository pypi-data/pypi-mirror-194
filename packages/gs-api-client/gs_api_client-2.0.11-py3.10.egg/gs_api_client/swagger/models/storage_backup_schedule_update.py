...
class StorageBackupScheduleUpdate(object):
    ...
    def __init__(self, name=None, run_interval=None, keep_backups=None, next_runtime=None, active=None):  # noqa: E501
        """StorageBackupScheduleUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this StorageBackupScheduleUpdate.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The name of this StorageBackupScheduleUpdate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageBackupScheduleUpdate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StorageBackupScheduleUpdate.  # noqa: E501
        :type: str
        """
    ...
    def run_interval(self):
        """Gets the run_interval of this StorageBackupScheduleUpdate.  # noqa: E501

        The interval at which the schedule will run (in minutes). will be set from project default if not set  # noqa: E501

        :return: The run_interval of this StorageBackupScheduleUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def run_interval(self, run_interval):
        """Sets the run_interval of this StorageBackupScheduleUpdate.

        The interval at which the schedule will run (in minutes). will be set from project default if not set  # noqa: E501

        :param run_interval: The run_interval of this StorageBackupScheduleUpdate.  # noqa: E501
        :type: int
        """
    ...
    def keep_backups(self):
        """Gets the keep_backups of this StorageBackupScheduleUpdate.  # noqa: E501
        ...
        :return: The keep_backups of this StorageBackupScheduleUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def keep_backups(self, keep_backups):
        """Sets the keep_backups of this StorageBackupScheduleUpdate.

        The amount of backups to keep before overwriting the last created backup., will be set from project default if not set  # noqa: E501

        :param keep_backups: The keep_backups of this StorageBackupScheduleUpdate.  # noqa: E501
        :type: int
        """
    ...
    def next_runtime(self):
        """Gets the next_runtime of this StorageBackupScheduleUpdate.  # noqa: E501

        The date and time that the backup schedule will be run. will be set from project default if not set  # noqa: E501

        :return: The next_runtime of this StorageBackupScheduleUpdate.  # noqa: E501
        :rtype: datetime
        """
    ...
    def next_runtime(self, next_runtime):
        """Sets the next_runtime of this StorageBackupScheduleUpdate.

        The date and time that the backup schedule will be run. will be set from project default if not set  # noqa: E501

        :param next_runtime: The next_runtime of this StorageBackupScheduleUpdate.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def active(self):
        """Gets the active of this StorageBackupScheduleUpdate.  # noqa: E501

        The status of the schedule active or not. will be set true if not set  # noqa: E501

        :return: The active of this StorageBackupScheduleUpdate.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this StorageBackupScheduleUpdate.

        The status of the schedule active or not. will be set true if not set  # noqa: E501

        :param active: The active of this StorageBackupScheduleUpdate.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupScheduleUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupScheduleUpdate):
            return False
