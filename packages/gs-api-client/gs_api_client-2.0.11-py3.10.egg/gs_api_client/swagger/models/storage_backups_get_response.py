...
from gs_api_client.swagger.models.storage_backup_index import StorageBackupIndex  # noqa: F401,E501


class StorageBackupsGetResponse(object):
    ...
    def __init__(self, backups=None):  # noqa: E501
        """StorageBackupsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def backups(self):
        """Gets the backups of this StorageBackupsGetResponse.  # noqa: E501


        :return: The backups of this StorageBackupsGetResponse.  # noqa: E501
        :rtype: StorageBackupIndex
        """
        return self._backups

    @backups.setter
    def backups(self, backups):
        """Sets the backups of this StorageBackupsGetResponse.


        :param backups: The backups of this StorageBackupsGetResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupsGetResponse):
            return False
