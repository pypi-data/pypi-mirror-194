...
from gs_api_client.swagger.models.storage_backup_schedule import StorageBackupSchedule  # noqa: F401,E501


class StorageBackupScheduleGetResponse(object):
    ...
    attribute_map = {
        'schedule_storage_backup': 'schedule_storage_backup'
    }

    def __init__(self, schedule_storage_backup=None):  # noqa: E501
        """StorageBackupScheduleGetResponse - a model defined in Swagger"""  # noqa: E501

        self._schedule_storage_backup = None
        self.discriminator = None

        if schedule_storage_backup is not None:
            self.schedule_storage_backup = schedule_storage_backup

    @property
    def schedule_storage_backup(self):
        """Gets the schedule_storage_backup of this StorageBackupScheduleGetResponse.  # noqa: E501


        :return: The schedule_storage_backup of this StorageBackupScheduleGetResponse.  # noqa: E501
        :rtype: StorageBackupSchedule
        """
        return self._schedule_storage_backup

    @schedule_storage_backup.setter
    def schedule_storage_backup(self, schedule_storage_backup):
        """Sets the schedule_storage_backup of this StorageBackupScheduleGetResponse.


        :param schedule_storage_backup: The schedule_storage_backup of this StorageBackupScheduleGetResponse.  # noqa: E501
        :type: StorageBackupSchedule
        """

        self._schedule_storage_backup = schedule_storage_backup
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupScheduleGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupScheduleGetResponse):
            return False
