...
class NetworksGetResponse(object):
    ...
    def __init__(self, networks=None):  # noqa: E501
        """NetworksGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def networks(self):
        """Gets the networks of this NetworksGetResponse.  # noqa: E501


        :return: The networks of this NetworksGetResponse.  # noqa: E501
        :rtype: NetworkIndex
        """
    ...
    def networks(self, networks):
        """Sets the networks of this NetworksGetResponse.


        :param networks: The networks of this NetworksGetResponse.  # noqa: E501
        :type: NetworkIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworksGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworksGetResponse):
            return False
