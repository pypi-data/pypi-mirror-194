...
class ServersGetResponse(object):
    ...
    def __init__(self, servers=None):  # noqa: E501
        """ServersGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def servers(self):
        """Gets the servers of this ServersGetResponse.  # noqa: E501


        :return: The servers of this ServersGetResponse.  # noqa: E501
        :rtype: ServerIndex
        """
    ...
    def servers(self, servers):
        """Sets the servers of this ServersGetResponse.


        :param servers: The servers of this ServersGetResponse.  # noqa: E501
        :type: ServerIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServersGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServersGetResponse):
            return False
