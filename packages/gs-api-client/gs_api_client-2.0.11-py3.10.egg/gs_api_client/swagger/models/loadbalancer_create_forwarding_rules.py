...
class LoadbalancerCreateForwardingRules(object):
    ...
    def __init__(self, mode=None, listen_port=None, target_port=None, letsencrypt_ssl=None, certificate_uuid=None):  # noqa: E501
        """LoadbalancerCreateForwardingRules - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def mode(self):
        """Gets the mode of this LoadbalancerCreateForwardingRules.  # noqa: E501

        Supports HTTP and TCP mode  # noqa: E501

        :return: The mode of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this LoadbalancerCreateForwardingRules.

        Supports HTTP and TCP mode  # noqa: E501

        :param mode: The mode of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :type: str
        """
        if mode is None:
    ...
    def listen_port(self):
        """Gets the listen_port of this LoadbalancerCreateForwardingRules.  # noqa: E501

        Specifies the entry port of the load balancer  # noqa: E501

        :return: The listen_port of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :rtype: int
        """
    ...
    def listen_port(self, listen_port):
        """Sets the listen_port of this LoadbalancerCreateForwardingRules.

        Specifies the entry port of the load balancer  # noqa: E501

        :param listen_port: The listen_port of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :type: int
        """
    ...
    def target_port(self):
        """Gets the target_port of this LoadbalancerCreateForwardingRules.  # noqa: E501

        Specifies the exit port that the load balancer uses to forward the traffic to the backend server  # noqa: E501

        :return: The target_port of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :rtype: int
        """
    ...
    def target_port(self, target_port):
        """Sets the target_port of this LoadbalancerCreateForwardingRules.

        Specifies the exit port that the load balancer uses to forward the traffic to the backend server  # noqa: E501

        :param target_port: The target_port of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :type: int
        """
    ...
    def letsencrypt_ssl(self):
        """Gets the letsencrypt_ssl of this LoadbalancerCreateForwardingRules.  # noqa: E501

        A valid domain name that points to the loadbalancer's IP address  # noqa: E501

        :return: The letsencrypt_ssl of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :rtype: str
        """
    ...
    def letsencrypt_ssl(self, letsencrypt_ssl):
        """Sets the letsencrypt_ssl of this LoadbalancerCreateForwardingRules.

        A valid domain name that points to the loadbalancer's IP address  # noqa: E501

        :param letsencrypt_ssl: The letsencrypt_ssl of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :type: str
        """
        if letsencrypt_ssl is None:
            raise ValueError("Invalid value for `letsencrypt_ssl`, must not be `None`")  # noqa: E501

        self._letsencrypt_ssl = letsencrypt_ssl

    @property
    def certificate_uuid(self):
        """Gets the certificate_uuid of this LoadbalancerCreateForwardingRules.  # noqa: E501

        The UUID of a custom certificate  # noqa: E501

        :return: The certificate_uuid of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :rtype: str
        """
    ...
    def certificate_uuid(self, certificate_uuid):
        """Sets the certificate_uuid of this LoadbalancerCreateForwardingRules.

        The UUID of a custom certificate  # noqa: E501

        :param certificate_uuid: The certificate_uuid of this LoadbalancerCreateForwardingRules.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancerCreateForwardingRules, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancerCreateForwardingRules):
            return False
