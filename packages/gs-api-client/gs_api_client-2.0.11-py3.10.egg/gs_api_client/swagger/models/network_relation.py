...
from gs_api_client.swagger.models.paas_security_zonesin_network import PaasSecurityZonesinNetwork  # noqa: F401,E501
from gs_api_client.swagger.models.paas_servicesin_network import PaasServicesinNetwork  # noqa: F401,E501
from gs_api_client.swagger.models.serverin_network import ServerinNetwork  # noqa: F401,E501
from gs_api_client.swagger.models.vlansin_network import VlansinNetwork  # noqa: F401,E501


class NetworkRelation(object):
    ...
    attribute_map = {
        'servers': 'servers',
        'vlans': 'vlans',
        'paas_security_zones': 'paas_security_zones',
        'paas_services': 'paas_services'
    }

    def __init__(self, servers=None, vlans=None, paas_security_zones=None, paas_services=None):  # noqa: E501
        """NetworkRelation - a model defined in Swagger"""  # noqa: E501

        self._servers = None
        self._vlans = None
        self._paas_security_zones = None
        ...
        if vlans is not None:
            self.vlans = vlans
        if paas_security_zones is not None:
            self.paas_security_zones = paas_security_zones
        if paas_services is not None:
            self.paas_services = paas_services

    @property
    def servers(self):
        """Gets the servers of this NetworkRelation.  # noqa: E501


        :return: The servers of this NetworkRelation.  # noqa: E501
        :rtype: ServerinNetwork
        """
        return self._servers

    @servers.setter
    def servers(self, servers):
        """Sets the servers of this NetworkRelation.


        :param servers: The servers of this NetworkRelation.  # noqa: E501
    ...
    @property
    def vlans(self):
        """Gets the vlans of this NetworkRelation.  # noqa: E501


        :return: The vlans of this NetworkRelation.  # noqa: E501
        :rtype: VlansinNetwork
        """
        return self._vlans

    @vlans.setter
    def vlans(self, vlans):
        """Sets the vlans of this NetworkRelation.


        :param vlans: The vlans of this NetworkRelation.  # noqa: E501
        :type: VlansinNetwork
        """
    ...
    @property
    def paas_security_zones(self):
        """Gets the paas_security_zones of this NetworkRelation.  # noqa: E501


        :return: The paas_security_zones of this NetworkRelation.  # noqa: E501
        :rtype: PaasSecurityZonesinNetwork
        """
        return self._paas_security_zones

    @paas_security_zones.setter
    def paas_security_zones(self, paas_security_zones):
        """Sets the paas_security_zones of this NetworkRelation.


        :param paas_security_zones: The paas_security_zones of this NetworkRelation.  # noqa: E501
        :type: PaasSecurityZonesinNetwork
        """

        self._paas_security_zones = paas_security_zones

    @property
    def paas_services(self):
        """Gets the paas_services of this NetworkRelation.  # noqa: E501


        :return: The paas_services of this NetworkRelation.  # noqa: E501
        :rtype: PaasServicesinNetwork
        """
        return self._paas_services

    @paas_services.setter
    def paas_services(self, paas_services):
        """Sets the paas_services of this NetworkRelation.


        :param paas_services: The paas_services of this NetworkRelation.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworkRelation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkRelation):
            return False
