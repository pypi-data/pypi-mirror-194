...
from gs_api_client.swagger.models.task_events_storage_isoimage_update import TaskEventsStorageIsoimageUpdate  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_storage_storage_add import TaskEventsStorageStorageAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_storage_storage_remove import TaskEventsStorageStorageRemove  # noqa: F401,E501


class TaskEventsStorage(object):
    ...
    """
    swagger_types = {
        'storage_remove': 'TaskEventsStorageStorageRemove',
        'storage_add': 'TaskEventsStorageStorageAdd',
        'isoimage_update': 'TaskEventsStorageIsoimageUpdate'
    }
    ...
    def __init__(self, storage_remove=None, storage_add=None, isoimage_update=None):  # noqa: E501
        """TaskEventsStorage - a model defined in Swagger"""  # noqa: E501

        self._storage_remove = None
        self._storage_add = None
        self._isoimage_update = None
        self.discriminator = None

        if storage_remove is not None:
            self.storage_remove = storage_remove
        if storage_add is not None:
            self.storage_add = storage_add
        if isoimage_update is not None:
            self.isoimage_update = isoimage_update

    @property
    def storage_remove(self):
        """Gets the storage_remove of this TaskEventsStorage.  # noqa: E501


        :return: The storage_remove of this TaskEventsStorage.  # noqa: E501
        :rtype: TaskEventsStorageStorageRemove
        """
        return self._storage_remove

    @storage_remove.setter
    def storage_remove(self, storage_remove):
        """Sets the storage_remove of this TaskEventsStorage.


        :param storage_remove: The storage_remove of this TaskEventsStorage.  # noqa: E501
        :type: TaskEventsStorageStorageRemove
        """

        self._storage_remove = storage_remove

    @property
    def storage_add(self):
        """Gets the storage_add of this TaskEventsStorage.  # noqa: E501


        :return: The storage_add of this TaskEventsStorage.  # noqa: E501
        :rtype: TaskEventsStorageStorageAdd
        """
        return self._storage_add

    @storage_add.setter
    def storage_add(self, storage_add):
        """Sets the storage_add of this TaskEventsStorage.


        :param storage_add: The storage_add of this TaskEventsStorage.  # noqa: E501
        :type: TaskEventsStorageStorageAdd
        """

        self._storage_add = storage_add

    @property
    def isoimage_update(self):
        """Gets the isoimage_update of this TaskEventsStorage.  # noqa: E501


        :return: The isoimage_update of this TaskEventsStorage.  # noqa: E501
        :rtype: TaskEventsStorageIsoimageUpdate
        """
        return self._isoimage_update

    @isoimage_update.setter
    def isoimage_update(self, isoimage_update):
        """Sets the isoimage_update of this TaskEventsStorage.


        :param isoimage_update: The isoimage_update of this TaskEventsStorage.  # noqa: E501
        :type: TaskEventsStorageIsoimageUpdate
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsStorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsStorage):
            return False
