...
from gs_api_client.swagger.models.template_index import TemplateIndex  # noqa: F401,E501


class DeletedTemplatesGetResponse(object):
    ...
    def __init__(self, deleted_templates=None):  # noqa: E501
        """DeletedTemplatesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_templates = None
        self.discriminator = None

        if deleted_templates is not None:
            self.deleted_templates = deleted_templates

    @property
    def deleted_templates(self):
        """Gets the deleted_templates of this DeletedTemplatesGetResponse.  # noqa: E501


        :return: The deleted_templates of this DeletedTemplatesGetResponse.  # noqa: E501
        :rtype: TemplateIndex
        """
        return self._deleted_templates

    @deleted_templates.setter
    def deleted_templates(self, deleted_templates):
        """Sets the deleted_templates of this DeletedTemplatesGetResponse.


        :param deleted_templates: The deleted_templates of this DeletedTemplatesGetResponse.  # noqa: E501
        :type: TemplateIndex
        """

        self._deleted_templates = deleted_templates
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedTemplatesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedTemplatesGetResponse):
            return False
