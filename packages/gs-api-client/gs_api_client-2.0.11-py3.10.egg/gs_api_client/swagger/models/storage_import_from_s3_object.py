...
class StorageImportFromS3Object(object):
    ...
    def __init__(self, name=None, url=None, extension=None):  # noqa: E501
        """StorageImportFromS3Object - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageImportFromS3Object.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StorageImportFromS3Object.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def url(self):
        """Gets the url of this StorageImportFromS3Object.  # noqa: E501

        The source URL from which the object should be downloaded.  # noqa: E501

        :return: The url of this StorageImportFromS3Object.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this StorageImportFromS3Object.

        The source URL from which the object should be downloaded.  # noqa: E501

        :param url: The url of this StorageImportFromS3Object.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def extension(self):
        """Gets the extension of this StorageImportFromS3Object.  # noqa: E501

        The extension of source gz,iso, ..., but for now we will support gz  # noqa: E501

        :return: The extension of this StorageImportFromS3Object.  # noqa: E501
        :rtype: str
        """
    ...
    def extension(self, extension):
        """Sets the extension of this StorageImportFromS3Object.

        The extension of source gz,iso, ..., but for now we will support gz  # noqa: E501

        :param extension: The extension of this StorageImportFromS3Object.  # noqa: E501
        :type: str
        """
        if extension is None:
            raise ValueError("Invalid value for `extension`, must not be `None`")  # noqa: E501
        allowed_values = ["gz"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageImportFromS3Object, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageImportFromS3Object):
            return False
