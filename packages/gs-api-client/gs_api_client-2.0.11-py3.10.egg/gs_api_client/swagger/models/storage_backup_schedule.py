...
from gs_api_client.swagger.models.storage_backup_schedule_relations import StorageBackupScheduleRelations  # noqa: F401,E501


class StorageBackupSchedule(object):
    ...
    swagger_types = {
        ...
        'object_uuid': 'str',
        'backup_location_uuid': 'str',
        'backup_location_name': 'str',
        'relations': 'StorageBackupScheduleRelations',
        'run_interval': 'int',
        'status': 'str',
        'storage_uuid': 'str',
        'active': 'bool'
    ...
    attribute_map = {
        ...
        'backup_location_uuid': 'backup_location_uuid',
        'backup_location_name': 'backup_location_name',
        'relations': 'relations',
    ...
    def __init__(self, change_time=None, create_time=None, keep_backups=None, name=None, next_runtime=None, object_uuid=None, backup_location_uuid=None, backup_location_name=None, relations=None, run_interval=None, status=None, storage_uuid=None, active=None):  # noqa: E501
        """StorageBackupSchedule - a model defined in Swagger"""  # noqa: E501
        ...
        self._backup_location_uuid = None
        self._backup_location_name = None
        ...
        if backup_location_uuid is not None:
            self.backup_location_uuid = backup_location_uuid
        if backup_location_name is not None:
    ...
    def change_time(self):
        """Gets the change_time of this StorageBackupSchedule.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this StorageBackupSchedule.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this StorageBackupSchedule.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this StorageBackupSchedule.  # noqa: E501
        :type: datetime
        """
    ...
    def create_time(self):
        """Gets the create_time of this StorageBackupSchedule.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this StorageBackupSchedule.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this StorageBackupSchedule.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this StorageBackupSchedule.  # noqa: E501
        :type: datetime
        """
    ...
    def keep_backups(self):
        """Gets the keep_backups of this StorageBackupSchedule.  # noqa: E501

        The amount of backups to keep before overwriting the last created backup.  # noqa: E501

        :return: The keep_backups of this StorageBackupSchedule.  # noqa: E501
        :rtype: int
        """
    ...
    def keep_backups(self, keep_backups):
        """Sets the keep_backups of this StorageBackupSchedule.

        The amount of backups to keep before overwriting the last created backup.  # noqa: E501

        :param keep_backups: The keep_backups of this StorageBackupSchedule.  # noqa: E501
        :type: int
        """
        if keep_backups is not None and keep_backups < 1:  # noqa: E501
            raise ValueError("Invalid value for `keep_backups`, must be a value greater than or equal to `1`")  # noqa: E501

        self._keep_backups = keep_backups

    @property
    def name(self):
        """Gets the name of this StorageBackupSchedule.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The name of this StorageBackupSchedule.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageBackupSchedule.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StorageBackupSchedule.  # noqa: E501
        :type: str
        """
    ...
    def next_runtime(self):
        """Gets the next_runtime of this StorageBackupSchedule.  # noqa: E501

        The date and time that the backup schedule will be run.  # noqa: E501

        :return: The next_runtime of this StorageBackupSchedule.  # noqa: E501
        :rtype: datetime
        """
    ...
    def next_runtime(self, next_runtime):
        """Sets the next_runtime of this StorageBackupSchedule.

        The date and time that the backup schedule will be run.  # noqa: E501

        :param next_runtime: The next_runtime of this StorageBackupSchedule.  # noqa: E501
        :type: datetime
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this StorageBackupSchedule.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this StorageBackupSchedule.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this StorageBackupSchedule.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this StorageBackupSchedule.  # noqa: E501
        :type: str
        """
    ...
    @property
    def backup_location_uuid(self):
        """Gets the backup_location_uuid of this StorageBackupSchedule.  # noqa: E501

        The Location where your backup is stored  # noqa: E501

        :return: The backup_location_uuid of this StorageBackupSchedule.  # noqa: E501
        :rtype: str
        """
        return self._backup_location_uuid

    @backup_location_uuid.setter
    def backup_location_uuid(self, backup_location_uuid):
        """Sets the backup_location_uuid of this StorageBackupSchedule.

        The Location where your backup is stored  # noqa: E501

        :param backup_location_uuid: The backup_location_uuid of this StorageBackupSchedule.  # noqa: E501
        :type: str
        """

        self._backup_location_uuid = backup_location_uuid

    @property
    def backup_location_name(self):
        """Gets the backup_location_name of this StorageBackupSchedule.  # noqa: E501

        The human-readable name of backup location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The backup_location_name of this StorageBackupSchedule.  # noqa: E501
        :rtype: str
        """
        return self._backup_location_name

    @backup_location_name.setter
    def backup_location_name(self, backup_location_name):
        """Sets the backup_location_name of this StorageBackupSchedule.

        The human-readable name of backup location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param backup_location_name: The backup_location_name of this StorageBackupSchedule.  # noqa: E501
        :type: str
        """

        self._backup_location_name = backup_location_name

    @property
    def relations(self):
        """Gets the relations of this StorageBackupSchedule.  # noqa: E501


        :return: The relations of this StorageBackupSchedule.  # noqa: E501
        :rtype: StorageBackupScheduleRelations
        """
        return self._relations

    @relations.setter
    def relations(self, relations):
        """Sets the relations of this StorageBackupSchedule.


        :param relations: The relations of this StorageBackupSchedule.  # noqa: E501
    ...
    def run_interval(self):
        """Gets the run_interval of this StorageBackupSchedule.  # noqa: E501

        The interval at which the schedule will run (in minutes)  # noqa: E501

        :return: The run_interval of this StorageBackupSchedule.  # noqa: E501
        :rtype: int
        """
    ...
    def run_interval(self, run_interval):
        """Sets the run_interval of this StorageBackupSchedule.

        The interval at which the schedule will run (in minutes)  # noqa: E501

        :param run_interval: The run_interval of this StorageBackupSchedule.  # noqa: E501
        :type: int
        """
    ...
    @property
    def status(self):
        """Gets the status of this StorageBackupSchedule.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this StorageBackupSchedule.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this StorageBackupSchedule.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this StorageBackupSchedule.  # noqa: E501
        :type: str
        """
    ...
    def storage_uuid(self):
        """Gets the storage_uuid of this StorageBackupSchedule.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The storage_uuid of this StorageBackupSchedule.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_uuid(self, storage_uuid):
        """Sets the storage_uuid of this StorageBackupSchedule.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param storage_uuid: The storage_uuid of this StorageBackupSchedule.  # noqa: E501
        :type: str
        """
    ...
    @property
    def active(self):
        """Gets the active of this StorageBackupSchedule.  # noqa: E501

        Status of the schedule.  # noqa: E501

        :return: The active of this StorageBackupSchedule.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this StorageBackupSchedule.

        Status of the schedule.  # noqa: E501

        :param active: The active of this StorageBackupSchedule.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupSchedule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupSchedule):
            return False
