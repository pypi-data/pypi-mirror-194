...
from gs_api_client.swagger.models.snapshot_schedule_index import SnapshotScheduleIndex  # noqa: F401,E501


class SnapshotSchedulesGetResponse(object):
    ...
    def __init__(self, snapshot_schedules=None):  # noqa: E501
        """SnapshotSchedulesGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def snapshot_schedules(self):
        """Gets the snapshot_schedules of this SnapshotSchedulesGetResponse.  # noqa: E501


        :return: The snapshot_schedules of this SnapshotSchedulesGetResponse.  # noqa: E501
        :rtype: SnapshotScheduleIndex
        """
        return self._snapshot_schedules

    @snapshot_schedules.setter
    def snapshot_schedules(self, snapshot_schedules):
        """Sets the snapshot_schedules of this SnapshotSchedulesGetResponse.


        :param snapshot_schedules: The snapshot_schedules of this SnapshotSchedulesGetResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotSchedulesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotSchedulesGetResponse):
            return False
