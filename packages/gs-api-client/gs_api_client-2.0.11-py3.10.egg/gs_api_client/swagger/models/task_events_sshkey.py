...
from gs_api_client.swagger.models.task_events_sshkey_sshkey_add import TaskEventsSshkeySshkeyAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_sshkey_sshkey_remove import TaskEventsSshkeySshkeyRemove  # noqa: F401,E501


class TaskEventsSshkey(object):
    ...
    """
    swagger_types = {
        'sshkey_remove': 'TaskEventsSshkeySshkeyRemove',
        'sshkey_add': 'TaskEventsSshkeySshkeyAdd',
        'sshkey_update': 'TaskEventsSshkeySshkeyAdd'
    }

    attribute_map = {
        'sshkey_remove': 'sshkey_remove',
        'sshkey_add': 'sshkey_add',
        'sshkey_update': 'sshkey_update'
    }

    def __init__(self, sshkey_remove=None, sshkey_add=None, sshkey_update=None):  # noqa: E501
        """TaskEventsSshkey - a model defined in Swagger"""  # noqa: E501

        self._sshkey_remove = None
        self._sshkey_add = None
        self._sshkey_update = None
        self.discriminator = None

        if sshkey_remove is not None:
            self.sshkey_remove = sshkey_remove
        if sshkey_add is not None:
            self.sshkey_add = sshkey_add
        if sshkey_update is not None:
            self.sshkey_update = sshkey_update

    @property
    def sshkey_remove(self):
        """Gets the sshkey_remove of this TaskEventsSshkey.  # noqa: E501


        :return: The sshkey_remove of this TaskEventsSshkey.  # noqa: E501
        :rtype: TaskEventsSshkeySshkeyRemove
        """
        return self._sshkey_remove

    @sshkey_remove.setter
    def sshkey_remove(self, sshkey_remove):
        """Sets the sshkey_remove of this TaskEventsSshkey.


        :param sshkey_remove: The sshkey_remove of this TaskEventsSshkey.  # noqa: E501
        :type: TaskEventsSshkeySshkeyRemove
        """

        self._sshkey_remove = sshkey_remove

    @property
    def sshkey_add(self):
        """Gets the sshkey_add of this TaskEventsSshkey.  # noqa: E501


        :return: The sshkey_add of this TaskEventsSshkey.  # noqa: E501
        :rtype: TaskEventsSshkeySshkeyAdd
        """
        return self._sshkey_add

    @sshkey_add.setter
    def sshkey_add(self, sshkey_add):
        """Sets the sshkey_add of this TaskEventsSshkey.


        :param sshkey_add: The sshkey_add of this TaskEventsSshkey.  # noqa: E501
        :type: TaskEventsSshkeySshkeyAdd
        """

        self._sshkey_add = sshkey_add

    @property
    def sshkey_update(self):
        """Gets the sshkey_update of this TaskEventsSshkey.  # noqa: E501


        :return: The sshkey_update of this TaskEventsSshkey.  # noqa: E501
        :rtype: TaskEventsSshkeySshkeyAdd
        """
        return self._sshkey_update

    @sshkey_update.setter
    def sshkey_update(self, sshkey_update):
        """Sets the sshkey_update of this TaskEventsSshkey.


        :param sshkey_update: The sshkey_update of this TaskEventsSshkey.  # noqa: E501
        :type: TaskEventsSshkeySshkeyAdd
        """

        self._sshkey_update = sshkey_update
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSshkey, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSshkey):
            return False
