...
from gs_api_client.swagger.models.task_events_firewall_firewall_remove import TaskEventsFirewallFirewallRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_firewall_firewall_update import TaskEventsFirewallFirewallUpdate  # noqa: F401,E501


class TaskEventsFirewall(object):
    ...
    """
    swagger_types = {
        'firewall_remove': 'TaskEventsFirewallFirewallRemove',
        'firewall_update': 'TaskEventsFirewallFirewallUpdate',
        'firewall_add': 'TaskEventsFirewallFirewallUpdate'
    }
    ...
    def __init__(self, firewall_remove=None, firewall_update=None, firewall_add=None):  # noqa: E501
        """TaskEventsFirewall - a model defined in Swagger"""  # noqa: E501

        self._firewall_remove = None
        self._firewall_update = None
        self._firewall_add = None
        self.discriminator = None

        if firewall_remove is not None:
            self.firewall_remove = firewall_remove
        if firewall_update is not None:
            self.firewall_update = firewall_update
        if firewall_add is not None:
            self.firewall_add = firewall_add

    @property
    def firewall_remove(self):
        """Gets the firewall_remove of this TaskEventsFirewall.  # noqa: E501


        :return: The firewall_remove of this TaskEventsFirewall.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallRemove
        """
        return self._firewall_remove

    @firewall_remove.setter
    def firewall_remove(self, firewall_remove):
        """Sets the firewall_remove of this TaskEventsFirewall.


        :param firewall_remove: The firewall_remove of this TaskEventsFirewall.  # noqa: E501
        :type: TaskEventsFirewallFirewallRemove
        """

        self._firewall_remove = firewall_remove

    @property
    def firewall_update(self):
        """Gets the firewall_update of this TaskEventsFirewall.  # noqa: E501


        :return: The firewall_update of this TaskEventsFirewall.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdate
        """
        return self._firewall_update

    @firewall_update.setter
    def firewall_update(self, firewall_update):
        """Sets the firewall_update of this TaskEventsFirewall.


        :param firewall_update: The firewall_update of this TaskEventsFirewall.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdate
        """

        self._firewall_update = firewall_update

    @property
    def firewall_add(self):
        """Gets the firewall_add of this TaskEventsFirewall.  # noqa: E501


        :return: The firewall_add of this TaskEventsFirewall.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdate
        """
        return self._firewall_add

    @firewall_add.setter
    def firewall_add(self, firewall_add):
        """Sets the firewall_add of this TaskEventsFirewall.


        :param firewall_add: The firewall_add of this TaskEventsFirewall.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdate
        """

        self._firewall_add = firewall_add
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsFirewall, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsFirewall):
            return False
