...
from gs_api_client.swagger.models.task_events_firewall_firewall_update_rules_schema_rulesv4out import TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out  # noqa: F401,E501


class TaskEventsFirewallFirewallUpdateRulesSchema(object):
    ...
    """
    swagger_types = {
        'rules_v4_out': 'TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out',
        'rules_v6_out': 'TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out',
        'rules_v4_in': 'TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out',
        'rules_v6_in': 'TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out'
    }

    attribute_map = {
        'rules_v4_out': 'rules-v4-out',
        'rules_v6_out': 'rules-v6-out',
        'rules_v4_in': 'rules-v4-in',
        'rules_v6_in': 'rules-v6-in'
    }

    def __init__(self, rules_v4_out=None, rules_v6_out=None, rules_v4_in=None, rules_v6_in=None):  # noqa: E501
        """TaskEventsFirewallFirewallUpdateRulesSchema - a model defined in Swagger"""  # noqa: E501

        self._rules_v4_out = None
        self._rules_v6_out = None
        self._rules_v4_in = None
        self._rules_v6_in = None
        self.discriminator = None

        if rules_v4_out is not None:
            self.rules_v4_out = rules_v4_out
        if rules_v6_out is not None:
            self.rules_v6_out = rules_v6_out
        if rules_v4_in is not None:
            self.rules_v4_in = rules_v4_in
        if rules_v6_in is not None:
            self.rules_v6_in = rules_v6_in

    @property
    def rules_v4_out(self):
        """Gets the rules_v4_out of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501


        :return: The rules_v4_out of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """
        return self._rules_v4_out

    @rules_v4_out.setter
    def rules_v4_out(self, rules_v4_out):
        """Sets the rules_v4_out of this TaskEventsFirewallFirewallUpdateRulesSchema.


        :param rules_v4_out: The rules_v4_out of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """

        self._rules_v4_out = rules_v4_out

    @property
    def rules_v6_out(self):
        """Gets the rules_v6_out of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501


        :return: The rules_v6_out of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """
        return self._rules_v6_out

    @rules_v6_out.setter
    def rules_v6_out(self, rules_v6_out):
        """Sets the rules_v6_out of this TaskEventsFirewallFirewallUpdateRulesSchema.


        :param rules_v6_out: The rules_v6_out of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """

        self._rules_v6_out = rules_v6_out

    @property
    def rules_v4_in(self):
        """Gets the rules_v4_in of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501


        :return: The rules_v4_in of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """
        return self._rules_v4_in

    @rules_v4_in.setter
    def rules_v4_in(self, rules_v4_in):
        """Sets the rules_v4_in of this TaskEventsFirewallFirewallUpdateRulesSchema.


        :param rules_v4_in: The rules_v4_in of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """

        self._rules_v4_in = rules_v4_in

    @property
    def rules_v6_in(self):
        """Gets the rules_v6_in of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501


        :return: The rules_v6_in of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """
        return self._rules_v6_in

    @rules_v6_in.setter
    def rules_v6_in(self, rules_v6_in):
        """Sets the rules_v6_in of this TaskEventsFirewallFirewallUpdateRulesSchema.


        :param rules_v6_in: The rules_v6_in of this TaskEventsFirewallFirewallUpdateRulesSchema.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdateRulesSchemaRulesv4out
        """

        self._rules_v6_in = rules_v6_in
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsFirewallFirewallUpdateRulesSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsFirewallFirewallUpdateRulesSchema):
            return False
