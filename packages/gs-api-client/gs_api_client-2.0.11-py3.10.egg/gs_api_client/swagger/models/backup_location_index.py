...
from gs_api_client.swagger.models.backup_location import BackupLocation  # noqa: F401,E501


class BackupLocationIndex(dict):
    ...
    def __init__(self):  # noqa: E501
        """BackupLocationIndex - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BackupLocationIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupLocationIndex):
            return False
