...
class LocationCreate(object):
    ...
    def __init__(self, name=None, labels=None, parent_location_uuid=None, cpunode_count=None, product_no=None):  # noqa: E501
        """LocationCreate - a model defined in Swagger"""  # noqa: E501

        self._name = None
        self._labels = None
        self._parent_location_uuid = None
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LocationCreate.

        The human-readable name of the object. It supports the full UTF-8 charset, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this LocationCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this LocationCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this LocationCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this LocationCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this LocationCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def parent_location_uuid(self):
        """Gets the parent_location_uuid of this LocationCreate.  # noqa: E501

        The location_uuid of an existing public location in which to create the private location.  # noqa: E501

        :return: The parent_location_uuid of this LocationCreate.  # noqa: E501
        :rtype: str
        """
        return self._parent_location_uuid

    @parent_location_uuid.setter
    def parent_location_uuid(self, parent_location_uuid):
        """Sets the parent_location_uuid of this LocationCreate.

        The location_uuid of an existing public location in which to create the private location.  # noqa: E501

        :param parent_location_uuid: The parent_location_uuid of this LocationCreate.  # noqa: E501
        :type: str
        """
        if parent_location_uuid is None:
            raise ValueError("Invalid value for `parent_location_uuid`, must not be `None`")  # noqa: E501

        self._parent_location_uuid = parent_location_uuid

    @property
    def cpunode_count(self):
        """Gets the cpunode_count of this LocationCreate.  # noqa: E501

        The number of dedicated cpunodes to assigne to the private location.  # noqa: E501

        :return: The cpunode_count of this LocationCreate.  # noqa: E501
        :rtype: int
        """
    ...
    def cpunode_count(self, cpunode_count):
        """Sets the cpunode_count of this LocationCreate.

        The number of dedicated cpunodes to assigne to the private location.  # noqa: E501

        :param cpunode_count: The cpunode_count of this LocationCreate.  # noqa: E501
        :type: int
        """
        if cpunode_count is None:
            raise ValueError("Invalid value for `cpunode_count`, must not be `None`")  # noqa: E501

        self._cpunode_count = cpunode_count

    @property
    def product_no(self):
        """Gets the product_no of this LocationCreate.  # noqa: E501

        The product number of a valid and available dedicated cpunode article.  # noqa: E501

        :return: The product_no of this LocationCreate.  # noqa: E501
        :rtype: int
        """
    ...
    def product_no(self, product_no):
        """Sets the product_no of this LocationCreate.

        The product number of a valid and available dedicated cpunode article.  # noqa: E501

        :param product_no: The product_no of this LocationCreate.  # noqa: E501
        :type: int
        """
        if product_no is None:
            raise ValueError("Invalid value for `product_no`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationCreate):
            return False
