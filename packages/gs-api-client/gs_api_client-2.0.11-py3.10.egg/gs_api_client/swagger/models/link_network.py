...
class LinkNetwork(object):
    ...
    def __init__(self, object_uuid=None, ordering=None, bootdevice=None, l3security=None, firewall=None, firewall_template_uuid=None):  # noqa: E501
        """LinkNetwork - a model defined in Swagger"""  # noqa: E501
    ...
    def object_uuid(self):
        """Gets the object_uuid of this LinkNetwork.  # noqa: E501

        The uuid of network you wish to add. Only 7 private networks are allowed to be attached to a server  # noqa: E501

        :return: The object_uuid of this LinkNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this LinkNetwork.

        The uuid of network you wish to add. Only 7 private networks are allowed to be attached to a server  # noqa: E501

        :param object_uuid: The object_uuid of this LinkNetwork.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ordering(self):
        """Gets the ordering of this LinkNetwork.  # noqa: E501

        The ordering of the network interfaces. Lower numbers have lower PCI-IDs.  # noqa: E501

        :return: The ordering of this LinkNetwork.  # noqa: E501
        :rtype: int
        """
    ...
    def ordering(self, ordering):
        """Sets the ordering of this LinkNetwork.

        The ordering of the network interfaces. Lower numbers have lower PCI-IDs.  # noqa: E501

        :param ordering: The ordering of this LinkNetwork.  # noqa: E501
        :type: int
        """
    ...
    @property
    def bootdevice(self):
        """Gets the bootdevice of this LinkNetwork.  # noqa: E501

        Whether the server boots from this network or not.  # noqa: E501

        :return: The bootdevice of this LinkNetwork.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootdevice(self, bootdevice):
        """Sets the bootdevice of this LinkNetwork.

        Whether the server boots from this network or not.  # noqa: E501

        :param bootdevice: The bootdevice of this LinkNetwork.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def l3security(self):
        """Gets the l3security of this LinkNetwork.  # noqa: E501
        ...
        :return: The l3security of this LinkNetwork.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def l3security(self, l3security):
        """Sets the l3security of this LinkNetwork.

        Defines information about IP prefix spoof protection (it allows source traffic only from the IPv4/IPv4 network prefixes). If empty, it allow no IPv4/IPv6 source traffic. If set to null, l3security is disabled (default).  # noqa: E501

        :param l3security: The l3security of this LinkNetwork.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def firewall(self):
        """Gets the firewall of this LinkNetwork.  # noqa: E501


        :return: The firewall of this LinkNetwork.  # noqa: E501
        :rtype: FirewallRules
        """
    ...
    def firewall(self, firewall):
        """Sets the firewall of this LinkNetwork.


        :param firewall: The firewall of this LinkNetwork.  # noqa: E501
        :type: FirewallRules
        """
    ...
    def firewall_template_uuid(self):
        """Gets the firewall_template_uuid of this LinkNetwork.  # noqa: E501

        The UUID of firewall template.  # noqa: E501

        :return: The firewall_template_uuid of this LinkNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def firewall_template_uuid(self, firewall_template_uuid):
        """Sets the firewall_template_uuid of this LinkNetwork.

        The UUID of firewall template.  # noqa: E501

        :param firewall_template_uuid: The firewall_template_uuid of this LinkNetwork.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkNetwork, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkNetwork):
            return False
