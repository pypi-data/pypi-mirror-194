...
class TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps(object):
    ...
    def __init__(self, type=None, required=None):  # noqa: E501
        """TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.  # noqa: E501


        :return: The type of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.


        :param type: The type of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.  # noqa: E501
        :type: str
        """
    ...
    @property
    def required(self):
        """Gets the required of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.  # noqa: E501


        :return: The required of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.


        :param required: The required of this TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps):
            return False
