...
from gs_api_client.swagger.models.paas_service_metrics_list import PaasServiceMetricsList  # noqa: F401,E501


class PaasServiceMetricsGetResponse(object):
    ...
    """
    swagger_types = {
        'paas_service_metrics': 'PaasServiceMetricsList'
    }

    attribute_map = {
        'paas_service_metrics': 'paas_service_metrics'
    }

    def __init__(self, paas_service_metrics=None):  # noqa: E501
        """PaasServiceMetricsGetResponse - a model defined in Swagger"""  # noqa: E501

        self._paas_service_metrics = None
        self.discriminator = None

        if paas_service_metrics is not None:
            self.paas_service_metrics = paas_service_metrics

    @property
    def paas_service_metrics(self):
        """Gets the paas_service_metrics of this PaasServiceMetricsGetResponse.  # noqa: E501


        :return: The paas_service_metrics of this PaasServiceMetricsGetResponse.  # noqa: E501
        :rtype: PaasServiceMetricsList
        """
        return self._paas_service_metrics

    @paas_service_metrics.setter
    def paas_service_metrics(self, paas_service_metrics):
        """Sets the paas_service_metrics of this PaasServiceMetricsGetResponse.


        :param paas_service_metrics: The paas_service_metrics of this PaasServiceMetricsGetResponse.  # noqa: E501
        :type: PaasServiceMetricsList
        """

        self._paas_service_metrics = paas_service_metrics
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceMetricsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceMetricsGetResponse):
            return False
