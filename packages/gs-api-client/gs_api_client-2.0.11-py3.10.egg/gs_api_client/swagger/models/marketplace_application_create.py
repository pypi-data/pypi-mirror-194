...
from gs_api_client.swagger.models.marketplace_application_create_setup import MarketplaceApplicationCreateSetup  # noqa: F401,E501
from gs_api_client.swagger.models.marketplace_application_metadata import MarketplaceApplicationMetadata  # noqa: F401,E501


class MarketplaceApplicationCreate(object):
    ...
    swagger_types = {
        ...
        'category': 'str',
        'publish': 'bool',
        'setup': 'MarketplaceApplicationCreateSetup',
    ...
    def __init__(self, name=None, object_storage_path=None, category=None, publish=None, setup=None, metadata=None):  # noqa: E501
        """MarketplaceApplicationCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this MarketplaceApplicationCreate.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The name of this MarketplaceApplicationCreate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MarketplaceApplicationCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this MarketplaceApplicationCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def object_storage_path(self):
        """Gets the object_storage_path of this MarketplaceApplicationCreate.  # noqa: E501

        Path to the images for the application, must be in .gz format and started with s3//  # noqa: E501

        :return: The object_storage_path of this MarketplaceApplicationCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def object_storage_path(self, object_storage_path):
        """Sets the object_storage_path of this MarketplaceApplicationCreate.

        Path to the images for the application, must be in .gz format and started with s3//  # noqa: E501

        :param object_storage_path: The object_storage_path of this MarketplaceApplicationCreate.  # noqa: E501
        :type: str
        """
        if object_storage_path is None:
            raise ValueError("Invalid value for `object_storage_path`, must not be `None`")  # noqa: E501

        self._object_storage_path = object_storage_path

    @property
    def category(self):
        """Gets the category of this MarketplaceApplicationCreate.  # noqa: E501


        :return: The category of this MarketplaceApplicationCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this MarketplaceApplicationCreate.


        :param category: The category of this MarketplaceApplicationCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def publish(self):
        """Gets the publish of this MarketplaceApplicationCreate.  # noqa: E501

        whether you want to publish your application or not  # noqa: E501

        :return: The publish of this MarketplaceApplicationCreate.  # noqa: E501
        :rtype: bool
        """
    ...
    def publish(self, publish):
        """Sets the publish of this MarketplaceApplicationCreate.

        whether you want to publish your application or not  # noqa: E501

        :param publish: The publish of this MarketplaceApplicationCreate.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def setup(self):
        """Gets the setup of this MarketplaceApplicationCreate.  # noqa: E501


        :return: The setup of this MarketplaceApplicationCreate.  # noqa: E501
        :rtype: MarketplaceApplicationCreateSetup
        """
        return self._setup

    @setup.setter
    def setup(self, setup):
        """Sets the setup of this MarketplaceApplicationCreate.


        :param setup: The setup of this MarketplaceApplicationCreate.  # noqa: E501
        :type: MarketplaceApplicationCreateSetup
        """
        if setup is None:
            raise ValueError("Invalid value for `setup`, must not be `None`")  # noqa: E501

        self._setup = setup

    @property
    def metadata(self):
        """Gets the metadata of this MarketplaceApplicationCreate.  # noqa: E501


        :return: The metadata of this MarketplaceApplicationCreate.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this MarketplaceApplicationCreate.


        :param metadata: The metadata of this MarketplaceApplicationCreate.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplicationCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplicationCreate):
            return False
