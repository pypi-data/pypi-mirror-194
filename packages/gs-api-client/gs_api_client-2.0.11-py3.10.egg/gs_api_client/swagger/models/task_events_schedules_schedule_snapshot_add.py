...
class TaskEventsSchedulesScheduleSnapshotAdd(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'run_interval': 'TaskEventsSchedulesScheduleSnapshotAddRunInterval',
        'keep_snapshots': 'TaskEventsSchedulesScheduleSnapshotAddRunInterval',
        'next_runtime': 'TaskEventsSchedulesScheduleSnapshotAddNextRuntime',
        'schedule_uuid': 'TaskEventsSchedulesScheduleSnapshotAddScheduleUuid',
        'storage_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid'
    }
    ...
    def __init__(self, labels=None, name=None, run_interval=None, keep_snapshots=None, next_runtime=None, schedule_uuid=None, storage_uuid=None):  # noqa: E501
        """TaskEventsSchedulesScheduleSnapshotAdd - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The labels of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param labels: The labels of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The name of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param name: The name of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    def run_interval(self):
        """Gets the run_interval of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The run_interval of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def run_interval(self, run_interval):
        """Sets the run_interval of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param run_interval: The run_interval of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def keep_snapshots(self):
        """Gets the keep_snapshots of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The keep_snapshots of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddRunInterval
        """
    ...
    def keep_snapshots(self, keep_snapshots):
        """Sets the keep_snapshots of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param keep_snapshots: The keep_snapshots of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddRunInterval
        """
    ...
    def next_runtime(self):
        """Gets the next_runtime of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The next_runtime of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def next_runtime(self, next_runtime):
        """Sets the next_runtime of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param next_runtime: The next_runtime of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def schedule_uuid(self):
        """Gets the schedule_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The schedule_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def schedule_uuid(self, schedule_uuid):
        """Sets the schedule_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param schedule_uuid: The schedule_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def storage_uuid(self):
        """Gets the storage_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501


        :return: The storage_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def storage_uuid(self, storage_uuid):
        """Sets the storage_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.


        :param storage_uuid: The storage_uuid of this TaskEventsSchedulesScheduleSnapshotAdd.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSchedulesScheduleSnapshotAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSchedulesScheduleSnapshotAdd):
            return False
