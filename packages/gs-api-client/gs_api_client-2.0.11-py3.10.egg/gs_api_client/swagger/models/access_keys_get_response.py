...
from gs_api_client.swagger.models.access_key_list import AccessKeyList  # noqa: F401,E501


class AccessKeysGetResponse(object):
    ...
    def __init__(self, access_keys=None):  # noqa: E501
        """AccessKeysGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def access_keys(self):
        """Gets the access_keys of this AccessKeysGetResponse.  # noqa: E501


        :return: The access_keys of this AccessKeysGetResponse.  # noqa: E501
        :rtype: AccessKeyList
        """
    ...
    def access_keys(self, access_keys):
        """Sets the access_keys of this AccessKeysGetResponse.


        :param access_keys: The access_keys of this AccessKeysGetResponse.  # noqa: E501
        :type: AccessKeyList
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccessKeysGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessKeysGetResponse):
            return False
