...
from gs_api_client.swagger.models.metrics import Metrics  # noqa: F401,E501
from gs_api_client.swagger.models.metrics_value import MetricsValue  # noqa: F401,E501
...
class ServerMetrics(object):
    ...
    def __init__(self, begin_time=None, end_time=None, server_uuid=None, core_usage=None, storage_read_iops=None, storage_write_iops=None):  # noqa: E501
        """ServerMetrics - a model defined in Swagger"""  # noqa: E501

        self._begin_time = None
        self._end_time = None
        self._server_uuid = None
        self._core_usage = None
        self._storage_read_iops = None
        self._storage_write_iops = None
        ...
        if storage_read_iops is not None:
            self.storage_read_iops = storage_read_iops
        if storage_write_iops is not None:
            self.storage_write_iops = storage_write_iops

    @property
    def begin_time(self):
        """Gets the begin_time of this ServerMetrics.  # noqa: E501

        Defines the begin of the time range.  # noqa: E501

        :return: The begin_time of this ServerMetrics.  # noqa: E501
        :rtype: str
        """
    ...
    def begin_time(self, begin_time):
        """Sets the begin_time of this ServerMetrics.

        Defines the begin of the time range.  # noqa: E501

        :param begin_time: The begin_time of this ServerMetrics.  # noqa: E501
        :type: str
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this ServerMetrics.  # noqa: E501

        Defines the end of the time range.  # noqa: E501

        :return: The end_time of this ServerMetrics.  # noqa: E501
        :rtype: str
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this ServerMetrics.

        Defines the end of the time range.  # noqa: E501

        :param end_time: The end_time of this ServerMetrics.  # noqa: E501
        :type: str
        """
        if end_time is None:
    ...
    def server_uuid(self):
        """Gets the server_uuid of this ServerMetrics.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The server_uuid of this ServerMetrics.  # noqa: E501
        :rtype: str
        """
    ...
    def server_uuid(self, server_uuid):
        """Sets the server_uuid of this ServerMetrics.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param server_uuid: The server_uuid of this ServerMetrics.  # noqa: E501
        :type: str
        """
    ...
    @property
    def core_usage(self):
        """Gets the core_usage of this ServerMetrics.  # noqa: E501


        :return: The core_usage of this ServerMetrics.  # noqa: E501
        :rtype: MetricsValue
        """
        return self._core_usage

    @core_usage.setter
    def core_usage(self, core_usage):
        """Sets the core_usage of this ServerMetrics.


        :param core_usage: The core_usage of this ServerMetrics.  # noqa: E501
        :type: MetricsValue
        """

        self._core_usage = core_usage

    @property
    def storage_read_iops(self):
        """Gets the storage_read_iops of this ServerMetrics.  # noqa: E501


        :return: The storage_read_iops of this ServerMetrics.  # noqa: E501
        :rtype: MetricsValue
        """
        return self._storage_read_iops

    @storage_read_iops.setter
    def storage_read_iops(self, storage_read_iops):
        """Sets the storage_read_iops of this ServerMetrics.


        :param storage_read_iops: The storage_read_iops of this ServerMetrics.  # noqa: E501
        :type: MetricsValue
        """

        self._storage_read_iops = storage_read_iops

    @property
    def storage_write_iops(self):
        """Gets the storage_write_iops of this ServerMetrics.  # noqa: E501


        :return: The storage_write_iops of this ServerMetrics.  # noqa: E501
        :rtype: MetricsValue
        """
        return self._storage_write_iops

    @storage_write_iops.setter
    def storage_write_iops(self, storage_write_iops):
        """Sets the storage_write_iops of this ServerMetrics.


        :param storage_write_iops: The storage_write_iops of this ServerMetrics.  # noqa: E501
        :type: MetricsValue
        """

        self._storage_write_iops = storage_write_iops
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerMetrics, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerMetrics):
            return False
