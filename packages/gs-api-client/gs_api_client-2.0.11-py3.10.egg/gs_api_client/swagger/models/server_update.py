...
class ServerUpdate(object):
    ...
    def __init__(self, name=None, cores=None, memory=None, labels=None, availability_zone=None, auto_recovery=None, hardware_profile=None):  # noqa: E501
        """ServerUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ServerUpdate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this ServerUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cores(self):
        """Gets the cores of this ServerUpdate.  # noqa: E501

        The number of server cores.  # noqa: E501

        :return: The cores of this ServerUpdate.  # noqa: E501
        :rtype: int
        """
        return self._cores
    ...
    def cores(self, cores):
        """Sets the cores of this ServerUpdate.

        The number of server cores.  # noqa: E501

        :param cores: The cores of this ServerUpdate.  # noqa: E501
        :type: int
        """
    ...
    @property
    def memory(self):
        """Gets the memory of this ServerUpdate.  # noqa: E501

        The amount of server memory in GB.  # noqa: E501

        :return: The memory of this ServerUpdate.  # noqa: E501
        :rtype: int
        """
        return self._memory
    ...
    def memory(self, memory):
        """Sets the memory of this ServerUpdate.

        The amount of server memory in GB.  # noqa: E501

        :param memory: The memory of this ServerUpdate.  # noqa: E501
        :type: int
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this ServerUpdate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this ServerUpdate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this ServerUpdate.

        List of labels.  # noqa: E501

        :param labels: The labels of this ServerUpdate.  # noqa: E501
        :type: list[str]
        """
    ...
    def availability_zone(self):
        """Gets the availability_zone of this ServerUpdate.  # noqa: E501

        Defines which Availability-Zone the Server is placed.  # noqa: E501

        :return: The availability_zone of this ServerUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def availability_zone(self, availability_zone):
        """Sets the availability_zone of this ServerUpdate.

        Defines which Availability-Zone the Server is placed.  # noqa: E501

        :param availability_zone: The availability_zone of this ServerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def auto_recovery(self):
        """Gets the auto_recovery of this ServerUpdate.  # noqa: E501

        If the server should be auto-started in case of a failure (default=true).  # noqa: E501

        :return: The auto_recovery of this ServerUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_recovery(self, auto_recovery):
        """Sets the auto_recovery of this ServerUpdate.

        If the server should be auto-started in case of a failure (default=true).  # noqa: E501

        :param auto_recovery: The auto_recovery of this ServerUpdate.  # noqa: E501
        :type: bool
        """
    ...
    def hardware_profile(self):
        """Gets the hardware_profile of this ServerUpdate.  # noqa: E501

        Specifies the hardware settings for the virtual machine.  # noqa: E501

        :return: The hardware_profile of this ServerUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def hardware_profile(self, hardware_profile):
        """Sets the hardware_profile of this ServerUpdate.

        Specifies the hardware settings for the virtual machine.  # noqa: E501

        :param hardware_profile: The hardware_profile of this ServerUpdate.  # noqa: E501
        :type: str
        """
        allowed_values = ["default", "nested", "legacy", "cisco_csr", "sophos_utm", "f5_bigip", "q35"]  # noqa: E501
        if hardware_profile not in allowed_values:
            raise ValueError(
                "Invalid value for `hardware_profile` ({0}), must be one of {1}"  # noqa: E501
                .format(hardware_profile, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerUpdate):
            return False
