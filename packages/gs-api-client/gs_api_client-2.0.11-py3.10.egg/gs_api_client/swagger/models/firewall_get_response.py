...
from gs_api_client.swagger.models.firewall import Firewall  # noqa: F401,E501


class FirewallGetResponse(object):
    ...
    def __init__(self, firewall=None):  # noqa: E501
        """FirewallGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def firewall(self):
        """Gets the firewall of this FirewallGetResponse.  # noqa: E501


        :return: The firewall of this FirewallGetResponse.  # noqa: E501
        :rtype: Firewall
        """
    ...
    def firewall(self, firewall):
        """Sets the firewall of this FirewallGetResponse.


        :param firewall: The firewall of this FirewallGetResponse.  # noqa: E501
        :type: Firewall
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallGetResponse):
            return False
