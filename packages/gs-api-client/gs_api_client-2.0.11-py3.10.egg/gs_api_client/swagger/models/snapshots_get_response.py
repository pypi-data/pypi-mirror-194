...
class SnapshotsGetResponse(object):
    ...
    def __init__(self, snapshots=None):  # noqa: E501
        """SnapshotsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def snapshots(self):
        """Gets the snapshots of this SnapshotsGetResponse.  # noqa: E501


        :return: The snapshots of this SnapshotsGetResponse.  # noqa: E501
        :rtype: SnapshotIndex
        """
    ...
    def snapshots(self, snapshots):
        """Sets the snapshots of this SnapshotsGetResponse.


        :param snapshots: The snapshots of this SnapshotsGetResponse.  # noqa: E501
        :type: SnapshotIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotsGetResponse):
            return False
