...
from gs_api_client.swagger.models.location_change_requested import LocationChangeRequested  # noqa: F401,E501
from gs_api_client.swagger.models.location_features import LocationFeatures  # noqa: F401,E501
from gs_api_client.swagger.models.location_information import LocationInformation  # noqa: F401,E501
...
class Location(object):
    ...
    attribute_map = {
        ...
        'hybrid_core_uuid': 'hybrid_core_uuid',
        'hybrid_core_id': 'hybrid_core_id',
        'country': 'country',
        'active': 'active',
        'change_requested': 'change_requested',
        'cpunode_count': 'cpunode_count',
        'public': 'public',
    ...
    def __init__(self, iata=None, labels=None, name=None, object_uuid=None, hybrid_core_uuid=None, hybrid_core_id=None, country=None, active=None, change_requested=None, cpunode_count=None, public=None, product_no=None, location_information=None, features=None):  # noqa: E501
        ...
        self._hybrid_core_uuid = None
        self._hybrid_core_id = None
        self._country = None
        self._active = None
        self._change_requested = None
        self._cpunode_count = None
        self._public = None
        ...
        if hybrid_core_uuid is not None:
            self.hybrid_core_uuid = hybrid_core_uuid
        if hybrid_core_id is not None:
            self.hybrid_core_id = hybrid_core_id
        if country is not None:
            self.country = country
        if active is not None:
            self.active = active
        if change_requested is not None:
            self.change_requested = change_requested
        if cpunode_count is not None:
            self.cpunode_count = cpunode_count
    ...
    @property
    def iata(self):
        """Gets the iata of this Location.  # noqa: E501

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :return: The iata of this Location.  # noqa: E501
        :rtype: str
        """
        return self._iata
    ...
    @iata.setter
    def iata(self, iata):
        """Sets the iata of this Location.

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :param iata: The iata of this Location.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this Location.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this Location.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        ...
        :param labels: The labels of this Location.  # noqa: E501
        :type: list[str]
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this Location.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this Location.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this Location.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this Location.  # noqa: E501
        :type: str
        """
    ...
    @property
    def hybrid_core_uuid(self):
        """Gets the hybrid_core_uuid of this Location.  # noqa: E501

        Used to uniquely identify the Hybrid Core.  # noqa: E501

        :return: The hybrid_core_uuid of this Location.  # noqa: E501
        :rtype: str
        """
        return self._hybrid_core_uuid

    @hybrid_core_uuid.setter
    def hybrid_core_uuid(self, hybrid_core_uuid):
        """Sets the hybrid_core_uuid of this Location.

        Used to uniquely identify the Hybrid Core.  # noqa: E501

        :param hybrid_core_uuid: The hybrid_core_uuid of this Location.  # noqa: E501
        :type: str
        """

        self._hybrid_core_uuid = hybrid_core_uuid

    @property
    def hybrid_core_id(self):
        """Gets the hybrid_core_id of this Location.  # noqa: E501

        The ID of a Hybrid Core.  # noqa: E501

        :return: The hybrid_core_id of this Location.  # noqa: E501
        :rtype: str
        """
        return self._hybrid_core_id

    @hybrid_core_id.setter
    def hybrid_core_id(self, hybrid_core_id):
        """Sets the hybrid_core_id of this Location.

        The ID of a Hybrid Core.  # noqa: E501

        :param hybrid_core_id: The hybrid_core_id of this Location.  # noqa: E501
        :type: str
        """

        self._hybrid_core_id = hybrid_core_id
    ...
    def change_requested(self):
        """Gets the change_requested of this Location.  # noqa: E501


        :return: The change_requested of this Location.  # noqa: E501
        :rtype: LocationChangeRequested
        """
        return self._change_requested

    @change_requested.setter
    def change_requested(self, change_requested):
        """Sets the change_requested of this Location.


        :param change_requested: The change_requested of this Location.  # noqa: E501
    ...
    @property
    def cpunode_count(self):
        """Gets the cpunode_count of this Location.  # noqa: E501

        The number of dedicated cpunodes to assigne to the private location.  # noqa: E501

        :return: The cpunode_count of this Location.  # noqa: E501
        :rtype: int
        """
        return self._cpunode_count

    @cpunode_count.setter
    def cpunode_count(self, cpunode_count):
        """Sets the cpunode_count of this Location.

        The number of dedicated cpunodes to assigne to the private location.  # noqa: E501

        :param cpunode_count: The cpunode_count of this Location.  # noqa: E501
        :type: int
        """

        self._cpunode_count = cpunode_count

    @property
    def public(self):
        """Gets the public of this Location.  # noqa: E501

        If this location is publicly available or a private location.  # noqa: E501

        :return: The public of this Location.  # noqa: E501
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this Location.

        If this location is publicly available or a private location.  # noqa: E501

        :param public: The public of this Location.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def product_no(self):
        """Gets the product_no of this Location.  # noqa: E501

        The product number of a valid and available dedicated cpunode article.  # noqa: E501

        :return: The product_no of this Location.  # noqa: E501
        :rtype: int
        """
    ...
    def product_no(self, product_no):
        """Sets the product_no of this Location.

        The product number of a valid and available dedicated cpunode article.  # noqa: E501

        :param product_no: The product_no of this Location.  # noqa: E501
        :type: int
        """
    ...
    def location_information(self):
        """Gets the location_information of this Location.  # noqa: E501


        :return: The location_information of this Location.  # noqa: E501
    ...
    def location_information(self, location_information):
        """Sets the location_information of this Location.


        :param location_information: The location_information of this Location.  # noqa: E501
    ...
    @property
    def features(self):
        """Gets the features of this Location.  # noqa: E501


        :return: The features of this Location.  # noqa: E501
        :rtype: LocationFeatures
        """
    ...
    def features(self, features):
        ...
        :param features: The features of this Location.  # noqa: E501
