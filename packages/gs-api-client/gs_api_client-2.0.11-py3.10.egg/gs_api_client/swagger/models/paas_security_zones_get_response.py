...
from gs_api_client.swagger.models.paas_security_zone_index import PaasSecurityZoneIndex  # noqa: F401,E501


class PaasSecurityZonesGetResponse(object):
    ...
    def __init__(self, paas_security_zones=None):  # noqa: E501
        """PaasSecurityZonesGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def paas_security_zones(self):
        """Gets the paas_security_zones of this PaasSecurityZonesGetResponse.  # noqa: E501


        :return: The paas_security_zones of this PaasSecurityZonesGetResponse.  # noqa: E501
        :rtype: PaasSecurityZoneIndex
        """
        return self._paas_security_zones

    @paas_security_zones.setter
    def paas_security_zones(self, paas_security_zones):
        """Sets the paas_security_zones of this PaasSecurityZonesGetResponse.


        :param paas_security_zones: The paas_security_zones of this PaasSecurityZonesGetResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZonesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZonesGetResponse):
            return False
