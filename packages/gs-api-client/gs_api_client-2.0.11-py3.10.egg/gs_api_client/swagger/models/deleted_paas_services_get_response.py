...
from gs_api_client.swagger.models.paas_service_index import PaasServiceIndex  # noqa: F401,E501


class DeletedPaasServicesGetResponse(object):
    ...
    attribute_map = {
        'deleted_paas_services': 'deleted_paas_services'
    }

    def __init__(self, deleted_paas_services=None):  # noqa: E501
        """DeletedPaasServicesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_paas_services = None
        self.discriminator = None

        if deleted_paas_services is not None:
            self.deleted_paas_services = deleted_paas_services

    @property
    def deleted_paas_services(self):
        """Gets the deleted_paas_services of this DeletedPaasServicesGetResponse.  # noqa: E501


        :return: The deleted_paas_services of this DeletedPaasServicesGetResponse.  # noqa: E501
        :rtype: PaasServiceIndex
        """
        return self._deleted_paas_services

    @deleted_paas_services.setter
    def deleted_paas_services(self, deleted_paas_services):
        """Sets the deleted_paas_services of this DeletedPaasServicesGetResponse.


        :param deleted_paas_services: The deleted_paas_services of this DeletedPaasServicesGetResponse.  # noqa: E501
        :type: PaasServiceIndex
        """

        self._deleted_paas_services = deleted_paas_services
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedPaasServicesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedPaasServicesGetResponse):
            return False
