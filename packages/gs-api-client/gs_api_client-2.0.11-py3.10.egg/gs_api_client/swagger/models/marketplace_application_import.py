...
class MarketplaceApplicationImport(object):
    ...
    def __init__(self, unique_hash=None):  # noqa: E501
        """MarketplaceApplicationImport - a model defined in Swagger"""  # noqa: E501
    ...
    def unique_hash(self):
        """Gets the unique_hash of this MarketplaceApplicationImport.  # noqa: E501

        unique hash to allow user to import the self-created marketplace application  # noqa: E501

        :return: The unique_hash of this MarketplaceApplicationImport.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_hash(self, unique_hash):
        """Sets the unique_hash of this MarketplaceApplicationImport.

        unique hash to allow user to import the self-created marketplace application  # noqa: E501

        :param unique_hash: The unique_hash of this MarketplaceApplicationImport.  # noqa: E501
        :type: str
        """
        if unique_hash is None:
            raise ValueError("Invalid value for `unique_hash`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplicationImport, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplicationImport):
            return False
