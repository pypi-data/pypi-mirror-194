...
from gs_api_client.swagger.models.paas_security_zones_relation import PaasSecurityZonesRelation  # noqa: F401,E501


class PaasSecurityZones(object):
    ...
    def __init__(self, location_country=None, relations=None, create_time=None, location_iata=None, object_uuid=None, labels=None, location_name=None, status=None, location_uuid=None, change_time=None, name=None):  # noqa: E501
        """PaasSecurityZones - a model defined in Swagger"""  # noqa: E501
    ...
    def location_country(self):
        """Gets the location_country of this PaasSecurityZones.  # noqa: E501
        ...
        :return: The location_country of this PaasSecurityZones.  # noqa: E501
        :rtype: str
        """
    ...
    def location_country(self, location_country):
        """Sets the location_country of this PaasSecurityZones.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_country: The location_country of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    @property
    def relations(self):
        """Gets the relations of this PaasSecurityZones.  # noqa: E501


        :return: The relations of this PaasSecurityZones.  # noqa: E501
        :rtype: PaasSecurityZonesRelation
        """
        return self._relations

    @relations.setter
    def relations(self, relations):
        """Sets the relations of this PaasSecurityZones.


        :param relations: The relations of this PaasSecurityZones.  # noqa: E501
    ...
    def create_time(self):
        """Gets the create_time of this PaasSecurityZones.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this PaasSecurityZones.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this PaasSecurityZones.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this PaasSecurityZones.  # noqa: E501
        :type: datetime
        """
    ...
    def location_iata(self):
        """Gets the location_iata of this PaasSecurityZones.  # noqa: E501

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :return: The location_iata of this PaasSecurityZones.  # noqa: E501
        :rtype: str
        """
    ...
    def location_iata(self, location_iata):
        """Sets the location_iata of this PaasSecurityZones.

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :param location_iata: The location_iata of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this PaasSecurityZones.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this PaasSecurityZones.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this PaasSecurityZones.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this PaasSecurityZones.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this PaasSecurityZones.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this PaasSecurityZones.

        List of labels.  # noqa: E501

        :param labels: The labels of this PaasSecurityZones.  # noqa: E501
        :type: list[str]
        """
    ...
    def location_name(self):
        """Gets the location_name of this PaasSecurityZones.  # noqa: E501

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The location_name of this PaasSecurityZones.  # noqa: E501
        :rtype: str
        """
    ...
    def location_name(self, location_name):
        """Sets the location_name of this PaasSecurityZones.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_name: The location_name of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this PaasSecurityZones.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this PaasSecurityZones.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PaasSecurityZones.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    def location_uuid(self):
        """Gets the location_uuid of this PaasSecurityZones.  # noqa: E501

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :return: The location_uuid of this PaasSecurityZones.  # noqa: E501
        :rtype: str
        """
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this PaasSecurityZones.

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :param location_uuid: The location_uuid of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    def change_time(self):
        """Gets the change_time of this PaasSecurityZones.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this PaasSecurityZones.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this PaasSecurityZones.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this PaasSecurityZones.  # noqa: E501
        :type: datetime
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PaasSecurityZones.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this PaasSecurityZones.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZones, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZones):
            return False
