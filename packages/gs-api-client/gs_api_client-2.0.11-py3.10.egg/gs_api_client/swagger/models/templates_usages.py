...
from gs_api_client.swagger.models.templates_usage import TemplatesUsage  # noqa: F401,E501


class TemplatesUsages(object):
    ...
    def __init__(self, templates=None):  # noqa: E501
        """TemplatesUsages - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def templates(self):
        """Gets the templates of this TemplatesUsages.  # noqa: E501


        :return: The templates of this TemplatesUsages.  # noqa: E501
        :rtype: list[TemplatesUsage]
        """
        return self._templates

    @templates.setter
    def templates(self, templates):
        """Sets the templates of this TemplatesUsages.


        :param templates: The templates of this TemplatesUsages.  # noqa: E501
        :type: list[TemplatesUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TemplatesUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TemplatesUsages):
            return False
