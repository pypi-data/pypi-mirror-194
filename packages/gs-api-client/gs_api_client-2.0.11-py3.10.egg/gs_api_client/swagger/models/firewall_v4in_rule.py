...
class FirewallV4inRule(object):
    ...
    def __init__(self):  # noqa: E501
        """FirewallV4inRule - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallV4inRule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallV4inRule):
            return False
