...
from gs_api_client.swagger.models.linked_storage import LinkedStorage  # noqa: F401,E501


class LinkedStorageGetResponse(object):
    ...
    def __init__(self, storage_relation=None):  # noqa: E501
        """LinkedStorageGetResponse - a model defined in Swagger"""  # noqa: E501

        self._storage_relation = None
        self.discriminator = None

        if storage_relation is not None:
            self.storage_relation = storage_relation

    @property
    def storage_relation(self):
        """Gets the storage_relation of this LinkedStorageGetResponse.  # noqa: E501


        :return: The storage_relation of this LinkedStorageGetResponse.  # noqa: E501
        :rtype: LinkedStorage
        """
        return self._storage_relation

    @storage_relation.setter
    def storage_relation(self, storage_relation):
        """Sets the storage_relation of this LinkedStorageGetResponse.


        :param storage_relation: The storage_relation of this LinkedStorageGetResponse.  # noqa: E501
        :type: LinkedStorage
        """

        self._storage_relation = storage_relation
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedStorageGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedStorageGetResponse):
            return False
