...
class MarketplaceApplication(object):
    ...
    swagger_types = {
        ...
        'publish_requested_date': 'datetime',
        'publish_global_requested': 'bool',
        'publish_global_requested_date': 'datetime',
        'published_global': 'bool',
        'published_global_date': 'datetime',
        'category': 'str',
    ...
    attribute_map = {
        ...
        'publish_requested_date': 'publish_requested_date',
        'publish_global_requested': 'publish_global_requested',
        'publish_global_requested_date': 'publish_global_requested_date',
        'published_global': 'published_global',
        'published_global_date': 'published_global_date',
        'category': 'category',
        'metadata': 'metadata',
    ...
    def __init__(self, name=None, unique_hash=None, object_storage_path=None, application_owner=None, setup=None, published=None, published_date=None, publish_requested=None, publish_requested_date=None, publish_global_requested=None, publish_global_requested_date=None, published_global=None, published_global_date=None, category=None, metadata=None, change_time=None, create_time=None, labels=None, object_uuid=None, status=None, application_type=None):  # noqa: E501
        """MarketplaceApplication - a model defined in Swagger"""  # noqa: E501
        ...
        self._publish_requested = None
        self._publish_requested_date = None
        self._publish_global_requested = None
        self._publish_global_requested_date = None
        self._published_global = None
        self._published_global_date = None
        self._category = None
        self._metadata = None
        ...
        if publish_requested_date is not None:
            self.publish_requested_date = publish_requested_date
        if publish_global_requested is not None:
            self.publish_global_requested = publish_global_requested
        if publish_global_requested_date is not None:
            self.publish_global_requested_date = publish_global_requested_date
        if published_global is not None:
            self.published_global = published_global
        if published_global_date is not None:
            self.published_global_date = published_global_date
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MarketplaceApplication.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    def unique_hash(self):
        """Gets the unique_hash of this MarketplaceApplication.  # noqa: E501

        unique hash to allow user to import the self-created marketplace application  # noqa: E501

        :return: The unique_hash of this MarketplaceApplication.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_hash(self, unique_hash):
        """Sets the unique_hash of this MarketplaceApplication.

        unique hash to allow user to import the self-created marketplace application  # noqa: E501

        :param unique_hash: The unique_hash of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    def object_storage_path(self):
        """Gets the object_storage_path of this MarketplaceApplication.  # noqa: E501

        Path to the images of the application  # noqa: E501

        :return: The object_storage_path of this MarketplaceApplication.  # noqa: E501
        :rtype: str
        """
    ...
    def object_storage_path(self, object_storage_path):
        """Sets the object_storage_path of this MarketplaceApplication.

        Path to the images of the application  # noqa: E501

        :param object_storage_path: The object_storage_path of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    def application_owner(self):
        """Gets the application_owner of this MarketplaceApplication.  # noqa: E501

        Whether the you are the owner of application or not.  # noqa: E501

        :return: The application_owner of this MarketplaceApplication.  # noqa: E501
        :rtype: bool
        """
        return self._application_owner

    @application_owner.setter
    def application_owner(self, application_owner):
        """Sets the application_owner of this MarketplaceApplication.

        Whether the you are the owner of application or not.  # noqa: E501

        :param application_owner: The application_owner of this MarketplaceApplication.  # noqa: E501
        :type: bool
        """

        self._application_owner = application_owner

    @property
    def setup(self):
        """Gets the setup of this MarketplaceApplication.  # noqa: E501


        :return: The setup of this MarketplaceApplication.  # noqa: E501
    ...
    def setup(self, setup):
        """Sets the setup of this MarketplaceApplication.


        :param setup: The setup of this MarketplaceApplication.  # noqa: E501
    ...
    @property
    def published(self):
        """Gets the published of this MarketplaceApplication.  # noqa: E501

        Whether the template is published by the partner to their tenant.  # noqa: E501

        :return: The published of this MarketplaceApplication.  # noqa: E501
        :rtype: bool
        """
    ...
    def published(self, published):
        """Sets the published of this MarketplaceApplication.

        Whether the template is published by the partner to their tenant.  # noqa: E501

        :param published: The published of this MarketplaceApplication.  # noqa: E501
        :type: bool
        """
    ...
    def published_date(self):
        """Gets the published_date of this MarketplaceApplication.  # noqa: E501

        The date when the template is published into other tenant in the same partner.  # noqa: E501

        :return: The published_date of this MarketplaceApplication.  # noqa: E501
        :rtype: datetime
        """
    ...
    def published_date(self, published_date):
        """Sets the published_date of this MarketplaceApplication.

        The date when the template is published into other tenant in the same partner.  # noqa: E501

        :param published_date: The published_date of this MarketplaceApplication.  # noqa: E501
        :type: datetime
        """
    ...
    def publish_requested(self):
        """Gets the publish_requested of this MarketplaceApplication.  # noqa: E501

        Whether the tenants want their template to be published or not.  # noqa: E501

        :return: The publish_requested of this MarketplaceApplication.  # noqa: E501
        :rtype: bool
        """
        return self._publish_requested

    @publish_requested.setter
    def publish_requested(self, publish_requested):
        """Sets the publish_requested of this MarketplaceApplication.

        Whether the tenants want their template to be published or not.  # noqa: E501

        :param publish_requested: The publish_requested of this MarketplaceApplication.  # noqa: E501
        :type: bool
        """

        self._publish_requested = publish_requested

    @property
    def publish_requested_date(self):
        """Gets the publish_requested_date of this MarketplaceApplication.  # noqa: E501

        The date when the tenant requested their template to be published.  # noqa: E501

        :return: The publish_requested_date of this MarketplaceApplication.  # noqa: E501
        :rtype: datetime
        """
        return self._publish_requested_date

    @publish_requested_date.setter
    def publish_requested_date(self, publish_requested_date):
        """Sets the publish_requested_date of this MarketplaceApplication.

        The date when the tenant requested their template to be published.  # noqa: E501

        :param publish_requested_date: The publish_requested_date of this MarketplaceApplication.  # noqa: E501
        :type: datetime
        """

        self._publish_requested_date = publish_requested_date

    @property
    def publish_global_requested(self):
        """Gets the publish_global_requested of this MarketplaceApplication.  # noqa: E501

        Whether a partner wants their tenant template published to other partners.  # noqa: E501

        :return: The publish_global_requested of this MarketplaceApplication.  # noqa: E501
        :rtype: bool
        """
        return self._publish_global_requested

    @publish_global_requested.setter
    def publish_global_requested(self, publish_global_requested):
        """Sets the publish_global_requested of this MarketplaceApplication.

        Whether a partner wants their tenant template published to other partners.  # noqa: E501

        :param publish_global_requested: The publish_global_requested of this MarketplaceApplication.  # noqa: E501
        :type: bool
        """

        self._publish_global_requested = publish_global_requested

    @property
    def publish_global_requested_date(self):
        """Gets the publish_global_requested_date of this MarketplaceApplication.  # noqa: E501

        The date when a partner requested their tenants template to be published.  # noqa: E501

        :return: The publish_global_requested_date of this MarketplaceApplication.  # noqa: E501
        :rtype: datetime
        """
        return self._publish_global_requested_date

    @publish_global_requested_date.setter
    def publish_global_requested_date(self, publish_global_requested_date):
        """Sets the publish_global_requested_date of this MarketplaceApplication.

        The date when a partner requested their tenants template to be published.  # noqa: E501

        :param publish_global_requested_date: The publish_global_requested_date of this MarketplaceApplication.  # noqa: E501
        :type: datetime
        """

        self._publish_global_requested_date = publish_global_requested_date

    @property
    def published_global(self):
        """Gets the published_global of this MarketplaceApplication.  # noqa: E501

        Whether a template is published to other partner or not.  # noqa: E501

        :return: The published_global of this MarketplaceApplication.  # noqa: E501
        :rtype: bool
        """
        return self._published_global

    @published_global.setter
    def published_global(self, published_global):
        """Sets the published_global of this MarketplaceApplication.

        Whether a template is published to other partner or not.  # noqa: E501

        :param published_global: The published_global of this MarketplaceApplication.  # noqa: E501
        :type: bool
        """

        self._published_global = published_global

    @property
    def published_global_date(self):
        """Gets the published_global_date of this MarketplaceApplication.  # noqa: E501

        The date when a template is published to other partner.  # noqa: E501

        :return: The published_global_date of this MarketplaceApplication.  # noqa: E501
        :rtype: datetime
        """
        return self._published_global_date

    @published_global_date.setter
    def published_global_date(self, published_global_date):
        """Sets the published_global_date of this MarketplaceApplication.

        The date when a template is published to other partner.  # noqa: E501

        :param published_global_date: The published_global_date of this MarketplaceApplication.  # noqa: E501
        :type: datetime
        """

        self._published_global_date = published_global_date

    @property
    def category(self):
        """Gets the category of this MarketplaceApplication.  # noqa: E501

        Category of marketplace application  # noqa: E501

        :return: The category of this MarketplaceApplication.  # noqa: E501
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this MarketplaceApplication.

        Category of marketplace application  # noqa: E501

        :param category: The category of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this MarketplaceApplication.  # noqa: E501


        :return: The metadata of this MarketplaceApplication.  # noqa: E501
    ...
    def metadata(self, metadata):
        """Sets the metadata of this MarketplaceApplication.


        :param metadata: The metadata of this MarketplaceApplication.  # noqa: E501
    ...
    def change_time(self):
        """Gets the change_time of this MarketplaceApplication.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this MarketplaceApplication.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this MarketplaceApplication.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this MarketplaceApplication.  # noqa: E501
        :type: datetime
        """
    ...
    def create_time(self):
        """Gets the create_time of this MarketplaceApplication.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this MarketplaceApplication.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this MarketplaceApplication.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this MarketplaceApplication.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this MarketplaceApplication.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this MarketplaceApplication.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this MarketplaceApplication.

        List of labels.  # noqa: E501

        :param labels: The labels of this MarketplaceApplication.  # noqa: E501
        :type: list[str]
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this MarketplaceApplication.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this MarketplaceApplication.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this MarketplaceApplication.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this MarketplaceApplication.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this MarketplaceApplication.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this MarketplaceApplication.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    def application_type(self):
        """Gets the application_type of this MarketplaceApplication.  # noqa: E501

        the type of template  # noqa: E501

        :return: The application_type of this MarketplaceApplication.  # noqa: E501
        :rtype: str
        """
    ...
    def application_type(self, application_type):
        """Sets the application_type of this MarketplaceApplication.

        the type of template  # noqa: E501

        :param application_type: The application_type of this MarketplaceApplication.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplication, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplication):
            return False
