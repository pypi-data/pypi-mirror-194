...
class PaasSecurityZoneCreate(object):
    ...
    def __init__(self, name=None, location_uuid=None):  # noqa: E501
        """PaasSecurityZoneCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PaasSecurityZoneCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this PaasSecurityZoneCreate.  # noqa: E501
        :type: str
        """
    ...
    def location_uuid(self):
        """Gets the location_uuid of this PaasSecurityZoneCreate.  # noqa: E501

        Identifies which data-center the object belongs to.  # noqa: E501

        :return: The location_uuid of this PaasSecurityZoneCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this PaasSecurityZoneCreate.

        Identifies which data-center the object belongs to.  # noqa: E501

        :param location_uuid: The location_uuid of this PaasSecurityZoneCreate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZoneCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZoneCreate):
            return False
