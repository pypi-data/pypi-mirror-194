...
class ServerinStrorageInner(object):
    ...
    def __init__(self, bootdevice=None, bus=None, controller=None, create_time=None, lun=None, object_name=None, object_uuid=None, target=None):  # noqa: E501
        """ServerinStrorageInner - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def bootdevice(self):
        """Gets the bootdevice of this ServerinStrorageInner.  # noqa: E501

        Whether the server boots from this iso image or not.  # noqa: E501

        :return: The bootdevice of this ServerinStrorageInner.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootdevice(self, bootdevice):
        """Sets the bootdevice of this ServerinStrorageInner.

        Whether the server boots from this iso image or not.  # noqa: E501

        :param bootdevice: The bootdevice of this ServerinStrorageInner.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def bus(self):
        """Gets the bus of this ServerinStrorageInner.  # noqa: E501
        ...
        :return: The bus of this ServerinStrorageInner.  # noqa: E501
        :rtype: int
        """
        return self._bus
    ...
    @bus.setter
    def bus(self, bus):
        """Sets the bus of this ServerinStrorageInner.

        The SCSI bus id. The SCSI defines transmission routes like Serial Attached SCSI (SAS), Fibre Channel and iSCSI. Each SCSI device is addressed via a specific number. Each SCSI bus can have multiple SCSI devices connected to it.  # noqa: E501

        :param bus: The bus of this ServerinStrorageInner.  # noqa: E501
        :type: int
        """
    ...
    @property
    def controller(self):
        """Gets the controller of this ServerinStrorageInner.  # noqa: E501
        ...
        :return: The controller of this ServerinStrorageInner.  # noqa: E501
        :rtype: int
        """
    ...
    def controller(self, controller):
        """Sets the controller of this ServerinStrorageInner.

        Defines the SCSI controller id. The SCSI defines transmission routes such as Serial Attached SCSI (SAS), Fibre Channel and iSCSI.  # noqa: E501

        :param controller: The controller of this ServerinStrorageInner.  # noqa: E501
        :type: int
        """
    ...
    def create_time(self):
        """Gets the create_time of this ServerinStrorageInner.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this ServerinStrorageInner.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this ServerinStrorageInner.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this ServerinStrorageInner.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def lun(self):
        """Gets the lun of this ServerinStrorageInner.  # noqa: E501
        ...
        :return: The lun of this ServerinStrorageInner.  # noqa: E501
        :rtype: int
        """
        return self._lun
    ...
    @lun.setter
    def lun(self, lun):
        """Sets the lun of this ServerinStrorageInner.

        Is the common SCSI abbreviation of the Logical Unit Number. A lun is a unique identifier for a single disk or a composite of disks.  # noqa: E501

        :param lun: The lun of this ServerinStrorageInner.  # noqa: E501
        :type: int
        """
    ...
    def object_name(self):
        """Gets the object_name of this ServerinStrorageInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The object_name of this ServerinStrorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this ServerinStrorageInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this ServerinStrorageInner.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this ServerinStrorageInner.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this ServerinStrorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this ServerinStrorageInner.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this ServerinStrorageInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def target(self):
        """Gets the target of this ServerinStrorageInner.  # noqa: E501
        ...
        :return: The target of this ServerinStrorageInner.  # noqa: E501
        :rtype: int
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this ServerinStrorageInner.

        Defines the SCSI target ID. The SCSI defines transmission routes like Serial Attached SCSI (SAS), Fibre Channel and iSCSI. The target ID is a device (e.g. disk).  # noqa: E501

        :param target: The target of this ServerinStrorageInner.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerinStrorageInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerinStrorageInner):
            return False
