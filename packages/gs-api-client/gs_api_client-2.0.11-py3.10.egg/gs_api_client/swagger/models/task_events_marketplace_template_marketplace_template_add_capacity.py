...
class TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity(object):
    ...
    def __init__(self, required=None, max=None, type=None, description=None, min=None):  # noqa: E501
        """TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def required(self):
        """Gets the required of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501


        :return: The required of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.


        :param required: The required of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def max(self):
        """Gets the max of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501


        :return: The max of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :rtype: int
        """
        return self._max
    ...
    @max.setter
    def max(self, max):
        """Sets the max of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.


        :param max: The max of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :type: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501


        :return: The type of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.


        :param type: The type of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501


        :return: The description of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.


        :param description: The description of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :type: str
        """
    ...
    @property
    def min(self):
        """Gets the min of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501


        :return: The min of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :rtype: int
        """
        return self._min
    ...
    @min.setter
    def min(self, min):
        """Sets the min of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.


        :param min: The min of this TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity):
            return False
