...
class ServiceinPaasSecurityZonesInner(object):
    ...
    def __init__(self, object_uuid=None):  # noqa: E501
        """ServiceinPaasSecurityZonesInner - a model defined in Swagger"""  # noqa: E501
    ...
    def object_uuid(self):
        """Gets the object_uuid of this ServiceinPaasSecurityZonesInner.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this ServiceinPaasSecurityZonesInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this ServiceinPaasSecurityZonesInner.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this ServiceinPaasSecurityZonesInner.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceinPaasSecurityZonesInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceinPaasSecurityZonesInner):
            return False
