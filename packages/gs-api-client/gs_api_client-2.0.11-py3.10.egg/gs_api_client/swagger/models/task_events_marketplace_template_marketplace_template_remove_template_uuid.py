...
class TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid(object):
    ...
    def __init__(self, type=None, required=None, description=None):  # noqa: E501
        """TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501


        :return: The type of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.


        :param type: The type of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501
        :type: str
        """
    ...
    @property
    def required(self):
        """Gets the required of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501


        :return: The required of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.


        :param required: The required of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501
        :type: bool
        """
    ...
    def description(self):
        """Gets the description of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501


        :return: The description of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.


        :param description: The description of this TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid):
            return False
