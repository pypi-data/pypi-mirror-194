...
from gs_api_client.swagger.models.task_events_isoimage_isoimage_add import TaskEventsIsoimageIsoimageAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_isoimage_isoimage_remove import TaskEventsIsoimageIsoimageRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_isoimage_isoimage_update import TaskEventsIsoimageIsoimageUpdate  # noqa: F401,E501


class TaskEventsIsoimage(object):
    ...
    """
    swagger_types = {
        'isoimage_remove': 'TaskEventsIsoimageIsoimageRemove',
        'isoimage_add': 'TaskEventsIsoimageIsoimageAdd',
        'isoimage_update': 'TaskEventsIsoimageIsoimageUpdate'
    }

    attribute_map = {
        'isoimage_remove': 'isoimage_remove',
        'isoimage_add': 'isoimage_add',
        'isoimage_update': 'isoimage_update'
    }

    def __init__(self, isoimage_remove=None, isoimage_add=None, isoimage_update=None):  # noqa: E501
        """TaskEventsIsoimage - a model defined in Swagger"""  # noqa: E501

        self._isoimage_remove = None
        self._isoimage_add = None
        self._isoimage_update = None
        self.discriminator = None

        if isoimage_remove is not None:
            self.isoimage_remove = isoimage_remove
        if isoimage_add is not None:
            self.isoimage_add = isoimage_add
        if isoimage_update is not None:
            self.isoimage_update = isoimage_update

    @property
    def isoimage_remove(self):
        """Gets the isoimage_remove of this TaskEventsIsoimage.  # noqa: E501


        :return: The isoimage_remove of this TaskEventsIsoimage.  # noqa: E501
        :rtype: TaskEventsIsoimageIsoimageRemove
        """
        return self._isoimage_remove

    @isoimage_remove.setter
    def isoimage_remove(self, isoimage_remove):
        """Sets the isoimage_remove of this TaskEventsIsoimage.


        :param isoimage_remove: The isoimage_remove of this TaskEventsIsoimage.  # noqa: E501
        :type: TaskEventsIsoimageIsoimageRemove
        """

        self._isoimage_remove = isoimage_remove

    @property
    def isoimage_add(self):
        """Gets the isoimage_add of this TaskEventsIsoimage.  # noqa: E501


        :return: The isoimage_add of this TaskEventsIsoimage.  # noqa: E501
        :rtype: TaskEventsIsoimageIsoimageAdd
        """
        return self._isoimage_add

    @isoimage_add.setter
    def isoimage_add(self, isoimage_add):
        """Sets the isoimage_add of this TaskEventsIsoimage.


        :param isoimage_add: The isoimage_add of this TaskEventsIsoimage.  # noqa: E501
        :type: TaskEventsIsoimageIsoimageAdd
        """

        self._isoimage_add = isoimage_add

    @property
    def isoimage_update(self):
        """Gets the isoimage_update of this TaskEventsIsoimage.  # noqa: E501


        :return: The isoimage_update of this TaskEventsIsoimage.  # noqa: E501
        :rtype: TaskEventsIsoimageIsoimageUpdate
        """
        return self._isoimage_update

    @isoimage_update.setter
    def isoimage_update(self, isoimage_update):
        """Sets the isoimage_update of this TaskEventsIsoimage.


        :param isoimage_update: The isoimage_update of this TaskEventsIsoimage.  # noqa: E501
        :type: TaskEventsIsoimageIsoimageUpdate
        """

        self._isoimage_update = isoimage_update
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsIsoimage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsIsoimage):
            return False
