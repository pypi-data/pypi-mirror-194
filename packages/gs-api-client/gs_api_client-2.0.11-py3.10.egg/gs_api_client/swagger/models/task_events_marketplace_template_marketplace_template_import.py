...
from gs_api_client.swagger.models.task_events_marketplace_template_marketplace_template_import_unique_hash import TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash  # noqa: F401,E501


class TaskEventsMarketplaceTemplateMarketplaceTemplateImport(object):
    ...
    """
    swagger_types = {
        'unique_hash': 'TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash'
    }
    ...
    def __init__(self, unique_hash=None):  # noqa: E501
        """TaskEventsMarketplaceTemplateMarketplaceTemplateImport - a model defined in Swagger"""  # noqa: E501
    ...
    def unique_hash(self):
        """Gets the unique_hash of this TaskEventsMarketplaceTemplateMarketplaceTemplateImport.  # noqa: E501


        :return: The unique_hash of this TaskEventsMarketplaceTemplateMarketplaceTemplateImport.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash
        """
        return self._unique_hash

    @unique_hash.setter
    def unique_hash(self, unique_hash):
        """Sets the unique_hash of this TaskEventsMarketplaceTemplateMarketplaceTemplateImport.


        :param unique_hash: The unique_hash of this TaskEventsMarketplaceTemplateMarketplaceTemplateImport.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsMarketplaceTemplateMarketplaceTemplateImport, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsMarketplaceTemplateMarketplaceTemplateImport):
            return False
