...
class FirewallUpdate(object):
    ...
    def __init__(self, name=None, labels=None, rules=None):  # noqa: E501
        """FirewallUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this FirewallUpdate.  # noqa: E501


        :return: The name of this FirewallUpdate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FirewallUpdate.


        :param name: The name of this FirewallUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this FirewallUpdate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this FirewallUpdate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this FirewallUpdate.

        List of labels.  # noqa: E501

        :param labels: The labels of this FirewallUpdate.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def rules(self):
        """Gets the rules of this FirewallUpdate.  # noqa: E501


        :return: The rules of this FirewallUpdate.  # noqa: E501
        :rtype: FirewallRules
        """
        return self._rules
    ...
    def rules(self, rules):
        """Sets the rules of this FirewallUpdate.


        :param rules: The rules of this FirewallUpdate.  # noqa: E501
        :type: FirewallRules
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallUpdate):
            return False
