...
class Snapshot(object):
    ...
    def __init__(self, labels=None, object_uuid=None, name=None, status=None, location_country=None, usage_in_minutes=None, location_uuid=None, change_time=None, license_product_no=None, current_price=None, create_time=None, capacity=None, location_name=None, location_iata=None, parent_uuid=None, current_usage_per_minute=None, accumulated_usage=None):  # noqa: E501
    ...
    @property
    def labels(self):
        """Gets the labels of this Snapshot.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this Snapshot.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        ...
        :param labels: The labels of this Snapshot.  # noqa: E501
        :type: list[str]
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this Snapshot.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this Snapshot.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this Snapshot.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this Snapshot.  # noqa: E501
        :type: str
        """
    ...
    def location_country(self):
        """Gets the location_country of this Snapshot.  # noqa: E501
        ...
        :return: The location_country of this Snapshot.  # noqa: E501
        :rtype: str
        """
    ...
    def location_country(self, location_country):
        """Sets the location_country of this Snapshot.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_country: The location_country of this Snapshot.  # noqa: E501
        :type: str
        """
    ...
    def usage_in_minutes(self):
        """Gets the usage_in_minutes of this Snapshot.  # noqa: E501

        Total minutes the object has been running.  # noqa: E501

        :return: The usage_in_minutes of this Snapshot.  # noqa: E501
        :rtype: int
        """
    ...
    def usage_in_minutes(self, usage_in_minutes):
        """Sets the usage_in_minutes of this Snapshot.

        Total minutes the object has been running.  # noqa: E501

        :param usage_in_minutes: The usage_in_minutes of this Snapshot.  # noqa: E501
        :type: int
        """
    ...
    def location_uuid(self):
        """Gets the location_uuid of this Snapshot.  # noqa: E501

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :return: The location_uuid of this Snapshot.  # noqa: E501
        :rtype: str
        """
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this Snapshot.

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :param location_uuid: The location_uuid of this Snapshot.  # noqa: E501
        :type: str
        """
    ...
    def change_time(self):
        """Gets the change_time of this Snapshot.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this Snapshot.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this Snapshot.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this Snapshot.  # noqa: E501
        :type: datetime
        """
    ...
    def license_product_no(self):
        """Gets the license_product_no of this Snapshot.  # noqa: E501
        ...
        :return: The license_product_no of this Snapshot.  # noqa: E501
        :rtype: int
        """
    ...
    def license_product_no(self, license_product_no):
        """Sets the license_product_no of this Snapshot.

        If a template has been used that requires a license key (e.g. Windows Servers) this shows the product_no of the license (see the /prices endpoint for more details).  # noqa: E501

        :param license_product_no: The license_product_no of this Snapshot.  # noqa: E501
        :type: int
        """
    ...
    def current_price(self):
        """Gets the current_price of this Snapshot.  # noqa: E501

        Deprecated  # noqa: E501

        :return: The current_price of this Snapshot.  # noqa: E501
        :rtype: float
        """
    ...
    def current_price(self, current_price):
        """Sets the current_price of this Snapshot.

        Deprecated  # noqa: E501

        :param current_price: The current_price of this Snapshot.  # noqa: E501
        :type: float
        """
    ...
    @property
    def capacity(self):
        """Gets the capacity of this Snapshot.  # noqa: E501

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :return: The capacity of this Snapshot.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this Snapshot.

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :param capacity: The capacity of this Snapshot.  # noqa: E501
        :type: int
        """
    ...
    def location_name(self):
        """Gets the location_name of this Snapshot.  # noqa: E501

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The location_name of this Snapshot.  # noqa: E501
        :rtype: str
        """
    ...
    def location_name(self, location_name):
        """Sets the location_name of this Snapshot.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_name: The location_name of this Snapshot.  # noqa: E501
        :type: str
        """
    ...
    def location_iata(self):
        """Gets the location_iata of this Snapshot.  # noqa: E501

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :return: The location_iata of this Snapshot.  # noqa: E501
        :rtype: str
        """
    ...
    def location_iata(self, location_iata):
        """Sets the location_iata of this Snapshot.

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :param location_iata: The location_iata of this Snapshot.  # noqa: E501
        :type: str
        """
    ...
    def parent_uuid(self):
        """Gets the parent_uuid of this Snapshot.  # noqa: E501

        Uuid of the storage used to create this snapshot  # noqa: E501

        :return: The parent_uuid of this Snapshot.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_uuid(self, parent_uuid):
        """Sets the parent_uuid of this Snapshot.

        Uuid of the storage used to create this snapshot  # noqa: E501

        :param parent_uuid: The parent_uuid of this Snapshot.  # noqa: E501
        :type: str
        """
    ...
    def current_usage_per_minute(self):
        """Gets the current_usage_per_minute of this Snapshot.  # noqa: E501


        :return: The current_usage_per_minute of this Snapshot.  # noqa: E501
    ...
    def current_usage_per_minute(self, current_usage_per_minute):
        """Sets the current_usage_per_minute of this Snapshot.


        :param current_usage_per_minute: The current_usage_per_minute of this Snapshot.  # noqa: E501
    ...
    def accumulated_usage(self):
        """Gets the accumulated_usage of this Snapshot.  # noqa: E501


        :return: The accumulated_usage of this Snapshot.  # noqa: E501
    ...
    def accumulated_usage(self, accumulated_usage):
        """Sets the accumulated_usage of this Snapshot.


        :param accumulated_usage: The accumulated_usage of this Snapshot.  # noqa: E501
