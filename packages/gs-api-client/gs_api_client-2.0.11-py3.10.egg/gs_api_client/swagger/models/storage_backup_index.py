...
from gs_api_client.swagger.models.storage_backup import StorageBackup  # noqa: F401,E501


class StorageBackupIndex(dict):
    ...
    def __init__(self):  # noqa: E501
        """StorageBackupIndex - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupIndex):
            return False
