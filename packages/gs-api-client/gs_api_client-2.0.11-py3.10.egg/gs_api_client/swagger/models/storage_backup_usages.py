...
from gs_api_client.swagger.models.storage_backups_usage import StorageBackupsUsage  # noqa: F401,E501


class StorageBackupUsages(object):
    ...
    """
    swagger_types = {
        'storage_backups': 'list[StorageBackupsUsage]'
    }
    ...
    def __init__(self, storage_backups=None):  # noqa: E501
        """StorageBackupUsages - a model defined in Swagger"""  # noqa: E501
    ...
    def storage_backups(self):
        """Gets the storage_backups of this StorageBackupUsages.  # noqa: E501


        :return: The storage_backups of this StorageBackupUsages.  # noqa: E501
        :rtype: list[StorageBackupsUsage]
        """
        return self._storage_backups

    @storage_backups.setter
    def storage_backups(self, storage_backups):
        """Sets the storage_backups of this StorageBackupUsages.


        :param storage_backups: The storage_backups of this StorageBackupUsages.  # noqa: E501
        :type: list[StorageBackupsUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupUsages):
            return False
