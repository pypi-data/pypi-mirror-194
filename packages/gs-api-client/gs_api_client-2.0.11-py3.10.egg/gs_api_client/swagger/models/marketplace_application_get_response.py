...
from gs_api_client.swagger.models.marketplace_application import MarketplaceApplication  # noqa: F401,E501


class MarketplaceApplicationGetResponse(object):
    ...
    def __init__(self, application=None):  # noqa: E501
        """MarketplaceApplicationGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def application(self):
        """Gets the application of this MarketplaceApplicationGetResponse.  # noqa: E501


        :return: The application of this MarketplaceApplicationGetResponse.  # noqa: E501
        :rtype: MarketplaceApplication
        """
        return self._application

    @application.setter
    def application(self, application):
        """Sets the application of this MarketplaceApplicationGetResponse.


        :param application: The application of this MarketplaceApplicationGetResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplicationGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplicationGetResponse):
            return False
