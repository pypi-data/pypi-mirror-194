...
from gs_api_client.swagger.models.server_metrics_list import ServerMetricsList  # noqa: F401,E501


class ServerMetricsGetResponse(object):
    ...
    """
    swagger_types = {
        'server_metrics': 'ServerMetricsList'
    }
    ...
    def __init__(self, server_metrics=None):  # noqa: E501
        """ServerMetricsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def server_metrics(self):
        """Gets the server_metrics of this ServerMetricsGetResponse.  # noqa: E501


        :return: The server_metrics of this ServerMetricsGetResponse.  # noqa: E501
        :rtype: ServerMetricsList
        """
        return self._server_metrics

    @server_metrics.setter
    def server_metrics(self, server_metrics):
        """Sets the server_metrics of this ServerMetricsGetResponse.


        :param server_metrics: The server_metrics of this ServerMetricsGetResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerMetricsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerMetricsGetResponse):
            return False
