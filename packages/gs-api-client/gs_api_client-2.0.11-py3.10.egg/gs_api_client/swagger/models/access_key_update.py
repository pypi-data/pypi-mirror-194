...
class AccessKeyUpdate(object):
    ...
    def __init__(self, comment=None):  # noqa: E501
        """AccessKeyUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this AccessKeyUpdate.  # noqa: E501

        Comment for the access_key  # noqa: E501

        :return: The comment of this AccessKeyUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this AccessKeyUpdate.

        Comment for the access_key  # noqa: E501

        :param comment: The comment of this AccessKeyUpdate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccessKeyUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessKeyUpdate):
            return False
