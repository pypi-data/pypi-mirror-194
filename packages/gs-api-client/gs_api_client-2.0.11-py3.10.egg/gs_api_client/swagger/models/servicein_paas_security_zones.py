...
from gs_api_client.swagger.models.servicein_paas_security_zones_inner import ServiceinPaasSecurityZonesInner  # noqa: F401,E501


class ServiceinPaasSecurityZones(object):
    ...
    def __init__(self):  # noqa: E501
        """ServiceinPaasSecurityZones - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceinPaasSecurityZones, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceinPaasSecurityZones):
            return False
