...
from gs_api_client.swagger.models.paas_service_template_autoscaling_cores import PaasServiceTemplateAutoscalingCores  # noqa: F401,E501
from gs_api_client.swagger.models.paas_service_template_autoscaling_storage import PaasServiceTemplateAutoscalingStorage  # noqa: F401,E501


class PaasServiceTemplateAutoscaling(object):
    ...
    """
    swagger_types = {
        'cores': 'PaasServiceTemplateAutoscalingCores',
        'storage': 'PaasServiceTemplateAutoscalingStorage'
    }
    ...
    def __init__(self, cores=None, storage=None):  # noqa: E501
        """PaasServiceTemplateAutoscaling - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def cores(self):
        """Gets the cores of this PaasServiceTemplateAutoscaling.  # noqa: E501


        :return: The cores of this PaasServiceTemplateAutoscaling.  # noqa: E501
        :rtype: PaasServiceTemplateAutoscalingCores
        """
        return self._cores

    @cores.setter
    def cores(self, cores):
        """Sets the cores of this PaasServiceTemplateAutoscaling.


        :param cores: The cores of this PaasServiceTemplateAutoscaling.  # noqa: E501
        :type: PaasServiceTemplateAutoscalingCores
        """
    ...
    @property
    def storage(self):
        """Gets the storage of this PaasServiceTemplateAutoscaling.  # noqa: E501


        :return: The storage of this PaasServiceTemplateAutoscaling.  # noqa: E501
        :rtype: PaasServiceTemplateAutoscalingStorage
        """
        return self._storage

    @storage.setter
    def storage(self, storage):
        """Sets the storage of this PaasServiceTemplateAutoscaling.


        :param storage: The storage of this PaasServiceTemplateAutoscaling.  # noqa: E501
        :type: PaasServiceTemplateAutoscalingStorage
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceTemplateAutoscaling, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceTemplateAutoscaling):
            return False
