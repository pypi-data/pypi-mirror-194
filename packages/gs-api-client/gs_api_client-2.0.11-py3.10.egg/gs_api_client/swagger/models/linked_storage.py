...
class LinkedStorage(object):
    ...
    def __init__(self, storage_type=None, target=None, bus=None, capacity=None, license_product_no=None, object_uuid=None, controller=None, lun=None, create_time=None, last_used_template=None, bootdevice=None, object_name=None):  # noqa: E501
        """LinkedStorage - a model defined in Swagger"""  # noqa: E501
    ...
    def storage_type(self):
        """Gets the storage_type of this LinkedStorage.  # noqa: E501

        Indicates the speed of the storage. This may be (storage, storage_high or storage_insane).  # noqa: E501

        :return: The storage_type of this LinkedStorage.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_type(self, storage_type):
        """Sets the storage_type of this LinkedStorage.

        Indicates the speed of the storage. This may be (storage, storage_high or storage_insane).  # noqa: E501

        :param storage_type: The storage_type of this LinkedStorage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def target(self):
        """Gets the target of this LinkedStorage.  # noqa: E501
        ...
        :return: The target of this LinkedStorage.  # noqa: E501
        :rtype: int
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this LinkedStorage.

        Defines the SCSI target ID. The SCSI defines transmission routes like Serial Attached SCSI (SAS), Fibre Channel and iSCSI. The target ID is a device (e.g. disk).  # noqa: E501

        :param target: The target of this LinkedStorage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def bus(self):
        """Gets the bus of this LinkedStorage.  # noqa: E501
        ...
        :return: The bus of this LinkedStorage.  # noqa: E501
        :rtype: int
        """
        return self._bus
    ...
    @bus.setter
    def bus(self, bus):
        """Sets the bus of this LinkedStorage.

        The SCSI bus id. The SCSI defines transmission routes like Serial Attached SCSI (SAS), Fibre Channel and iSCSI. Each SCSI device is addressed via a specific number. Each SCSI bus can have multiple SCSI devices connected to it.  # noqa: E501

        :param bus: The bus of this LinkedStorage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def capacity(self):
        """Gets the capacity of this LinkedStorage.  # noqa: E501

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :return: The capacity of this LinkedStorage.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this LinkedStorage.

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :param capacity: The capacity of this LinkedStorage.  # noqa: E501
        :type: int
        """
    ...
    def license_product_no(self):
        """Gets the license_product_no of this LinkedStorage.  # noqa: E501
        ...
        :return: The license_product_no of this LinkedStorage.  # noqa: E501
        :rtype: int
        """
    ...
    def license_product_no(self, license_product_no):
        """Sets the license_product_no of this LinkedStorage.

        If a template has been used that requires a license key (e.g. Windows Servers) this shows the product_no of the license (see the /prices endpoint for more details).  # noqa: E501

        :param license_product_no: The license_product_no of this LinkedStorage.  # noqa: E501
        :type: int
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this LinkedStorage.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this LinkedStorage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this LinkedStorage.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this LinkedStorage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def controller(self):
        """Gets the controller of this LinkedStorage.  # noqa: E501
        ...
        :return: The controller of this LinkedStorage.  # noqa: E501
        :rtype: int
        """
    ...
    def controller(self, controller):
        """Sets the controller of this LinkedStorage.

        Defines the SCSI controller id. The SCSI defines transmission routes such as Serial Attached SCSI (SAS), Fibre Channel and iSCSI.  # noqa: E501

        :param controller: The controller of this LinkedStorage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def lun(self):
        """Gets the lun of this LinkedStorage.  # noqa: E501
        ...
        :return: The lun of this LinkedStorage.  # noqa: E501
        :rtype: int
        """
        return self._lun
    ...
    @lun.setter
    def lun(self, lun):
        """Sets the lun of this LinkedStorage.

        Is the common SCSI abbreviation of the Logical Unit Number. A lun is a unique identifier for a single disk or a composite of disks.  # noqa: E501

        :param lun: The lun of this LinkedStorage.  # noqa: E501
        :type: int
        """
    ...
    def create_time(self):
        """Gets the create_time of this LinkedStorage.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this LinkedStorage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this LinkedStorage.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this LinkedStorage.  # noqa: E501
        :type: datetime
        """
    ...
    def last_used_template(self):
        """Gets the last_used_template of this LinkedStorage.  # noqa: E501

        Indicates the UUID of the last used template on this storage (inherited from snapshots).  # noqa: E501

        :return: The last_used_template of this LinkedStorage.  # noqa: E501
        :rtype: str
        """
    ...
    def last_used_template(self, last_used_template):
        """Sets the last_used_template of this LinkedStorage.

        Indicates the UUID of the last used template on this storage (inherited from snapshots).  # noqa: E501

        :param last_used_template: The last_used_template of this LinkedStorage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def bootdevice(self):
        """Gets the bootdevice of this LinkedStorage.  # noqa: E501
        ...
        :return: The bootdevice of this LinkedStorage.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootdevice(self, bootdevice):
        """Sets the bootdevice of this LinkedStorage.

        Defines if this object is the bootdevice. Storages, Networks and ISO-Images can have a bootdevice configured, but only one bootdevice per Storage, Network or ISO-Image. The boot order is as follows => Network > ISO-Image > Storage.  # noqa: E501

        :param bootdevice: The bootdevice of this LinkedStorage.  # noqa: E501
        :type: bool
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this LinkedStorage.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this LinkedStorage.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedStorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedStorage):
            return False
