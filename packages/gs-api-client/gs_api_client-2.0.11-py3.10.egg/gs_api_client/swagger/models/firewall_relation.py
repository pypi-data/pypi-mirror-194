...
from gs_api_client.swagger.models.networkin_firewall import NetworkinFirewall  # noqa: F401,E501


class FirewallRelation(object):
    ...
    def __init__(self, networks=None):  # noqa: E501
        """FirewallRelation - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def networks(self):
        """Gets the networks of this FirewallRelation.  # noqa: E501


        :return: The networks of this FirewallRelation.  # noqa: E501
        :rtype: NetworkinFirewall
        """
        return self._networks

    @networks.setter
    def networks(self, networks):
        """Sets the networks of this FirewallRelation.


        :param networks: The networks of this FirewallRelation.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallRelation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallRelation):
            return False
