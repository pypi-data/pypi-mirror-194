...
from gs_api_client.swagger.models.linked_ip_brief import LinkedIpBrief  # noqa: F401,E501


class LinkedIpsGetResponse(object):
    ...
    """
    swagger_types = {
        'ip_relations': 'list[LinkedIpBrief]'
    }

    attribute_map = {
        'ip_relations': 'ip_relations'
    }

    def __init__(self, ip_relations=None):  # noqa: E501
        """LinkedIpsGetResponse - a model defined in Swagger"""  # noqa: E501

        self._ip_relations = None
        self.discriminator = None

        if ip_relations is not None:
            self.ip_relations = ip_relations

    @property
    def ip_relations(self):
        """Gets the ip_relations of this LinkedIpsGetResponse.  # noqa: E501


        :return: The ip_relations of this LinkedIpsGetResponse.  # noqa: E501
        :rtype: list[LinkedIpBrief]
        """
        return self._ip_relations

    @ip_relations.setter
    def ip_relations(self, ip_relations):
        """Sets the ip_relations of this LinkedIpsGetResponse.


        :param ip_relations: The ip_relations of this LinkedIpsGetResponse.  # noqa: E501
        :type: list[LinkedIpBrief]
        """

        self._ip_relations = ip_relations
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedIpsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedIpsGetResponse):
            return False
