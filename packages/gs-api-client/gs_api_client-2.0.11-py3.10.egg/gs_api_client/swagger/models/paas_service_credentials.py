...
from gs_api_client.swagger.models.paas_service_credentials_inner import PaasServiceCredentialsInner  # noqa: F401,E501


class PaasServiceCredentials(object):
    ...
    def __init__(self):  # noqa: E501
        """PaasServiceCredentials - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceCredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceCredentials):
            return False
