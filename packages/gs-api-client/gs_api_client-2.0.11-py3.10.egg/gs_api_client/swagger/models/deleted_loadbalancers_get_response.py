...
from gs_api_client.swagger.models.loadbalancer_index import LoadbalancerIndex  # noqa: F401,E501


class DeletedLoadbalancersGetResponse(object):
    ...
    attribute_map = {
        'deleted_loadbalancers': 'deleted_loadbalancers'
    }

    def __init__(self, deleted_loadbalancers=None):  # noqa: E501
        """DeletedLoadbalancersGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_loadbalancers = None
        self.discriminator = None

        if deleted_loadbalancers is not None:
            self.deleted_loadbalancers = deleted_loadbalancers

    @property
    def deleted_loadbalancers(self):
        """Gets the deleted_loadbalancers of this DeletedLoadbalancersGetResponse.  # noqa: E501


        :return: The deleted_loadbalancers of this DeletedLoadbalancersGetResponse.  # noqa: E501
        :rtype: LoadbalancerIndex
        """
        return self._deleted_loadbalancers

    @deleted_loadbalancers.setter
    def deleted_loadbalancers(self, deleted_loadbalancers):
        """Sets the deleted_loadbalancers of this DeletedLoadbalancersGetResponse.


        :param deleted_loadbalancers: The deleted_loadbalancers of this DeletedLoadbalancersGetResponse.  # noqa: E501
        :type: LoadbalancerIndex
        """

        self._deleted_loadbalancers = deleted_loadbalancers
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedLoadbalancersGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedLoadbalancersGetResponse):
            return False
