...
from gs_api_client.swagger.models.loadbalancers_usage import LoadbalancersUsage  # noqa: F401,E501


class LoadbalancersUsages(object):
    ...
    """
    swagger_types = {
        'load_balancers': 'list[LoadbalancersUsage]'
    }
    ...
    def __init__(self, load_balancers=None):  # noqa: E501
        """LoadbalancersUsages - a model defined in Swagger"""  # noqa: E501
    ...
    def load_balancers(self):
        """Gets the load_balancers of this LoadbalancersUsages.  # noqa: E501


        :return: The load_balancers of this LoadbalancersUsages.  # noqa: E501
        :rtype: list[LoadbalancersUsage]
        """
        return self._load_balancers

    @load_balancers.setter
    def load_balancers(self, load_balancers):
        """Sets the load_balancers of this LoadbalancersUsages.


        :param load_balancers: The load_balancers of this LoadbalancersUsages.  # noqa: E501
        :type: list[LoadbalancersUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancersUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancersUsages):
            return False
