...
from gs_api_client.swagger.models.task_events_ipaddr_ipaddr_add import TaskEventsIpaddrIpaddrAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_ipaddr_ipaddr_remove import TaskEventsIpaddrIpaddrRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_ipaddr_ipaddr_update import TaskEventsIpaddrIpaddrUpdate  # noqa: F401,E501


class TaskEventsIpaddr(object):
    ...
    """
    swagger_types = {
        'ipaddr_update': 'TaskEventsIpaddrIpaddrUpdate',
        'ipaddr_add': 'TaskEventsIpaddrIpaddrAdd',
        'ipaddr_remove': 'TaskEventsIpaddrIpaddrRemove'
    }

    attribute_map = {
        'ipaddr_update': 'ipaddr_update',
        'ipaddr_add': 'ipaddr_add',
        'ipaddr_remove': 'ipaddr_remove'
    }

    def __init__(self, ipaddr_update=None, ipaddr_add=None, ipaddr_remove=None):  # noqa: E501
        """TaskEventsIpaddr - a model defined in Swagger"""  # noqa: E501

        self._ipaddr_update = None
        self._ipaddr_add = None
        self._ipaddr_remove = None
        self.discriminator = None

        if ipaddr_update is not None:
            self.ipaddr_update = ipaddr_update
        if ipaddr_add is not None:
            self.ipaddr_add = ipaddr_add
        if ipaddr_remove is not None:
            self.ipaddr_remove = ipaddr_remove

    @property
    def ipaddr_update(self):
        """Gets the ipaddr_update of this TaskEventsIpaddr.  # noqa: E501


        :return: The ipaddr_update of this TaskEventsIpaddr.  # noqa: E501
        :rtype: TaskEventsIpaddrIpaddrUpdate
        """
        return self._ipaddr_update

    @ipaddr_update.setter
    def ipaddr_update(self, ipaddr_update):
        """Sets the ipaddr_update of this TaskEventsIpaddr.


        :param ipaddr_update: The ipaddr_update of this TaskEventsIpaddr.  # noqa: E501
        :type: TaskEventsIpaddrIpaddrUpdate
        """

        self._ipaddr_update = ipaddr_update

    @property
    def ipaddr_add(self):
        """Gets the ipaddr_add of this TaskEventsIpaddr.  # noqa: E501


        :return: The ipaddr_add of this TaskEventsIpaddr.  # noqa: E501
        :rtype: TaskEventsIpaddrIpaddrAdd
        """
        return self._ipaddr_add

    @ipaddr_add.setter
    def ipaddr_add(self, ipaddr_add):
        """Sets the ipaddr_add of this TaskEventsIpaddr.


        :param ipaddr_add: The ipaddr_add of this TaskEventsIpaddr.  # noqa: E501
        :type: TaskEventsIpaddrIpaddrAdd
        """

        self._ipaddr_add = ipaddr_add

    @property
    def ipaddr_remove(self):
        """Gets the ipaddr_remove of this TaskEventsIpaddr.  # noqa: E501


        :return: The ipaddr_remove of this TaskEventsIpaddr.  # noqa: E501
        :rtype: TaskEventsIpaddrIpaddrRemove
        """
        return self._ipaddr_remove

    @ipaddr_remove.setter
    def ipaddr_remove(self, ipaddr_remove):
        """Sets the ipaddr_remove of this TaskEventsIpaddr.


        :param ipaddr_remove: The ipaddr_remove of this TaskEventsIpaddr.  # noqa: E501
        :type: TaskEventsIpaddrIpaddrRemove
        """

        self._ipaddr_remove = ipaddr_remove
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsIpaddr, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsIpaddr):
            return False
