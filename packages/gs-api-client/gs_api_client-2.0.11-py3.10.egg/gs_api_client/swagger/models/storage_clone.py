...
class StorageClone(object):
    ...
    def __init__(self, password=None, password_type=None, sshkeys=None):  # noqa: E501
        """StorageClone - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def password(self):
        """Gets the password of this StorageClone.  # noqa: E501
        ...
        :return: The password of this StorageClone.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this StorageClone.

        The root (Linux) or Administrator (Windows) password to set for the installed storage. Valid only for public templates. The password has to be either plaintext or a crypt string (modular crypt format - MCF).  # noqa: E501

        :param password: The password of this StorageClone.  # noqa: E501
        :type: str
        """
    ...
    def password_type(self):
        """Gets the password_type of this StorageClone.  # noqa: E501

        Password type (one of plain, crypt).  # noqa: E501

        :return: The password_type of this StorageClone.  # noqa: E501
        :rtype: str
        """
    ...
    def password_type(self, password_type):
        """Sets the password_type of this StorageClone.

        Password type (one of plain, crypt).  # noqa: E501

        :param password_type: The password_type of this StorageClone.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sshkeys(self):
        """Gets the sshkeys of this StorageClone.  # noqa: E501

        List of SSH Keys uuid.  # noqa: E501

        :return: The sshkeys of this StorageClone.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def sshkeys(self, sshkeys):
        """Sets the sshkeys of this StorageClone.

        List of SSH Keys uuid.  # noqa: E501

        :param sshkeys: The sshkeys of this StorageClone.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageClone, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageClone):
            return False
