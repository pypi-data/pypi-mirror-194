...
from gs_api_client.swagger.models.task_events_paas_paas_service_add_resource_limit_schema_anyof import TaskEventsPaasPaasServiceAddResourceLimitSchemaAnyof  # noqa: F401,E501


class TaskEventsPaasPaasServiceAddResourceLimitSchema(object):
    ...
    """
    swagger_types = {
        'anyof': 'list[TaskEventsPaasPaasServiceAddResourceLimitSchemaAnyof]'
    }
    ...
    def __init__(self, anyof=None):  # noqa: E501
        """TaskEventsPaasPaasServiceAddResourceLimitSchema - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def anyof(self):
        """Gets the anyof of this TaskEventsPaasPaasServiceAddResourceLimitSchema.  # noqa: E501


        :return: The anyof of this TaskEventsPaasPaasServiceAddResourceLimitSchema.  # noqa: E501
        :rtype: list[TaskEventsPaasPaasServiceAddResourceLimitSchemaAnyof]
        """
        return self._anyof

    @anyof.setter
    def anyof(self, anyof):
        """Sets the anyof of this TaskEventsPaasPaasServiceAddResourceLimitSchema.


        :param anyof: The anyof of this TaskEventsPaasPaasServiceAddResourceLimitSchema.  # noqa: E501
        :type: list[TaskEventsPaasPaasServiceAddResourceLimitSchemaAnyof]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsPaasPaasServiceAddResourceLimitSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsPaasPaasServiceAddResourceLimitSchema):
            return False
