...
from gs_api_client.swagger.models.backup_location_index import BackupLocationIndex  # noqa: F401,E501


class BackupLocationsGetResponse(object):
    ...
    """
    swagger_types = {
        'backup_locations': 'BackupLocationIndex'
    }
    ...
    def __init__(self, backup_locations=None):  # noqa: E501
        """BackupLocationsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def backup_locations(self):
        """Gets the backup_locations of this BackupLocationsGetResponse.  # noqa: E501


        :return: The backup_locations of this BackupLocationsGetResponse.  # noqa: E501
        :rtype: BackupLocationIndex
        """
        return self._backup_locations

    @backup_locations.setter
    def backup_locations(self, backup_locations):
        """Sets the backup_locations of this BackupLocationsGetResponse.


        :param backup_locations: The backup_locations of this BackupLocationsGetResponse.  # noqa: E501
        :type: BackupLocationIndex
        """

        self._backup_locations = backup_locations
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BackupLocationsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupLocationsGetResponse):
            return False
