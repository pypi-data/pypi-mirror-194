...
class StorageSnapshots(object):
    ...
    swagger_types = {
        ...
        'object_name': 'str',
        'object_capacity': 'int',
        'schedules_snapshot_uuid': 'str',
        'schedules_snapshot_name': 'str',
    ...
    attribute_map = {
        ...
        'schedules_snapshot_uuid': 'schedules_snapshot_uuid',
        'schedules_snapshot_name': 'schedules_snapshot_name',
        'last_used_template': 'last_used_template',
        'create_time': 'create_time',
        'storage_uuid': 'storage_uuid'
    }

    def __init__(self, object_uuid=None, object_name=None, object_capacity=None, schedules_snapshot_uuid=None, schedules_snapshot_name=None, last_used_template=None, create_time=None, storage_uuid=None):  # noqa: E501
        """StorageSnapshots - a model defined in Swagger"""  # noqa: E501

        self._object_uuid = None
        self._object_name = None
        self._object_capacity = None
        self._schedules_snapshot_uuid = None
        self._schedules_snapshot_name = None
        ...
        if schedules_snapshot_uuid is not None:
            self.schedules_snapshot_uuid = schedules_snapshot_uuid
        if schedules_snapshot_name is not None:
            self.schedules_snapshot_name = schedules_snapshot_name
    ...
    def object_uuid(self):
        """Gets the object_uuid of this StorageSnapshots.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this StorageSnapshots.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this StorageSnapshots.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this StorageSnapshots.  # noqa: E501
        :type: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this StorageSnapshots.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this StorageSnapshots.  # noqa: E501
        :type: str
        """
    ...
    def object_capacity(self):
        """Gets the object_capacity of this StorageSnapshots.  # noqa: E501

        The size of the object in GB  # noqa: E501

        :return: The object_capacity of this StorageSnapshots.  # noqa: E501
        :rtype: int
        """
    ...
    def object_capacity(self, object_capacity):
        """Sets the object_capacity of this StorageSnapshots.

        The size of the object in GB  # noqa: E501

        :param object_capacity: The object_capacity of this StorageSnapshots.  # noqa: E501
        :type: int
        """
    ...
    @property
    def schedules_snapshot_uuid(self):
        """Gets the schedules_snapshot_uuid of this StorageSnapshots.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The schedules_snapshot_uuid of this StorageSnapshots.  # noqa: E501
        :rtype: str
        """
        return self._schedules_snapshot_uuid

    @schedules_snapshot_uuid.setter
    def schedules_snapshot_uuid(self, schedules_snapshot_uuid):
        """Sets the schedules_snapshot_uuid of this StorageSnapshots.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param schedules_snapshot_uuid: The schedules_snapshot_uuid of this StorageSnapshots.  # noqa: E501
        :type: str
        """

        self._schedules_snapshot_uuid = schedules_snapshot_uuid

    @property
    def schedules_snapshot_name(self):
        """Gets the schedules_snapshot_name of this StorageSnapshots.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The schedules_snapshot_name of this StorageSnapshots.  # noqa: E501
        :rtype: str
        """
        return self._schedules_snapshot_name

    @schedules_snapshot_name.setter
    def schedules_snapshot_name(self, schedules_snapshot_name):
        """Sets the schedules_snapshot_name of this StorageSnapshots.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param schedules_snapshot_name: The schedules_snapshot_name of this StorageSnapshots.  # noqa: E501
        :type: str
        """

        self._schedules_snapshot_name = schedules_snapshot_name

    @property
    def last_used_template(self):
        """Gets the last_used_template of this StorageSnapshots.  # noqa: E501

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :return: The last_used_template of this StorageSnapshots.  # noqa: E501
        :rtype: str
        """
    ...
    def last_used_template(self, last_used_template):
        """Sets the last_used_template of this StorageSnapshots.

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :param last_used_template: The last_used_template of this StorageSnapshots.  # noqa: E501
        :type: str
        """
    ...
    def create_time(self):
        """Gets the create_time of this StorageSnapshots.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this StorageSnapshots.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this StorageSnapshots.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this StorageSnapshots.  # noqa: E501
        :type: datetime
        """
    ...
    def storage_uuid(self):
        """Gets the storage_uuid of this StorageSnapshots.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The storage_uuid of this StorageSnapshots.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_uuid(self, storage_uuid):
        """Sets the storage_uuid of this StorageSnapshots.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param storage_uuid: The storage_uuid of this StorageSnapshots.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageSnapshots, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageSnapshots):
            return False
