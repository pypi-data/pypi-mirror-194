...
from gs_api_client.swagger.models.product_usage import ProductUsage  # noqa: F401,E501


class UsagePerIntervalInner(object):
    ...
    swagger_types = {
        'interval_start': 'str',
        'interval_end': 'str',
        'accumulated_usage': 'list[ProductUsage]'
    }
    ...
    def __init__(self, interval_start=None, interval_end=None, accumulated_usage=None):  # noqa: E501
        """UsagePerIntervalInner - a model defined in Swagger"""  # noqa: E501
    ...
    def interval_start(self):
        """Gets the interval_start of this UsagePerIntervalInner.  # noqa: E501

        Start accumulation period  # noqa: E501

        :return: The interval_start of this UsagePerIntervalInner.  # noqa: E501
        :rtype: str
        """
    ...
    def interval_start(self, interval_start):
        """Sets the interval_start of this UsagePerIntervalInner.

        Start accumulation period  # noqa: E501

        :param interval_start: The interval_start of this UsagePerIntervalInner.  # noqa: E501
        :type: str
        """
    ...
    def interval_end(self):
        """Gets the interval_end of this UsagePerIntervalInner.  # noqa: E501

        End accumulation period  # noqa: E501

        :return: The interval_end of this UsagePerIntervalInner.  # noqa: E501
        :rtype: str
        """
    ...
    def interval_end(self, interval_end):
        """Sets the interval_end of this UsagePerIntervalInner.

        End accumulation period  # noqa: E501

        :param interval_end: The interval_end of this UsagePerIntervalInner.  # noqa: E501
        :type: str
        """
    ...
    def accumulated_usage(self):
        """Gets the accumulated_usage of this UsagePerIntervalInner.  # noqa: E501

        Accumulation of product's usage in given period  # noqa: E501

        :return: The accumulated_usage of this UsagePerIntervalInner.  # noqa: E501
    ...
    def accumulated_usage(self, accumulated_usage):
        """Sets the accumulated_usage of this UsagePerIntervalInner.

        Accumulation of product's usage in given period  # noqa: E501

        :param accumulated_usage: The accumulated_usage of this UsagePerIntervalInner.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UsagePerIntervalInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UsagePerIntervalInner):
            return False
