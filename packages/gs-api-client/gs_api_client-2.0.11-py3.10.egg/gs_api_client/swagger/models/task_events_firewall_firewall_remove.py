...
class TaskEventsFirewallFirewallRemove(object):
    ...
    """
    swagger_types = {
        'tfirewall_uuid': 'TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid'
    }

    attribute_map = {
        'tfirewall_uuid': 'tfirewall_uuid'
    }

    def __init__(self, tfirewall_uuid=None):  # noqa: E501
        """TaskEventsFirewallFirewallRemove - a model defined in Swagger"""  # noqa: E501

        self._tfirewall_uuid = None
        self.discriminator = None

        if tfirewall_uuid is not None:
            self.tfirewall_uuid = tfirewall_uuid

    @property
    def tfirewall_uuid(self):
        """Gets the tfirewall_uuid of this TaskEventsFirewallFirewallRemove.  # noqa: E501


        :return: The tfirewall_uuid of this TaskEventsFirewallFirewallRemove.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """
        return self._tfirewall_uuid

    @tfirewall_uuid.setter
    def tfirewall_uuid(self, tfirewall_uuid):
        """Sets the tfirewall_uuid of this TaskEventsFirewallFirewallRemove.


        :param tfirewall_uuid: The tfirewall_uuid of this TaskEventsFirewallFirewallRemove.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """

        self._tfirewall_uuid = tfirewall_uuid
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsFirewallFirewallRemove, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsFirewallFirewallRemove):
            return False
