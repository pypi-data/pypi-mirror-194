...
class StoragesUsage(object):
    ...
    def __init__(self, parent_uuid=None, labels=None, object_uuid=None, name=None, deleted=None, status=None, storage_type=None, last_used_template=None, capacity=None, current_usage_per_minute=None, usage_per_interval=None):  # noqa: E501
        """StoragesUsage - a model defined in Swagger"""  # noqa: E501
    ...
    def parent_uuid(self):
        """Gets the parent_uuid of this StoragesUsage.  # noqa: E501

        The UUID of the Storage used to create this Snapshot.  # noqa: E501

        :return: The parent_uuid of this StoragesUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_uuid(self, parent_uuid):
        """Sets the parent_uuid of this StoragesUsage.

        The UUID of the Storage used to create this Snapshot.  # noqa: E501

        :param parent_uuid: The parent_uuid of this StoragesUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this StoragesUsage.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this StoragesUsage.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this StoragesUsage.

        List of labels.  # noqa: E501

        :param labels: The labels of this StoragesUsage.  # noqa: E501
        :type: list[str]
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this StoragesUsage.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this StoragesUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this StoragesUsage.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this StoragesUsage.  # noqa: E501
        :type: str
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StoragesUsage.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StoragesUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def deleted(self):
        """Gets the deleted of this StoragesUsage.  # noqa: E501

        The deleted status of the object.  # noqa: E501

        :return: The deleted of this StoragesUsage.  # noqa: E501
        :rtype: bool
        """
    ...
    def deleted(self, deleted):
        """Sets the deleted of this StoragesUsage.

        The deleted status of the object.  # noqa: E501

        :param deleted: The deleted of this StoragesUsage.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def status(self):
        """Gets the status of this StoragesUsage.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this StoragesUsage.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this StoragesUsage.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this StoragesUsage.  # noqa: E501
        :type: str
        """
    ...
    def storage_type(self):
        """Gets the storage_type of this StoragesUsage.  # noqa: E501

        (one of storage, storage_high, storage_insane).  # noqa: E501

        :return: The storage_type of this StoragesUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_type(self, storage_type):
        """Sets the storage_type of this StoragesUsage.

        (one of storage, storage_high, storage_insane).  # noqa: E501

        :param storage_type: The storage_type of this StoragesUsage.  # noqa: E501
        :type: str
        """
    ...
    def last_used_template(self):
        """Gets the last_used_template of this StoragesUsage.  # noqa: E501

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :return: The last_used_template of this StoragesUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def last_used_template(self, last_used_template):
        """Sets the last_used_template of this StoragesUsage.

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :param last_used_template: The last_used_template of this StoragesUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def capacity(self):
        """Gets the capacity of this StoragesUsage.  # noqa: E501

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :return: The capacity of this StoragesUsage.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this StoragesUsage.

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :param capacity: The capacity of this StoragesUsage.  # noqa: E501
        :type: int
        """
    ...
    def current_usage_per_minute(self):
        """Gets the current_usage_per_minute of this StoragesUsage.  # noqa: E501


        :return: The current_usage_per_minute of this StoragesUsage.  # noqa: E501
    ...
    def current_usage_per_minute(self, current_usage_per_minute):
        """Sets the current_usage_per_minute of this StoragesUsage.


        :param current_usage_per_minute: The current_usage_per_minute of this StoragesUsage.  # noqa: E501
    ...
    def usage_per_interval(self):
        """Gets the usage_per_interval of this StoragesUsage.  # noqa: E501


        :return: The usage_per_interval of this StoragesUsage.  # noqa: E501
    ...
    def usage_per_interval(self, usage_per_interval):
        """Sets the usage_per_interval of this StoragesUsage.


        :param usage_per_interval: The usage_per_interval of this StoragesUsage.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoragesUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoragesUsage):
            return False
