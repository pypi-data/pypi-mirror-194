...
from gs_api_client.swagger.models.snapshot import Snapshot  # noqa: F401,E501


class SnapshotGetResponse(object):
    ...
    def __init__(self, snapshot=None):  # noqa: E501
        """SnapshotGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def snapshot(self):
        """Gets the snapshot of this SnapshotGetResponse.  # noqa: E501


        :return: The snapshot of this SnapshotGetResponse.  # noqa: E501
        :rtype: Snapshot
        """
    ...
    def snapshot(self, snapshot):
        """Sets the snapshot of this SnapshotGetResponse.


        :param snapshot: The snapshot of this SnapshotGetResponse.  # noqa: E501
        :type: Snapshot
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotGetResponse):
            return False
