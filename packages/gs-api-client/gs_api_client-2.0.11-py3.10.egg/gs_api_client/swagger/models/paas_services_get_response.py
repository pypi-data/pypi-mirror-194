...
class PaasServicesGetResponse(object):
    ...
    def __init__(self, paas_services=None):  # noqa: E501
        """PaasServicesGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def paas_services(self):
        """Gets the paas_services of this PaasServicesGetResponse.  # noqa: E501


        :return: The paas_services of this PaasServicesGetResponse.  # noqa: E501
    ...
    def paas_services(self, paas_services):
        """Sets the paas_services of this PaasServicesGetResponse.


        :param paas_services: The paas_services of this PaasServicesGetResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServicesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServicesGetResponse):
            return False
