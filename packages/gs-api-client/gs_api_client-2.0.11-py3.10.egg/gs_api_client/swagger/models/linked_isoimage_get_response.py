...
from gs_api_client.swagger.models.linked_isoimage import LinkedIsoimage  # noqa: F401,E501


class LinkedIsoimageGetResponse(object):
    ...
    attribute_map = {
        'isoimage_relation': 'isoimage_relation'
    }

    def __init__(self, isoimage_relation=None):  # noqa: E501
        """LinkedIsoimageGetResponse - a model defined in Swagger"""  # noqa: E501

        self._isoimage_relation = None
        self.discriminator = None

        if isoimage_relation is not None:
            self.isoimage_relation = isoimage_relation

    @property
    def isoimage_relation(self):
        """Gets the isoimage_relation of this LinkedIsoimageGetResponse.  # noqa: E501


        :return: The isoimage_relation of this LinkedIsoimageGetResponse.  # noqa: E501
        :rtype: LinkedIsoimage
        """
        return self._isoimage_relation

    @isoimage_relation.setter
    def isoimage_relation(self, isoimage_relation):
        """Sets the isoimage_relation of this LinkedIsoimageGetResponse.


        :param isoimage_relation: The isoimage_relation of this LinkedIsoimageGetResponse.  # noqa: E501
        :type: LinkedIsoimage
        """

        self._isoimage_relation = isoimage_relation
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedIsoimageGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedIsoimageGetResponse):
            return False
