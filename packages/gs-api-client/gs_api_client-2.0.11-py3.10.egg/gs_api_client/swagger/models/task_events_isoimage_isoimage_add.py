...
from gs_api_client.swagger.models.task_events_isoimage_isoimage_add_source_url import TaskEventsIsoimageIsoimageAddSourceUrl  # noqa: F401,E501
...
class TaskEventsIsoimageIsoimageAdd(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'isoimage_uuid': 'TaskEventsIsoimageIsoimageAddIsoimageUuid',
        'location_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'source_url': 'TaskEventsIsoimageIsoimageAddSourceUrl'
    }
    ...
    def __init__(self, labels=None, name=None, isoimage_uuid=None, location_uuid=None, source_url=None):  # noqa: E501
        """TaskEventsIsoimageIsoimageAdd - a model defined in Swagger"""  # noqa: E501

        self._labels = None
        self._name = None
        self._isoimage_uuid = None
        ...
        if name is not None:
            self.name = name
        if isoimage_uuid is not None:
            self.isoimage_uuid = isoimage_uuid
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501


        :return: The labels of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsIsoimageIsoimageAdd.


        :param labels: The labels of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501


        :return: The name of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsIsoimageIsoimageAdd.


        :param name: The name of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    @property
    def isoimage_uuid(self):
        """Gets the isoimage_uuid of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501


        :return: The isoimage_uuid of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :rtype: TaskEventsIsoimageIsoimageAddIsoimageUuid
        """
        return self._isoimage_uuid

    @isoimage_uuid.setter
    def isoimage_uuid(self, isoimage_uuid):
        """Sets the isoimage_uuid of this TaskEventsIsoimageIsoimageAdd.


        :param isoimage_uuid: The isoimage_uuid of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :type: TaskEventsIsoimageIsoimageAddIsoimageUuid
        """

        self._isoimage_uuid = isoimage_uuid

    @property
    def location_uuid(self):
        """Gets the location_uuid of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501


        :return: The location_uuid of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this TaskEventsIsoimageIsoimageAdd.


        :param location_uuid: The location_uuid of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
    ...
    @property
    def source_url(self):
        """Gets the source_url of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501


        :return: The source_url of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :rtype: TaskEventsIsoimageIsoimageAddSourceUrl
        """
        return self._source_url

    @source_url.setter
    def source_url(self, source_url):
        """Sets the source_url of this TaskEventsIsoimageIsoimageAdd.


        :param source_url: The source_url of this TaskEventsIsoimageIsoimageAdd.  # noqa: E501
        :type: TaskEventsIsoimageIsoimageAddSourceUrl
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsIsoimageIsoimageAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsIsoimageIsoimageAdd):
            return False
