...
class StorageTemplateCreate(object):
    ...
    def __init__(self, name=None, snapshot_uuid=None, labels=None):  # noqa: E501
        """StorageTemplateCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageTemplateCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StorageTemplateCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def snapshot_uuid(self):
        """Gets the snapshot_uuid of this StorageTemplateCreate.  # noqa: E501

        snapshot uuid for template  # noqa: E501

        :return: The snapshot_uuid of this StorageTemplateCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def snapshot_uuid(self, snapshot_uuid):
        """Sets the snapshot_uuid of this StorageTemplateCreate.

        snapshot uuid for template  # noqa: E501

        :param snapshot_uuid: The snapshot_uuid of this StorageTemplateCreate.  # noqa: E501
        :type: str
        """
        if snapshot_uuid is None:
            raise ValueError("Invalid value for `snapshot_uuid`, must not be `None`")  # noqa: E501

        self._snapshot_uuid = snapshot_uuid

    @property
    def labels(self):
        """Gets the labels of this StorageTemplateCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this StorageTemplateCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this StorageTemplateCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this StorageTemplateCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageTemplateCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageTemplateCreate):
            return False
