...
from gs_api_client.swagger.models.task_events_firewall_firewall_update_rules import TaskEventsFirewallFirewallUpdateRules  # noqa: F401,E501
...
class TaskEventsFirewallFirewallUpdate(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'firewall_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'rules': 'TaskEventsFirewallFirewallUpdateRules'
    }

    attribute_map = {
        'labels': 'labels',
        'name': 'name',
        'firewall_uuid': 'firewall_uuid',
        'rules': 'rules'
    }

    def __init__(self, labels=None, name=None, firewall_uuid=None, rules=None):  # noqa: E501
        """TaskEventsFirewallFirewallUpdate - a model defined in Swagger"""  # noqa: E501

        self._labels = None
        self._name = None
        self._firewall_uuid = None
        self._rules = None
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskEventsFirewallFirewallUpdate.  # noqa: E501


        :return: The labels of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsFirewallFirewallUpdate.


        :param labels: The labels of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsFirewallFirewallUpdate.  # noqa: E501


        :return: The name of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsFirewallFirewallUpdate.


        :param name: The name of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :type: TaskEventName
        """
    ...
    def firewall_uuid(self):
        """Gets the firewall_uuid of this TaskEventsFirewallFirewallUpdate.  # noqa: E501


        :return: The firewall_uuid of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
        return self._firewall_uuid

    @firewall_uuid.setter
    def firewall_uuid(self, firewall_uuid):
        """Sets the firewall_uuid of this TaskEventsFirewallFirewallUpdate.


        :param firewall_uuid: The firewall_uuid of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """

        self._firewall_uuid = firewall_uuid

    @property
    def rules(self):
        """Gets the rules of this TaskEventsFirewallFirewallUpdate.  # noqa: E501


        :return: The rules of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :rtype: TaskEventsFirewallFirewallUpdateRules
        """
        return self._rules

    @rules.setter
    def rules(self, rules):
        """Sets the rules of this TaskEventsFirewallFirewallUpdate.


        :param rules: The rules of this TaskEventsFirewallFirewallUpdate.  # noqa: E501
        :type: TaskEventsFirewallFirewallUpdateRules
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsFirewallFirewallUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsFirewallFirewallUpdate):
            return False
