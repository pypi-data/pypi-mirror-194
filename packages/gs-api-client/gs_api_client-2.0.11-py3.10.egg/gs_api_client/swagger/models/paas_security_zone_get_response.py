...
from gs_api_client.swagger.models.paas_security_zone import PaasSecurityZone  # noqa: F401,E501


class PaasSecurityZoneGetResponse(object):
    ...
    attribute_map = {
        'paas_security_zone': 'paas_security_zone'
    }

    def __init__(self, paas_security_zone=None):  # noqa: E501
        """PaasSecurityZoneGetResponse - a model defined in Swagger"""  # noqa: E501

        self._paas_security_zone = None
        self.discriminator = None

        if paas_security_zone is not None:
            self.paas_security_zone = paas_security_zone

    @property
    def paas_security_zone(self):
        """Gets the paas_security_zone of this PaasSecurityZoneGetResponse.  # noqa: E501


        :return: The paas_security_zone of this PaasSecurityZoneGetResponse.  # noqa: E501
        :rtype: PaasSecurityZone
        """
        return self._paas_security_zone

    @paas_security_zone.setter
    def paas_security_zone(self, paas_security_zone):
        """Sets the paas_security_zone of this PaasSecurityZoneGetResponse.


        :param paas_security_zone: The paas_security_zone of this PaasSecurityZoneGetResponse.  # noqa: E501
        :type: PaasSecurityZone
        """

        self._paas_security_zone = paas_security_zone
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZoneGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZoneGetResponse):
            return False
