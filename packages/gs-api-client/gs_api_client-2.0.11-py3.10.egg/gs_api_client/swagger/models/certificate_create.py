...
class CertificateCreate(object):
    ...
    def __init__(self, name=None, private_key=None, leaf_certificate=None, certificate_chain=None):  # noqa: E501
        """CertificateCreate - a model defined in Swagger"""  # noqa: E501

        self._name = None
        self._private_key = None
        self._leaf_certificate = None
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CertificateCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this CertificateCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def private_key(self):
        """Gets the private_key of this CertificateCreate.  # noqa: E501

        The PEM-formatted private-key of the SSL certificate.  # noqa: E501

        :return: The private_key of this CertificateCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def private_key(self, private_key):
        """Sets the private_key of this CertificateCreate.

        The PEM-formatted private-key of the SSL certificate.  # noqa: E501

        :param private_key: The private_key of this CertificateCreate.  # noqa: E501
        :type: str
        """
    ...
    def leaf_certificate(self):
        """Gets the leaf_certificate of this CertificateCreate.  # noqa: E501

        The PEM-formatted public SSL of the SSL certificate.  # noqa: E501

        :return: The leaf_certificate of this CertificateCreate.  # noqa: E501
        :rtype: str
        """
        return self._leaf_certificate

    @leaf_certificate.setter
    def leaf_certificate(self, leaf_certificate):
        """Sets the leaf_certificate of this CertificateCreate.

        The PEM-formatted public SSL of the SSL certificate.  # noqa: E501

        :param leaf_certificate: The leaf_certificate of this CertificateCreate.  # noqa: E501
        :type: str
        """
        if leaf_certificate is None:
            raise ValueError("Invalid value for `leaf_certificate`, must not be `None`")  # noqa: E501

        self._leaf_certificate = leaf_certificate

    @property
    def certificate_chain(self):
        """Gets the certificate_chain of this CertificateCreate.  # noqa: E501
        ...
        :return: The certificate_chain of this CertificateCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def certificate_chain(self, certificate_chain):
        """Sets the certificate_chain of this CertificateCreate.

        The PEM-formatted full-chain between the certificate authority and the domain's SSL certificate. The certificate_chain should include the leaf_certificate as well. The certificate_chain should include the certificates in the following order: -----BEGIN CERTIFICATE-----\\ncontent of your domain certificate (leaf certificate)\\n-----END CERTIFICATE----- \\n-----BEGIN CERTIFICATE-----\\ncontent of any intermediate CA certificate\\n-----END CERTIFICATE---- \\n-----BEGIN CERTIFICATE-----\\ncontent of CA certificate\\n-----END CERTIFICATE----  # noqa: E501

        :param certificate_chain: The certificate_chain of this CertificateCreate.  # noqa: E501
        :type: str
        """
