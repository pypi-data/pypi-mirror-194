...
from gs_api_client.swagger.models.task_events_loadbalancer_loadbalancer_update_backend_servers_schema_schema_host import TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_loadbalancer_loadbalancer_update_backend_servers_schema_schema_weight import TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaWeight  # noqa: F401,E501


class TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema(object):
    ...
    """
    swagger_types = {
        'host': 'TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost',
        'weight': 'TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaWeight'
    }
    ...
    def __init__(self, host=None, weight=None):  # noqa: E501
        """TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def host(self):
        """Gets the host of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.  # noqa: E501


        :return: The host of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost
        """
        return self._host

    @host.setter
    def host(self, host):
        """Sets the host of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.


        :param host: The host of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost
        """
    ...
    @property
    def weight(self):
        """Gets the weight of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.  # noqa: E501


        :return: The weight of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaWeight
        """
        return self._weight

    @weight.setter
    def weight(self, weight):
        """Sets the weight of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.


        :param weight: The weight of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaWeight
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchema):
            return False
