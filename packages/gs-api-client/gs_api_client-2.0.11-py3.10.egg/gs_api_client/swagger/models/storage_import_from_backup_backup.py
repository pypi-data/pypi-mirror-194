...
class StorageImportFromBackupBackup(object):
    ...
    def __init__(self, name=None, backup_uuid=None):  # noqa: E501
        """StorageImportFromBackupBackup - a model defined in Swagger"""  # noqa: E501

        self._name = None
        self._backup_uuid = None
    ...
    @property
    def name(self):
        """Gets the name of this StorageImportFromBackupBackup.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The name of this StorageImportFromBackupBackup.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageImportFromBackupBackup.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StorageImportFromBackupBackup.  # noqa: E501
        :type: str
        """
    ...
    def backup_uuid(self):
        """Gets the backup_uuid of this StorageImportFromBackupBackup.  # noqa: E501

        The UUID of a backup is always unique, and refers to a specific object.  # noqa: E501

        :return: The backup_uuid of this StorageImportFromBackupBackup.  # noqa: E501
        :rtype: str
        """
    ...
    def backup_uuid(self, backup_uuid):
        """Sets the backup_uuid of this StorageImportFromBackupBackup.

        The UUID of a backup is always unique, and refers to a specific object.  # noqa: E501

        :param backup_uuid: The backup_uuid of this StorageImportFromBackupBackup.  # noqa: E501
        :type: str
        """
        if backup_uuid is None:
            raise ValueError("Invalid value for `backup_uuid`, must not be `None`")  # noqa: E501

        self._backup_uuid = backup_uuid
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageImportFromBackupBackup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageImportFromBackupBackup):
            return False
