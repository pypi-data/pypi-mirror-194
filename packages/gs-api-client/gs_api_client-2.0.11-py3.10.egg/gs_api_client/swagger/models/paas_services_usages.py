...
from gs_api_client.swagger.models.paas_services_usage import PaasServicesUsage  # noqa: F401,E501


class PaasServicesUsages(object):
    ...
    """
    swagger_types = {
        'paas_services': 'list[PaasServicesUsage]'
    }
    ...
    def __init__(self, paas_services=None):  # noqa: E501
        """PaasServicesUsages - a model defined in Swagger"""  # noqa: E501
    ...
    def paas_services(self):
        """Gets the paas_services of this PaasServicesUsages.  # noqa: E501


        :return: The paas_services of this PaasServicesUsages.  # noqa: E501
        :rtype: list[PaasServicesUsage]
        """
        return self._paas_services

    @paas_services.setter
    def paas_services(self, paas_services):
        """Sets the paas_services of this PaasServicesUsages.


        :param paas_services: The paas_services of this PaasServicesUsages.  # noqa: E501
        :type: list[PaasServicesUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServicesUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServicesUsages):
            return False
