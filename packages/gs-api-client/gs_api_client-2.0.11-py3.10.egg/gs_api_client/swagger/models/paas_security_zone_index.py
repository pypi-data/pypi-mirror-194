...
from gs_api_client.swagger.models.paas_security_zones import PaasSecurityZones  # noqa: F401,E501


class PaasSecurityZoneIndex(dict):
    ...
    def __init__(self):  # noqa: E501
        """PaasSecurityZoneIndex - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZoneIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZoneIndex):
            return False
