...
from gs_api_client.swagger.models.firewall_index import FirewallIndex  # noqa: F401,E501


class FirewallsGetResponse(object):
    ...
    def __init__(self, firewalls=None):  # noqa: E501
        """FirewallsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def firewalls(self):
        """Gets the firewalls of this FirewallsGetResponse.  # noqa: E501


        :return: The firewalls of this FirewallsGetResponse.  # noqa: E501
        :rtype: FirewallIndex
        """
    ...
    def firewalls(self, firewalls):
        """Sets the firewalls of this FirewallsGetResponse.


        :param firewalls: The firewalls of this FirewallsGetResponse.  # noqa: E501
        :type: FirewallIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallsGetResponse):
            return False
