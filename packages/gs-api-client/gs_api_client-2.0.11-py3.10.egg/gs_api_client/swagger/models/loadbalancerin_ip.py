...
from gs_api_client.swagger.models.loadbalancerin_ip_inner import LoadbalancerinIpInner  # noqa: F401,E501


class LoadbalancerinIp(object):
    ...
    def __init__(self):  # noqa: E501
        """LoadbalancerinIp - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancerinIp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancerinIp):
            return False
