...
from gs_api_client.swagger.models.task_events_loadbalancer_loadbalancer_remove import TaskEventsLoadbalancerLoadbalancerRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_loadbalancer_loadbalancer_update import TaskEventsLoadbalancerLoadbalancerUpdate  # noqa: F401,E501


class TaskEventsLoadbalancer(object):
    ...
    """
    swagger_types = {
        'loadbalancer_update': 'TaskEventsLoadbalancerLoadbalancerUpdate',
        'loadbalancer_add': 'TaskEventsLoadbalancerLoadbalancerUpdate',
        'loadbalancer_remove': 'TaskEventsLoadbalancerLoadbalancerRemove'
    }

    attribute_map = {
        'loadbalancer_update': 'loadbalancer_update',
        'loadbalancer_add': 'loadbalancer_add',
        'loadbalancer_remove': 'loadbalancer_remove'
    }

    def __init__(self, loadbalancer_update=None, loadbalancer_add=None, loadbalancer_remove=None):  # noqa: E501
        """TaskEventsLoadbalancer - a model defined in Swagger"""  # noqa: E501

        self._loadbalancer_update = None
        self._loadbalancer_add = None
        self._loadbalancer_remove = None
        self.discriminator = None

        if loadbalancer_update is not None:
            self.loadbalancer_update = loadbalancer_update
        if loadbalancer_add is not None:
            self.loadbalancer_add = loadbalancer_add
        if loadbalancer_remove is not None:
            self.loadbalancer_remove = loadbalancer_remove

    @property
    def loadbalancer_update(self):
        """Gets the loadbalancer_update of this TaskEventsLoadbalancer.  # noqa: E501


        :return: The loadbalancer_update of this TaskEventsLoadbalancer.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdate
        """
        return self._loadbalancer_update

    @loadbalancer_update.setter
    def loadbalancer_update(self, loadbalancer_update):
        """Sets the loadbalancer_update of this TaskEventsLoadbalancer.


        :param loadbalancer_update: The loadbalancer_update of this TaskEventsLoadbalancer.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdate
        """

        self._loadbalancer_update = loadbalancer_update

    @property
    def loadbalancer_add(self):
        """Gets the loadbalancer_add of this TaskEventsLoadbalancer.  # noqa: E501


        :return: The loadbalancer_add of this TaskEventsLoadbalancer.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdate
        """
        return self._loadbalancer_add

    @loadbalancer_add.setter
    def loadbalancer_add(self, loadbalancer_add):
        """Sets the loadbalancer_add of this TaskEventsLoadbalancer.


        :param loadbalancer_add: The loadbalancer_add of this TaskEventsLoadbalancer.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdate
        """

        self._loadbalancer_add = loadbalancer_add

    @property
    def loadbalancer_remove(self):
        """Gets the loadbalancer_remove of this TaskEventsLoadbalancer.  # noqa: E501


        :return: The loadbalancer_remove of this TaskEventsLoadbalancer.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerRemove
        """
        return self._loadbalancer_remove

    @loadbalancer_remove.setter
    def loadbalancer_remove(self, loadbalancer_remove):
        """Sets the loadbalancer_remove of this TaskEventsLoadbalancer.


        :param loadbalancer_remove: The loadbalancer_remove of this TaskEventsLoadbalancer.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerRemove
        """

        self._loadbalancer_remove = loadbalancer_remove
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsLoadbalancer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsLoadbalancer):
            return False
