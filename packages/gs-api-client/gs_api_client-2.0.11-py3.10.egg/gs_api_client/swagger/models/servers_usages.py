...
from gs_api_client.swagger.models.servers_usage import ServersUsage  # noqa: F401,E501


class ServersUsages(object):
    ...
    def __init__(self, servers=None):  # noqa: E501
        """ServersUsages - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def servers(self):
        """Gets the servers of this ServersUsages.  # noqa: E501


        :return: The servers of this ServersUsages.  # noqa: E501
        :rtype: list[ServersUsage]
        """
        return self._servers

    @servers.setter
    def servers(self, servers):
        """Sets the servers of this ServersUsages.


        :param servers: The servers of this ServersUsages.  # noqa: E501
        :type: list[ServersUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServersUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServersUsages):
            return False
