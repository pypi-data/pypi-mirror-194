...
class TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash(object):
    ...
    def __init__(self, required=None, type=None):  # noqa: E501
        """TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def required(self):
        """Gets the required of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.  # noqa: E501


        :return: The required of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.


        :param required: The required of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def type(self):
        """Gets the type of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.  # noqa: E501


        :return: The type of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.


        :param type: The type of this TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsMarketplaceTemplateMarketplaceTemplateImportUniqueHash):
            return False
