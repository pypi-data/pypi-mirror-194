...
from gs_api_client.swagger.models.task_events_snapshot_snapshot_export_tos3_s3auth_schema_secret_key import TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey  # noqa: F401,E501


class TaskEventsSnapshotSnapshotExportTos3S3dataSchema(object):
    ...
    """
    swagger_types = {
        'host': 'TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps',
        'bucket': 'TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey',
        'filename': 'TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey',
        'private': 'TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps'
    }
    ...
    def __init__(self, host=None, bucket=None, filename=None, private=None):  # noqa: E501
        """TaskEventsSnapshotSnapshotExportTos3S3dataSchema - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def host(self):
        """Gets the host of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501


        :return: The host of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.


        :param host: The host of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
    ...
    @property
    def bucket(self):
        """Gets the bucket of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501


        :return: The bucket of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey
        """
        return self._bucket

    @bucket.setter
    def bucket(self, bucket):
        """Sets the bucket of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.


        :param bucket: The bucket of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey
        """
    ...
    @property
    def filename(self):
        """Gets the filename of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501


        :return: The filename of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey
        """
    ...
    def filename(self, filename):
        """Sets the filename of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.


        :param filename: The filename of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotExportTos3S3authSchemaSecretKey
        """
    ...
    @property
    def private(self):
        """Gets the private of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501


        :return: The private of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps
        """
    ...
    def private(self, private):
        """Sets the private of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.


        :param private: The private of this TaskEventsSnapshotSnapshotExportTos3S3dataSchema.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSnapshotSnapshotExportTos3S3dataSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSnapshotSnapshotExportTos3S3dataSchema):
            return False
