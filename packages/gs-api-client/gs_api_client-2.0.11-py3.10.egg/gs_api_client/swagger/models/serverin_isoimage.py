...
from gs_api_client.swagger.models.serverin_isoimage_inner import ServerinIsoimageInner  # noqa: F401,E501


class ServerinIsoimage(object):
    ...
    def __init__(self):  # noqa: E501
        """ServerinIsoimage - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerinIsoimage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerinIsoimage):
            return False
