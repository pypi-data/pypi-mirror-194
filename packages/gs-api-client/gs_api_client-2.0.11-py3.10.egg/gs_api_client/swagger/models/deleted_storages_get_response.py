...
from gs_api_client.swagger.models.storage_index import StorageIndex  # noqa: F401,E501


class DeletedStoragesGetResponse(object):
    ...
    attribute_map = {
        'deleted_storages': 'deleted_storages'
    }

    def __init__(self, deleted_storages=None):  # noqa: E501
        """DeletedStoragesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_storages = None
        self.discriminator = None

        if deleted_storages is not None:
            self.deleted_storages = deleted_storages

    @property
    def deleted_storages(self):
        """Gets the deleted_storages of this DeletedStoragesGetResponse.  # noqa: E501


        :return: The deleted_storages of this DeletedStoragesGetResponse.  # noqa: E501
        :rtype: StorageIndex
        """
        return self._deleted_storages

    @deleted_storages.setter
    def deleted_storages(self, deleted_storages):
        """Sets the deleted_storages of this DeletedStoragesGetResponse.


        :param deleted_storages: The deleted_storages of this DeletedStoragesGetResponse.  # noqa: E501
        :type: StorageIndex
        """

        self._deleted_storages = deleted_storages
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedStoragesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedStoragesGetResponse):
            return False
