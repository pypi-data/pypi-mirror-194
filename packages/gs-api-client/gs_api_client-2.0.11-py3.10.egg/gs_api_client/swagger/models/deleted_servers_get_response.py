...
from gs_api_client.swagger.models.server_index import ServerIndex  # noqa: F401,E501


class DeletedServersGetResponse(object):
    ...
    def __init__(self, deleted_servers=None):  # noqa: E501
        """DeletedServersGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_servers = None
        self.discriminator = None

        if deleted_servers is not None:
            self.deleted_servers = deleted_servers

    @property
    def deleted_servers(self):
        """Gets the deleted_servers of this DeletedServersGetResponse.  # noqa: E501


        :return: The deleted_servers of this DeletedServersGetResponse.  # noqa: E501
        :rtype: ServerIndex
        """
        return self._deleted_servers

    @deleted_servers.setter
    def deleted_servers(self, deleted_servers):
        """Sets the deleted_servers of this DeletedServersGetResponse.


        :param deleted_servers: The deleted_servers of this DeletedServersGetResponse.  # noqa: E501
        :type: ServerIndex
        """

        self._deleted_servers = deleted_servers
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedServersGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedServersGetResponse):
            return False
