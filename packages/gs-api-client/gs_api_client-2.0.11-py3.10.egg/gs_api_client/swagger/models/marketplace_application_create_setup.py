...
class MarketplaceApplicationCreateSetup(object):
    ...
    def __init__(self, cores=None, memory=None, capacity=None):  # noqa: E501
        """MarketplaceApplicationCreateSetup - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def cores(self):
        """Gets the cores of this MarketplaceApplicationCreateSetup.  # noqa: E501

        Number of server cores.  # noqa: E501

        :return: The cores of this MarketplaceApplicationCreateSetup.  # noqa: E501
        :rtype: int
        """
        return self._cores
    ...
    def cores(self, cores):
        """Sets the cores of this MarketplaceApplicationCreateSetup.

        Number of server cores.  # noqa: E501

        :param cores: The cores of this MarketplaceApplicationCreateSetup.  # noqa: E501
        :type: int
        """
        if cores is None:
            raise ValueError("Invalid value for `cores`, must not be `None`")  # noqa: E501
        if cores is not None and cores > 64:  # noqa: E501
            raise ValueError("Invalid value for `cores`, must be a value less than or equal to `64`")  # noqa: E501
        if cores is not None and cores < 1:  # noqa: E501
    ...
    @property
    def memory(self):
        """Gets the memory of this MarketplaceApplicationCreateSetup.  # noqa: E501

        Number of server memory.  # noqa: E501

        :return: The memory of this MarketplaceApplicationCreateSetup.  # noqa: E501
        :rtype: int
        """
        return self._memory
    ...
    def memory(self, memory):
        """Sets the memory of this MarketplaceApplicationCreateSetup.

        Number of server memory.  # noqa: E501

        :param memory: The memory of this MarketplaceApplicationCreateSetup.  # noqa: E501
        :type: int
        """
        if memory is None:
            raise ValueError("Invalid value for `memory`, must not be `None`")  # noqa: E501
        if memory is not None and memory > 192:  # noqa: E501
            raise ValueError("Invalid value for `memory`, must be a value less than or equal to `192`")  # noqa: E501
        if memory is not None and memory < 1:  # noqa: E501
            raise ValueError("Invalid value for `memory`, must be a value greater than or equal to `1`")  # noqa: E501

        self._memory = memory

    @property
    def capacity(self):
        """Gets the capacity of this MarketplaceApplicationCreateSetup.  # noqa: E501

        The capacity of a storage in GB.  # noqa: E501

        :return: The capacity of this MarketplaceApplicationCreateSetup.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this MarketplaceApplicationCreateSetup.

        The capacity of a storage in GB.  # noqa: E501

        :param capacity: The capacity of this MarketplaceApplicationCreateSetup.  # noqa: E501
        :type: int
        """
        if capacity is None:
            raise ValueError("Invalid value for `capacity`, must not be `None`")  # noqa: E501
        if capacity is not None and capacity > 16384:  # noqa: E501
            raise ValueError("Invalid value for `capacity`, must be a value less than or equal to `16384`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplicationCreateSetup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplicationCreateSetup):
            return False
