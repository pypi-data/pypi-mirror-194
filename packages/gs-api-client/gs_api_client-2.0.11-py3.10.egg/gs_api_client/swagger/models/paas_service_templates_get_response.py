...
from gs_api_client.swagger.models.paas_service_template_index import PaasServiceTemplateIndex  # noqa: F401,E501


class PaasServiceTemplatesGetResponse(object):
    ...
    attribute_map = {
        'paas_service_templates': 'paas_service_templates'
    }

    def __init__(self, paas_service_templates=None):  # noqa: E501
        """PaasServiceTemplatesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._paas_service_templates = None
        self.discriminator = None

        if paas_service_templates is not None:
            self.paas_service_templates = paas_service_templates

    @property
    def paas_service_templates(self):
        """Gets the paas_service_templates of this PaasServiceTemplatesGetResponse.  # noqa: E501


        :return: The paas_service_templates of this PaasServiceTemplatesGetResponse.  # noqa: E501
        :rtype: PaasServiceTemplateIndex
        """
        return self._paas_service_templates

    @paas_service_templates.setter
    def paas_service_templates(self, paas_service_templates):
        """Sets the paas_service_templates of this PaasServiceTemplatesGetResponse.


        :param paas_service_templates: The paas_service_templates of this PaasServiceTemplatesGetResponse.  # noqa: E501
        :type: PaasServiceTemplateIndex
        """

        self._paas_service_templates = paas_service_templates
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceTemplatesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceTemplatesGetResponse):
            return False
