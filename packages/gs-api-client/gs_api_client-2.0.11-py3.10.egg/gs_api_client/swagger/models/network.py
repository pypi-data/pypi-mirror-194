...
from gs_api_client.swagger.models.dhcp_server import DhcpServer  # noqa: F401,E501
from gs_api_client.swagger.models.network_relation import NetworkRelation  # noqa: F401,E501
...
class Network(object):
    ...
    swagger_types = {
        ...
        'dhcp_gateway': 'str',
        'dhcp_dns': 'str',
        'dhcp_reserved_subnet': 'list[str]',
        'auto_assigned_servers': 'list[DhcpServer]',
        'pinned_servers': 'list[DhcpServer]'
    }
    ...
    attribute_map = {
        ...
        'dhcp_dns': 'dhcp_dns',
        'dhcp_reserved_subnet': 'dhcp_reserved_subnet',
        'auto_assigned_servers': 'auto_assigned_servers',
        'pinned_servers': 'pinned_servers'
    }

    def __init__(self, location_country=None, location_uuid=None, public_net=None, object_uuid=None, network_type=None, name=None, delete_block=None, status=None, create_time=None, l2security=None, relations=None, labels=None, change_time=None, location_iata=None, location_name=None, dhcp_active=None, dhcp_range=None, dhcp_gateway=None, dhcp_dns=None, dhcp_reserved_subnet=None, auto_assigned_servers=None, pinned_servers=None):  # noqa: E501
        ...
        self._dhcp_active = None
        self._dhcp_range = None
        self._dhcp_gateway = None
        self._dhcp_dns = None
        self._dhcp_reserved_subnet = None
        self._auto_assigned_servers = None
        self._pinned_servers = None
        ...
        if dhcp_active is not None:
            self.dhcp_active = dhcp_active
        if dhcp_range is not None:
            self.dhcp_range = dhcp_range
        if dhcp_gateway is not None:
            self.dhcp_gateway = dhcp_gateway
        if dhcp_dns is not None:
            self.dhcp_dns = dhcp_dns
        if dhcp_reserved_subnet is not None:
            self.dhcp_reserved_subnet = dhcp_reserved_subnet
        if auto_assigned_servers is not None:
            self.auto_assigned_servers = auto_assigned_servers
        if pinned_servers is not None:
            self.pinned_servers = pinned_servers

    @property
    def location_country(self):
        """Gets the location_country of this Network.  # noqa: E501
        ...
        :return: The location_country of this Network.  # noqa: E501
        :rtype: str
        """
    ...
    def location_country(self, location_country):
        """Sets the location_country of this Network.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_country: The location_country of this Network.  # noqa: E501
        :type: str
        """
    ...
    def location_uuid(self):
        """Gets the location_uuid of this Network.  # noqa: E501

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :return: The location_uuid of this Network.  # noqa: E501
        :rtype: str
        """
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this Network.

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :param location_uuid: The location_uuid of this Network.  # noqa: E501
        :type: str
        """
    ...
    @property
    def public_net(self):
        """Gets the public_net of this Network.  # noqa: E501
        ...
        :return: The public_net of this Network.  # noqa: E501
        :rtype: bool
        """
    ...
    def public_net(self, public_net):
        """Sets the public_net of this Network.

        True if the network is public. If private it will be false. Each private network is a secure and fully transparent 2-Layer network between servers. There is no limit on how many servers can be connected to the same private network.  # noqa: E501

        :param public_net: The public_net of this Network.  # noqa: E501
        :type: bool
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this Network.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this Network.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this Network.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this Network.  # noqa: E501
        :type: str
        """
    ...
    def network_type(self):
        """Gets the network_type of this Network.  # noqa: E501

        One of 'network', 'network_high' or 'network_insane'.  # noqa: E501

        :return: The network_type of this Network.  # noqa: E501
        :rtype: str
        """
    ...
    def network_type(self, network_type):
        """Sets the network_type of this Network.

        One of 'network', 'network_high' or 'network_insane'.  # noqa: E501

        :param network_type: The network_type of this Network.  # noqa: E501
        :type: str
        """
    ...
    def delete_block(self, delete_block):
        """Sets the delete_block of this Network.

        Defines if the object is administratively blocked. If true, it can not be deleted by the user.  # noqa: E501

        :param delete_block: The delete_block of this Network.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def l2security(self):
        """Gets the l2security of this Network.  # noqa: E501
        ...
        :return: The l2security of this Network.  # noqa: E501
        :rtype: bool
        """
    ...
    def l2security(self, l2security):
        """Sets the l2security of this Network.

        Defines information about MAC spoofing protection (filters layer2 and ARP traffic based on MAC source). It can only be (de-)activated on a private network - the public network always has l2security enabled. It will be true if the network is public, and false if the network is private.  # noqa: E501

        :param l2security: The l2security of this Network.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def relations(self):
        """Gets the relations of this Network.  # noqa: E501


        :return: The relations of this Network.  # noqa: E501
        :rtype: NetworkRelation
        """
        return self._relations

    @relations.setter
    def relations(self, relations):
        """Sets the relations of this Network.


        :param relations: The relations of this Network.  # noqa: E501
    ...
    def change_time(self):
        """Gets the change_time of this Network.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this Network.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this Network.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this Network.  # noqa: E501
        :type: datetime
        """
    ...
    def location_iata(self):
        """Gets the location_iata of this Network.  # noqa: E501

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :return: The location_iata of this Network.  # noqa: E501
        :rtype: str
        """
    ...
    def location_iata(self, location_iata):
        """Sets the location_iata of this Network.

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :param location_iata: The location_iata of this Network.  # noqa: E501
        :type: str
        """
    ...
    def location_name(self):
        """Gets the location_name of this Network.  # noqa: E501

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The location_name of this Network.  # noqa: E501
        :rtype: str
        """
    ...
    def location_name(self, location_name):
        """Sets the location_name of this Network.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_name: The location_name of this Network.  # noqa: E501
        :type: str
        """
    ...
    def dhcp_active(self):
        """Gets the dhcp_active of this Network.  # noqa: E501

        Defines the information if dhcp is activated for this network or not  # noqa: E501

        :return: The dhcp_active of this Network.  # noqa: E501
        :rtype: bool
        """
        return self._dhcp_active

    @dhcp_active.setter
    def dhcp_active(self, dhcp_active):
        """Sets the dhcp_active of this Network.

        Defines the information if dhcp is activated for this network or not  # noqa: E501

        :param dhcp_active: The dhcp_active of this Network.  # noqa: E501
        :type: bool
        """

        self._dhcp_active = dhcp_active

    @property
    def dhcp_range(self):
        """Gets the dhcp_range of this Network.  # noqa: E501


        :return: The dhcp_range of this Network.  # noqa: E501
        :rtype: str
        """
        return self._dhcp_range

    @dhcp_range.setter
    def dhcp_range(self, dhcp_range):
        """Sets the dhcp_range of this Network.


        :param dhcp_range: The dhcp_range of this Network.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dhcp_gateway(self):
        """Gets the dhcp_gateway of this Network.  # noqa: E501


        :return: The dhcp_gateway of this Network.  # noqa: E501
        :rtype: str
        """
        return self._dhcp_gateway

    @dhcp_gateway.setter
    def dhcp_gateway(self, dhcp_gateway):
        """Sets the dhcp_gateway of this Network.


        :param dhcp_gateway: The dhcp_gateway of this Network.  # noqa: E501
        :type: str
        """

        self._dhcp_gateway = dhcp_gateway

    @property
    def dhcp_dns(self):
        """Gets the dhcp_dns of this Network.  # noqa: E501


        :return: The dhcp_dns of this Network.  # noqa: E501
        :rtype: str
        """
        return self._dhcp_dns

    @dhcp_dns.setter
    def dhcp_dns(self, dhcp_dns):
        """Sets the dhcp_dns of this Network.


        :param dhcp_dns: The dhcp_dns of this Network.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dhcp_reserved_subnet(self):
        """Gets the dhcp_reserved_subnet of this Network.  # noqa: E501

        Any subrange within the ip range not conflicting with gateway or dns address, not used for automatic assignment of IPs  # noqa: E501

        :return: The dhcp_reserved_subnet of this Network.  # noqa: E501
        :rtype: list[str]
        """
        return self._dhcp_reserved_subnet

    @dhcp_reserved_subnet.setter
    def dhcp_reserved_subnet(self, dhcp_reserved_subnet):
        """Sets the dhcp_reserved_subnet of this Network.

        Any subrange within the ip range not conflicting with gateway or dns address, not used for automatic assignment of IPs  # noqa: E501

        :param dhcp_reserved_subnet: The dhcp_reserved_subnet of this Network.  # noqa: E501
        :type: list[str]
        """

        self._dhcp_reserved_subnet = dhcp_reserved_subnet

    @property
    def auto_assigned_servers(self):
        """Gets the auto_assigned_servers of this Network.  # noqa: E501


        :return: The auto_assigned_servers of this Network.  # noqa: E501
        :rtype: list[DhcpServer]
        """
        return self._auto_assigned_servers

    @auto_assigned_servers.setter
    def auto_assigned_servers(self, auto_assigned_servers):
        """Sets the auto_assigned_servers of this Network.


        :param auto_assigned_servers: The auto_assigned_servers of this Network.  # noqa: E501
        :type: list[DhcpServer]
        """

        self._auto_assigned_servers = auto_assigned_servers

    @property
    def pinned_servers(self):
        """Gets the pinned_servers of this Network.  # noqa: E501

        Contains ips of all servers in the network which got a designated IP by the user  # noqa: E501

        :return: The pinned_servers of this Network.  # noqa: E501
        :rtype: list[DhcpServer]
        """
        return self._pinned_servers

    @pinned_servers.setter
    def pinned_servers(self, pinned_servers):
        """Sets the pinned_servers of this Network.

        Contains ips of all servers in the network which got a designated IP by the user  # noqa: E501

        :param pinned_servers: The pinned_servers of this Network.  # noqa: E501
        :type: list[DhcpServer]
        """

        self._pinned_servers = pinned_servers
