...
from gs_api_client.swagger.models.linked_ip import LinkedIp  # noqa: F401,E501


class LinkedIpGetResponse(object):
    ...
    def __init__(self, ip_relation=None):  # noqa: E501
        """LinkedIpGetResponse - a model defined in Swagger"""  # noqa: E501

        self._ip_relation = None
        self.discriminator = None

        if ip_relation is not None:
            self.ip_relation = ip_relation

    @property
    def ip_relation(self):
        """Gets the ip_relation of this LinkedIpGetResponse.  # noqa: E501


        :return: The ip_relation of this LinkedIpGetResponse.  # noqa: E501
        :rtype: LinkedIp
        """
        return self._ip_relation

    @ip_relation.setter
    def ip_relation(self, ip_relation):
        """Sets the ip_relation of this LinkedIpGetResponse.


        :param ip_relation: The ip_relation of this LinkedIpGetResponse.  # noqa: E501
        :type: LinkedIp
        """

        self._ip_relation = ip_relation
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedIpGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedIpGetResponse):
            return False
