...
class ServerStorageApi(object):
    ...
    def get_server_linked_storage(self, server_uuid, storage_uuid, **kwargs):  # noqa: E501
        """Server Storage Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages/{storage_uuid} To retrieve detailed information about a particular storage linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_storage(server_uuid, storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :param str storage_uuid: ID of storage (required)
        :return: LinkedStorageGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_storage_with_http_info(server_uuid, storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_storage_with_http_info(server_uuid, storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_storage_with_http_info(self, server_uuid, storage_uuid, **kwargs):  # noqa: E501
        """Server Storage Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages/{storage_uuid} To retrieve detailed information about a particular storage linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_storage_with_http_info(server_uuid, storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'storage_uuid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_server_linked_storage" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('server_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_storage`")  # noqa: E501
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_server_linked_storage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/storages/{storage_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LinkedStorageGetResponse',  # noqa: E501
    ...
    def get_server_linked_storages(self, server_uuid, **kwargs):  # noqa: E501
        """Server Storages Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages To retrieve detailed information about all storages linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_storages(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :return: LinkedStoragesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_storages_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_storages_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_storages_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server Storages Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages To retrieve detailed information about all storages linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_storages_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_linked_storages" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_storages`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/storages', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LinkedStoragesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def link_storage_to_server(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Storage Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages To link a storage to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_storage_to_server(server_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the Server. (required)
        :param LinkStorage payload: storage uuid which going to be linked (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.link_storage_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.link_storage_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def link_storage_to_server_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Storage Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages To link a storage to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_storage_to_server_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method link_storage_to_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `link_storage_to_server`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `link_storage_to_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/storages', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unlink_storage_from_server(self, server_uuid, storage_uuid, **kwargs):  # noqa: E501
        """Server Storage Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages/{storage_uuid} To unlink a storage from the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_storage_from_server(server_uuid, storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the Storage you are removing. (required)
        :param str storage_uuid: The UUID of the Storage you are removing. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unlink_storage_from_server_with_http_info(server_uuid, storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.unlink_storage_from_server_with_http_info(server_uuid, storage_uuid, **kwargs)  # noqa: E501
            return data

    def unlink_storage_from_server_with_http_info(self, server_uuid, storage_uuid, **kwargs):  # noqa: E501
        """Server Storage Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages/{storage_uuid} To unlink a storage from the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_storage_from_server_with_http_info(server_uuid, storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unlink_storage_from_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `unlink_storage_from_server`")  # noqa: E501
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `unlink_storage_from_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/storages/{storage_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_server_linked_storage(self, server_uuid, storage_uuid, payload, **kwargs):  # noqa: E501
        """Server Storage Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages/{storage_uuid} To update the attributes of a storage attached to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_linked_storage(server_uuid, storage_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :param str storage_uuid: ID of storage (required)
        :param LinkedStorageUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_server_linked_storage_with_http_info(server_uuid, storage_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_server_linked_storage_with_http_info(server_uuid, storage_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_server_linked_storage_with_http_info(self, server_uuid, storage_uuid, payload, **kwargs):  # noqa: E501
        """Server Storage Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/storages/{storage_uuid} To update the attributes of a storage attached to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_linked_storage_with_http_info(server_uuid, storage_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'storage_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_server_linked_storage" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `update_server_linked_storage`")  # noqa: E501
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `update_server_linked_storage`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_server_linked_storage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/storages/{storage_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
