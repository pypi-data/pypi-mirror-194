...
class StorageSnapshotApi(object):
    ...
    def create_snapshot(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Storage Snapshot Post  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots To create a new snapshot for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_snapshot(storage_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: storage uuid for snapshot (required)
        :param SnapshotCreate payload: payload for creating snapshot (required)
        ...
        if kwargs.get('async_req'):
            return self.create_snapshot_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_snapshot_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
            return data

    def create_snapshot_with_http_info(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Storage Snapshot Post  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots To create a new snapshot for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_snapshot_with_http_info(storage_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'payload']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `create_snapshot`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `create_snapshot`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'storage_uuid' in params:
            path_params['storage_uuid'] = params['storage_uuid']  # noqa: E501
        ...
        auth_settings = ['API_Token', 'ServiceToken', 'User_UUID']  # noqa: E501

        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_snapshot(self, storage_uuid, snapshot_uuid, **kwargs):  # noqa: E501
        """Storage Snapshot Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid} To delete the specified snapshot of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_snapshot(storage_uuid, snapshot_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be deleted (required)
        :param str snapshot_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_snapshot_with_http_info(storage_uuid, snapshot_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_snapshot_with_http_info(storage_uuid, snapshot_uuid, **kwargs)  # noqa: E501
            return data

    def delete_snapshot_with_http_info(self, storage_uuid, snapshot_uuid, **kwargs):  # noqa: E501
        """Storage Snapshot Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid} To delete the specified snapshot of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_snapshot_with_http_info(storage_uuid, snapshot_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'snapshot_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `delete_snapshot`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_snapshot(self, storage_uuid, snapshot_uuid, **kwargs):  # noqa: E501
        """Storage Snapshot Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid} To retrieve detailed information about the specified snapshot of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot(storage_uuid, snapshot_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param str snapshot_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_snapshot_with_http_info(storage_uuid, snapshot_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_snapshot_with_http_info(storage_uuid, snapshot_uuid, **kwargs)  # noqa: E501
            return data

    def get_snapshot_with_http_info(self, storage_uuid, snapshot_uuid, **kwargs):  # noqa: E501
        """Storage Snapshot Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid} To retrieve detailed information about the specified snapshot of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot_with_http_info(storage_uuid, snapshot_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_snapshot`")  # noqa: E501
        # verify the required parameter 'snapshot_uuid' is set
        if ('snapshot_uuid' not in params or
                params['snapshot_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_uuid` when calling `get_snapshot`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SnapshotGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_snapshots(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Snapshots Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots To retrieve detailed information about every snapshot for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshots(storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be deleted (required)
        :return: SnapshotsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_snapshots_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_snapshots_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_snapshots_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Snapshots Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots To retrieve detailed information about every snapshot for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshots_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_snapshots`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SnapshotsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def snapshot_export_to_s3(self, storage_uuid, snapshot_uuid, payload, **kwargs):  # noqa: E501
        """Storage Snapshot Export To S3  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}/export_to_s3 To export the specified snapshot to S3.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.snapshot_export_to_s3(storage_uuid, snapshot_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param str snapshot_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param SnapshotExportToS3Payload payload: export to s3 (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.snapshot_export_to_s3_with_http_info(storage_uuid, snapshot_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.snapshot_export_to_s3_with_http_info(storage_uuid, snapshot_uuid, payload, **kwargs)  # noqa: E501
            return data

    def snapshot_export_to_s3_with_http_info(self, storage_uuid, snapshot_uuid, payload, **kwargs):  # noqa: E501
        """Storage Snapshot Export To S3  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}/export_to_s3 To export the specified snapshot to S3.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.snapshot_export_to_s3_with_http_info(storage_uuid, snapshot_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'snapshot_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method snapshot_export_to_s3" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `snapshot_export_to_s3`")  # noqa: E501
        # verify the required parameter 'snapshot_uuid' is set
        if ('snapshot_uuid' not in params or
                params['snapshot_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_uuid` when calling `snapshot_export_to_s3`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `snapshot_export_to_s3`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}/export_to_s3', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def storage_rollback(self, storage_uuid, snapshot_uuid, payload, **kwargs):  # noqa: E501
        """Storage Rollback to Snapshot  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}/rollback To return the specified storage back to the state of the selected snapshot.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_rollback(storage_uuid, snapshot_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param str snapshot_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param StorageRollback payload: rollback (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.storage_rollback_with_http_info(storage_uuid, snapshot_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.storage_rollback_with_http_info(storage_uuid, snapshot_uuid, payload, **kwargs)  # noqa: E501
            return data

    def storage_rollback_with_http_info(self, storage_uuid, snapshot_uuid, payload, **kwargs):  # noqa: E501
        """Storage Rollback to Snapshot  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}/rollback To return the specified storage back to the state of the selected snapshot.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_rollback_with_http_info(storage_uuid, snapshot_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method storage_rollback" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `storage_rollback`")  # noqa: E501
        # verify the required parameter 'snapshot_uuid' is set
        if ('snapshot_uuid' not in params or
                params['snapshot_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_uuid` when calling `storage_rollback`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `storage_rollback`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}/rollback', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_snapshot(self, storage_uuid, snapshot_uuid, payload, **kwargs):  # noqa: E501
        """Storage Snapshot Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid} To update the attributes of the specified snapshot of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_snapshot(storage_uuid, snapshot_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be updated. (required)
        :param str snapshot_uuid: object that need to be updated. (required)
        :param SnapshotUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_snapshot_with_http_info(storage_uuid, snapshot_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_snapshot_with_http_info(storage_uuid, snapshot_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_snapshot_with_http_info(self, storage_uuid, snapshot_uuid, payload, **kwargs):  # noqa: E501
        """Storage Snapshot Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid} To update the attributes of the specified snapshot of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_snapshot_with_http_info(storage_uuid, snapshot_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `update_snapshot`")  # noqa: E501
        # verify the required parameter 'snapshot_uuid' is set
        if ('snapshot_uuid' not in params or
                params['snapshot_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_uuid` when calling `update_snapshot`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_snapshot`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshots/{snapshot_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
