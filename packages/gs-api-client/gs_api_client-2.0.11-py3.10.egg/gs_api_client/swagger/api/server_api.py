...
class ServerApi(object):
    ...
    def create_server(self, payload, **kwargs):  # noqa: E501
        """Server Post  # noqa: E501

        https://api.gridscale.io/objects/servers To create a new server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_server(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ServerCreate payload: Data for a new server (required)
        ...
        if kwargs.get('async_req'):
            return self.create_server_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_server_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_server_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Server Post  # noqa: E501

        https://api.gridscale.io/objects/servers To create a new server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_server_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ServerCreateResponse',  # noqa: E501
    ...
    def delete_server(self, server_uuid, **kwargs):  # noqa: E501
        """Server Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid} To delete the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_server(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_server_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_server_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def delete_server_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid} To delete the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_server_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('server_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `server_uuid` when calling `delete_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_server(self, server_uuid, **kwargs):  # noqa: E501
        """Server Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid} To retrieve detailed information regarding the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid} To retrieve detailed information regarding the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ServerGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_server_events(self, server_uuid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_events(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_events_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_events_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data
    ...
    def get_server_metrics(self, server_uuid, **kwargs):  # noqa: E501
        """Server Usage  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/metrics To retrieve the usage metrics for the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_metrics(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: UUID of the Server. (required)
        :return: ServerMetricsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_metrics_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_metrics_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_metrics_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server Usage  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/metrics To retrieve the usage metrics for the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_metrics_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_metrics" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ServerMetricsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_servers(self, **kwargs):  # noqa: E501
        """Servers Get  # noqa: E501

        https://api.gridscale.io/objects/servers To retrieve detailed information of all servers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_servers_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ServersGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_server(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid} To update the attributes of the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server(server_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: object that need to be updated. (required)
        :param ServerUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_server_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid} To update the attributes of the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `update_server`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
