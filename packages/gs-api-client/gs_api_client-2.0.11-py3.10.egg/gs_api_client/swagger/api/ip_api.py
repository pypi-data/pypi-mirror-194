...
class IpApi(object):
    ...
    def create_ip(self, payload, **kwargs):  # noqa: E501
        """IP Post  # noqa: E501

        https://api.gridscale.io/objects/ips To create a new IPv4 or IPv6 address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ip(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param IpCreate payload: Data for a new ip (required)
        :return: IpCreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_ip_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_ip_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_ip_with_http_info(self, payload, **kwargs):  # noqa: E501
        """IP Post  # noqa: E501

        https://api.gridscale.io/objects/ips To create a new IPv4 or IPv6 address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ip_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_ip`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='IpCreateResponse',  # noqa: E501
    ...
    def delete_ip(self, ip_uuid, **kwargs):  # noqa: E501
        """IP Delete  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid} To delete the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_ip(ip_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ip_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_ip_with_http_info(ip_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_ip_with_http_info(ip_uuid, **kwargs)  # noqa: E501
            return data

    def delete_ip_with_http_info(self, ip_uuid, **kwargs):  # noqa: E501
        """IP Delete  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid} To delete the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_ip_with_http_info(ip_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('ip_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `ip_uuid` when calling `delete_ip`")  # noqa: E501
    ...
    def get_ip(self, ip_uuid, **kwargs):  # noqa: E501
        """IP Get  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid} To retrieve detailed information about the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ip(ip_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ip_uuid: uuid of ip (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_ip_with_http_info(ip_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_ip_with_http_info(ip_uuid, **kwargs)  # noqa: E501
            return data

    def get_ip_with_http_info(self, ip_uuid, **kwargs):  # noqa: E501
        """IP Get  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid} To retrieve detailed information about the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ip_with_http_info(ip_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('ip_uuid' not in params or
                params['ip_uuid'] is None):
            raise ValueError("Missing the required parameter `ip_uuid` when calling `get_ip`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='IpGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_ip_events(self, ip_uuid, **kwargs):  # noqa: E501
        """IP Events  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid}/events To retrieve the event log of the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ip_events(ip_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_ip_events_with_http_info(ip_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_ip_events_with_http_info(ip_uuid, **kwargs)  # noqa: E501
            return data

    def get_ip_events_with_http_info(self, ip_uuid, **kwargs):  # noqa: E501
        """IP Events  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid}/events To retrieve the event log of the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ip_events_with_http_info(ip_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('ip_uuid' not in params or
                params['ip_uuid'] is None):
            raise ValueError("Missing the required parameter `ip_uuid` when calling `get_ip_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/ips/{ip_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_ips(self, **kwargs):  # noqa: E501
        ...
        https://api.gridscale.io/objects/ips To retrieve detailed information about all the IP addresses.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_ips_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='IpsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_ip(self, ip_uuid, payload, **kwargs):  # noqa: E501
        """IP Patch  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid} To update the attributes of the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ip(ip_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ip_uuid: object that need to be updated. (required)
        :param IpUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_ip_with_http_info(ip_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_ip_with_http_info(ip_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_ip_with_http_info(self, ip_uuid, payload, **kwargs):  # noqa: E501
        """IP Patch  # noqa: E501

        https://api.gridscale.io/objects/ips/{ip_uuid} To update the attributes of the specified IP address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ip_with_http_info(ip_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ip_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('ip_uuid' not in params or
                params['ip_uuid'] is None):
            raise ValueError("Missing the required parameter `ip_uuid` when calling `update_ip`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_ip`")  # noqa: E501
