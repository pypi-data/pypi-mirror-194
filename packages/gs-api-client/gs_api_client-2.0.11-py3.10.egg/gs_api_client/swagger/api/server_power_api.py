...
class ServerPowerApi(object):
    ...
    def get_server_power(self, server_uuid, **kwargs):  # noqa: E501
        """Server Power Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/power To retrieve the specified server's current power status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_power(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of storage (required)
        ...
        if kwargs.get('async_req'):
            return self.get_server_power_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_power_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_power_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server Power Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/power To retrieve the specified server's current power status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_power_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_server_power" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('server_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_power`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/power', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ServerPowerStatus',  # noqa: E501
    ...
    def server_power_shutdown(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server ACPI Shutdown  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/shutdown To turn the specified server off via ACPI.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_power_shutdown(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.server_power_shutdown_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.server_power_shutdown_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def server_power_shutdown_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server ACPI Shutdown  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/shutdown To turn the specified server off via ACPI.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_power_shutdown_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method server_power_shutdown" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `server_power_shutdown`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `server_power_shutdown`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/shutdown', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_server_power(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Power Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/power To turn the specified server on or off.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_power(server_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :param ServerPowerUpdate payload: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_server_power_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_server_power_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_server_power_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Power Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/power To turn the specified server on or off.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_power_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_server_power" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `update_server_power`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_server_power`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/power', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
