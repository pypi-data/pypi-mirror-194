...
class ServerNetworkApi(object):
    ...
    def get_server_linked_network(self, server_uuid, network_uuid, **kwargs):  # noqa: E501
        """Server Network Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks/{network_uuid} To retrieve information about the specified network to which a particular server is connected.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_network(server_uuid, network_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the Network you are requesting. (required)
        :param str network_uuid: The UUID of the network you're requesting. (required)
        :return: LinkedNetworkGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_network_with_http_info(server_uuid, network_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_network_with_http_info(server_uuid, network_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_network_with_http_info(self, server_uuid, network_uuid, **kwargs):  # noqa: E501
        """Server Network Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks/{network_uuid} To retrieve information about the specified network to which a particular server is connected.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_network_with_http_info(server_uuid, network_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'network_uuid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_server_linked_network" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('server_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_network`")  # noqa: E501
        # verify the required parameter 'network_uuid' is set
        if ('network_uuid' not in params or
                params['network_uuid'] is None):
            raise ValueError("Missing the required parameter `network_uuid` when calling `get_server_linked_network`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/networks/{network_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LinkedNetworkGetResponse',  # noqa: E501
    ...
    def get_server_linked_networks(self, server_uuid, **kwargs):  # noqa: E501
        """Server Networks Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks To retrieve detailed information about all the networks to which the specified server is connected.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_networks(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :return: LinkedNetworksGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_networks_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_networks_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_networks_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server Networks Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks To retrieve detailed information about all the networks to which the specified server is connected.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_networks_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_linked_networks" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_networks`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/networks', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LinkedNetworksGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def link_network_to_server(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Network Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks To add the specified server to a network.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_network_to_server(server_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the Server. (required)
        :param LinkNetwork payload: Network UUID which is going to be linked (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.link_network_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.link_network_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def link_network_to_server_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server Network Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks To add the specified server to a network.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_network_to_server_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method link_network_to_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `link_network_to_server`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `link_network_to_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/networks', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unlink_network_from_server(self, server_uuid, network_uuid, **kwargs):  # noqa: E501
        """Server Network Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks/{network_uuid} To unlink the specified network from a particular server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_network_from_server(server_uuid, network_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the IP you are requesting. (required)
        :param str network_uuid: The UUID of the IP Address you're requesting. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unlink_network_from_server_with_http_info(server_uuid, network_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.unlink_network_from_server_with_http_info(server_uuid, network_uuid, **kwargs)  # noqa: E501
            return data

    def unlink_network_from_server_with_http_info(self, server_uuid, network_uuid, **kwargs):  # noqa: E501
        """Server Network Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks/{network_uuid} To unlink the specified network from a particular server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_network_from_server_with_http_info(server_uuid, network_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unlink_network_from_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `unlink_network_from_server`")  # noqa: E501
        # verify the required parameter 'network_uuid' is set
        if ('network_uuid' not in params or
                params['network_uuid'] is None):
            raise ValueError("Missing the required parameter `network_uuid` when calling `unlink_network_from_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/networks/{network_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_server_linked_network(self, server_uuid, network_uuid, payload, **kwargs):  # noqa: E501
        """Server Network Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks/{network_uuid} To update the attributes of the specified network connected to a particular server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_linked_network(server_uuid, network_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the network you are requesting. (required)
        :param str network_uuid: The UUID of the network you're requesting. (required)
        :param LinkedNetworkUpdate payload: Updated user object. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_server_linked_network_with_http_info(server_uuid, network_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_server_linked_network_with_http_info(server_uuid, network_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_server_linked_network_with_http_info(self, server_uuid, network_uuid, payload, **kwargs):  # noqa: E501
        """Server Network Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/networks/{network_uuid} To update the attributes of the specified network connected to a particular server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_linked_network_with_http_info(server_uuid, network_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'network_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_server_linked_network" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `update_server_linked_network`")  # noqa: E501
        # verify the required parameter 'network_uuid' is set
        if ('network_uuid' not in params or
                params['network_uuid'] is None):
            raise ValueError("Missing the required parameter `network_uuid` when calling `update_server_linked_network`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_server_linked_network`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/networks/{network_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
