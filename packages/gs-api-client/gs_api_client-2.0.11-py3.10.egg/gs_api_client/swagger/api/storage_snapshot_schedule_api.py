...
class StorageSnapshotScheduleApi(object):
    ...
    def create_snapshot_schedule(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Snapshot Schedule Post  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules To create a new snapshot schedule for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_snapshot_schedule(storage_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: storage uuid for snapshot_schedule. (required)
        :param SnapshotScheduleCreate payload: payload for creating snapshot_schedule. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_snapshot_schedule_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_snapshot_schedule_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
            return data

    def create_snapshot_schedule_with_http_info(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Snapshot Schedule Post  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules To create a new snapshot schedule for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_snapshot_schedule_with_http_info(storage_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `storage_uuid` when calling `create_snapshot_schedule`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `create_snapshot_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshot_schedules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_snapshot_schedule(self, storage_uuid, snapshot_schedule_uuid, **kwargs):  # noqa: E501
        """Snapshot Schedule Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid} To delete the schedule of a snapshot of a storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_snapshot_schedule(storage_uuid, snapshot_schedule_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be deleted. (required)
        :param str snapshot_schedule_uuid: object that need to be deleted. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, **kwargs)  # noqa: E501
            return data

    def delete_snapshot_schedule_with_http_info(self, storage_uuid, snapshot_schedule_uuid, **kwargs):  # noqa: E501
        """Snapshot Schedule Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid} To delete the schedule of a snapshot of a storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'snapshot_schedule_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `delete_snapshot_schedule`")  # noqa: E501
        # verify the required parameter 'snapshot_schedule_uuid' is set
        if ('snapshot_schedule_uuid' not in params or
                params['snapshot_schedule_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_schedule_uuid` when calling `delete_snapshot_schedule`")  # noqa: E501
        ...
        if 'storage_uuid' in params:
            path_params['storage_uuid'] = params['storage_uuid']  # noqa: E501
        if 'snapshot_schedule_uuid' in params:
            path_params['snapshot_schedule_uuid'] = params['snapshot_schedule_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_snapshot_schedule(self, storage_uuid, snapshot_schedule_uuid, **kwargs):  # noqa: E501
        """Snapshot Schedule Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid} To retrieve detailed information about the specified snapshot schedule for a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot_schedule(storage_uuid, snapshot_schedule_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param str snapshot_schedule_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :return: SnapshotScheduleGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, **kwargs)  # noqa: E501
            return data

    def get_snapshot_schedule_with_http_info(self, storage_uuid, snapshot_schedule_uuid, **kwargs):  # noqa: E501
        """Snapshot Schedule Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid} To retrieve detailed information about the specified snapshot schedule for a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_snapshot_schedule`")  # noqa: E501
        # verify the required parameter 'snapshot_schedule_uuid' is set
        if ('snapshot_schedule_uuid' not in params or
                params['snapshot_schedule_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_schedule_uuid` when calling `get_snapshot_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SnapshotScheduleGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_snapshot_schedules(self, storage_uuid, **kwargs):  # noqa: E501
        """Snapshot Schedules Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules To retrieve detailed information about all snapshot schedules for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot_schedules(storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: Storage UUID of the scheduler. (required)
        :return: SnapshotSchedulesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_snapshot_schedules_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_snapshot_schedules_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_snapshot_schedules_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Snapshot Schedules Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules To retrieve detailed information about all snapshot schedules for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_snapshot_schedules_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_snapshot_schedules" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_snapshot_schedules`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshot_schedules', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SnapshotSchedulesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_snapshot_schedule(self, storage_uuid, snapshot_schedule_uuid, payload, **kwargs):  # noqa: E501
        """Snapshot Schedule Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid} To update the attributes of the specified snapshot schedule of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_snapshot_schedule(storage_uuid, snapshot_schedule_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be updated. (required)
        :param str snapshot_schedule_uuid: object that need to be updated. (required)
        :param SnapshotScheduleUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_snapshot_schedule_with_http_info(self, storage_uuid, snapshot_schedule_uuid, payload, **kwargs):  # noqa: E501
        """Snapshot Schedule Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid} To update the attributes of the specified snapshot schedule of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_snapshot_schedule_with_http_info(storage_uuid, snapshot_schedule_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'snapshot_schedule_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `update_snapshot_schedule`")  # noqa: E501
        # verify the required parameter 'snapshot_schedule_uuid' is set
        if ('snapshot_schedule_uuid' not in params or
                params['snapshot_schedule_uuid'] is None):
            raise ValueError("Missing the required parameter `snapshot_schedule_uuid` when calling `update_snapshot_schedule`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_snapshot_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/snapshot_schedules/{snapshot_schedule_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
