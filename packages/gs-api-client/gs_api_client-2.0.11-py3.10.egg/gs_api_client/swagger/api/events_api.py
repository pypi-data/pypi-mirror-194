...
class EventsApi(object):
    ...
    def event_get_all(self, **kwargs):  # noqa: E501
        """Events Get  # noqa: E501

        https://api.gridscale.io/objects/events To retrieve the audit log of all the events.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.event_get_all(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.event_get_all_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.event_get_all_with_http_info(**kwargs)  # noqa: E501
            return data

    def event_get_all_with_http_info(self, **kwargs):  # noqa: E501
        """Events Get  # noqa: E501

        https://api.gridscale.io/objects/events To retrieve the audit log of all the events.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.event_get_all_with_http_info(async_req=True)
        >>> result = thread.get()
