...
class ServerIpApi(object):
    ...
    def get_server_linked_ip(self, server_uuid, ip_uuid, **kwargs):  # noqa: E501
        """Server IP Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips/{ip_uuid} To retrieve detailed information about a specific IP linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_ip(server_uuid, ip_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the IP you are requesting. (required)
        :param str ip_uuid: The UUID of the IP Address you're requesting. (required)
        :return: LinkedIpGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_ip_with_http_info(server_uuid, ip_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_ip_with_http_info(server_uuid, ip_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_ip_with_http_info(self, server_uuid, ip_uuid, **kwargs):  # noqa: E501
        """Server IP Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips/{ip_uuid} To retrieve detailed information about a specific IP linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_ip_with_http_info(server_uuid, ip_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'ip_uuid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_server_linked_ip" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('server_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_ip`")  # noqa: E501
        # verify the required parameter 'ip_uuid' is set
        if ('ip_uuid' not in params or
                params['ip_uuid'] is None):
            raise ValueError("Missing the required parameter `ip_uuid` when calling `get_server_linked_ip`")  # noqa: E501
        ...
        if 'ip_uuid' in params:
            path_params['ip_uuid'] = params['ip_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/ips/{ip_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LinkedIpGetResponse',  # noqa: E501
    ...
    def get_server_linked_ips(self, server_uuid, **kwargs):  # noqa: E501
        """Server IPs Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips To retrieve detailed information about all the IPs linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_ips(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :return: LinkedIpsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_ips_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_ips_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_ips_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server IPs Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips To retrieve detailed information about all the IPs linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_ips_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_linked_ips" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_ips`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/ips', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LinkedIpsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def link_ip_to_server(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server IP Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips To link an IP to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_ip_to_server(server_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the Server. (required)
        :param LinkIp payload: IP uuid which going to be linked (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.link_ip_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.link_ip_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def link_ip_to_server_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server IP Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips To link an IP to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_ip_to_server_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method link_ip_to_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `link_ip_to_server`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `link_ip_to_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/ips', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unlink_ip_from_server(self, server_uuid, ip_uuid, **kwargs):  # noqa: E501
        """Server IP Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips/{ip_uuid} To unlink a specific IP from the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_ip_from_server(server_uuid, ip_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the Server. (required)
        :param str ip_uuid: ip uuid (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unlink_ip_from_server_with_http_info(server_uuid, ip_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.unlink_ip_from_server_with_http_info(server_uuid, ip_uuid, **kwargs)  # noqa: E501
            return data

    def unlink_ip_from_server_with_http_info(self, server_uuid, ip_uuid, **kwargs):  # noqa: E501
        """Server IP Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/ips/{ip_uuid} To unlink a specific IP from the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_ip_from_server_with_http_info(server_uuid, ip_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unlink_ip_from_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `unlink_ip_from_server`")  # noqa: E501
        # verify the required parameter 'ip_uuid' is set
        if ('ip_uuid' not in params or
                params['ip_uuid'] is None):
            raise ValueError("Missing the required parameter `ip_uuid` when calling `unlink_ip_from_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/ips/{ip_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
