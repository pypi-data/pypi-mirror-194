...
class MarketplaceApplicationApi(object):
    ...
    def create_marketplace_application(self, payload, **kwargs):  # noqa: E501
        """Marketplace Application Create/Import  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications To create a new application, or to import a self-created marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_marketplace_application(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object payload: Data for a new template (required)
        :return: MarketplaceApplicationCreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_marketplace_application_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_marketplace_application_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_marketplace_application_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Marketplace Application Create/Import  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications To create a new application, or to import a self-created marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_marketplace_application_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_marketplace_application" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_marketplace_application`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/applications', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='MarketplaceApplicationCreateResponse',  # noqa: E501
    ...
    def delete_marketplace_application(self, application_uuid, **kwargs):  # noqa: E501
        """Marketplace Application Delete  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid} To delete the specified marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_marketplace_application(application_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str application_uuid: object that need to be deleted. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_marketplace_application_with_http_info(application_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_marketplace_application_with_http_info(application_uuid, **kwargs)  # noqa: E501
            return data

    def delete_marketplace_application_with_http_info(self, application_uuid, **kwargs):  # noqa: E501
        """Marketplace Application Delete  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid} To delete the specified marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_marketplace_application_with_http_info(application_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_marketplace_application" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'application_uuid' is set
        if ('application_uuid' not in params or
                params['application_uuid'] is None):
            raise ValueError("Missing the required parameter `application_uuid` when calling `delete_marketplace_application`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'application_uuid' in params:
            path_params['application_uuid'] = params['application_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/applications/{application_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_marketplace_application(self, application_uuid, **kwargs):  # noqa: E501
        """Marketplace Application Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid} To retrieve detailed information about all marketplace applications.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_application(application_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str application_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :return: MarketplaceApplicationGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_marketplace_application_with_http_info(application_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_marketplace_application_with_http_info(application_uuid, **kwargs)  # noqa: E501
            return data

    def get_marketplace_application_with_http_info(self, application_uuid, **kwargs):  # noqa: E501
        """Marketplace Application Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid} To retrieve detailed information about all marketplace applications.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_application_with_http_info(application_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marketplace_application" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'application_uuid' is set
        if ('application_uuid' not in params or
                params['application_uuid'] is None):
            raise ValueError("Missing the required parameter `application_uuid` when calling `get_marketplace_application`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/applications/{application_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='MarketplaceApplicationGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_marketplace_application_events(self, application_uuid, **kwargs):  # noqa: E501
        """Marketplace Application Events  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid}/events To retrieve the event log of the specified marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_application_events(application_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str application_uuid: uuid of marketplace application (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_marketplace_application_events_with_http_info(application_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_marketplace_application_events_with_http_info(application_uuid, **kwargs)  # noqa: E501
            return data

    def get_marketplace_application_events_with_http_info(self, application_uuid, **kwargs):  # noqa: E501
        """Marketplace Application Events  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid}/events To retrieve the event log of the specified marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_application_events_with_http_info(application_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marketplace_application_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'application_uuid' is set
        if ('application_uuid' not in params or
                params['application_uuid'] is None):
            raise ValueError("Missing the required parameter `application_uuid` when calling `get_marketplace_application_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/applications/{application_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_marketplace_applications(self, **kwargs):  # noqa: E501
        """Marketplace Applications Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_applications(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: MarketplaceApplicationsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_marketplace_applications_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_marketplace_applications_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_marketplace_applications_with_http_info(self, **kwargs):  # noqa: E501
        """Marketplace Applications Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_applications_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marketplace_applications" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/objects/marketplace/applications', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='MarketplaceApplicationsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_marketplace_application(self, application_uuid, payload, **kwargs):  # noqa: E501
        """Marketplace Application Patch  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid} To update the attributes of the specified marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_marketplace_application(application_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str application_uuid: object that need to be updated.. (required)
        :param MarketplaceApplicationUpdate payload: Updated user object. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_marketplace_application_with_http_info(application_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_marketplace_application_with_http_info(application_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_marketplace_application_with_http_info(self, application_uuid, payload, **kwargs):  # noqa: E501
        """Marketplace Application Patch  # noqa: E501

        https://api.gridscale.io/objects/marketplace/applications/{application_uuid} To update the attributes of the specified marketplace application.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_marketplace_application_with_http_info(application_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['application_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_marketplace_application" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'application_uuid' is set
        if ('application_uuid' not in params or
                params['application_uuid'] is None):
            raise ValueError("Missing the required parameter `application_uuid` when calling `update_marketplace_application`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_marketplace_application`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/applications/{application_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
