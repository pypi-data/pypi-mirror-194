...
class StorageBackupScheduleApi(object):
    ...
    def create_storage_backup_schedule(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Storage Backup Schedule Post  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules To create a new backup schedule for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_storage_backup_schedule(storage_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: storage uuid for backup_schedule. (required)
        :param StorageBackupScheduleCreate payload: payload for creating storage backup schedule. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_storage_backup_schedule_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_storage_backup_schedule_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
            return data

    def create_storage_backup_schedule_with_http_info(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Storage Backup Schedule Post  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules To create a new backup schedule for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_storage_backup_schedule_with_http_info(storage_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_storage_backup_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('storage_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `storage_uuid` when calling `create_storage_backup_schedule`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `create_storage_backup_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backup_schedules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_storage_backup_schedule(self, storage_uuid, schedule_uuid, **kwargs):  # noqa: E501
        """Storage Backup Schedule Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid} To delete the specified backup schedule of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_storage_backup_schedule(storage_uuid, schedule_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be deleted. (required)
        :param str schedule_uuid: object that need to be deleted. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, **kwargs)  # noqa: E501
            return data

    def delete_storage_backup_schedule_with_http_info(self, storage_uuid, schedule_uuid, **kwargs):  # noqa: E501
        """Storage Backup Schedule Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid} To delete the specified backup schedule of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'schedule_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_storage_backup_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `delete_storage_backup_schedule`")  # noqa: E501
        # verify the required parameter 'schedule_uuid' is set
        if ('schedule_uuid' not in params or
                params['schedule_uuid'] is None):
            raise ValueError("Missing the required parameter `schedule_uuid` when calling `delete_storage_backup_schedule`")  # noqa: E501
        ...
        if 'storage_uuid' in params:
            path_params['storage_uuid'] = params['storage_uuid']  # noqa: E501
        if 'schedule_uuid' in params:
            path_params['schedule_uuid'] = params['schedule_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_backup_locations(self, **kwargs):  # noqa: E501
        """Backup Location Get  # noqa: E501

        https://api.gridscale.io/objects/backup_locations To retrieve all of available location to store your backup.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_backup_locations(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: BackupLocationsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_backup_locations_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_backup_locations_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_backup_locations_with_http_info(self, **kwargs):  # noqa: E501
        """Backup Location Get  # noqa: E501

        https://api.gridscale.io/objects/backup_locations To retrieve all of available location to store your backup.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_backup_locations_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_backup_locations" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='BackupLocationsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_storage_backup_schedule(self, storage_uuid, schedule_uuid, **kwargs):  # noqa: E501
        """Storage Backup Schedule Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid} To retrieve detailed information about the specified backup schedule for a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_backup_schedule(storage_uuid, schedule_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :param str schedule_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :return: StorageBackupScheduleGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, **kwargs)  # noqa: E501
            return data

    def get_storage_backup_schedule_with_http_info(self, storage_uuid, schedule_uuid, **kwargs):  # noqa: E501
        """Storage Backup Schedule Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid} To retrieve detailed information about the specified backup schedule for a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_storage_backup_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_storage_backup_schedule`")  # noqa: E501
        # verify the required parameter 'schedule_uuid' is set
        if ('schedule_uuid' not in params or
                params['schedule_uuid'] is None):
            raise ValueError("Missing the required parameter `schedule_uuid` when calling `get_storage_backup_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='StorageBackupScheduleGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_storage_backup_schedules(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Backup Schedules Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules To retrieve detailed information about all the backup schedules for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_backup_schedules(storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be get. (required)
        :return: StorageBackupSchedulesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_storage_backup_schedules_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_storage_backup_schedules_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_storage_backup_schedules_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Backup Schedules Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules To retrieve detailed information about all the backup schedules for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_backup_schedules_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_storage_backup_schedules" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_storage_backup_schedules`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backup_schedules', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='StorageBackupSchedulesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_storage_backup_schedule(self, storage_uuid, schedule_uuid, payload, **kwargs):  # noqa: E501
        """Storage Backup Schedule Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid} To update the attributes of the specified backup schedule of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_storage_backup_schedule(storage_uuid, schedule_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be updated. (required)
        :param str schedule_uuid: object that need to be updated. (required)
        :param StorageBackupScheduleUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_storage_backup_schedule_with_http_info(self, storage_uuid, schedule_uuid, payload, **kwargs):  # noqa: E501
        """Storage Backup Schedule Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid} To update the attributes of the specified backup schedule of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_storage_backup_schedule_with_http_info(storage_uuid, schedule_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'schedule_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_storage_backup_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `update_storage_backup_schedule`")  # noqa: E501
        # verify the required parameter 'schedule_uuid' is set
        if ('schedule_uuid' not in params or
                params['schedule_uuid'] is None):
            raise ValueError("Missing the required parameter `schedule_uuid` when calling `update_storage_backup_schedule`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_storage_backup_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backup_schedules/{schedule_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
