...
class LabelApi(object):
    ...
    def get_label(self, label, **kwargs):  # noqa: E501
        """Label Get  # noqa: E501

        https://api.gridscale.io/objects/labels/{label} To retrieve detailed information about the specified label.  # noqa: E501
        ...
        :param str label: get a label. (required)
        ...
        if kwargs.get('async_req'):
            return self.get_label_with_http_info(label, **kwargs)  # noqa: E501
        else:
            (data) = self.get_label_with_http_info(label, **kwargs)  # noqa: E501
            return data

    def get_label_with_http_info(self, label, **kwargs):  # noqa: E501
        """Label Get  # noqa: E501

        https://api.gridscale.io/objects/labels/{label} To retrieve detailed information about the specified label.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_label_with_http_info(label, async_req=True)
        >>> result = thread.get()
        ...
        if ('label' not in params or
            ...
            raise ValueError("Missing the required parameter `label` when calling `get_label`")  # noqa: E501
    ...
    def get_labels(self, **kwargs):  # noqa: E501
        """Labels Get  # noqa: E501

        https://api.gridscale.io/objects/labels To retrieve detailed information about all the labels.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
