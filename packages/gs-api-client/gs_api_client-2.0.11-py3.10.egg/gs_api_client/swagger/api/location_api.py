...
class LocationApi(object):
    ...
    def create_location(self, payload, **kwargs):  # noqa: E501
        """Location Post  # noqa: E501

        https://api.gridscale.io/objects/locations To add a new location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_location(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LocationCreate payload: Data for a new Location (required)
        ...
        if kwargs.get('async_req'):
            return self.create_location_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_location_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_location_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Location Post  # noqa: E501

        https://api.gridscale.io/objects/locations To add a new location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_location_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_location`")  # noqa: E501
    ...
    def delete_location(self, location_uuid, **kwargs):  # noqa: E501
        """Location Delete  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid} To delete a Location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_location(location_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str location_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_location_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_location_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def delete_location_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Delete  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid} To delete a Location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_location_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['location_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `delete_location`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'location_uuid' in params:
            path_params['location_uuid'] = params['location_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location(self, location_uuid, **kwargs):  # noqa: E501
        """Location Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid} To retrieve detailed information about the specified location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location(location_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str location_uuid: UUID of the Location (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid} To retrieve detailed information about the specified location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LocationGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_locations(self, **kwargs):  # noqa: E501
        """Locations Get  # noqa: E501

        https://api.gridscale.io/objects/locations To retrieve detailed information about all locations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_locations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LocationsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_location(self, location_uuid, payload, **kwargs):  # noqa: E501
        """Location Patch  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid} To update a Location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_location(location_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str location_uuid: object that need to be updated. (required)
        :param LocationUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_location_with_http_info(location_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_location_with_http_info(location_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_location_with_http_info(self, location_uuid, payload, **kwargs):  # noqa: E501
        """Location Patch  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid} To update a Location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_location_with_http_info(location_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['location_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `update_location`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_location`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
