...
class TemplateApi(object):
    ...
    def create_template(self, payload, **kwargs):  # noqa: E501
        """Template Post  # noqa: E501

        https://api.gridscale.io/objects/templates To create a new template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_template(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StorageTemplateCreate payload: Data for a new template (required)
        ...
        if kwargs.get('async_req'):
            return self.create_template_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_template_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_template_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Template Post  # noqa: E501

        https://api.gridscale.io/objects/templates To create a new template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_template_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_template`")  # noqa: E501
    ...
    def delete_template(self, template_uuid, **kwargs):  # noqa: E501
        """Template Delete  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid} To delete the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_template(template_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str template_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_template_with_http_info(template_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_template_with_http_info(template_uuid, **kwargs)  # noqa: E501
            return data

    def delete_template_with_http_info(self, template_uuid, **kwargs):  # noqa: E501
        """Template Delete  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid} To delete the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_template_with_http_info(template_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['template_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('template_uuid' not in params or
                params['template_uuid'] is None):
            raise ValueError("Missing the required parameter `template_uuid` when calling `delete_template`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'template_uuid' in params:
            path_params['template_uuid'] = params['template_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/templates/{template_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_template(self, template_uuid, **kwargs):  # noqa: E501
        """Template Get  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid} To retrieve detailed information about the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_template(template_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str template_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_template_with_http_info(template_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_template_with_http_info(template_uuid, **kwargs)  # noqa: E501
            return data

    def get_template_with_http_info(self, template_uuid, **kwargs):  # noqa: E501
        """Template Get  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid} To retrieve detailed information about the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_template_with_http_info(template_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('template_uuid' not in params or
                params['template_uuid'] is None):
            raise ValueError("Missing the required parameter `template_uuid` when calling `get_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/templates/{template_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_template_events(self, template_uuid, **kwargs):  # noqa: E501
        """Template Events  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid}/events To retrieve the event log of the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_template_events(template_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str template_uuid: uuid of storage (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_template_events_with_http_info(template_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_template_events_with_http_info(template_uuid, **kwargs)  # noqa: E501
            return data

    def get_template_events_with_http_info(self, template_uuid, **kwargs):  # noqa: E501
        """Template Events  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid}/events To retrieve the event log of the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_template_events_with_http_info(template_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_template_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'template_uuid' is set
        if ('template_uuid' not in params or
                params['template_uuid'] is None):
            raise ValueError("Missing the required parameter `template_uuid` when calling `get_template_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/templates/{template_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_templates(self, **kwargs):  # noqa: E501
        """Templates Get  # noqa: E501

        https://api.gridscale.io/objects/templates To retrieve detailed information about all templates.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :return: StorageTemplatesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_templates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='StorageTemplatesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_template(self, template_uuid, payload, **kwargs):  # noqa: E501
        """Template Patch  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid} To update the attributes of the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_template(template_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str template_uuid: object that need to be updated. (required)
        :param TemplateUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_template_with_http_info(template_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_template_with_http_info(template_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_template_with_http_info(self, template_uuid, payload, **kwargs):  # noqa: E501
        """Template Patch  # noqa: E501

        https://api.gridscale.io/objects/templates/{template_uuid} To update the attributes of the specified template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_template_with_http_info(template_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['template_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('template_uuid' not in params or
                params['template_uuid'] is None):
            raise ValueError("Missing the required parameter `template_uuid` when calling `update_template`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/templates/{template_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
