...
class LoadbalancerApi(object):
    ...
    def create_loadbalancer(self, payload, **kwargs):  # noqa: E501
        """Load Balancers Post  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers To create a new load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_loadbalancer(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LoadbalancerCreate payload: Request body for creating loadbalancer (required)
        ...
        if kwargs.get('async_req'):
            return self.create_loadbalancer_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_loadbalancer_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_loadbalancer_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Load Balancers Post  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers To create a new load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_loadbalancer_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_loadbalancer" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_loadbalancer`")  # noqa: E501
    ...
    def delete_loadbalancer(self, loadbalancer_uuid, **kwargs):  # noqa: E501
        """Load Balancer Delete  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers/{loadbalancer_uuid} To delete the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_loadbalancer(loadbalancer_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str loadbalancer_uuid: ID of paas (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_loadbalancer_with_http_info(loadbalancer_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_loadbalancer_with_http_info(loadbalancer_uuid, **kwargs)  # noqa: E501
            return data

    def delete_loadbalancer_with_http_info(self, loadbalancer_uuid, **kwargs):  # noqa: E501
        """Load Balancer Delete  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers/{loadbalancer_uuid} To delete the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_loadbalancer_with_http_info(loadbalancer_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['loadbalancer_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_loadbalancer" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'loadbalancer_uuid' is set
        if ('loadbalancer_uuid' not in params or
                params['loadbalancer_uuid'] is None):
            raise ValueError("Missing the required parameter `loadbalancer_uuid` when calling `delete_loadbalancer`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'loadbalancer_uuid' in params:
            path_params['loadbalancer_uuid'] = params['loadbalancer_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/loadbalancers/{loadbalancer_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_loadbalancer(self, loadbalancer_uuid, **kwargs):  # noqa: E501
        """Load Balancer Get  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers/{loadbalancer_uuid} To retrieve detailed information about the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_loadbalancer(loadbalancer_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_loadbalancer_with_http_info(loadbalancer_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_loadbalancer_with_http_info(loadbalancer_uuid, **kwargs)  # noqa: E501
            return data

    def get_loadbalancer_with_http_info(self, loadbalancer_uuid, **kwargs):  # noqa: E501
        """Load Balancer Get  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers/{loadbalancer_uuid} To retrieve detailed information about the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_loadbalancer_with_http_info(loadbalancer_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_loadbalancer" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'loadbalancer_uuid' is set
        if ('loadbalancer_uuid' not in params or
                params['loadbalancer_uuid'] is None):
            raise ValueError("Missing the required parameter `loadbalancer_uuid` when calling `get_loadbalancer`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/loadbalancers/{loadbalancer_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LoadbalancerGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_loadbalancer_events(self, loadbalancer_uuid, **kwargs):  # noqa: E501
        """Load Balancer Events  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers/{loadbalancer_uuids} To retrieve the event log of the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_loadbalancer_events(loadbalancer_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str loadbalancer_uuid: uuid of loadbalancer (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_loadbalancer_events_with_http_info(loadbalancer_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_loadbalancer_events_with_http_info(loadbalancer_uuid, **kwargs)  # noqa: E501
            return data

    def get_loadbalancer_events_with_http_info(self, loadbalancer_uuid, **kwargs):  # noqa: E501
        """Load Balancer Events  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers/{loadbalancer_uuids} To retrieve the event log of the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_loadbalancer_events_with_http_info(loadbalancer_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_loadbalancer_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'loadbalancer_uuid' is set
        if ('loadbalancer_uuid' not in params or
                params['loadbalancer_uuid'] is None):
            raise ValueError("Missing the required parameter `loadbalancer_uuid` when calling `get_loadbalancer_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/loadbalancers/{loadbalancer_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_loadbalancers(self, **kwargs):  # noqa: E501
        """Load Balancers Get  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers To retrieve detailed information about all load balancers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_loadbalancers(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: LoadbalancersGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_loadbalancers_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_loadbalancers_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_loadbalancers_with_http_info(self, **kwargs):  # noqa: E501
        """Load Balancers Get  # noqa: E501

        https://api.gridscale.io/objects/loadbalancers To retrieve detailed information about all load balancers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_loadbalancers_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_loadbalancers" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LoadbalancersGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_loadbalancer(self, loadbalancer_uuid, payload, **kwargs):  # noqa: E501
        """Load Balancer Patch  # noqa: E501

        https://api.gridscale.io/objects/loadbalancer/{loadbalancer_uuid} To update the attributes of the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_loadbalancer(loadbalancer_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str loadbalancer_uuid: object that need to be updated. (required)
        :param LoadbalancerUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_loadbalancer_with_http_info(loadbalancer_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_loadbalancer_with_http_info(loadbalancer_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_loadbalancer_with_http_info(self, loadbalancer_uuid, payload, **kwargs):  # noqa: E501
        """Load Balancer Patch  # noqa: E501

        https://api.gridscale.io/objects/loadbalancer/{loadbalancer_uuid} To update the attributes of the specified load balancer.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_loadbalancer_with_http_info(loadbalancer_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['loadbalancer_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_loadbalancer" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'loadbalancer_uuid' is set
        if ('loadbalancer_uuid' not in params or
                params['loadbalancer_uuid'] is None):
            raise ValueError("Missing the required parameter `loadbalancer_uuid` when calling `update_loadbalancer`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_loadbalancer`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/loadbalancers/{loadbalancer_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
