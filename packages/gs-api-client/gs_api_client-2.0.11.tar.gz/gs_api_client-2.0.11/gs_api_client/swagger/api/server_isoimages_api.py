...
class ServerIsoimagesApi(object):
    ...
    def get_server_linked_isoimage(self, server_uuid, isoimage_uuid, **kwargs):  # noqa: E501
        """Server ISO-Image Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages/{object_uuid} To retrieve detailed information about the specified ISO image linked to a server.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_isoimage(server_uuid, isoimage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the ISO Image you are requesting. (required)
        :param str isoimage_uuid: The UUID of the ISO-Image you're requesting. (required)
        :return: LinkedIsoimageGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_isoimage_with_http_info(server_uuid, isoimage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_isoimage_with_http_info(server_uuid, isoimage_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_isoimage_with_http_info(self, server_uuid, isoimage_uuid, **kwargs):  # noqa: E501
        """Server ISO-Image Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages/{object_uuid} To retrieve detailed information about the specified ISO image linked to a server.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_isoimage_with_http_info(server_uuid, isoimage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'isoimage_uuid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_server_linked_isoimage" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('server_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_isoimage`")  # noqa: E501
        # verify the required parameter 'isoimage_uuid' is set
        if ('isoimage_uuid' not in params or
                params['isoimage_uuid'] is None):
            raise ValueError("Missing the required parameter `isoimage_uuid` when calling `get_server_linked_isoimage`")  # noqa: E501
        ...
        if 'isoimage_uuid' in params:
            path_params['isoimage_uuid'] = params['isoimage_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/isoimages/{isoimage_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='LinkedIsoimageGetResponse',  # noqa: E501
    ...
    def get_server_linked_isoimages(self, server_uuid, **kwargs):  # noqa: E501
        """Server ISO-Images Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages To retrieve detailed information about all ISO images linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_isoimages(server_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: ID of server (required)
        :return: LinkedIsoimagesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_server_linked_isoimages_with_http_info(server_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_server_linked_isoimages_with_http_info(server_uuid, **kwargs)  # noqa: E501
            return data

    def get_server_linked_isoimages_with_http_info(self, server_uuid, **kwargs):  # noqa: E501
        """Server ISO-Images Get  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages To retrieve detailed information about all ISO images linked to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_server_linked_isoimages_with_http_info(server_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_linked_isoimages" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `get_server_linked_isoimages`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/isoimages', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='LinkedIsoimagesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def link_isoimage_to_server(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server ISO-Image Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages To link an ISO image to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_isoimage_to_server(server_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the Iso image you are requesting. (required)
        :param LinkIsoimage payload: ISO image UUID which is going to be linked. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.link_isoimage_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.link_isoimage_to_server_with_http_info(server_uuid, payload, **kwargs)  # noqa: E501
            return data

    def link_isoimage_to_server_with_http_info(self, server_uuid, payload, **kwargs):  # noqa: E501
        """Server ISO-Image Post  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages To link an ISO image to the specified server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_isoimage_to_server_with_http_info(server_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method link_isoimage_to_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `link_isoimage_to_server`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `link_isoimage_to_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/isoimages', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unlink_isoimage_from_server(self, server_uuid, isoimage_uuid, **kwargs):  # noqa: E501
        """Server ISO-Image Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages/{object_uuid} To unlink the specified ISO image from a server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_isoimage_from_server(server_uuid, isoimage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unlink_isoimage_from_server_with_http_info(server_uuid, isoimage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.unlink_isoimage_from_server_with_http_info(server_uuid, isoimage_uuid, **kwargs)  # noqa: E501
            return data

    def unlink_isoimage_from_server_with_http_info(self, server_uuid, isoimage_uuid, **kwargs):  # noqa: E501
        """Server ISO-Image Delete  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages/{object_uuid} To unlink the specified ISO image from a server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_isoimage_from_server_with_http_info(server_uuid, isoimage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unlink_isoimage_from_server" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `unlink_isoimage_from_server`")  # noqa: E501
        # verify the required parameter 'isoimage_uuid' is set
        if ('isoimage_uuid' not in params or
                params['isoimage_uuid'] is None):
            raise ValueError("Missing the required parameter `isoimage_uuid` when calling `unlink_isoimage_from_server`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/isoimages/{isoimage_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_server_linked_isoimage(self, server_uuid, isoimage_uuid, payload, **kwargs):  # noqa: E501
        """Server ISO-Image Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages/{object_uuid} To update the attributes of the specified ISO image linked to a server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_linked_isoimage(server_uuid, isoimage_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str server_uuid: The UUID of the server, that relates to the ISO Image you are requesting. (required)
        :param str isoimage_uuid: The UUID of the ISO-Image you're requesting. (required)
        :param LinkedIsoimageUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_server_linked_isoimage_with_http_info(server_uuid, isoimage_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_server_linked_isoimage_with_http_info(server_uuid, isoimage_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_server_linked_isoimage_with_http_info(self, server_uuid, isoimage_uuid, payload, **kwargs):  # noqa: E501
        """Server ISO-Image Patch  # noqa: E501

        https://api.gridscale.io/objects/servers/{server_uuid}/isoimages/{object_uuid} To update the attributes of the specified ISO image linked to a server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_server_linked_isoimage_with_http_info(server_uuid, isoimage_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['server_uuid', 'isoimage_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_server_linked_isoimage" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'server_uuid' is set
        if ('server_uuid' not in params or
                params['server_uuid'] is None):
            raise ValueError("Missing the required parameter `server_uuid` when calling `update_server_linked_isoimage`")  # noqa: E501
        # verify the required parameter 'isoimage_uuid' is set
        if ('isoimage_uuid' not in params or
                params['isoimage_uuid'] is None):
            raise ValueError("Missing the required parameter `isoimage_uuid` when calling `update_server_linked_isoimage`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_server_linked_isoimage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/servers/{server_uuid}/isoimages/{isoimage_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
