...
class CertificateApi(object):
    ...
    def create_certificate(self, payload, **kwargs):  # noqa: E501
        """Certificates Post  # noqa: E501

        https://api.gridscale.io/objects/certificates To create a new certificate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_certificate(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CertificateCreate payload: Request body for creating certificate. The certificate_chain should include the leaf_certificate as well. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_certificate_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_certificate_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_certificate_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Certificates Post  # noqa: E501

        https://api.gridscale.io/objects/certificates To create a new certificate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_certificate_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_certificate`")  # noqa: E501
    ...
    def delete_certificate(self, certificate_uuid, **kwargs):  # noqa: E501
        """Certificate Delete  # noqa: E501

        https://api.gridscale.io/objects/certificates/{certificate_uuid} To delete the specified certificate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_certificate(certificate_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str certificate_uuid: ID of the certificate (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_certificate_with_http_info(certificate_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_certificate_with_http_info(certificate_uuid, **kwargs)  # noqa: E501
            return data

    def delete_certificate_with_http_info(self, certificate_uuid, **kwargs):  # noqa: E501
        """Certificate Delete  # noqa: E501

        https://api.gridscale.io/objects/certificates/{certificate_uuid} To delete the specified certificate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_certificate_with_http_info(certificate_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['certificate_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('certificate_uuid' not in params or
                params['certificate_uuid'] is None):
            raise ValueError("Missing the required parameter `certificate_uuid` when calling `delete_certificate`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'certificate_uuid' in params:
            path_params['certificate_uuid'] = params['certificate_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/certificates/{certificate_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_certificate(self, certificate_uuid, **kwargs):  # noqa: E501
        """Certificate Get  # noqa: E501

        https://api.gridscale.io/objects/certificates/{certificate_uuid} To retrieve detailed information about the specified certificate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_certificate(certificate_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_certificate_with_http_info(certificate_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_certificate_with_http_info(certificate_uuid, **kwargs)  # noqa: E501
            return data

    def get_certificate_with_http_info(self, certificate_uuid, **kwargs):  # noqa: E501
        """Certificate Get  # noqa: E501

        https://api.gridscale.io/objects/certificates/{certificate_uuid} To retrieve detailed information about the specified certificate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_certificate_with_http_info(certificate_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('certificate_uuid' not in params or
                params['certificate_uuid'] is None):
            raise ValueError("Missing the required parameter `certificate_uuid` when calling `get_certificate`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/certificates/{certificate_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='CertificateGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_certificates(self, **kwargs):  # noqa: E501
        """Certificates Get  # noqa: E501

        https://api.gridscale.io/objects/certificates To retrieve detailed information about all certificates.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :return: CertificatesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_certificates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CertificatesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
