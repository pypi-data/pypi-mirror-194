...
class StorageBackupsApi(object):
    ...
    def delete_storage_backup(self, storage_uuid, backup_uuid, **kwargs):  # noqa: E501
        """Storage Backup Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backups/{backup_uuid} To delete the specified backup of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_storage_backup(storage_uuid, backup_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: Storage (required)
        :param str backup_uuid: object that need to be deleted (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.delete_storage_backup_with_http_info(storage_uuid, backup_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_storage_backup_with_http_info(storage_uuid, backup_uuid, **kwargs)  # noqa: E501
            return data

    def delete_storage_backup_with_http_info(self, storage_uuid, backup_uuid, **kwargs):  # noqa: E501
        """Storage Backup Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backups/{backup_uuid} To delete the specified backup of a particular storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_storage_backup_with_http_info(storage_uuid, backup_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'backup_uuid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_storage_backup" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('storage_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `storage_uuid` when calling `delete_storage_backup`")  # noqa: E501
        # verify the required parameter 'backup_uuid' is set
        if ('backup_uuid' not in params or
                params['backup_uuid'] is None):
            raise ValueError("Missing the required parameter `backup_uuid` when calling `delete_storage_backup`")  # noqa: E501
        ...
        if 'backup_uuid' in params:
            path_params['backup_uuid'] = params['backup_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backups/{backup_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_storage_backups(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Backups Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backups To retrieve detailed information about every backup for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_backups(storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be display (required)
        :return: StorageBackupsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_storage_backups_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_storage_backups_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_storage_backups_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Backups Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backups To retrieve detailed information about every backup for the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_backups_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_storage_backups" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_storage_backups`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backups', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='StorageBackupsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def rollback_storage_backup(self, storage_uuid, backup_uuid, payload, **kwargs):  # noqa: E501
        """Storage Backup Rollback  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backups/{backup_uuid}/rollback To roll a storage back to the backup.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rollback_storage_backup(storage_uuid, backup_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: Storage (required)
        :param str backup_uuid: Backup that needs to be rolled back (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rollback_storage_backup_with_http_info(storage_uuid, backup_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.rollback_storage_backup_with_http_info(storage_uuid, backup_uuid, payload, **kwargs)  # noqa: E501
            return data

    def rollback_storage_backup_with_http_info(self, storage_uuid, backup_uuid, payload, **kwargs):  # noqa: E501
        """Storage Backup Rollback  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/backups/{backup_uuid}/rollback To roll a storage back to the backup.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rollback_storage_backup_with_http_info(storage_uuid, backup_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_uuid', 'backup_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rollback_storage_backup" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `rollback_storage_backup`")  # noqa: E501
        # verify the required parameter 'backup_uuid' is set
        if ('backup_uuid' not in params or
                params['backup_uuid'] is None):
            raise ValueError("Missing the required parameter `backup_uuid` when calling `rollback_storage_backup`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `rollback_storage_backup`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/backups/{backup_uuid}/rollback', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
