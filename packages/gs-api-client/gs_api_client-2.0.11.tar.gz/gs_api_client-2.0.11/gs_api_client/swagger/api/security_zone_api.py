...
class SecurityZoneApi(object):
    ...
    def delete_paas_security_zone(self, paas_security_zone_uuid, **kwargs):  # noqa: E501
        """Security Zone Delete  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones/{paas_security_zone_uuid} To delete the specified security zone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_paas_security_zone(paas_security_zone_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str paas_security_zone_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_paas_security_zone_with_http_info(paas_security_zone_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_paas_security_zone_with_http_info(paas_security_zone_uuid, **kwargs)  # noqa: E501
            return data

    def delete_paas_security_zone_with_http_info(self, paas_security_zone_uuid, **kwargs):  # noqa: E501
        """Security Zone Delete  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones/{paas_security_zone_uuid} To delete the specified security zone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_paas_security_zone_with_http_info(paas_security_zone_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['paas_security_zone_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_paas_security_zone" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'paas_security_zone_uuid' is set
        if ('paas_security_zone_uuid' not in params or
                params['paas_security_zone_uuid'] is None):
            raise ValueError("Missing the required parameter `paas_security_zone_uuid` when calling `delete_paas_security_zone`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'paas_security_zone_uuid' in params:
            path_params['paas_security_zone_uuid'] = params['paas_security_zone_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/paas/security_zones/{paas_security_zone_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_paas_security_zone(self, paas_security_zone_uuid, **kwargs):  # noqa: E501
        """Security Zone Get  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones/{paas_security_zone_uuid} To retrieve detailed information about the specified security zone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_paas_security_zone(paas_security_zone_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str paas_security_zone_uuid: ID of paas (required)
        :return: PaasSecurityZoneGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_paas_security_zone_with_http_info(paas_security_zone_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_paas_security_zone_with_http_info(paas_security_zone_uuid, **kwargs)  # noqa: E501
            return data

    def get_paas_security_zone_with_http_info(self, paas_security_zone_uuid, **kwargs):  # noqa: E501
        """Security Zone Get  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones/{paas_security_zone_uuid} To retrieve detailed information about the specified security zone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_paas_security_zone_with_http_info(paas_security_zone_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_paas_security_zone" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'paas_security_zone_uuid' is set
        if ('paas_security_zone_uuid' not in params or
                params['paas_security_zone_uuid'] is None):
            raise ValueError("Missing the required parameter `paas_security_zone_uuid` when calling `get_paas_security_zone`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/paas/security_zones/{paas_security_zone_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaasSecurityZoneGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_paas_security_zones(self, **kwargs):  # noqa: E501
        """Security Zones Get  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones To retrieve detailed information about all security zones.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_paas_security_zones(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: PaasSecurityZonesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_paas_security_zones_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_paas_security_zones_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_paas_security_zones_with_http_info(self, **kwargs):  # noqa: E501
        """Security Zones Get  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones To retrieve detailed information about all security zones.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_paas_security_zones_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_paas_security_zones" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/objects/paas/security_zones', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PaasSecurityZonesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_paas_security_zone(self, paas_security_zone_uuid, payload, **kwargs):  # noqa: E501
        ...
        https://api.gridscale.io/objects/paas/security_zones/{paas_security_zone_uuid} To update the attributes of the specified security zone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_paas_security_zone(paas_security_zone_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str paas_security_zone_uuid: Object that need to be updated. (required)
        :param PaasSecurityZoneUpdate payload: Updated PaaS (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_paas_security_zone_with_http_info(paas_security_zone_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_paas_security_zone_with_http_info(paas_security_zone_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_paas_security_zone_with_http_info(self, paas_security_zone_uuid, payload, **kwargs):  # noqa: E501
        """Security Zone Patch  # noqa: E501

        https://api.gridscale.io/objects/paas/security_zones/{paas_security_zone_uuid} To update the attributes of the specified security zone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_paas_security_zone_with_http_info(paas_security_zone_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['paas_security_zone_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_paas_security_zone" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'paas_security_zone_uuid' is set
        if ('paas_security_zone_uuid' not in params or
                params['paas_security_zone_uuid'] is None):
            raise ValueError("Missing the required parameter `paas_security_zone_uuid` when calling `update_paas_security_zone`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_paas_security_zone`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/paas/security_zones/{paas_security_zone_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
