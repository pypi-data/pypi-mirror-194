...
class IsoImageApi(object):
    ...
    def create_isoimage(self, payload, **kwargs):  # noqa: E501
        """ISO Image Post  # noqa: E501

        https://api.gridscale.io/objects/isoimages To create a new ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_isoimage(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param IsoimageCreate payload: Data for a new isoimage (required)
        ...
        if kwargs.get('async_req'):
            return self.create_isoimage_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_isoimage_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_isoimage_with_http_info(self, payload, **kwargs):  # noqa: E501
        """ISO Image Post  # noqa: E501

        https://api.gridscale.io/objects/isoimages To create a new ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_isoimage_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_isoimage`")  # noqa: E501
    ...
    def delete_isoimage(self, iso_image_uuid, **kwargs):  # noqa: E501
        """ISO Image Delete  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid} To delete the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_isoimage(iso_image_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str iso_image_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_isoimage_with_http_info(iso_image_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_isoimage_with_http_info(iso_image_uuid, **kwargs)  # noqa: E501
            return data

    def delete_isoimage_with_http_info(self, iso_image_uuid, **kwargs):  # noqa: E501
        """ISO Image Delete  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid} To delete the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_isoimage_with_http_info(iso_image_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['iso_image_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_isoimage" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'iso_image_uuid' is set
        if ('iso_image_uuid' not in params or
                params['iso_image_uuid'] is None):
            raise ValueError("Missing the required parameter `iso_image_uuid` when calling `delete_isoimage`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'iso_image_uuid' in params:
            path_params['iso_image_uuid'] = params['iso_image_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/isoimages/{iso_image_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_isoimage(self, iso_image_uuid, **kwargs):  # noqa: E501
        """ISO Image Get  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid} To retrieve detailed information about the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_isoimage(iso_image_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str iso_image_uuid: ID of isoimage (required)
        :return: IsoimageGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_isoimage_with_http_info(iso_image_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_isoimage_with_http_info(iso_image_uuid, **kwargs)  # noqa: E501
            return data

    def get_isoimage_with_http_info(self, iso_image_uuid, **kwargs):  # noqa: E501
        """ISO Image Get  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid} To retrieve detailed information about the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_isoimage_with_http_info(iso_image_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('iso_image_uuid' not in params or
                params['iso_image_uuid'] is None):
            raise ValueError("Missing the required parameter `iso_image_uuid` when calling `get_isoimage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/isoimages/{iso_image_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='IsoimageGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_isoimage_events(self, iso_image_uuid, **kwargs):  # noqa: E501
        """ISO Image Events  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid}/events To retrieve the event log of the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_isoimage_events(iso_image_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str iso_image_uuid: uuid of Isoimage (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_isoimage_events_with_http_info(iso_image_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_isoimage_events_with_http_info(iso_image_uuid, **kwargs)  # noqa: E501
            return data

    def get_isoimage_events_with_http_info(self, iso_image_uuid, **kwargs):  # noqa: E501
        """ISO Image Events  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid}/events To retrieve the event log of the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_isoimage_events_with_http_info(iso_image_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_isoimage_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'iso_image_uuid' is set
        if ('iso_image_uuid' not in params or
                params['iso_image_uuid'] is None):
            raise ValueError("Missing the required parameter `iso_image_uuid` when calling `get_isoimage_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/isoimages/{iso_image_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_isoimages(self, **kwargs):  # noqa: E501
        """ISO Images Get  # noqa: E501

        https://api.gridscale.io/objects/isoimages To retrieve detailed information about all ISO images.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_isoimages(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: IsoimagesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_isoimages_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_isoimages_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_isoimages_with_http_info(self, **kwargs):  # noqa: E501
        """ISO Images Get  # noqa: E501

        https://api.gridscale.io/objects/isoimages To retrieve detailed information about all ISO images.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_isoimages_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='IsoimagesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_isoimage(self, iso_image_uuid, payload, **kwargs):  # noqa: E501
        """ISO Image Patch  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid} To update the attributes of the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_isoimage(iso_image_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str iso_image_uuid: object that need to be updated. (required)
        :param IsoimageUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_isoimage_with_http_info(iso_image_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_isoimage_with_http_info(iso_image_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_isoimage_with_http_info(self, iso_image_uuid, payload, **kwargs):  # noqa: E501
        """ISO Image Patch  # noqa: E501

        https://api.gridscale.io/objects/isoimages/{iso_image_uuid} To update the attributes of the specified ISO image.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_isoimage_with_http_info(iso_image_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['iso_image_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('iso_image_uuid' not in params or
                params['iso_image_uuid'] is None):
            raise ValueError("Missing the required parameter `iso_image_uuid` when calling `update_isoimage`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_isoimage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/isoimages/{iso_image_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
