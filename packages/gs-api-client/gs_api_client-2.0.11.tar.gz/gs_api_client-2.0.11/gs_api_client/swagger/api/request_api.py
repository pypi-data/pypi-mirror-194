...
class RequestApi(object):
    ...
    def get_request(self, request_uuid, **kwargs):  # noqa: E501
        """Request Get  # noqa: E501

        https://api.gridscale.io/requests/{request_uuid} To poll our provisioning system to find out what provisioning state a resource is currently in.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_request(request_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str request_uuid: UUID of the request. (required)
        ...
        if kwargs.get('async_req'):
            return self.get_request_with_http_info(request_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_request_with_http_info(request_uuid, **kwargs)  # noqa: E501
            return data

    def get_request_with_http_info(self, request_uuid, **kwargs):  # noqa: E501
        """Request Get  # noqa: E501

        https://api.gridscale.io/requests/{request_uuid} To poll our provisioning system to find out what provisioning state a resource is currently in.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_request_with_http_info(request_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['request_uuid']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'request_uuid' is set
        if ('request_uuid' not in params or
                params['request_uuid'] is None):
            raise ValueError("Missing the required parameter `request_uuid` when calling `get_request`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'request_uuid' in params:
            path_params['request_uuid'] = params['request_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='RequestGetResponse',  # noqa: E501
