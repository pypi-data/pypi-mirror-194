...
class SSHKeyApi(object):
    ...
    def create_ssh_key(self, payload, **kwargs):  # noqa: E501
        """SSH Key Post  # noqa: E501

        https://api.gridscale.io/objects/sshkeys To add a new SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ssh_key(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SshkeyCreate payload: Data for a new SSHkey (required)
        ...
        if kwargs.get('async_req'):
            return self.create_ssh_key_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_ssh_key_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_ssh_key_with_http_info(self, payload, **kwargs):  # noqa: E501
        """SSH Key Post  # noqa: E501

        https://api.gridscale.io/objects/sshkeys To add a new SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ssh_key_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_ssh_key`")  # noqa: E501
    ...
    def delete_ssh_key(self, ssh_key_uuid, **kwargs):  # noqa: E501
        """SSH Key Delete  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To delete the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_ssh_key(ssh_key_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ssh_key_uuid: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_ssh_key_with_http_info(ssh_key_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_ssh_key_with_http_info(ssh_key_uuid, **kwargs)  # noqa: E501
            return data

    def delete_ssh_key_with_http_info(self, ssh_key_uuid, **kwargs):  # noqa: E501
        """SSH Key Delete  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To delete the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_ssh_key_with_http_info(ssh_key_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ssh_key_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('ssh_key_uuid' not in params or
                params['ssh_key_uuid'] is None):
            raise ValueError("Missing the required parameter `ssh_key_uuid` when calling `delete_ssh_key`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'ssh_key_uuid' in params:
            path_params['ssh_key_uuid'] = params['ssh_key_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/sshkeys/{ssh_key_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_ssh_key(self, ssh_key_uuid, **kwargs):  # noqa: E501
        """SSH Key Get  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To retrieve detailed information about the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_key(ssh_key_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ssh_key_uuid: ID of sshkey (required)
        :return: SshkeyGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_ssh_key_with_http_info(ssh_key_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_ssh_key_with_http_info(ssh_key_uuid, **kwargs)  # noqa: E501
            return data

    def get_ssh_key_with_http_info(self, ssh_key_uuid, **kwargs):  # noqa: E501
        """SSH Key Get  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To retrieve detailed information about the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_key_with_http_info(ssh_key_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('ssh_key_uuid' not in params or
                params['ssh_key_uuid'] is None):
            raise ValueError("Missing the required parameter `ssh_key_uuid` when calling `get_ssh_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/sshkeys/{ssh_key_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SshkeyGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_ssh_key_events(self, ssh_key_uuid, **kwargs):  # noqa: E501
        """SSH Key Events  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To retrieve the event log of the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_key_events(ssh_key_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ssh_key_uuid: uuid of sshkey (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_ssh_key_events_with_http_info(ssh_key_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_ssh_key_events_with_http_info(ssh_key_uuid, **kwargs)  # noqa: E501
            return data

    def get_ssh_key_events_with_http_info(self, ssh_key_uuid, **kwargs):  # noqa: E501
        """SSH Key Events  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To retrieve the event log of the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_key_events_with_http_info(ssh_key_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_ssh_key_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'ssh_key_uuid' is set
        if ('ssh_key_uuid' not in params or
                params['ssh_key_uuid'] is None):
            raise ValueError("Missing the required parameter `ssh_key_uuid` when calling `get_ssh_key_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/sshkeys/{ssh_key_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_ssh_keys(self, **kwargs):  # noqa: E501
        """SSH Keys Get  # noqa: E501

        https://api.gridscale.io/objects/sshkeys To retrieve detailed information about all SSH keys.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :return: SshkeysGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_ssh_keys_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_ssh_keys_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_ssh_keys_with_http_info(self, **kwargs):  # noqa: E501
        """SSH Keys Get  # noqa: E501

        https://api.gridscale.io/objects/sshkeys To retrieve detailed information about all SSH keys.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_keys_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SshkeysGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_ssh_key(self, ssh_key_uuid, payload, **kwargs):  # noqa: E501
        """SSH Key Patch  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To update the attributes of the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ssh_key(ssh_key_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ssh_key_uuid: object that need to be updated. (required)
        :param SshkeyUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_ssh_key_with_http_info(ssh_key_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_ssh_key_with_http_info(ssh_key_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_ssh_key_with_http_info(self, ssh_key_uuid, payload, **kwargs):  # noqa: E501
        """SSH Key Patch  # noqa: E501

        https://api.gridscale.io/objects/sshkeys/{ssh_key_uuid} To update the attributes of the specified SSH key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ssh_key_with_http_info(ssh_key_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ssh_key_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('ssh_key_uuid' not in params or
                params['ssh_key_uuid'] is None):
            raise ValueError("Missing the required parameter `ssh_key_uuid` when calling `update_ssh_key`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_ssh_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/sshkeys/{ssh_key_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
