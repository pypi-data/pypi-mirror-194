...
class ObjectStorageApi(object):
    ...
    def create_access_key(self, payload, **kwargs):  # noqa: E501
        """Access Key Create  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys To create a new access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_access_key(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AccessKeyCreate payload: Data for a new access key (required)
        ...
        if kwargs.get('async_req'):
            return self.create_access_key_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_access_key_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_access_key_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Access Key Create  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys To create a new access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_access_key_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_access_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/objectstorages/access_keys', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='AccessKeyCreateResponse',  # noqa: E501
    ...
    def delete_access_key(self, accesskey, **kwargs):  # noqa: E501
        """Access Key Delete  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys/{accesskey} To delete the specified access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_access_key(accesskey, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str accesskey: object that need to be deleted (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_access_key_with_http_info(accesskey, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_access_key_with_http_info(accesskey, **kwargs)  # noqa: E501
            return data

    def delete_access_key_with_http_info(self, accesskey, **kwargs):  # noqa: E501
        """Access Key Delete  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys/{accesskey} To delete the specified access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_access_key_with_http_info(accesskey, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['accesskey']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('accesskey' not in params or
                params['accesskey'] is None):
            raise ValueError("Missing the required parameter `accesskey` when calling `delete_access_key`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'accesskey' in params:
            path_params['accesskey'] = params['accesskey']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/objectstorages/access_keys/{accesskey}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_access_key(self, accesskey, **kwargs):  # noqa: E501
        """Access Key Get  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys/{accesskey} To retrieve the specified access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_access_key(accesskey, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str accesskey: Your access key (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_access_key_with_http_info(accesskey, **kwargs)  # noqa: E501
        else:
            (data) = self.get_access_key_with_http_info(accesskey, **kwargs)  # noqa: E501
            return data

    def get_access_key_with_http_info(self, accesskey, **kwargs):  # noqa: E501
        """Access Key Get  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys/{accesskey} To retrieve the specified access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_access_key_with_http_info(accesskey, async_req=True)
        >>> result = thread.get()
        ...
        if ('accesskey' not in params or
                params['accesskey'] is None):
            raise ValueError("Missing the required parameter `accesskey` when calling `get_access_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/objectstorages/access_keys/{accesskey}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AccessKeyGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_access_keys(self, **kwargs):  # noqa: E501
        """Access Keys Get  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys To retrieve all access keys.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_access_keys(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: AccessKeysGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_access_keys_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_access_keys_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_access_keys_with_http_info(self, **kwargs):  # noqa: E501
        """Access Keys Get  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys To retrieve all access keys.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_access_keys_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/objects/objectstorages/access_keys', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AccessKeysGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_buckets(self, **kwargs):  # noqa: E501
        """Buckets Get  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/buckets To retrieve buckets.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_buckets_with_http_info(self, **kwargs):  # noqa: E501
        """Buckets Get  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/objectstorages/buckets', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='BucketsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_access_key(self, accesskey, payload, **kwargs):  # noqa: E501
        """Access Key Update  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys/{accesskey} To update a comment in the specified access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_access_key(accesskey, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str accesskey: Your access key (required)
        :param AccessKeyUpdate payload: Updated access key comment (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_access_key_with_http_info(accesskey, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_access_key_with_http_info(accesskey, payload, **kwargs)  # noqa: E501
            return data

    def update_access_key_with_http_info(self, accesskey, payload, **kwargs):  # noqa: E501
        """Access Key Update  # noqa: E501

        https://api.gridscale.io/objects/objectstorages/access_keys/{accesskey} To update a comment in the specified access key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_access_key_with_http_info(accesskey, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['accesskey', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('accesskey' not in params or
                params['accesskey'] is None):
            raise ValueError("Missing the required parameter `accesskey` when calling `update_access_key`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_access_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/objectstorages/access_keys/{accesskey}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
