...
class StorageApi(object):
    ...
    def create_storage(self, payload, **kwargs):  # noqa: E501
        """Storage Post  # noqa: E501

        https://api.gridscale.io/objects/storages To create a new storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_storage(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StorageCreate payload: Request body for creating storage (required)
        ...
        if kwargs.get('async_req'):
            return self.create_storage_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_storage_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_storage_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Storage Post  # noqa: E501

        https://api.gridscale.io/objects/storages To create a new storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_storage_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_storage`")  # noqa: E501
    ...
    def delete_storage(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid} To delete the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_storage(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_storage_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_storage_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def delete_storage_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Delete  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid} To delete the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_storage_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
            ...
            raise ValueError("Missing the required parameter `storage_uuid` when calling `delete_storage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_storage(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid} To retrieve detailed information about the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_storage_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_storage_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_storage_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Get  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid} To retrieve detailed information about the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_storage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='StorageGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_storage_events(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Events  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/events To retrieve the event log of the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_events(storage_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: uuid of storage (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_storage_events_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_storage_events_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def get_storage_events_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Events  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/events To retrieve the event log of the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_storage_events_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_storage_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storage_uuid' is set
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `get_storage_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_storages(self, **kwargs):  # noqa: E501
        """Storages Get  # noqa: E501

        https://api.gridscale.io/objects/storages To retrieve detailed information about all the storages.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_storages_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='StoragesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def storage_clone(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Clone  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/clone To clone the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_clone(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.storage_clone_with_http_info(storage_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.storage_clone_with_http_info(storage_uuid, **kwargs)  # noqa: E501
            return data

    def storage_clone_with_http_info(self, storage_uuid, **kwargs):  # noqa: E501
        """Storage Clone  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid}/clone To clone the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_clone_with_http_info(storage_uuid, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `storage_clone`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}/clone', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def storage_import(self, payload, **kwargs):  # noqa: E501
        """Storage Create/Import  # noqa: E501

        https://api.gridscale.io/objects/storages/import To create new storage from backup, object or from another source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_import(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StorageImportFromBackup payload: Create new storage by import backup or from source (required)
        :return: CreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.storage_import_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.storage_import_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def storage_import_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Storage Create/Import  # noqa: E501

        https://api.gridscale.io/objects/storages/import To create new storage from backup, object or from another source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.storage_import_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `storage_import`")  # noqa: E501
    ...
    def update_storage(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Storage Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid} To update the attributes of the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_storage(storage_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str storage_uuid: object that need to be updated. (required)
        :param StorageUpdate payload: Updated user object (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_storage_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_storage_with_http_info(storage_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_storage_with_http_info(self, storage_uuid, payload, **kwargs):  # noqa: E501
        """Storage Patch  # noqa: E501

        https://api.gridscale.io/objects/storages/{storage_uuid} To update the attributes of the specified storage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_storage_with_http_info(storage_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        if ('storage_uuid' not in params or
                params['storage_uuid'] is None):
            raise ValueError("Missing the required parameter `storage_uuid` when calling `update_storage`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_storage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/storages/{storage_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
