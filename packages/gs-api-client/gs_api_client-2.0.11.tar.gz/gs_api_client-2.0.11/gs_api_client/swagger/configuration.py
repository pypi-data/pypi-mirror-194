...
class Configuration(object):
    ...
    def __init__(self):
        ...
        # Default Base url
        self.host = "https://api.gridscale.io"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("gs_api_client.swagger")
            ...
            'ServiceToken':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-Auth-ServiceToken',
                    'value': self.get_api_key_with_prefix('X-Auth-ServiceToken')
                },
            'User_UUID':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-Auth-UserId',
                    'value': self.get_api_key_with_prefix('X-Auth-UserId')
                },
