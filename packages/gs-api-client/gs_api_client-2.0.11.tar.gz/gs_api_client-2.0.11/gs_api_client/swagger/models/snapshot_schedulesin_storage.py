...
from gs_api_client.swagger.models.snapshot_schedulesin_storage_inner import SnapshotSchedulesinStorageInner  # noqa: F401,E501


class SnapshotSchedulesinStorage(object):
    ...
    def __init__(self):  # noqa: E501
        """SnapshotSchedulesinStorage - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotSchedulesinStorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotSchedulesinStorage):
            return False
