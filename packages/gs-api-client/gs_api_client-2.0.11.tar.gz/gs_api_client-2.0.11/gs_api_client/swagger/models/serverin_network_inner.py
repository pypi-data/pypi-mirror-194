...
class ServerinNetworkInner(object):
    ...
    def __init__(self, bootdevice=None, create_time=None, l3security=None, mac=None, network_uuid=None, object_name=None, object_uuid=None, ordering=None):  # noqa: E501
        """ServerinNetworkInner - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def bootdevice(self):
        """Gets the bootdevice of this ServerinNetworkInner.  # noqa: E501

        Whether the server boots from this iso image or not.  # noqa: E501

        :return: The bootdevice of this ServerinNetworkInner.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootdevice(self, bootdevice):
        """Sets the bootdevice of this ServerinNetworkInner.

        Whether the server boots from this iso image or not.  # noqa: E501

        :param bootdevice: The bootdevice of this ServerinNetworkInner.  # noqa: E501
        :type: bool
        """
    ...
    def create_time(self):
        """Gets the create_time of this ServerinNetworkInner.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this ServerinNetworkInner.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this ServerinNetworkInner.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this ServerinNetworkInner.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def l3security(self):
        """Gets the l3security of this ServerinNetworkInner.  # noqa: E501
        ...
        :return: The l3security of this ServerinNetworkInner.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def l3security(self, l3security):
        """Sets the l3security of this ServerinNetworkInner.

        Defines information about IP prefix spoof protection (it allows source traffic only from the IPv4/IPv4 network prefixes). If empty, it allow no IPv4/IPv6 source traffic. If set to null, l3security is disabled (default).  # noqa: E501

        :param l3security: The l3security of this ServerinNetworkInner.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def mac(self):
        """Gets the mac of this ServerinNetworkInner.  # noqa: E501

        network_mac defines the MAC address of the network interface.  # noqa: E501

        :return: The mac of this ServerinNetworkInner.  # noqa: E501
        :rtype: str
        """
        return self._mac
    ...
    @mac.setter
    def mac(self, mac):
        """Sets the mac of this ServerinNetworkInner.

        network_mac defines the MAC address of the network interface.  # noqa: E501

        :param mac: The mac of this ServerinNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    def network_uuid(self):
        """Gets the network_uuid of this ServerinNetworkInner.  # noqa: E501

        The UUID of the network you're requesting.  # noqa: E501

        :return: The network_uuid of this ServerinNetworkInner.  # noqa: E501
        :rtype: str
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this ServerinNetworkInner.

        The UUID of the network you're requesting.  # noqa: E501

        :param network_uuid: The network_uuid of this ServerinNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    def object_name(self):
        """Gets the object_name of this ServerinNetworkInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The object_name of this ServerinNetworkInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this ServerinNetworkInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this ServerinNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this ServerinNetworkInner.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this ServerinNetworkInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this ServerinNetworkInner.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this ServerinNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ordering(self):
        """Gets the ordering of this ServerinNetworkInner.  # noqa: E501

        The ordering of the network interfaces. Lower numbers have lower PCI-IDs.  # noqa: E501

        :return: The ordering of this ServerinNetworkInner.  # noqa: E501
        :rtype: int
        """
    ...
    def ordering(self, ordering):
        """Sets the ordering of this ServerinNetworkInner.

        The ordering of the network interfaces. Lower numbers have lower PCI-IDs.  # noqa: E501

        :param ordering: The ordering of this ServerinNetworkInner.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerinNetworkInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerinNetworkInner):
            return False
