...
from gs_api_client.swagger.models.pinned_server import PinnedServer  # noqa: F401,E501


class NetworkPinnedServersResponse(object):
    ...
    """
    swagger_types = {
        'pinned_servers': 'list[PinnedServer]'
    }
    ...
    def __init__(self, pinned_servers=None):  # noqa: E501
        """NetworkPinnedServersResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def pinned_servers(self):
        """Gets the pinned_servers of this NetworkPinnedServersResponse.  # noqa: E501

        List of server and it's assigned DHCP IP  # noqa: E501

        :return: The pinned_servers of this NetworkPinnedServersResponse.  # noqa: E501
        :rtype: list[PinnedServer]
        """
        return self._pinned_servers

    @pinned_servers.setter
    def pinned_servers(self, pinned_servers):
        """Sets the pinned_servers of this NetworkPinnedServersResponse.

        List of server and it's assigned DHCP IP  # noqa: E501

        :param pinned_servers: The pinned_servers of this NetworkPinnedServersResponse.  # noqa: E501
        :type: list[PinnedServer]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworkPinnedServersResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkPinnedServersResponse):
            return False
