...
from gs_api_client.swagger.models.usage_per_interval_inner import UsagePerIntervalInner  # noqa: F401,E501


class UsagePerInterval(object):
    ...
    def __init__(self):  # noqa: E501
        """UsagePerInterval - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UsagePerInterval, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UsagePerInterval):
            return False
