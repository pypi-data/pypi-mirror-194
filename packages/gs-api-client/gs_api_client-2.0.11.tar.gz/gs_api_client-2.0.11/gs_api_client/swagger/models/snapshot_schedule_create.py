...
class SnapshotScheduleCreate(object):
    ...
    def __init__(self, name=None, labels=None, run_interval=None, keep_snapshots=None, next_runtime=None):  # noqa: E501
        """SnapshotScheduleCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SnapshotScheduleCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this SnapshotScheduleCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this SnapshotScheduleCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this SnapshotScheduleCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this SnapshotScheduleCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this SnapshotScheduleCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def run_interval(self):
        """Gets the run_interval of this SnapshotScheduleCreate.  # noqa: E501

        The interval at which the schedule will run (in seconds).run_interval has to be 60 or a multiple of 60  # noqa: E501

        :return: The run_interval of this SnapshotScheduleCreate.  # noqa: E501
        :rtype: int
        """
    ...
    def run_interval(self, run_interval):
        """Sets the run_interval of this SnapshotScheduleCreate.

        The interval at which the schedule will run (in seconds).run_interval has to be 60 or a multiple of 60  # noqa: E501

        :param run_interval: The run_interval of this SnapshotScheduleCreate.  # noqa: E501
        :type: int
        """
        if run_interval is None:
            raise ValueError("Invalid value for `run_interval`, must not be `None`")  # noqa: E501
        if run_interval is not None and run_interval < 60:  # noqa: E501
            raise ValueError("Invalid value for `run_interval`, must be a value greater than or equal to `60`")  # noqa: E501

        self._run_interval = run_interval

    @property
    def keep_snapshots(self):
        """Gets the keep_snapshots of this SnapshotScheduleCreate.  # noqa: E501

        The amount of Snapshots to keep before overwriting the last created Snapshot.  # noqa: E501

        :return: The keep_snapshots of this SnapshotScheduleCreate.  # noqa: E501
        :rtype: int
        """
    ...
    def keep_snapshots(self, keep_snapshots):
        """Sets the keep_snapshots of this SnapshotScheduleCreate.

        The amount of Snapshots to keep before overwriting the last created Snapshot.  # noqa: E501

        :param keep_snapshots: The keep_snapshots of this SnapshotScheduleCreate.  # noqa: E501
        :type: int
        """
        if keep_snapshots is None:
            raise ValueError("Invalid value for `keep_snapshots`, must not be `None`")  # noqa: E501
    ...
    def next_runtime(self):
        """Gets the next_runtime of this SnapshotScheduleCreate.  # noqa: E501

        The date and time that the snapshot schedule will be run.  # noqa: E501

        :return: The next_runtime of this SnapshotScheduleCreate.  # noqa: E501
        :rtype: datetime
        """
    ...
    def next_runtime(self, next_runtime):
        """Sets the next_runtime of this SnapshotScheduleCreate.

        The date and time that the snapshot schedule will be run.  # noqa: E501

        :param next_runtime: The next_runtime of this SnapshotScheduleCreate.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotScheduleCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotScheduleCreate):
            return False
