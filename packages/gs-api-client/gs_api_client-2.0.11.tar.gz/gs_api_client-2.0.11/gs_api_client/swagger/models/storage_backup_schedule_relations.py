...
from gs_api_client.swagger.models.snapshot_schedule_relations_snapshots import SnapshotScheduleRelationsSnapshots  # noqa: F401,E501


class StorageBackupScheduleRelations(object):
    ...
    """
    swagger_types = {
        'storage_backups': 'list[SnapshotScheduleRelationsSnapshots]'
    }
    ...
    def __init__(self, storage_backups=None):  # noqa: E501
        """StorageBackupScheduleRelations - a model defined in Swagger"""  # noqa: E501
    ...
    def storage_backups(self):
        """Gets the storage_backups of this StorageBackupScheduleRelations.  # noqa: E501


        :return: The storage_backups of this StorageBackupScheduleRelations.  # noqa: E501
        :rtype: list[SnapshotScheduleRelationsSnapshots]
        """
        return self._storage_backups

    @storage_backups.setter
    def storage_backups(self, storage_backups):
        """Sets the storage_backups of this StorageBackupScheduleRelations.


        :param storage_backups: The storage_backups of this StorageBackupScheduleRelations.  # noqa: E501
        :type: list[SnapshotScheduleRelationsSnapshots]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupScheduleRelations, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupScheduleRelations):
            return False
