...
class ServerCreate(object):
    ...
    def __init__(self, name=None, cores=None, memory=None, labels=None, status=None, availability_zone=None, auto_recovery=None, hardware_profile=None):  # noqa: E501
        """ServerCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def cores(self):
        """Gets the cores of this ServerCreate.  # noqa: E501

        The number of server cores.  # noqa: E501

        :return: The cores of this ServerCreate.  # noqa: E501
        :rtype: int
        """
        return self._cores
    ...
    def cores(self, cores):
        """Sets the cores of this ServerCreate.

        The number of server cores.  # noqa: E501

        :param cores: The cores of this ServerCreate.  # noqa: E501
        :type: int
        """
        if cores is None:
    ...
    @property
    def memory(self):
        """Gets the memory of this ServerCreate.  # noqa: E501

        The amount of server memory in GB.  # noqa: E501

        :return: The memory of this ServerCreate.  # noqa: E501
        :rtype: int
        """
        return self._memory
    ...
    def memory(self, memory):
        """Sets the memory of this ServerCreate.

        The amount of server memory in GB.  # noqa: E501

        :param memory: The memory of this ServerCreate.  # noqa: E501
        :type: int
        """
        if memory is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this ServerCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this ServerCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this ServerCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this ServerCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def status(self):
        """Gets the status of this ServerCreate.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this ServerCreate.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ServerCreate.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this ServerCreate.  # noqa: E501
        :type: str
        """
    ...
    def availability_zone(self):
        """Gets the availability_zone of this ServerCreate.  # noqa: E501

        Defines which Availability-Zone the Server is placed.  # noqa: E501

        :return: The availability_zone of this ServerCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def availability_zone(self, availability_zone):
        """Sets the availability_zone of this ServerCreate.

        Defines which Availability-Zone the Server is placed.  # noqa: E501

        :param availability_zone: The availability_zone of this ServerCreate.  # noqa: E501
        :type: str
        """
    ...
    def auto_recovery(self):
        """Gets the auto_recovery of this ServerCreate.  # noqa: E501

        If the server should be auto-started in case of a failure (default=true).  # noqa: E501

        :return: The auto_recovery of this ServerCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def auto_recovery(self, auto_recovery):
        """Sets the auto_recovery of this ServerCreate.

        If the server should be auto-started in case of a failure (default=true).  # noqa: E501

        :param auto_recovery: The auto_recovery of this ServerCreate.  # noqa: E501
        :type: str
        """
    ...
    def hardware_profile(self):
        """Gets the hardware_profile of this ServerCreate.  # noqa: E501

        Specifies the hardware settings for the virtual machine.  # noqa: E501

        :return: The hardware_profile of this ServerCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def hardware_profile(self, hardware_profile):
        """Sets the hardware_profile of this ServerCreate.

        Specifies the hardware settings for the virtual machine.  # noqa: E501

        :param hardware_profile: The hardware_profile of this ServerCreate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerCreate, dict):
