...
class SnapshotSchedulesinStorageInner(object):
    ...
    def __init__(self, object_name=None, next_runtime=None, keep_snapshots=None, create_time=None, name=None, run_interval=None, object_uuid=None):  # noqa: E501
        """SnapshotSchedulesinStorageInner - a model defined in Swagger"""  # noqa: E501
    ...
    def object_name(self):
        """Gets the object_name of this SnapshotSchedulesinStorageInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The object_name of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this SnapshotSchedulesinStorageInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    def next_runtime(self):
        """Gets the next_runtime of this SnapshotSchedulesinStorageInner.  # noqa: E501

        The date and time that the snapshot schedule will be run.  # noqa: E501

        :return: The next_runtime of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: datetime
        """
    ...
    def next_runtime(self, next_runtime):
        """Sets the next_runtime of this SnapshotSchedulesinStorageInner.

        The date and time that the snapshot schedule will be run.  # noqa: E501

        :param next_runtime: The next_runtime of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: datetime
        """
    ...
    def keep_snapshots(self):
        """Gets the keep_snapshots of this SnapshotSchedulesinStorageInner.  # noqa: E501

        The amount of Snapshots to keep before overwriting the last created Snapshot.  # noqa: E501

        :return: The keep_snapshots of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: int
        """
    ...
    def keep_snapshots(self, keep_snapshots):
        """Sets the keep_snapshots of this SnapshotSchedulesinStorageInner.

        The amount of Snapshots to keep before overwriting the last created Snapshot.  # noqa: E501

        :param keep_snapshots: The keep_snapshots of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: int
        """
    ...
    def create_time(self):
        """Gets the create_time of this SnapshotSchedulesinStorageInner.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this SnapshotSchedulesinStorageInner.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this SnapshotSchedulesinStorageInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The name of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SnapshotSchedulesinStorageInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    def run_interval(self):
        """Gets the run_interval of this SnapshotSchedulesinStorageInner.  # noqa: E501

        The interval at which the schedule will run (in seconds)  # noqa: E501

        :return: The run_interval of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: int
        """
    ...
    def run_interval(self, run_interval):
        """Sets the run_interval of this SnapshotSchedulesinStorageInner.

        The interval at which the schedule will run (in seconds)  # noqa: E501

        :param run_interval: The run_interval of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: int
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this SnapshotSchedulesinStorageInner.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this SnapshotSchedulesinStorageInner.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this SnapshotSchedulesinStorageInner.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotSchedulesinStorageInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotSchedulesinStorageInner):
            return False
