...
class SshkeyCreate(object):
    ...
    def __init__(self, name=None, labels=None, sshkey=None):  # noqa: E501
        """SshkeyCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SshkeyCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this SshkeyCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this SshkeyCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this SshkeyCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this SshkeyCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this SshkeyCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def sshkey(self):
        """Gets the sshkey of this SshkeyCreate.  # noqa: E501

        The OpenSSH public key string (all key types are supported => ed25519, ecdsa, dsa, rsa, rsa1).  # noqa: E501

        :return: The sshkey of this SshkeyCreate.  # noqa: E501
        :rtype: str
        """
        return self._sshkey
    ...
    def sshkey(self, sshkey):
        """Sets the sshkey of this SshkeyCreate.

        The OpenSSH public key string (all key types are supported => ed25519, ecdsa, dsa, rsa, rsa1).  # noqa: E501

        :param sshkey: The sshkey of this SshkeyCreate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SshkeyCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SshkeyCreate):
            return False
