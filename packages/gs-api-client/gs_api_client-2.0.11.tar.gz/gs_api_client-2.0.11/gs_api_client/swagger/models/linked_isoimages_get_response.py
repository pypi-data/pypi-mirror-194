...
from gs_api_client.swagger.models.linked_isoimage_brief import LinkedIsoimageBrief  # noqa: F401,E501


class LinkedIsoimagesGetResponse(object):
    ...
    """
    swagger_types = {
        'isoimage_relations': 'list[LinkedIsoimageBrief]'
    }

    attribute_map = {
        'isoimage_relations': 'isoimage_relations'
    }

    def __init__(self, isoimage_relations=None):  # noqa: E501
        """LinkedIsoimagesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._isoimage_relations = None
        self.discriminator = None

        if isoimage_relations is not None:
            self.isoimage_relations = isoimage_relations

    @property
    def isoimage_relations(self):
        """Gets the isoimage_relations of this LinkedIsoimagesGetResponse.  # noqa: E501


        :return: The isoimage_relations of this LinkedIsoimagesGetResponse.  # noqa: E501
        :rtype: list[LinkedIsoimageBrief]
        """
        return self._isoimage_relations

    @isoimage_relations.setter
    def isoimage_relations(self, isoimage_relations):
        """Sets the isoimage_relations of this LinkedIsoimagesGetResponse.


        :param isoimage_relations: The isoimage_relations of this LinkedIsoimagesGetResponse.  # noqa: E501
        :type: list[LinkedIsoimageBrief]
        """

        self._isoimage_relations = isoimage_relations
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedIsoimagesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedIsoimagesGetResponse):
            return False
