...
from gs_api_client.swagger.models.task_events_snapshot_snapshot_add import TaskEventsSnapshotSnapshotAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_snapshot_snapshot_export_tos3 import TaskEventsSnapshotSnapshotExportTos3  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_snapshot_snapshot_remove import TaskEventsSnapshotSnapshotRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_snapshot_snapshot_rollback import TaskEventsSnapshotSnapshotRollback  # noqa: F401,E501


class TaskEventsSnapshot(object):
    ...
    """
    swagger_types = {
        'snapshot_remove': 'TaskEventsSnapshotSnapshotRemove',
        'snapshot_add': 'TaskEventsSnapshotSnapshotAdd',
        'snapshot_export_tos3': 'TaskEventsSnapshotSnapshotExportTos3',
        'snapshot_rollback': 'TaskEventsSnapshotSnapshotRollback',
        'snapshot_update': 'TaskEventsSnapshotSnapshotAdd'
    }

    attribute_map = {
        'snapshot_remove': 'snapshot_remove',
        'snapshot_add': 'snapshot_add',
        'snapshot_export_tos3': 'snapshot_export_tos3',
        'snapshot_rollback': 'snapshot_rollback',
        'snapshot_update': 'snapshot_update'
    }

    def __init__(self, snapshot_remove=None, snapshot_add=None, snapshot_export_tos3=None, snapshot_rollback=None, snapshot_update=None):  # noqa: E501
        """TaskEventsSnapshot - a model defined in Swagger"""  # noqa: E501

        self._snapshot_remove = None
        self._snapshot_add = None
        self._snapshot_export_tos3 = None
        self._snapshot_rollback = None
        self._snapshot_update = None
        self.discriminator = None

        if snapshot_remove is not None:
            self.snapshot_remove = snapshot_remove
        if snapshot_add is not None:
            self.snapshot_add = snapshot_add
        if snapshot_export_tos3 is not None:
            self.snapshot_export_tos3 = snapshot_export_tos3
        if snapshot_rollback is not None:
    ...
    def snapshot_remove(self):
        """Gets the snapshot_remove of this TaskEventsSnapshot.  # noqa: E501


        :return: The snapshot_remove of this TaskEventsSnapshot.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotRemove
        """
        return self._snapshot_remove

    @snapshot_remove.setter
    def snapshot_remove(self, snapshot_remove):
        """Sets the snapshot_remove of this TaskEventsSnapshot.


        :param snapshot_remove: The snapshot_remove of this TaskEventsSnapshot.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotRemove
        """

        self._snapshot_remove = snapshot_remove

    @property
    def snapshot_add(self):
        """Gets the snapshot_add of this TaskEventsSnapshot.  # noqa: E501


        :return: The snapshot_add of this TaskEventsSnapshot.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotAdd
        """
        return self._snapshot_add

    @snapshot_add.setter
    def snapshot_add(self, snapshot_add):
        """Sets the snapshot_add of this TaskEventsSnapshot.


        :param snapshot_add: The snapshot_add of this TaskEventsSnapshot.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotAdd
        """

        self._snapshot_add = snapshot_add

    @property
    def snapshot_export_tos3(self):
        """Gets the snapshot_export_tos3 of this TaskEventsSnapshot.  # noqa: E501


        :return: The snapshot_export_tos3 of this TaskEventsSnapshot.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotExportTos3
        """
        return self._snapshot_export_tos3

    @snapshot_export_tos3.setter
    def snapshot_export_tos3(self, snapshot_export_tos3):
        """Sets the snapshot_export_tos3 of this TaskEventsSnapshot.


        :param snapshot_export_tos3: The snapshot_export_tos3 of this TaskEventsSnapshot.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotExportTos3
        """

        self._snapshot_export_tos3 = snapshot_export_tos3

    @property
    def snapshot_rollback(self):
        """Gets the snapshot_rollback of this TaskEventsSnapshot.  # noqa: E501


        :return: The snapshot_rollback of this TaskEventsSnapshot.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotRollback
        """
        return self._snapshot_rollback

    @snapshot_rollback.setter
    def snapshot_rollback(self, snapshot_rollback):
        """Sets the snapshot_rollback of this TaskEventsSnapshot.


        :param snapshot_rollback: The snapshot_rollback of this TaskEventsSnapshot.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotRollback
        """

        self._snapshot_rollback = snapshot_rollback

    @property
    def snapshot_update(self):
        """Gets the snapshot_update of this TaskEventsSnapshot.  # noqa: E501


        :return: The snapshot_update of this TaskEventsSnapshot.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotAdd
        """
        return self._snapshot_update

    @snapshot_update.setter
    def snapshot_update(self, snapshot_update):
        """Sets the snapshot_update of this TaskEventsSnapshot.


        :param snapshot_update: The snapshot_update of this TaskEventsSnapshot.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotAdd
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSnapshot, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSnapshot):
            return False
