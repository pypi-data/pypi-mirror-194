...
class TaskEventsIsoimageIsoimageRemove(object):
    ...
    """
    swagger_types = {
        'isoimage_uuid': 'TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid'
    }
    ...
    def __init__(self, isoimage_uuid=None):  # noqa: E501
        """TaskEventsIsoimageIsoimageRemove - a model defined in Swagger"""  # noqa: E501
    ...
    def isoimage_uuid(self):
        """Gets the isoimage_uuid of this TaskEventsIsoimageIsoimageRemove.  # noqa: E501


        :return: The isoimage_uuid of this TaskEventsIsoimageIsoimageRemove.  # noqa: E501
    ...
    def isoimage_uuid(self, isoimage_uuid):
        """Sets the isoimage_uuid of this TaskEventsIsoimageIsoimageRemove.


        :param isoimage_uuid: The isoimage_uuid of this TaskEventsIsoimageIsoimageRemove.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsIsoimageIsoimageRemove, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsIsoimageIsoimageRemove):
            return False
