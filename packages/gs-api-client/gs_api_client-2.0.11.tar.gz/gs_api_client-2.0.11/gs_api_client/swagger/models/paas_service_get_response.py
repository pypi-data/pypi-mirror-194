...
from gs_api_client.swagger.models.paas_service import PaasService  # noqa: F401,E501


class PaasServiceGetResponse(object):
    ...
    def __init__(self, paas_service=None):  # noqa: E501
        """PaasServiceGetResponse - a model defined in Swagger"""  # noqa: E501

        self._paas_service = None
        self.discriminator = None

        if paas_service is not None:
            self.paas_service = paas_service

    @property
    def paas_service(self):
        """Gets the paas_service of this PaasServiceGetResponse.  # noqa: E501


        :return: The paas_service of this PaasServiceGetResponse.  # noqa: E501
        :rtype: PaasService
        """
        return self._paas_service

    @paas_service.setter
    def paas_service(self, paas_service):
        """Sets the paas_service of this PaasServiceGetResponse.


        :param paas_service: The paas_service of this PaasServiceGetResponse.  # noqa: E501
        :type: PaasService
        """

        self._paas_service = paas_service
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceGetResponse):
            return False
