...
from gs_api_client.swagger.models.loadbalancer import Loadbalancer  # noqa: F401,E501
...
class LoadbalancerGetResponse(object):
    ...
    def __init__(self, loadbalancer=None):  # noqa: E501
        """LoadbalancerGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def loadbalancer(self):
        """Gets the loadbalancer of this LoadbalancerGetResponse.  # noqa: E501


        :return: The loadbalancer of this LoadbalancerGetResponse.  # noqa: E501
        :rtype: Loadbalancer
        """
    ...
    def loadbalancer(self, loadbalancer):
        """Sets the loadbalancer of this LoadbalancerGetResponse.


        :param loadbalancer: The loadbalancer of this LoadbalancerGetResponse.  # noqa: E501
        :type: Loadbalancer
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancerGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancerGetResponse):
            return False
