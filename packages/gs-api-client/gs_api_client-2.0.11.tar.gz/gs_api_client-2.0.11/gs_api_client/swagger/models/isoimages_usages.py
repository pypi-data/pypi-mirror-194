...
from gs_api_client.swagger.models.isoimages_usage import IsoimagesUsage  # noqa: F401,E501


class IsoimagesUsages(object):
    ...
    """
    swagger_types = {
        'iso_images': 'list[IsoimagesUsage]'
    }
    ...
    def __init__(self, iso_images=None):  # noqa: E501
        """IsoimagesUsages - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def iso_images(self):
        """Gets the iso_images of this IsoimagesUsages.  # noqa: E501


        :return: The iso_images of this IsoimagesUsages.  # noqa: E501
        :rtype: list[IsoimagesUsage]
        """
        return self._iso_images

    @iso_images.setter
    def iso_images(self, iso_images):
        """Sets the iso_images of this IsoimagesUsages.


        :param iso_images: The iso_images of this IsoimagesUsages.  # noqa: E501
        :type: list[IsoimagesUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IsoimagesUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsoimagesUsages):
            return False
