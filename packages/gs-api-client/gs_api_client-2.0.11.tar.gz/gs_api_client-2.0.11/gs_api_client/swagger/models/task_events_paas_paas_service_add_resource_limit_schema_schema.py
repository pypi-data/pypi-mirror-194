...
from gs_api_client.swagger.models.task_events_paas_paas_service_add_resource_limit_schema_schema_limit import TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaLimit  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_service_add_resource_limit_schema_schema_resource import TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaResource  # noqa: F401,E501


class TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema(object):
    ...
    """
    swagger_types = {
        'resource': 'TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaResource',
        'limit': 'TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaLimit'
    }
    ...
    def __init__(self, resource=None, limit=None):  # noqa: E501
        """TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def resource(self):
        """Gets the resource of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.  # noqa: E501


        :return: The resource of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaResource
        """
        return self._resource

    @resource.setter
    def resource(self, resource):
        """Sets the resource of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.


        :param resource: The resource of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.  # noqa: E501
        :type: TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaResource
        """
    ...
    @property
    def limit(self):
        """Gets the limit of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.  # noqa: E501


        :return: The limit of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaLimit
        """
        return self._limit

    @limit.setter
    def limit(self, limit):
        """Sets the limit of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.


        :param limit: The limit of this TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema.  # noqa: E501
        :type: TaskEventsPaasPaasServiceAddResourceLimitSchemaSchemaLimit
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsPaasPaasServiceAddResourceLimitSchemaSchema):
            return False
