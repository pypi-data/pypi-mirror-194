...
from gs_api_client.swagger.models.isoimage_index import IsoimageIndex  # noqa: F401,E501


class DeletedIsoimagesGetResponse(object):
    ...
    attribute_map = {
        'deleted_isoimages': 'deleted_isoimages'
    }

    def __init__(self, deleted_isoimages=None):  # noqa: E501
        """DeletedIsoimagesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_isoimages = None
        self.discriminator = None

        if deleted_isoimages is not None:
            self.deleted_isoimages = deleted_isoimages

    @property
    def deleted_isoimages(self):
        """Gets the deleted_isoimages of this DeletedIsoimagesGetResponse.  # noqa: E501


        :return: The deleted_isoimages of this DeletedIsoimagesGetResponse.  # noqa: E501
        :rtype: IsoimageIndex
        """
        return self._deleted_isoimages

    @deleted_isoimages.setter
    def deleted_isoimages(self, deleted_isoimages):
        """Sets the deleted_isoimages of this DeletedIsoimagesGetResponse.


        :param deleted_isoimages: The deleted_isoimages of this DeletedIsoimagesGetResponse.  # noqa: E501
        :type: IsoimageIndex
        """

        self._deleted_isoimages = deleted_isoimages
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedIsoimagesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedIsoimagesGetResponse):
            return False
