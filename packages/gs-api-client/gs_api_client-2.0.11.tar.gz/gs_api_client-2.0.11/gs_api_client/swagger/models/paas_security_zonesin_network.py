...
from gs_api_client.swagger.models.paas_security_zonesin_network_inner import PaasSecurityZonesinNetworkInner  # noqa: F401,E501


class PaasSecurityZonesinNetwork(object):
    ...
    def __init__(self):  # noqa: E501
        """PaasSecurityZonesinNetwork - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZonesinNetwork, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZonesinNetwork):
            return False
