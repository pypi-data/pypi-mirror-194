...
from gs_api_client.swagger.models.bucket_list import BucketList  # noqa: F401,E501


class BucketsGetResponse(object):
    ...
    def __init__(self, buckets=None):  # noqa: E501
        """BucketsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def buckets(self):
        """Gets the buckets of this BucketsGetResponse.  # noqa: E501


        :return: The buckets of this BucketsGetResponse.  # noqa: E501
        :rtype: BucketList
        """
    ...
    def buckets(self, buckets):
        """Sets the buckets of this BucketsGetResponse.


        :param buckets: The buckets of this BucketsGetResponse.  # noqa: E501
        :type: BucketList
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BucketsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BucketsGetResponse):
            return False
