...
class MarketplaceApplicationCreateResponse(object):
    ...
    def __init__(self, request_uuid=None, object_uuid=None, unique_hash=None):  # noqa: E501
        """MarketplaceApplicationCreateResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def request_uuid(self):
        """Gets the request_uuid of this MarketplaceApplicationCreateResponse.  # noqa: E501

        request user ID.  # noqa: E501

        :return: The request_uuid of this MarketplaceApplicationCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def request_uuid(self, request_uuid):
        """Sets the request_uuid of this MarketplaceApplicationCreateResponse.

        request user ID.  # noqa: E501

        :param request_uuid: The request_uuid of this MarketplaceApplicationCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this MarketplaceApplicationCreateResponse.  # noqa: E501

        The user name.  # noqa: E501

        :return: The object_uuid of this MarketplaceApplicationCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this MarketplaceApplicationCreateResponse.

        The user name.  # noqa: E501

        :param object_uuid: The object_uuid of this MarketplaceApplicationCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def unique_hash(self):
        """Gets the unique_hash of this MarketplaceApplicationCreateResponse.  # noqa: E501

        Unique hash for importing this marketplace application  # noqa: E501

        :return: The unique_hash of this MarketplaceApplicationCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_hash(self, unique_hash):
        """Sets the unique_hash of this MarketplaceApplicationCreateResponse.

        Unique hash for importing this marketplace application  # noqa: E501

        :param unique_hash: The unique_hash of this MarketplaceApplicationCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplicationCreateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplicationCreateResponse):
            return False
