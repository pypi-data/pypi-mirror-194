...
class NetworkCreate(object):
    ...
    @property
    def l2security(self):
        """Gets the l2security of this NetworkCreate.  # noqa: E501
        ...
        :return: The l2security of this NetworkCreate.  # noqa: E501
        :rtype: bool
        """
    ...
    def l2security(self, l2security):
        """Sets the l2security of this NetworkCreate.

        Defines information about MAC spoofing protection (filters layer2 and ARP traffic based on MAC source). It can only be (de-)activated on a private network - the public network always has l2security enabled. It will be true if the network is public, and false if the network is private.  # noqa: E501

        :param l2security: The l2security of this NetworkCreate.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this NetworkCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this NetworkCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this NetworkCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this NetworkCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def dhcp_active(self):
        """Gets the dhcp_active of this NetworkCreate.  # noqa: E501

        Set if dhcp is supposed to be active on the new network  # noqa: E501

        :return: The dhcp_active of this NetworkCreate.  # noqa: E501
        :rtype: bool
        """
    ...
    def dhcp_active(self, dhcp_active):
        """Sets the dhcp_active of this NetworkCreate.

        Set if dhcp is supposed to be active on the new network  # noqa: E501

        :param dhcp_active: The dhcp_active of this NetworkCreate.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def dhcp_range(self):
        """Gets the dhcp_range of this NetworkCreate.  # noqa: E501
        ...
        :return: The dhcp_range of this NetworkCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def dhcp_range(self, dhcp_range):
        """Sets the dhcp_range of this NetworkCreate.

        The general IP Range configured for this network (/24 for private networks). If None will default to our internal default range for either  # noqa: E501

        :param dhcp_range: The dhcp_range of this NetworkCreate.  # noqa: E501
        :type: str
        """
    ...
    def dhcp_gateway(self):
        """Gets the dhcp_gateway of this NetworkCreate.  # noqa: E501
        ...
        :return: The dhcp_gateway of this NetworkCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def dhcp_gateway(self, dhcp_gateway):
        """Sets the dhcp_gateway of this NetworkCreate.

        The ip reserved and communicated by the dhcp service to be the default gateway If none, will default to the first adress in the defined (or default) range  # noqa: E501

        :param dhcp_gateway: The dhcp_gateway of this NetworkCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dhcp_dns(self):
        """Gets the dhcp_dns of this NetworkCreate.  # noqa: E501

        The ip reserved and communicated by the dhcp service to be the default gateway If none, will default to the first adress in the defined (or default) range  # noqa: E501

        :return: The dhcp_dns of this NetworkCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def dhcp_dns(self, dhcp_dns):
        """Sets the dhcp_dns of this NetworkCreate.

        The ip reserved and communicated by the dhcp service to be the default gateway If none, will default to the first adress in the defined (or default) range  # noqa: E501

        :param dhcp_dns: The dhcp_dns of this NetworkCreate.  # noqa: E501
        :type: str
        """
    ...
    def dhcp_reserved_subnet(self):
        """Gets the dhcp_reserved_subnet of this NetworkCreate.  # noqa: E501
        ...
        :return: The dhcp_reserved_subnet of this NetworkCreate.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def dhcp_reserved_subnet(self, dhcp_reserved_subnet):
        """Sets the dhcp_reserved_subnet of this NetworkCreate.

        Any subrange within the ip range not conflicting with gateway or dns address, not used for automatic assignment of IPs  # noqa: E501

        :param dhcp_reserved_subnet: The dhcp_reserved_subnet of this NetworkCreate.  # noqa: E501
        :type: list[str]
        """
