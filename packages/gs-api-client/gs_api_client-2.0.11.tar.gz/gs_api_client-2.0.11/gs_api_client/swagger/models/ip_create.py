...
class IpCreate(object):
    ...
    def __init__(self, family=None, failover=None, reverse_dns=None, labels=None, name=None):  # noqa: E501
        """IpCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def family(self):
        """Gets the family of this IpCreate.  # noqa: E501

        Defines the IP Address family (v4 or v6).  # noqa: E501

        :return: The family of this IpCreate.  # noqa: E501
        :rtype: int
        """
        return self._family
    ...
    def family(self, family):
        """Sets the family of this IpCreate.

        Defines the IP Address family (v4 or v6).  # noqa: E501

        :param family: The family of this IpCreate.  # noqa: E501
        :type: int
        """
        if family is None:
    ...
    @property
    def failover(self):
        """Gets the failover of this IpCreate.  # noqa: E501
        ...
        :return: The failover of this IpCreate.  # noqa: E501
        :rtype: bool
        """
    ...
    def failover(self, failover):
        """Sets the failover of this IpCreate.

        Sets failover mode for this IP. If true, then this IP is no longer available for DHCP and can no longer be related to any server.  # noqa: E501

        :param failover: The failover of this IpCreate.  # noqa: E501
        :type: bool
        """
    ...
    def reverse_dns(self):
        """Gets the reverse_dns of this IpCreate.  # noqa: E501

        Defines the reverse DNS entry for the IP Address (PTR Resource Record).  # noqa: E501

        :return: The reverse_dns of this IpCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def reverse_dns(self, reverse_dns):
        """Sets the reverse_dns of this IpCreate.

        Defines the reverse DNS entry for the IP Address (PTR Resource Record).  # noqa: E501

        :param reverse_dns: The reverse_dns of this IpCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this IpCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this IpCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this IpCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this IpCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IpCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this IpCreate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpCreate):
            return False
