...
class LoadbalancerCreateBackendServers(object):
    ...
    def __init__(self, weight=None, host=None):  # noqa: E501
        """LoadbalancerCreateBackendServers - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def weight(self):
        """Gets the weight of this LoadbalancerCreateBackendServers.  # noqa: E501

        The backend host weight  # noqa: E501

        :return: The weight of this LoadbalancerCreateBackendServers.  # noqa: E501
        :rtype: int
        """
        return self._weight
    ...
    def weight(self, weight):
        """Sets the weight of this LoadbalancerCreateBackendServers.

        The backend host weight  # noqa: E501

        :param weight: The weight of this LoadbalancerCreateBackendServers.  # noqa: E501
        :type: int
        """
        if weight is None:
    ...
    @property
    def host(self):
        """Gets the host of this LoadbalancerCreateBackendServers.  # noqa: E501

        A valid domain or an IP address of a server  # noqa: E501

        :return: The host of this LoadbalancerCreateBackendServers.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this LoadbalancerCreateBackendServers.

        A valid domain or an IP address of a server  # noqa: E501

        :param host: The host of this LoadbalancerCreateBackendServers.  # noqa: E501
        :type: str
        """
        if host is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancerCreateBackendServers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancerCreateBackendServers):
            return False
