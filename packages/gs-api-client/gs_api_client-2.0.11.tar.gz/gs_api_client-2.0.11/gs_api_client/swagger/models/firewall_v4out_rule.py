...
from gs_api_client.swagger.models.rules_properties import RulesProperties  # noqa: F401,E501


class FirewallV4outRule(object):
    ...
    def __init__(self):  # noqa: E501
        """FirewallV4outRule - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallV4outRule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallV4outRule):
            return False
