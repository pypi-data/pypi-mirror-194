...
from gs_api_client.swagger.models.task_events_marketplace_template_marketplace_template_remove_template_uuid import TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_snapshot_snapshot_export_tos3_s3auth import TaskEventsSnapshotSnapshotExportTos3S3auth  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_snapshot_snapshot_export_tos3_s3data import TaskEventsSnapshotSnapshotExportTos3S3data  # noqa: F401,E501


class TaskEventsSnapshotSnapshotExportTos3(object):
    ...
    """
    swagger_types = {
        'snaapshot_uuid': 'TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid',
        'storage_uuid': 'TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid',
        's3auth': 'TaskEventsSnapshotSnapshotExportTos3S3auth',
        's3data': 'TaskEventsSnapshotSnapshotExportTos3S3data'
    }

    attribute_map = {
        'snaapshot_uuid': 'snaapshot_uuid',
        'storage_uuid': 'storage_uuid',
        's3auth': 's3auth',
        's3data': 's3data'
    }

    def __init__(self, snaapshot_uuid=None, storage_uuid=None, s3auth=None, s3data=None):  # noqa: E501
        """TaskEventsSnapshotSnapshotExportTos3 - a model defined in Swagger"""  # noqa: E501

        self._snaapshot_uuid = None
        self._storage_uuid = None
        self._s3auth = None
        self._s3data = None
        self.discriminator = None

        if snaapshot_uuid is not None:
            self.snaapshot_uuid = snaapshot_uuid
        if storage_uuid is not None:
            self.storage_uuid = storage_uuid
        if s3auth is not None:
            self.s3auth = s3auth
        if s3data is not None:
            self.s3data = s3data

    @property
    def snaapshot_uuid(self):
        """Gets the snaapshot_uuid of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501


        :return: The snaapshot_uuid of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """
        return self._snaapshot_uuid

    @snaapshot_uuid.setter
    def snaapshot_uuid(self, snaapshot_uuid):
        """Sets the snaapshot_uuid of this TaskEventsSnapshotSnapshotExportTos3.


        :param snaapshot_uuid: The snaapshot_uuid of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """

        self._snaapshot_uuid = snaapshot_uuid

    @property
    def storage_uuid(self):
        """Gets the storage_uuid of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501


        :return: The storage_uuid of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """
    ...
    def storage_uuid(self, storage_uuid):
        """Sets the storage_uuid of this TaskEventsSnapshotSnapshotExportTos3.


        :param storage_uuid: The storage_uuid of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """
    ...
    @property
    def s3auth(self):
        """Gets the s3auth of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501


        :return: The s3auth of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotExportTos3S3auth
        """
        return self._s3auth

    @s3auth.setter
    def s3auth(self, s3auth):
        """Sets the s3auth of this TaskEventsSnapshotSnapshotExportTos3.


        :param s3auth: The s3auth of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotExportTos3S3auth
        """
    ...
    @property
    def s3data(self):
        """Gets the s3data of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501


        :return: The s3data of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :rtype: TaskEventsSnapshotSnapshotExportTos3S3data
        """
        return self._s3data

    @s3data.setter
    def s3data(self, s3data):
        """Sets the s3data of this TaskEventsSnapshotSnapshotExportTos3.


        :param s3data: The s3data of this TaskEventsSnapshotSnapshotExportTos3.  # noqa: E501
        :type: TaskEventsSnapshotSnapshotExportTos3S3data
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSnapshotSnapshotExportTos3, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSnapshotSnapshotExportTos3):
            return False
