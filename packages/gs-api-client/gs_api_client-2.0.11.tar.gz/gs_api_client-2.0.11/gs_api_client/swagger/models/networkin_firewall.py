...
from gs_api_client.swagger.models.networkin_firewall_inner import NetworkinFirewallInner  # noqa: F401,E501


class NetworkinFirewall(object):
    ...
    def __init__(self):  # noqa: E501
        """NetworkinFirewall - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworkinFirewall, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkinFirewall):
            return False
