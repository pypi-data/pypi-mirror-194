...
from gs_api_client.swagger.models.linked_network import LinkedNetwork  # noqa: F401,E501


class LinkedNetworkGetResponse(object):
    ...
    def __init__(self, network_relation=None):  # noqa: E501
        """LinkedNetworkGetResponse - a model defined in Swagger"""  # noqa: E501

        self._network_relation = None
        self.discriminator = None

        if network_relation is not None:
            self.network_relation = network_relation

    @property
    def network_relation(self):
        """Gets the network_relation of this LinkedNetworkGetResponse.  # noqa: E501


        :return: The network_relation of this LinkedNetworkGetResponse.  # noqa: E501
        :rtype: LinkedNetwork
        """
        return self._network_relation

    @network_relation.setter
    def network_relation(self, network_relation):
        """Sets the network_relation of this LinkedNetworkGetResponse.


        :param network_relation: The network_relation of this LinkedNetworkGetResponse.  # noqa: E501
        :type: LinkedNetwork
        """

        self._network_relation = network_relation
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedNetworkGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedNetworkGetResponse):
            return False
