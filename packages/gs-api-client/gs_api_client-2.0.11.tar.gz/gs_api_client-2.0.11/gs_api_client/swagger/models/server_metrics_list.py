...
from gs_api_client.swagger.models.server_metrics import ServerMetrics  # noqa: F401,E501


class ServerMetricsList(object):
    ...
    def __init__(self):  # noqa: E501
        """ServerMetricsList - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerMetricsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerMetricsList):
            return False
