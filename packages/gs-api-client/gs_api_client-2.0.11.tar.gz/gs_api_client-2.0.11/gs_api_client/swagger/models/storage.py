...
from gs_api_client.swagger.models.storage_backups import StorageBackups  # noqa: F401,E501
from gs_api_client.swagger.models.storage_snapshots import StorageSnapshots  # noqa: F401,E501
from gs_api_client.swagger.models.storage_variant import StorageVariant  # noqa: F401,E501
from gs_api_client.swagger.models.storages_relation import StoragesRelation  # noqa: F401,E501
...
class Storage(object):
    ...
    swagger_types = {
        'parent_uuid': 'str',
        'labels': 'list[str]',
        'backups': 'list[StorageBackups]',
        'snapshots': 'list[StorageSnapshots]',
        'object_uuid': 'str',
    ...
    def __init__(self, parent_uuid=None, labels=None, backups=None, snapshots=None, object_uuid=None, relations=None, name=None, status=None, location_country=None, usage_in_minutes=None, location_uuid=None, change_time=None, storage_type=None, storage_variant=None, license_product_no=None, current_price=None, create_time=None, last_used_template=None, capacity=None, location_name=None, location_iata=None, current_usage_per_minute=None, accumulated_usage=None):  # noqa: E501
        ...
        if storage_variant is not None:
            self.storage_variant = storage_variant
    ...
    def parent_uuid(self):
        """Gets the parent_uuid of this Storage.  # noqa: E501

        The UUID of the Storage used to create this Snapshot.  # noqa: E501

        :return: The parent_uuid of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_uuid(self, parent_uuid):
        """Sets the parent_uuid of this Storage.

        The UUID of the Storage used to create this Snapshot.  # noqa: E501

        :param parent_uuid: The parent_uuid of this Storage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this Storage.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this Storage.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this Storage.

        List of labels.  # noqa: E501

        :param labels: The labels of this Storage.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def backups(self):
        """Gets the backups of this Storage.  # noqa: E501

        Bakckups list in this storage.  # noqa: E501

        :return: The backups of this Storage.  # noqa: E501
        :rtype: list[StorageBackups]
        """
        return self._backups

    @backups.setter
    def backups(self, backups):
        """Sets the backups of this Storage.

        Bakckups list in this storage.  # noqa: E501

        :param backups: The backups of this Storage.  # noqa: E501
        :type: list[StorageBackups]
        """
    ...
    @property
    def snapshots(self):
        """Gets the snapshots of this Storage.  # noqa: E501

        Snapshots list in this storage.  # noqa: E501

        :return: The snapshots of this Storage.  # noqa: E501
        :rtype: list[StorageSnapshots]
        """
        return self._snapshots

    @snapshots.setter
    def snapshots(self, snapshots):
        """Sets the snapshots of this Storage.

        Snapshots list in this storage.  # noqa: E501

        :param snapshots: The snapshots of this Storage.  # noqa: E501
        :type: list[StorageSnapshots]
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this Storage.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this Storage.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this Storage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def relations(self):
        """Gets the relations of this Storage.  # noqa: E501


        :return: The relations of this Storage.  # noqa: E501
        :rtype: StoragesRelation
        """
        return self._relations

    @relations.setter
    def relations(self, relations):
        """Sets the relations of this Storage.


        :param relations: The relations of this Storage.  # noqa: E501
    ...
    def location_country(self):
        """Gets the location_country of this Storage.  # noqa: E501
        ...
        :return: The location_country of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def location_country(self, location_country):
        """Sets the location_country of this Storage.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_country: The location_country of this Storage.  # noqa: E501
        :type: str
        """
    ...
    def usage_in_minutes(self):
        """Gets the usage_in_minutes of this Storage.  # noqa: E501

        Total minutes the object has been running.  # noqa: E501

        :return: The usage_in_minutes of this Storage.  # noqa: E501
        :rtype: int
        """
    ...
    def usage_in_minutes(self, usage_in_minutes):
        """Sets the usage_in_minutes of this Storage.

        Total minutes the object has been running.  # noqa: E501

        :param usage_in_minutes: The usage_in_minutes of this Storage.  # noqa: E501
        :type: int
        """
    ...
    def location_uuid(self):
        """Gets the location_uuid of this Storage.  # noqa: E501

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :return: The location_uuid of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this Storage.

        Helps to identify which data-center an object belongs to.  # noqa: E501

        :param location_uuid: The location_uuid of this Storage.  # noqa: E501
        :type: str
        """
    ...
    def change_time(self):
        """Gets the change_time of this Storage.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this Storage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this Storage.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this Storage.  # noqa: E501
        :type: datetime
        """
    ...
    def storage_type(self):
        ...
        (one of storage, storage_high, storage_insane).  # noqa: E501
    ...
    def storage_type(self, storage_type):
        ...
        :type: str
        """
        allowed_values = ["storage", "storage_high", "storage_insane", "storage_local"]  # noqa: E501
    ...
    @property
    def storage_variant(self):
        """Gets the storage_variant of this Storage.  # noqa: E501


        :return: The storage_variant of this Storage.  # noqa: E501
        :rtype: StorageVariant
        """
        return self._storage_variant

    @storage_variant.setter
    def storage_variant(self, storage_variant):
        """Sets the storage_variant of this Storage.


        :param storage_variant: The storage_variant of this Storage.  # noqa: E501
        :type: StorageVariant
        """

        self._storage_variant = storage_variant

    @property
    def license_product_no(self):
        """Gets the license_product_no of this Storage.  # noqa: E501
        ...
        :return: The license_product_no of this Storage.  # noqa: E501
        :rtype: int
        """
    ...
    def license_product_no(self, license_product_no):
        """Sets the license_product_no of this Storage.

        If a template has been used that requires a license key (e.g. Windows Servers) this shows the product_no of the license (see the /prices endpoint for more details).  # noqa: E501

        :param license_product_no: The license_product_no of this Storage.  # noqa: E501
        :type: int
        """
    ...
    def current_price(self):
        """Gets the current_price of this Storage.  # noqa: E501

        Deprecated  # noqa: E501

        :return: The current_price of this Storage.  # noqa: E501
        :rtype: float
        """
    ...
    def current_price(self, current_price):
        """Sets the current_price of this Storage.

        Deprecated  # noqa: E501

        :param current_price: The current_price of this Storage.  # noqa: E501
        :type: float
        """
    ...
    def create_time(self):
        """Gets the create_time of this Storage.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this Storage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this Storage.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this Storage.  # noqa: E501
        :type: datetime
        """
    ...
    def last_used_template(self):
        """Gets the last_used_template of this Storage.  # noqa: E501

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :return: The last_used_template of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def last_used_template(self, last_used_template):
        """Sets the last_used_template of this Storage.

        Indicates the UUID of the last used template on this storage.  # noqa: E501

        :param last_used_template: The last_used_template of this Storage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def capacity(self):
        """Gets the capacity of this Storage.  # noqa: E501

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :return: The capacity of this Storage.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this Storage.

        The capacity of a storage/ISO-Image/template/snapshot in GB.  # noqa: E501

        :param capacity: The capacity of this Storage.  # noqa: E501
        :type: int
        """
    ...
    def location_name(self):
        """Gets the location_name of this Storage.  # noqa: E501

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The location_name of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def location_name(self, location_name):
        """Sets the location_name of this Storage.

        The human-readable name of the location. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param location_name: The location_name of this Storage.  # noqa: E501
        :type: str
        """
    ...
    def location_iata(self):
        """Gets the location_iata of this Storage.  # noqa: E501

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :return: The location_iata of this Storage.  # noqa: E501
        :rtype: str
        """
    ...
    def location_iata(self, location_iata):
        """Sets the location_iata of this Storage.

        Uses IATA airport code, which works as a location identifier.  # noqa: E501

        :param location_iata: The location_iata of this Storage.  # noqa: E501
        :type: str
        """
    ...
    def current_usage_per_minute(self):
        """Gets the current_usage_per_minute of this Storage.  # noqa: E501


        :return: The current_usage_per_minute of this Storage.  # noqa: E501
    ...
    def current_usage_per_minute(self, current_usage_per_minute):
        """Sets the current_usage_per_minute of this Storage.


        :param current_usage_per_minute: The current_usage_per_minute of this Storage.  # noqa: E501
    ...
    def accumulated_usage(self):
        """Gets the accumulated_usage of this Storage.  # noqa: E501


        :return: The accumulated_usage of this Storage.  # noqa: E501
    ...
    def accumulated_usage(self, accumulated_usage):
        """Sets the accumulated_usage of this Storage.


        :param accumulated_usage: The accumulated_usage of this Storage.  # noqa: E501
