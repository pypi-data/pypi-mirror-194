...
from gs_api_client.swagger.models.paas_service_credentials import PaasServiceCredentials  # noqa: F401,E501
...
class PaasService(object):
    ...
    attribute_map = {
        ...
        'security_zone_uuid': 'security_zone_uuid',
    ...
    def __init__(self, object_uuid=None, labels=None, credentials=None, create_time=None, listen_ports=None, security_zone_uuid=None, network_uuid=None, service_template_uuid=None, service_template_category=None, usage_in_minutes=None, current_price=None, change_time=None, status=None, name=None, parameters=None, resource_limits=None):  # noqa: E501
        """PaasService - a model defined in Swagger"""  # noqa: E501
        ...
        if security_zone_uuid is not None:
            self.security_zone_uuid = security_zone_uuid
    ...
    def object_uuid(self):
        """Gets the object_uuid of this PaasService.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this PaasService.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this PaasService.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this PaasService.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this PaasService.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this PaasService.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this PaasService.

        List of labels.  # noqa: E501

        :param labels: The labels of this PaasService.  # noqa: E501
        :type: list[str]
        """
    ...
    def credentials(self):
        """Gets the credentials of this PaasService.  # noqa: E501


        :return: The credentials of this PaasService.  # noqa: E501
        :rtype: PaasServiceCredentials
        """
        return self._credentials

    @credentials.setter
    def credentials(self, credentials):
        """Sets the credentials of this PaasService.


        :param credentials: The credentials of this PaasService.  # noqa: E501
    ...
    def create_time(self):
        """Gets the create_time of this PaasService.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this PaasService.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this PaasService.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this PaasService.  # noqa: E501
        :type: datetime
        """
    ...
    def listen_ports(self):
        """Gets the listen_ports of this PaasService.  # noqa: E501


        :return: The listen_ports of this PaasService.  # noqa: E501
    ...
    def listen_ports(self, listen_ports):
        """Sets the listen_ports of this PaasService.


        :param listen_ports: The listen_ports of this PaasService.  # noqa: E501
    ...
    @property
    def security_zone_uuid(self):
        """Gets the security_zone_uuid of this PaasService.  # noqa: E501

        The UUID of the security zone that the service is running in.  # noqa: E501

        :return: The security_zone_uuid of this PaasService.  # noqa: E501
        :rtype: str
        """
        return self._security_zone_uuid

    @security_zone_uuid.setter
    def security_zone_uuid(self, security_zone_uuid):
        """Sets the security_zone_uuid of this PaasService.

        The UUID of the security zone that the service is running in.  # noqa: E501

        :param security_zone_uuid: The security_zone_uuid of this PaasService.  # noqa: E501
        :type: str
        """

        self._security_zone_uuid = security_zone_uuid

    @property
    def network_uuid(self):
        """Gets the network_uuid of this PaasService.  # noqa: E501

        The UUID of the private network to which the service should be connected  # noqa: E501

        :return: The network_uuid of this PaasService.  # noqa: E501
        :rtype: str
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this PaasService.

        The UUID of the private network to which the service should be connected  # noqa: E501

        :param network_uuid: The network_uuid of this PaasService.  # noqa: E501
        :type: str
        """
    ...
    def service_template_uuid(self):
        """Gets the service_template_uuid of this PaasService.  # noqa: E501

        The template used to create the service, you can find an available list at the /service_templates endpoint.  # noqa: E501

        :return: The service_template_uuid of this PaasService.  # noqa: E501
        :rtype: str
        """
    ...
    def service_template_uuid(self, service_template_uuid):
        """Sets the service_template_uuid of this PaasService.

        The template used to create the service, you can find an available list at the /service_templates endpoint.  # noqa: E501

        :param service_template_uuid: The service_template_uuid of this PaasService.  # noqa: E501
        :type: str
        """
    ...
    def service_template_category(self):
        """Gets the service_template_category of this PaasService.  # noqa: E501

        The template service's category used to create the service  # noqa: E501

        :return: The service_template_category of this PaasService.  # noqa: E501
        :rtype: str
        """
    ...
    def service_template_category(self, service_template_category):
        """Sets the service_template_category of this PaasService.

        The template service's category used to create the service  # noqa: E501

        :param service_template_category: The service_template_category of this PaasService.  # noqa: E501
        :type: str
        """
    ...
    def usage_in_minutes(self):
        """Gets the usage_in_minutes of this PaasService.  # noqa: E501

        Total minutes the object has been running.  # noqa: E501

        :return: The usage_in_minutes of this PaasService.  # noqa: E501
        :rtype: int
        """
    ...
    def usage_in_minutes(self, usage_in_minutes):
        """Sets the usage_in_minutes of this PaasService.

        Total minutes the object has been running.  # noqa: E501

        :param usage_in_minutes: The usage_in_minutes of this PaasService.  # noqa: E501
        :type: int
        """
    ...
    def current_price(self):
        """Gets the current_price of this PaasService.  # noqa: E501

        Deprecated  # noqa: E501

        :return: The current_price of this PaasService.  # noqa: E501
        :rtype: float
        """
    ...
    def current_price(self, current_price):
        """Sets the current_price of this PaasService.

        Deprecated  # noqa: E501

        :param current_price: The current_price of this PaasService.  # noqa: E501
        :type: float
        """
    ...
    def change_time(self):
        """Gets the change_time of this PaasService.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this PaasService.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this PaasService.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this PaasService.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def status(self):
        """Gets the status of this PaasService.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this PaasService.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PaasService.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this PaasService.  # noqa: E501
        :type: str
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PaasService.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this PaasService.  # noqa: E501
        :type: str
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this PaasService.  # noqa: E501


        :return: The parameters of this PaasService.  # noqa: E501
    ...
    def parameters(self, parameters):
        """Sets the parameters of this PaasService.


        :param parameters: The parameters of this PaasService.  # noqa: E501
    ...
    def resource_limits(self):
        """Gets the resource_limits of this PaasService.  # noqa: E501


        :return: The resource_limits of this PaasService.  # noqa: E501
    ...
    def resource_limits(self, resource_limits):
        """Sets the resource_limits of this PaasService.


        :param resource_limits: The resource_limits of this PaasService.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasService, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasService):
            return False
