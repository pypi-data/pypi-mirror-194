...
class LoadbalancerinIpInner(object):
    ...
    def __init__(self, create_time=None, loadbalancer_uuid=None, loadbalancer_name=None):  # noqa: E501
        """LoadbalancerinIpInner - a model defined in Swagger"""  # noqa: E501

        self._create_time = None
        self._loadbalancer_uuid = None
        self._loadbalancer_name = None
        self.discriminator = None

        if create_time is not None:
            self.create_time = create_time
        if loadbalancer_uuid is not None:
    ...
    def create_time(self):
        """Gets the create_time of this LoadbalancerinIpInner.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this LoadbalancerinIpInner.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this LoadbalancerinIpInner.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this LoadbalancerinIpInner.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def loadbalancer_uuid(self):
        """Gets the loadbalancer_uuid of this LoadbalancerinIpInner.  # noqa: E501

        The UUID of loadbalancer.  # noqa: E501

        :return: The loadbalancer_uuid of this LoadbalancerinIpInner.  # noqa: E501
        :rtype: str
        """
        return self._loadbalancer_uuid

    @loadbalancer_uuid.setter
    def loadbalancer_uuid(self, loadbalancer_uuid):
        """Sets the loadbalancer_uuid of this LoadbalancerinIpInner.

        The UUID of loadbalancer.  # noqa: E501

        :param loadbalancer_uuid: The loadbalancer_uuid of this LoadbalancerinIpInner.  # noqa: E501
        :type: str
        """

        self._loadbalancer_uuid = loadbalancer_uuid

    @property
    def loadbalancer_name(self):
        """Gets the loadbalancer_name of this LoadbalancerinIpInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The loadbalancer_name of this LoadbalancerinIpInner.  # noqa: E501
        :rtype: str
        """
    ...
    def loadbalancer_name(self, loadbalancer_name):
        """Sets the loadbalancer_name of this LoadbalancerinIpInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param loadbalancer_name: The loadbalancer_name of this LoadbalancerinIpInner.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancerinIpInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancerinIpInner):
            return False
