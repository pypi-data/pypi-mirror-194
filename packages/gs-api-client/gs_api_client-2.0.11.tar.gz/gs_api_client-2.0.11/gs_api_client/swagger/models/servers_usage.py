...
class ServersUsage(object):
    ...
    def __init__(self, cores=None, memory=None, object_uuid=None, labels=None, power=None, deleted=None, name=None, status=None, current_usage_per_minute=None, usage_per_interval=None):  # noqa: E501
        """ServersUsage - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def cores(self):
        """Gets the cores of this ServersUsage.  # noqa: E501

        Number of server cores.  # noqa: E501

        :return: The cores of this ServersUsage.  # noqa: E501
        :rtype: int
        """
        return self._cores
    ...
    def cores(self, cores):
        """Sets the cores of this ServersUsage.

        Number of server cores.  # noqa: E501

        :param cores: The cores of this ServersUsage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def memory(self):
        """Gets the memory of this ServersUsage.  # noqa: E501

        Indicates the amount of memory in GB.  # noqa: E501

        :return: The memory of this ServersUsage.  # noqa: E501
        :rtype: int
        """
        return self._memory
    ...
    def memory(self, memory):
        """Sets the memory of this ServersUsage.

        Indicates the amount of memory in GB.  # noqa: E501

        :param memory: The memory of this ServersUsage.  # noqa: E501
        :type: int
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this ServersUsage.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this ServersUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this ServersUsage.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this ServersUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this ServersUsage.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this ServersUsage.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this ServersUsage.

        List of labels.  # noqa: E501

        :param labels: The labels of this ServersUsage.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def power(self):
        """Gets the power of this ServersUsage.  # noqa: E501

        The power status of the server.  # noqa: E501

        :return: The power of this ServersUsage.  # noqa: E501
        :rtype: bool
        """
        return self._power
    ...
    def power(self, power):
        """Sets the power of this ServersUsage.

        The power status of the server.  # noqa: E501

        :param power: The power of this ServersUsage.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def deleted(self):
        """Gets the deleted of this ServersUsage.  # noqa: E501

        The deleted status of the object.  # noqa: E501

        :return: The deleted of this ServersUsage.  # noqa: E501
        :rtype: bool
        """
    ...
    def deleted(self, deleted):
        """Sets the deleted of this ServersUsage.

        The deleted status of the object.  # noqa: E501

        :param deleted: The deleted of this ServersUsage.  # noqa: E501
        :type: bool
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ServersUsage.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this ServersUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ServersUsage.  # noqa: E501

        Status indicates the status of the object, e.g., in-provisioning or active.  # noqa: E501

        :return: The status of this ServersUsage.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ServersUsage.

        Status indicates the status of the object, e.g., in-provisioning or active.  # noqa: E501

        :param status: The status of this ServersUsage.  # noqa: E501
        :type: str
        """
    ...
    def current_usage_per_minute(self):
        """Gets the current_usage_per_minute of this ServersUsage.  # noqa: E501


        :return: The current_usage_per_minute of this ServersUsage.  # noqa: E501
    ...
    def current_usage_per_minute(self, current_usage_per_minute):
        """Sets the current_usage_per_minute of this ServersUsage.


        :param current_usage_per_minute: The current_usage_per_minute of this ServersUsage.  # noqa: E501
    ...
    def usage_per_interval(self):
        """Gets the usage_per_interval of this ServersUsage.  # noqa: E501


        :return: The usage_per_interval of this ServersUsage.  # noqa: E501
    ...
    def usage_per_interval(self, usage_per_interval):
        """Sets the usage_per_interval of this ServersUsage.


        :param usage_per_interval: The usage_per_interval of this ServersUsage.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServersUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServersUsage):
            return False
