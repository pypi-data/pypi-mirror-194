...
from gs_api_client.swagger.models.task_events_server_server_power_update_power import TaskEventsServerServerPowerUpdatePower  # noqa: F401,E501


class TaskEventsServerServerPowerUpdate(object):
    ...
    swagger_types = {
        ...
        'autotriger': 'TaskEventsSchedulesScheduleSnapshotPerform',
        'power': 'TaskEventsServerServerPowerUpdatePower'
    }

    attribute_map = {
        'server_uuid': 'server_uuid',
        'autotriger': 'autotriger',
        'power': 'power'
    }

    def __init__(self, server_uuid=None, autotriger=None, power=None):  # noqa: E501
        """TaskEventsServerServerPowerUpdate - a model defined in Swagger"""  # noqa: E501

        self._server_uuid = None
        self._autotriger = None
        self._power = None
        self.discriminator = None

        if server_uuid is not None:
            self.server_uuid = server_uuid
        if autotriger is not None:
            self.autotriger = autotriger
        if power is not None:
            self.power = power

    @property
    def server_uuid(self):
        """Gets the server_uuid of this TaskEventsServerServerPowerUpdate.  # noqa: E501


        :return: The server_uuid of this TaskEventsServerServerPowerUpdate.  # noqa: E501
    ...
    def server_uuid(self, server_uuid):
        """Sets the server_uuid of this TaskEventsServerServerPowerUpdate.


        :param server_uuid: The server_uuid of this TaskEventsServerServerPowerUpdate.  # noqa: E501
    ...
    @property
    def autotriger(self):
        """Gets the autotriger of this TaskEventsServerServerPowerUpdate.  # noqa: E501


        :return: The autotriger of this TaskEventsServerServerPowerUpdate.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotPerform
        """
        return self._autotriger

    @autotriger.setter
    def autotriger(self, autotriger):
        """Sets the autotriger of this TaskEventsServerServerPowerUpdate.


        :param autotriger: The autotriger of this TaskEventsServerServerPowerUpdate.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotPerform
        """

        self._autotriger = autotriger

    @property
    def power(self):
        """Gets the power of this TaskEventsServerServerPowerUpdate.  # noqa: E501


        :return: The power of this TaskEventsServerServerPowerUpdate.  # noqa: E501
        :rtype: TaskEventsServerServerPowerUpdatePower
        """
        return self._power

    @power.setter
    def power(self, power):
        """Sets the power of this TaskEventsServerServerPowerUpdate.


        :param power: The power of this TaskEventsServerServerPowerUpdate.  # noqa: E501
        :type: TaskEventsServerServerPowerUpdatePower
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsServerServerPowerUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsServerServerPowerUpdate):
            return False
