...
from gs_api_client.swagger.models.location_index import LocationIndex  # noqa: F401,E501


class LocationsGetResponse(object):
    ...
    def __init__(self, locations=None):  # noqa: E501
        """LocationsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def locations(self):
        """Gets the locations of this LocationsGetResponse.  # noqa: E501


        :return: The locations of this LocationsGetResponse.  # noqa: E501
        :rtype: LocationIndex
        """
    ...
    def locations(self, locations):
        """Sets the locations of this LocationsGetResponse.


        :param locations: The locations of this LocationsGetResponse.  # noqa: E501
        :type: LocationIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationsGetResponse):
            return False
