...
from gs_api_client.swagger.models.task_events_isoimage_isoimage_add_isoimage_uuid import TaskEventsIsoimageIsoimageAddIsoimageUuid  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_marketplace_template_marketplace_template_add_capacity import TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity  # noqa: F401,E501
...
from gs_api_client.swagger.models.task_events_storage_storage_add_storage_type import TaskEventsStorageStorageAddStorageType  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_storage_storage_add_template import TaskEventsStorageStorageAddTemplate  # noqa: F401,E501


class TaskEventsStorageStorageAdd(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'storage_uuid': 'TaskEventsIsoimageIsoimageAddIsoimageUuid',
        'location_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'template': 'TaskEventsStorageStorageAddTemplate',
        'capacity': 'TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity',
        'storage_type': 'TaskEventsStorageStorageAddStorageType'
    }
    ...
    def __init__(self, labels=None, name=None, storage_uuid=None, location_uuid=None, template=None, capacity=None, storage_type=None):  # noqa: E501
        """TaskEventsStorageStorageAdd - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The labels of this TaskEventsStorageStorageAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsStorageStorageAdd.


        :param labels: The labels of this TaskEventsStorageStorageAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The name of this TaskEventsStorageStorageAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsStorageStorageAdd.


        :param name: The name of this TaskEventsStorageStorageAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    def storage_uuid(self):
        """Gets the storage_uuid of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The storage_uuid of this TaskEventsStorageStorageAdd.  # noqa: E501
        :rtype: TaskEventsIsoimageIsoimageAddIsoimageUuid
        """
        return self._storage_uuid

    @storage_uuid.setter
    def storage_uuid(self, storage_uuid):
        """Sets the storage_uuid of this TaskEventsStorageStorageAdd.


        :param storage_uuid: The storage_uuid of this TaskEventsStorageStorageAdd.  # noqa: E501
        :type: TaskEventsIsoimageIsoimageAddIsoimageUuid
        """
    ...
    def location_uuid(self):
        """Gets the location_uuid of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The location_uuid of this TaskEventsStorageStorageAdd.  # noqa: E501
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this TaskEventsStorageStorageAdd.


        :param location_uuid: The location_uuid of this TaskEventsStorageStorageAdd.  # noqa: E501
    ...
    @property
    def template(self):
        """Gets the template of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The template of this TaskEventsStorageStorageAdd.  # noqa: E501
        :rtype: TaskEventsStorageStorageAddTemplate
        """
        return self._template

    @template.setter
    def template(self, template):
        """Sets the template of this TaskEventsStorageStorageAdd.


        :param template: The template of this TaskEventsStorageStorageAdd.  # noqa: E501
        :type: TaskEventsStorageStorageAddTemplate
        """
    ...
    @property
    def capacity(self):
        """Gets the capacity of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The capacity of this TaskEventsStorageStorageAdd.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity
        """
        return self._capacity

    @capacity.setter
    def capacity(self, capacity):
        """Sets the capacity of this TaskEventsStorageStorageAdd.


        :param capacity: The capacity of this TaskEventsStorageStorageAdd.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity
        """
    ...
    def storage_type(self):
        """Gets the storage_type of this TaskEventsStorageStorageAdd.  # noqa: E501


        :return: The storage_type of this TaskEventsStorageStorageAdd.  # noqa: E501
        :rtype: TaskEventsStorageStorageAddStorageType
        """
        return self._storage_type

    @storage_type.setter
    def storage_type(self, storage_type):
        """Sets the storage_type of this TaskEventsStorageStorageAdd.


        :param storage_type: The storage_type of this TaskEventsStorageStorageAdd.  # noqa: E501
        :type: TaskEventsStorageStorageAddStorageType
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsStorageStorageAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsStorageStorageAdd):
            return False
