...
from gs_api_client.swagger.models.task_events_paas_paas_service_add_credentials import TaskEventsPaasPaasServiceAddCredentials  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_service_add_resource_limit import TaskEventsPaasPaasServiceAddResourceLimit  # noqa: F401,E501
...
class TaskEventsPaasPaasServiceAdd(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'paas_security_zone_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'network_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'paas_service_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'paas_template_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'credentials': 'TaskEventsPaasPaasServiceAddCredentials',
        'resource_limit': 'TaskEventsPaasPaasServiceAddResourceLimit',
        'parameters': 'TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps'
    }

    attribute_map = {
        'labels': 'labels',
        'name': 'name',
        'paas_security_zone_uuid': 'paas_security_zone_uuid',
        'network_uuid': 'network_uuid',
        'paas_service_uuid': 'paas_service_uuid',
        'paas_template_uuid': 'paas_template_uuid',
        'credentials': 'credentials',
        'resource_limit': 'resource_limit',
        'parameters': 'parameters'
    }

    def __init__(self, labels=None, name=None, paas_security_zone_uuid=None, network_uuid=None, paas_service_uuid=None, paas_template_uuid=None, credentials=None, resource_limit=None, parameters=None):  # noqa: E501
        """TaskEventsPaasPaasServiceAdd - a model defined in Swagger"""  # noqa: E501

        self._labels = None
        self._name = None
        self._paas_security_zone_uuid = None
        self._network_uuid = None
        self._paas_service_uuid = None
        self._paas_template_uuid = None
        ...
        if name is not None:
            self.name = name
        if paas_security_zone_uuid is not None:
            self.paas_security_zone_uuid = paas_security_zone_uuid
        if network_uuid is not None:
            self.network_uuid = network_uuid
        if paas_service_uuid is not None:
            self.paas_service_uuid = paas_service_uuid
        if paas_template_uuid is not None:
            self.paas_template_uuid = paas_template_uuid
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The labels of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsPaasPaasServiceAdd.


        :param labels: The labels of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The name of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsPaasPaasServiceAdd.


        :param name: The name of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    @property
    def paas_security_zone_uuid(self):
        """Gets the paas_security_zone_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The paas_security_zone_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
        return self._paas_security_zone_uuid

    @paas_security_zone_uuid.setter
    def paas_security_zone_uuid(self, paas_security_zone_uuid):
        """Sets the paas_security_zone_uuid of this TaskEventsPaasPaasServiceAdd.


        :param paas_security_zone_uuid: The paas_security_zone_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """

        self._paas_security_zone_uuid = paas_security_zone_uuid

    @property
    def network_uuid(self):
        """Gets the network_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The network_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this TaskEventsPaasPaasServiceAdd.


        :param network_uuid: The network_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
    ...
    @property
    def paas_service_uuid(self):
        """Gets the paas_service_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The paas_service_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
        return self._paas_service_uuid

    @paas_service_uuid.setter
    def paas_service_uuid(self, paas_service_uuid):
        """Sets the paas_service_uuid of this TaskEventsPaasPaasServiceAdd.


        :param paas_service_uuid: The paas_service_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """

        self._paas_service_uuid = paas_service_uuid

    @property
    def paas_template_uuid(self):
        """Gets the paas_template_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The paas_template_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
        return self._paas_template_uuid

    @paas_template_uuid.setter
    def paas_template_uuid(self, paas_template_uuid):
        """Sets the paas_template_uuid of this TaskEventsPaasPaasServiceAdd.


        :param paas_template_uuid: The paas_template_uuid of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """

        self._paas_template_uuid = paas_template_uuid

    @property
    def credentials(self):
        """Gets the credentials of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The credentials of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceAddCredentials
        """
        return self._credentials

    @credentials.setter
    def credentials(self, credentials):
        """Sets the credentials of this TaskEventsPaasPaasServiceAdd.


        :param credentials: The credentials of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventsPaasPaasServiceAddCredentials
        """
    ...
    def resource_limit(self):
        """Gets the resource_limit of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The resource_limit of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceAddResourceLimit
        """
        return self._resource_limit

    @resource_limit.setter
    def resource_limit(self, resource_limit):
        """Sets the resource_limit of this TaskEventsPaasPaasServiceAdd.


        :param resource_limit: The resource_limit of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
        :type: TaskEventsPaasPaasServiceAddResourceLimit
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this TaskEventsPaasPaasServiceAdd.  # noqa: E501


        :return: The parameters of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
    ...
    def parameters(self, parameters):
        """Sets the parameters of this TaskEventsPaasPaasServiceAdd.


        :param parameters: The parameters of this TaskEventsPaasPaasServiceAdd.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsPaasPaasServiceAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsPaasPaasServiceAdd):
            return False
