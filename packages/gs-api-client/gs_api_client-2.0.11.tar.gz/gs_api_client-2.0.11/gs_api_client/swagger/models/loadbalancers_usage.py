...
class LoadbalancersUsage(object):
    ...
    def __init__(self, object_uuid=None, name=None, forwarding_rules=None, backend_servers=None, change_time=None, status=None, redirect_http_to_https=None, algorithm=None, listen_ipv4_uuid=None, listen_ipv6_uuid=None, current_usage_per_minute=None, usage_per_interval=None):  # noqa: E501
        """LoadbalancersUsage - a model defined in Swagger"""  # noqa: E501
    ...
    def object_uuid(self):
        """Gets the object_uuid of this LoadbalancersUsage.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this LoadbalancersUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this LoadbalancersUsage.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this LoadbalancersUsage.  # noqa: E501
        :type: str
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LoadbalancersUsage.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this LoadbalancersUsage.  # noqa: E501
        :type: str
        """
    ...
    def forwarding_rules(self):
        """Gets the forwarding_rules of this LoadbalancersUsage.  # noqa: E501

        An array of objects containing the forwarding rules of the load balancer. The listen_port field specifies the entry port of the load balancer and the target_port field specifies the exit port that the load balancer uses to forward the traffic to the backend server. The load balancer supports HTTP and TCP modes. Furthermore, the load balancer supports SSL termination for letsencrypt and custom certificates (e.g., bring your own certificate). The certificate_uuid is the UUID of a custom certificate and is an optional field, but letsencrypt is a required field, which should be set to null if no letsencrypt is requested.  # noqa: E501

        :return: The forwarding_rules of this LoadbalancersUsage.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def forwarding_rules(self, forwarding_rules):
        """Sets the forwarding_rules of this LoadbalancersUsage.

        An array of objects containing the forwarding rules of the load balancer. The listen_port field specifies the entry port of the load balancer and the target_port field specifies the exit port that the load balancer uses to forward the traffic to the backend server. The load balancer supports HTTP and TCP modes. Furthermore, the load balancer supports SSL termination for letsencrypt and custom certificates (e.g., bring your own certificate). The certificate_uuid is the UUID of a custom certificate and is an optional field, but letsencrypt is a required field, which should be set to null if no letsencrypt is requested.  # noqa: E501

        :param forwarding_rules: The forwarding_rules of this LoadbalancersUsage.  # noqa: E501
        :type: list[object]
        """
    ...
    def backend_servers(self):
        """Gets the backend_servers of this LoadbalancersUsage.  # noqa: E501

        The servers that this Load balancer can communicate with (see table below).  # noqa: E501

        :return: The backend_servers of this LoadbalancersUsage.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def backend_servers(self, backend_servers):
        """Sets the backend_servers of this LoadbalancersUsage.

        The servers that this Load balancer can communicate with (see table below).  # noqa: E501

        :param backend_servers: The backend_servers of this LoadbalancersUsage.  # noqa: E501
        :type: list[object]
        """
    ...
    def change_time(self):
        """Gets the change_time of this LoadbalancersUsage.  # noqa: E501

        Defines the date and time of the last object change.  # noqa: E501

        :return: The change_time of this LoadbalancersUsage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this LoadbalancersUsage.

        Defines the date and time of the last object change.  # noqa: E501

        :param change_time: The change_time of this LoadbalancersUsage.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def status(self):
        """Gets the status of this LoadbalancersUsage.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this LoadbalancersUsage.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this LoadbalancersUsage.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this LoadbalancersUsage.  # noqa: E501
        :type: str
        """
    ...
    def redirect_http_to_https(self):
        """Gets the redirect_http_to_https of this LoadbalancersUsage.  # noqa: E501

        Whether the Load balancer is forced to redirect requests from HTTP to HTTPS.  # noqa: E501

        :return: The redirect_http_to_https of this LoadbalancersUsage.  # noqa: E501
        :rtype: bool
        """
    ...
    def redirect_http_to_https(self, redirect_http_to_https):
        """Sets the redirect_http_to_https of this LoadbalancersUsage.

        Whether the Load balancer is forced to redirect requests from HTTP to HTTPS.  # noqa: E501

        :param redirect_http_to_https: The redirect_http_to_https of this LoadbalancersUsage.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def algorithm(self):
        """Gets the algorithm of this LoadbalancersUsage.  # noqa: E501

        The algorithm used to process requests. Accepted values: roundrobin / leastconn.  # noqa: E501

        :return: The algorithm of this LoadbalancersUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def algorithm(self, algorithm):
        """Sets the algorithm of this LoadbalancersUsage.

        The algorithm used to process requests. Accepted values: roundrobin / leastconn.  # noqa: E501

        :param algorithm: The algorithm of this LoadbalancersUsage.  # noqa: E501
        :type: str
        """
    ...
    def listen_ipv4_uuid(self):
        """Gets the listen_ipv4_uuid of this LoadbalancersUsage.  # noqa: E501

        The UUID of the IPv4 address the Load balancer will listen to for incoming requests.  # noqa: E501

        :return: The listen_ipv4_uuid of this LoadbalancersUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def listen_ipv4_uuid(self, listen_ipv4_uuid):
        """Sets the listen_ipv4_uuid of this LoadbalancersUsage.

        The UUID of the IPv4 address the Load balancer will listen to for incoming requests.  # noqa: E501

        :param listen_ipv4_uuid: The listen_ipv4_uuid of this LoadbalancersUsage.  # noqa: E501
        :type: str
        """
    ...
    def listen_ipv6_uuid(self):
        """Gets the listen_ipv6_uuid of this LoadbalancersUsage.  # noqa: E501

        The UUID of the IPv6 address the Load balancer will listen to for incoming requests.  # noqa: E501

        :return: The listen_ipv6_uuid of this LoadbalancersUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def listen_ipv6_uuid(self, listen_ipv6_uuid):
        """Sets the listen_ipv6_uuid of this LoadbalancersUsage.

        The UUID of the IPv6 address the Load balancer will listen to for incoming requests.  # noqa: E501

        :param listen_ipv6_uuid: The listen_ipv6_uuid of this LoadbalancersUsage.  # noqa: E501
        :type: str
        """
    ...
    def current_usage_per_minute(self):
        """Gets the current_usage_per_minute of this LoadbalancersUsage.  # noqa: E501


        :return: The current_usage_per_minute of this LoadbalancersUsage.  # noqa: E501
    ...
    def current_usage_per_minute(self, current_usage_per_minute):
        """Sets the current_usage_per_minute of this LoadbalancersUsage.


        :param current_usage_per_minute: The current_usage_per_minute of this LoadbalancersUsage.  # noqa: E501
    ...
    def usage_per_interval(self):
        """Gets the usage_per_interval of this LoadbalancersUsage.  # noqa: E501


        :return: The usage_per_interval of this LoadbalancersUsage.  # noqa: E501
    ...
    def usage_per_interval(self, usage_per_interval):
        """Sets the usage_per_interval of this LoadbalancersUsage.


        :param usage_per_interval: The usage_per_interval of this LoadbalancersUsage.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancersUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancersUsage):
            return False
