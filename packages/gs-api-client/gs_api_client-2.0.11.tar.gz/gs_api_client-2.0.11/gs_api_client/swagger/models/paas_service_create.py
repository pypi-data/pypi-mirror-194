...
class PaasServiceCreate(object):
    ...
    swagger_types = {
        'name': 'str',
        'paas_service_template_uuid': 'str',
        'labels': 'list[str]',
        'paas_security_zone_uuid': 'str',
        'network_uuid': 'str',
    ...
    def __init__(self, name=None, paas_service_template_uuid=None, labels=None, paas_security_zone_uuid=None, network_uuid=None, parameters=None, resource_limits=None):  # noqa: E501
        """PaasServiceCreate - a model defined in Swagger"""  # noqa: E501

        self._name = None
        self._paas_service_template_uuid = None
        self._labels = None
        ...
        self.name = name
        self.paas_service_template_uuid = paas_service_template_uuid
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PaasServiceCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this PaasServiceCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def paas_service_template_uuid(self):
        """Gets the paas_service_template_uuid of this PaasServiceCreate.  # noqa: E501

        The template used to create the service, you can find an available list at the /service_templates endpoint.  # noqa: E501

        :return: The paas_service_template_uuid of this PaasServiceCreate.  # noqa: E501
        :rtype: str
        """
        return self._paas_service_template_uuid

    @paas_service_template_uuid.setter
    def paas_service_template_uuid(self, paas_service_template_uuid):
        """Sets the paas_service_template_uuid of this PaasServiceCreate.

        The template used to create the service, you can find an available list at the /service_templates endpoint.  # noqa: E501

        :param paas_service_template_uuid: The paas_service_template_uuid of this PaasServiceCreate.  # noqa: E501
        :type: str
        """
        if paas_service_template_uuid is None:
            raise ValueError("Invalid value for `paas_service_template_uuid`, must not be `None`")  # noqa: E501

        self._paas_service_template_uuid = paas_service_template_uuid

    @property
    def labels(self):
        """Gets the labels of this PaasServiceCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this PaasServiceCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this PaasServiceCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this PaasServiceCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def paas_security_zone_uuid(self):
        """Gets the paas_security_zone_uuid of this PaasServiceCreate.  # noqa: E501

        The UUID of the security zone that the service is running in.  # noqa: E501

        :return: The paas_security_zone_uuid of this PaasServiceCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def paas_security_zone_uuid(self, paas_security_zone_uuid):
        """Sets the paas_security_zone_uuid of this PaasServiceCreate.

        The UUID of the security zone that the service is running in.  # noqa: E501

        :param paas_security_zone_uuid: The paas_security_zone_uuid of this PaasServiceCreate.  # noqa: E501
        :type: str
        """
    ...
    def network_uuid(self):
        """Gets the network_uuid of this PaasServiceCreate.  # noqa: E501

        The UUID of the private network to which the service should be connected  # noqa: E501

        :return: The network_uuid of this PaasServiceCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this PaasServiceCreate.

        The UUID of the private network to which the service should be connected  # noqa: E501

        :param network_uuid: The network_uuid of this PaasServiceCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this PaasServiceCreate.  # noqa: E501


        :return: The parameters of this PaasServiceCreate.  # noqa: E501
    ...
    def parameters(self, parameters):
        """Sets the parameters of this PaasServiceCreate.


        :param parameters: The parameters of this PaasServiceCreate.  # noqa: E501
    ...
    def resource_limits(self):
        """Gets the resource_limits of this PaasServiceCreate.  # noqa: E501


        :return: The resource_limits of this PaasServiceCreate.  # noqa: E501
    ...
    def resource_limits(self, resource_limits):
        """Sets the resource_limits of this PaasServiceCreate.


        :param resource_limits: The resource_limits of this PaasServiceCreate.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceCreate):
            return False
