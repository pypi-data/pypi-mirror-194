...
from gs_api_client.swagger.models.ip_brief_index import IpBriefIndex  # noqa: F401,E501


class DeletedIpsGetResponse(object):
    ...
    def __init__(self, deleted_ips=None):  # noqa: E501
        """DeletedIpsGetResponse - a model defined in Swagger"""  # noqa: E501

        self._deleted_ips = None
        self.discriminator = None

        if deleted_ips is not None:
            self.deleted_ips = deleted_ips

    @property
    def deleted_ips(self):
        """Gets the deleted_ips of this DeletedIpsGetResponse.  # noqa: E501


        :return: The deleted_ips of this DeletedIpsGetResponse.  # noqa: E501
        :rtype: IpBriefIndex
        """
        return self._deleted_ips

    @deleted_ips.setter
    def deleted_ips(self, deleted_ips):
        """Sets the deleted_ips of this DeletedIpsGetResponse.


        :param deleted_ips: The deleted_ips of this DeletedIpsGetResponse.  # noqa: E501
        :type: IpBriefIndex
        """

        self._deleted_ips = deleted_ips
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedIpsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedIpsGetResponse):
            return False
