...
class RulesProperties(object):
    ...
    def __init__(self, protocol=None, dst_port=None, src_port=None, src_cidr=None, action=None, comment=None, dst_cidr=None, order=None):  # noqa: E501
        """RulesProperties - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def protocol(self):
        """Gets the protocol of this RulesProperties.  # noqa: E501

        Either udp or tcp  # noqa: E501

        :return: The protocol of this RulesProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this RulesProperties.

        Either udp or tcp  # noqa: E501

        :param protocol: The protocol of this RulesProperties.  # noqa: E501
        :type: str
        """
        if protocol is None:
    ...
    @property
    def dst_port(self):
        """Gets the dst_port of this RulesProperties.  # noqa: E501

        A Number between 1 and 65535, port ranges are seperated by a colon for FTP.  # noqa: E501

        :return: The dst_port of this RulesProperties.  # noqa: E501
        :rtype: object
        """
    ...
    def dst_port(self, dst_port):
        """Sets the dst_port of this RulesProperties.

        A Number between 1 and 65535, port ranges are seperated by a colon for FTP.  # noqa: E501

        :param dst_port: The dst_port of this RulesProperties.  # noqa: E501
        :type: object
        """
    ...
    @property
    def src_port(self):
        """Gets the src_port of this RulesProperties.  # noqa: E501

        A Number between 1 and 65535, port ranges are seperated by a colon for FTP.  # noqa: E501

        :return: The src_port of this RulesProperties.  # noqa: E501
        :rtype: object
        """
    ...
    def src_port(self, src_port):
        """Sets the src_port of this RulesProperties.

        A Number between 1 and 65535, port ranges are seperated by a colon for FTP.  # noqa: E501

        :param src_port: The src_port of this RulesProperties.  # noqa: E501
        :type: object
        """
    ...
    @property
    def src_cidr(self):
        """Gets the src_cidr of this RulesProperties.  # noqa: E501


        :return: The src_cidr of this RulesProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def src_cidr(self, src_cidr):
        """Sets the src_cidr of this RulesProperties.


        :param src_cidr: The src_cidr of this RulesProperties.  # noqa: E501
        :type: str
        """
    ...
    @property
    def action(self):
        """Gets the action of this RulesProperties.  # noqa: E501

        This defines what the firewall will do. Either accept or drop.  # noqa: E501

        :return: The action of this RulesProperties.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this RulesProperties.

        This defines what the firewall will do. Either accept or drop.  # noqa: E501

        :param action: The action of this RulesProperties.  # noqa: E501
        :type: str
        """
        if action is None:
            raise ValueError("Invalid value for `action`, must not be `None`")  # noqa: E501
        allowed_values = ["accept", "drop"]  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this RulesProperties.  # noqa: E501


        :return: The comment of this RulesProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this RulesProperties.


        :param comment: The comment of this RulesProperties.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dst_cidr(self):
        """Gets the dst_cidr of this RulesProperties.  # noqa: E501

        Either an IPv4/6 address or and IP Network in CIDR format. If this field is empty then all IPs have access to this service.  # noqa: E501

        :return: The dst_cidr of this RulesProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def dst_cidr(self, dst_cidr):
        """Sets the dst_cidr of this RulesProperties.

        Either an IPv4/6 address or and IP Network in CIDR format. If this field is empty then all IPs have access to this service.  # noqa: E501

        :param dst_cidr: The dst_cidr of this RulesProperties.  # noqa: E501
        :type: str
        """
    ...
    def order(self, order):
        """Sets the order of this RulesProperties.

        The order at which the firewall will compare packets against its rules, a packet will be compared against the first rule, it will either allow it to pass or block it and it won t be matched against any other rules. However, if it does no match the rule, then it will proceed onto rule 2. Packets that do not match any rules are blocked by default.  # noqa: E501

        :param order: The order of this RulesProperties.  # noqa: E501
        :type: str
        """
        if order is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RulesProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RulesProperties):
            return False
