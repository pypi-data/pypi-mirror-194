...
class LocationChangeRequested(object):
    ...
    def __init__(self, cpunode_count=None, product_no=None, parent_location_uuid=None):  # noqa: E501
        """LocationChangeRequested - a model defined in Swagger"""  # noqa: E501
        ...
        if parent_location_uuid is not None:
            self.parent_location_uuid = parent_location_uuid

    @property
    def cpunode_count(self):
        """Gets the cpunode_count of this LocationChangeRequested.  # noqa: E501

        The requested number of dedicated cpunodes.  # noqa: E501

        :return: The cpunode_count of this LocationChangeRequested.  # noqa: E501
        :rtype: str
        """
    ...
    def cpunode_count(self, cpunode_count):
        """Sets the cpunode_count of this LocationChangeRequested.

        The requested number of dedicated cpunodes.  # noqa: E501

        :param cpunode_count: The cpunode_count of this LocationChangeRequested.  # noqa: E501
        :type: str
        """
    ...
    @property
    def product_no(self):
        """Gets the product_no of this LocationChangeRequested.  # noqa: E501

        The product number of a valid and available dedicated cpunode article.  # noqa: E501

        :return: The product_no of this LocationChangeRequested.  # noqa: E501
        :rtype: int
        """
    ...
    def product_no(self, product_no):
        """Sets the product_no of this LocationChangeRequested.

        The product number of a valid and available dedicated cpunode article.  # noqa: E501

        :param product_no: The product_no of this LocationChangeRequested.  # noqa: E501
        :type: int
        """
    ...
    def parent_location_uuid(self):
        """Gets the parent_location_uuid of this LocationChangeRequested.  # noqa: E501

        The location_uuid of an existing public location in which to create the private location.  # noqa: E501

        :return: The parent_location_uuid of this LocationChangeRequested.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_location_uuid(self, parent_location_uuid):
        """Sets the parent_location_uuid of this LocationChangeRequested.

        The location_uuid of an existing public location in which to create the private location.  # noqa: E501

        :param parent_location_uuid: The parent_location_uuid of this LocationChangeRequested.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationChangeRequested, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationChangeRequested):
            return False
