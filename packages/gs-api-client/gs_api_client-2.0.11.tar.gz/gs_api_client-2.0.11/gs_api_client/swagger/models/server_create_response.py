...
class ServerCreateResponse(object):
    ...
    attribute_map = {
        ...
        'ipaddr_uuids': 'ipaddr_uuids'
    }

    def __init__(self, server_uuid=None, object_uuid=None, request_uuid=None, network_uuids=None, storage_uuids=None, ipaddr_uuids=None):  # noqa: E501
        """ServerCreateResponse - a model defined in Swagger"""  # noqa: E501

        self._server_uuid = None
        self._object_uuid = None
        self._request_uuid = None
        self._network_uuids = None
        self._storage_uuids = None
        self._ipaddr_uuids = None
        ...
        if network_uuids is not None:
            self.network_uuids = network_uuids
        if storage_uuids is not None:
            self.storage_uuids = storage_uuids
        if ipaddr_uuids is not None:
            self.ipaddr_uuids = ipaddr_uuids

    @property
    def server_uuid(self):
        """Gets the server_uuid of this ServerCreateResponse.  # noqa: E501


        :return: The server_uuid of this ServerCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def server_uuid(self, server_uuid):
        """Sets the server_uuid of this ServerCreateResponse.


        :param server_uuid: The server_uuid of this ServerCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this ServerCreateResponse.  # noqa: E501


        :return: The object_uuid of this ServerCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this ServerCreateResponse.


        :param object_uuid: The object_uuid of this ServerCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def request_uuid(self):
        """Gets the request_uuid of this ServerCreateResponse.  # noqa: E501


        :return: The request_uuid of this ServerCreateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def request_uuid(self, request_uuid):
        """Sets the request_uuid of this ServerCreateResponse.


        :param request_uuid: The request_uuid of this ServerCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def network_uuids(self):
        """Gets the network_uuids of this ServerCreateResponse.  # noqa: E501


        :return: The network_uuids of this ServerCreateResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._network_uuids

    @network_uuids.setter
    def network_uuids(self, network_uuids):
        """Sets the network_uuids of this ServerCreateResponse.


        :param network_uuids: The network_uuids of this ServerCreateResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def storage_uuids(self):
        """Gets the storage_uuids of this ServerCreateResponse.  # noqa: E501


        :return: The storage_uuids of this ServerCreateResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._storage_uuids

    @storage_uuids.setter
    def storage_uuids(self, storage_uuids):
        """Sets the storage_uuids of this ServerCreateResponse.


        :param storage_uuids: The storage_uuids of this ServerCreateResponse.  # noqa: E501
        :type: list[str]
        """

        self._storage_uuids = storage_uuids

    @property
    def ipaddr_uuids(self):
        """Gets the ipaddr_uuids of this ServerCreateResponse.  # noqa: E501


        :return: The ipaddr_uuids of this ServerCreateResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._ipaddr_uuids

    @ipaddr_uuids.setter
    def ipaddr_uuids(self, ipaddr_uuids):
        """Sets the ipaddr_uuids of this ServerCreateResponse.


        :param ipaddr_uuids: The ipaddr_uuids of this ServerCreateResponse.  # noqa: E501
        :type: list[str]
        """

        self._ipaddr_uuids = ipaddr_uuids
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerCreateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerCreateResponse):
            return False
