...
class AccessKeyCreate(object):
    ...
    def __init__(self, comment=None, user_uuid=None):  # noqa: E501
        """AccessKeyCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this AccessKeyCreate.  # noqa: E501

        Comment for the access_key  # noqa: E501

        :return: The comment of this AccessKeyCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this AccessKeyCreate.

        Comment for the access_key  # noqa: E501

        :param comment: The comment of this AccessKeyCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_uuid(self):
        """Gets the user_uuid of this AccessKeyCreate.  # noqa: E501

        Which User UUID the access key will be created  # noqa: E501

        :return: The user_uuid of this AccessKeyCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def user_uuid(self, user_uuid):
        """Sets the user_uuid of this AccessKeyCreate.

        Which User UUID the access key will be created  # noqa: E501

        :param user_uuid: The user_uuid of this AccessKeyCreate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccessKeyCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessKeyCreate):
            return False
