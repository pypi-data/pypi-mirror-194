...
class MarketplaceApplicationSetup(object):
    ...
    def __init__(self, capacity=None, cores=None, memory=None):  # noqa: E501
        """MarketplaceApplicationSetup - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def capacity(self):
        """Gets the capacity of this MarketplaceApplicationSetup.  # noqa: E501

        The capacity of a storage in GB.  # noqa: E501

        :return: The capacity of this MarketplaceApplicationSetup.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this MarketplaceApplicationSetup.

        The capacity of a storage in GB.  # noqa: E501

        :param capacity: The capacity of this MarketplaceApplicationSetup.  # noqa: E501
        :type: int
        """
    ...
    @property
    def cores(self):
        """Gets the cores of this MarketplaceApplicationSetup.  # noqa: E501

        Number of server cores.  # noqa: E501

        :return: The cores of this MarketplaceApplicationSetup.  # noqa: E501
        :rtype: int
        """
        return self._cores
    ...
    def cores(self, cores):
        """Sets the cores of this MarketplaceApplicationSetup.

        Number of server cores.  # noqa: E501

        :param cores: The cores of this MarketplaceApplicationSetup.  # noqa: E501
        :type: int
        """
    ...
    @property
    def memory(self):
        """Gets the memory of this MarketplaceApplicationSetup.  # noqa: E501

        Number of server memory.  # noqa: E501

        :return: The memory of this MarketplaceApplicationSetup.  # noqa: E501
        :rtype: int
        """
        return self._memory
    ...
    def memory(self, memory):
        """Sets the memory of this MarketplaceApplicationSetup.

        Number of server memory.  # noqa: E501

        :param memory: The memory of this MarketplaceApplicationSetup.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketplaceApplicationSetup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketplaceApplicationSetup):
            return False
