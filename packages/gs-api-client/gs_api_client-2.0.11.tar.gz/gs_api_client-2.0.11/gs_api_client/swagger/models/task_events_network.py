...
from gs_api_client.swagger.models.task_events_network_network_add import TaskEventsNetworkNetworkAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_network_network_remove import TaskEventsNetworkNetworkRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_network_network_update import TaskEventsNetworkNetworkUpdate  # noqa: F401,E501


class TaskEventsNetwork(object):
    ...
    """
    swagger_types = {
        'network_add': 'TaskEventsNetworkNetworkAdd',
        'network_update': 'TaskEventsNetworkNetworkUpdate',
        'network_remove': 'TaskEventsNetworkNetworkRemove'
    }
    ...
    def __init__(self, network_add=None, network_update=None, network_remove=None):  # noqa: E501
        """TaskEventsNetwork - a model defined in Swagger"""  # noqa: E501

        self._network_add = None
        self._network_update = None
        self._network_remove = None
        self.discriminator = None

        if network_add is not None:
            self.network_add = network_add
        if network_update is not None:
            self.network_update = network_update
        if network_remove is not None:
            self.network_remove = network_remove

    @property
    def network_add(self):
        """Gets the network_add of this TaskEventsNetwork.  # noqa: E501


        :return: The network_add of this TaskEventsNetwork.  # noqa: E501
        :rtype: TaskEventsNetworkNetworkAdd
        """
        return self._network_add

    @network_add.setter
    def network_add(self, network_add):
        """Sets the network_add of this TaskEventsNetwork.


        :param network_add: The network_add of this TaskEventsNetwork.  # noqa: E501
        :type: TaskEventsNetworkNetworkAdd
        """

        self._network_add = network_add

    @property
    def network_update(self):
        """Gets the network_update of this TaskEventsNetwork.  # noqa: E501


        :return: The network_update of this TaskEventsNetwork.  # noqa: E501
        :rtype: TaskEventsNetworkNetworkUpdate
        """
        return self._network_update

    @network_update.setter
    def network_update(self, network_update):
        """Sets the network_update of this TaskEventsNetwork.


        :param network_update: The network_update of this TaskEventsNetwork.  # noqa: E501
        :type: TaskEventsNetworkNetworkUpdate
        """

        self._network_update = network_update

    @property
    def network_remove(self):
        """Gets the network_remove of this TaskEventsNetwork.  # noqa: E501


        :return: The network_remove of this TaskEventsNetwork.  # noqa: E501
        :rtype: TaskEventsNetworkNetworkRemove
        """
        return self._network_remove

    @network_remove.setter
    def network_remove(self, network_remove):
        """Sets the network_remove of this TaskEventsNetwork.


        :param network_remove: The network_remove of this TaskEventsNetwork.  # noqa: E501
        :type: TaskEventsNetworkNetworkRemove
        """

        self._network_remove = network_remove
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsNetwork, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsNetwork):
            return False
