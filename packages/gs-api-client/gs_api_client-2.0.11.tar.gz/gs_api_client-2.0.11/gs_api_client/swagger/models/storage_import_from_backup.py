...
from gs_api_client.swagger.models.storage_import_from_backup_backup import StorageImportFromBackupBackup  # noqa: F401,E501


class StorageImportFromBackup(object):
    ...
    """
    swagger_types = {
        'backup': 'StorageImportFromBackupBackup'
    }
    ...
    def __init__(self, backup=None):  # noqa: E501
        """StorageImportFromBackup - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def backup(self):
        """Gets the backup of this StorageImportFromBackup.  # noqa: E501


        :return: The backup of this StorageImportFromBackup.  # noqa: E501
        :rtype: StorageImportFromBackupBackup
        """
        return self._backup

    @backup.setter
    def backup(self, backup):
        """Sets the backup of this StorageImportFromBackup.


        :param backup: The backup of this StorageImportFromBackup.  # noqa: E501
        :type: StorageImportFromBackupBackup
        """
        if backup is None:
            raise ValueError("Invalid value for `backup`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageImportFromBackup, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageImportFromBackup):
            return False
