...
from gs_api_client.swagger.models.listen_ports import ListenPorts  # noqa: F401,E501


class ListenPortsByIpIndex(dict):
    ...
    def __init__(self):  # noqa: E501
        """ListenPortsByIpIndex - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListenPortsByIpIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListenPortsByIpIndex):
            return False
