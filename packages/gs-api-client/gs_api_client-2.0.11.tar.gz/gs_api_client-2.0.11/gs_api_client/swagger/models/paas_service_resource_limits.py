...
from gs_api_client.swagger.models.paas_service_resource_limit import PaasServiceResourceLimit  # noqa: F401,E501


class PaasServiceResourceLimits(object):
    ...
    def __init__(self):  # noqa: E501
        """PaasServiceResourceLimits - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceResourceLimits, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceResourceLimits):
            return False
