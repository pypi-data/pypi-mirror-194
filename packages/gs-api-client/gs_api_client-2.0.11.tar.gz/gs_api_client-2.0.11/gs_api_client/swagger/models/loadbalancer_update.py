...
from gs_api_client.swagger.models.loadbalancer_create_backend_servers import LoadbalancerCreateBackendServers  # noqa: F401,E501
from gs_api_client.swagger.models.loadbalancer_create_forwarding_rules import LoadbalancerCreateForwardingRules  # noqa: F401,E501


class LoadbalancerUpdate(object):
    ...
    swagger_types = {
        'name': 'str',
        'forwarding_rules': 'list[LoadbalancerCreateForwardingRules]',
        'backend_servers': 'list[LoadbalancerCreateBackendServers]',
        'status': 'str',
    ...
    def __init__(self, name=None, forwarding_rules=None, backend_servers=None, status=None, redirect_http_to_https=None, labels=None, algorithm=None):  # noqa: E501
        """LoadbalancerUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LoadbalancerUpdate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this LoadbalancerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def forwarding_rules(self):
        """Gets the forwarding_rules of this LoadbalancerUpdate.  # noqa: E501
        ...
        :return: The forwarding_rules of this LoadbalancerUpdate.  # noqa: E501
        :rtype: list[LoadbalancerCreateForwardingRules]
        """
        return self._forwarding_rules

    @forwarding_rules.setter
    def forwarding_rules(self, forwarding_rules):
        """Sets the forwarding_rules of this LoadbalancerUpdate.

        An array of objects containing the forwarding rules of the load balancer. The listen_port field specifies the entry port of the load balancer and the target_port field specifies the exit port that the load balancer uses to forward the traffic to the backend server. The load balancer supports HTTP and TCP modes. Furthermore, the load balancer supports SSL termination for letsencrypt and custom certificates (e.g., bring your own certificate). The certificate_uuid is the UUID of a custom certificate and is an optional field, but letsencrypt is a required field, which should be set to null if no letsencrypt is requested.  # noqa: E501

        :param forwarding_rules: The forwarding_rules of this LoadbalancerUpdate.  # noqa: E501
        :type: list[LoadbalancerCreateForwardingRules]
        """
    ...
    def backend_servers(self):
        """Gets the backend_servers of this LoadbalancerUpdate.  # noqa: E501

        The servers that this Load balancer can communicate with  # noqa: E501

        :return: The backend_servers of this LoadbalancerUpdate.  # noqa: E501
        :rtype: list[LoadbalancerCreateBackendServers]
        """
        return self._backend_servers

    @backend_servers.setter
    def backend_servers(self, backend_servers):
        """Sets the backend_servers of this LoadbalancerUpdate.

        The servers that this Load balancer can communicate with  # noqa: E501

        :param backend_servers: The backend_servers of this LoadbalancerUpdate.  # noqa: E501
        :type: list[LoadbalancerCreateBackendServers]
        """
    ...
    @property
    def status(self):
        """Gets the status of this LoadbalancerUpdate.  # noqa: E501

        Status indicates the status of the object.  # noqa: E501

        :return: The status of this LoadbalancerUpdate.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this LoadbalancerUpdate.

        Status indicates the status of the object.  # noqa: E501

        :param status: The status of this LoadbalancerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def redirect_http_to_https(self):
        """Gets the redirect_http_to_https of this LoadbalancerUpdate.  # noqa: E501

        Whether the Load balancer is forced to redirect requests from HTTP to HTTPS.  # noqa: E501

        :return: The redirect_http_to_https of this LoadbalancerUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def redirect_http_to_https(self, redirect_http_to_https):
        """Sets the redirect_http_to_https of this LoadbalancerUpdate.

        Whether the Load balancer is forced to redirect requests from HTTP to HTTPS.  # noqa: E501

        :param redirect_http_to_https: The redirect_http_to_https of this LoadbalancerUpdate.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this LoadbalancerUpdate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this LoadbalancerUpdate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this LoadbalancerUpdate.

        List of labels.  # noqa: E501

        :param labels: The labels of this LoadbalancerUpdate.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def algorithm(self):
        """Gets the algorithm of this LoadbalancerUpdate.  # noqa: E501

        The algorithm used to process requests. Accepted values: roundrobin / leastconn.  # noqa: E501

        :return: The algorithm of this LoadbalancerUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def algorithm(self, algorithm):
        """Sets the algorithm of this LoadbalancerUpdate.

        The algorithm used to process requests. Accepted values: roundrobin / leastconn.  # noqa: E501

        :param algorithm: The algorithm of this LoadbalancerUpdate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LoadbalancerUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadbalancerUpdate):
            return False
