...
class TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost(object):
    ...
    """
    swagger_types = {
        'anyof_schema': 'list[TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps]'
    }

    attribute_map = {
        'anyof_schema': 'anyof_schema'
    }

    def __init__(self, anyof_schema=None):  # noqa: E501
        """TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost - a model defined in Swagger"""  # noqa: E501

        self._anyof_schema = None
        self.discriminator = None

        if anyof_schema is not None:
            self.anyof_schema = anyof_schema

    @property
    def anyof_schema(self):
        """Gets the anyof_schema of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost.  # noqa: E501


        :return: The anyof_schema of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost.  # noqa: E501
        :rtype: list[TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps]
        """
        return self._anyof_schema

    @anyof_schema.setter
    def anyof_schema(self, anyof_schema):
        """Sets the anyof_schema of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost.


        :param anyof_schema: The anyof_schema of this TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost.  # noqa: E501
        :type: list[TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps]
        """

        self._anyof_schema = anyof_schema
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsLoadbalancerLoadbalancerUpdateBackendServersSchemaSchemaHost):
            return False
