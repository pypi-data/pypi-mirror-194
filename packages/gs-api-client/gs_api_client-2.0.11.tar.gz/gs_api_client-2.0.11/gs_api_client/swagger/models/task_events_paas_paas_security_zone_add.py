...
class TaskEventsPaasPaasSecurityZoneAdd(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'mpls_mgmt_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'mpls_cust_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
    ...
    attribute_map = {
        'labels': 'labels',
        'name': 'name',
        'mpls_mgmt_uuid': 'mpls_mgmt_uuid',
        'mpls_cust_uuid': 'mpls_cust_uuid',
        'paas_security_zone_uuid': 'paas_security_zone_uuid'
    }

    def __init__(self, labels=None, name=None, mpls_mgmt_uuid=None, mpls_cust_uuid=None, paas_security_zone_uuid=None):  # noqa: E501
        """TaskEventsPaasPaasSecurityZoneAdd - a model defined in Swagger"""  # noqa: E501

        self._labels = None
        self._name = None
        self._mpls_mgmt_uuid = None
        self._mpls_cust_uuid = None
        ...
        if name is not None:
            self.name = name
        if mpls_mgmt_uuid is not None:
            self.mpls_mgmt_uuid = mpls_mgmt_uuid
        if mpls_cust_uuid is not None:
            self.mpls_cust_uuid = mpls_cust_uuid
        if paas_security_zone_uuid is not None:
            self.paas_security_zone_uuid = paas_security_zone_uuid

    @property
    def labels(self):
        """Gets the labels of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501


        :return: The labels of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsPaasPaasSecurityZoneAdd.


        :param labels: The labels of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501


        :return: The name of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsPaasPaasSecurityZoneAdd.


        :param name: The name of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    @property
    def mpls_mgmt_uuid(self):
        """Gets the mpls_mgmt_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501


        :return: The mpls_mgmt_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
        return self._mpls_mgmt_uuid

    @mpls_mgmt_uuid.setter
    def mpls_mgmt_uuid(self, mpls_mgmt_uuid):
        """Sets the mpls_mgmt_uuid of this TaskEventsPaasPaasSecurityZoneAdd.


        :param mpls_mgmt_uuid: The mpls_mgmt_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """

        self._mpls_mgmt_uuid = mpls_mgmt_uuid

    @property
    def mpls_cust_uuid(self):
        """Gets the mpls_cust_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501


        :return: The mpls_cust_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
        return self._mpls_cust_uuid

    @mpls_cust_uuid.setter
    def mpls_cust_uuid(self, mpls_cust_uuid):
        """Sets the mpls_cust_uuid of this TaskEventsPaasPaasSecurityZoneAdd.


        :param mpls_cust_uuid: The mpls_cust_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """

        self._mpls_cust_uuid = mpls_cust_uuid

    @property
    def paas_security_zone_uuid(self):
        """Gets the paas_security_zone_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501


        :return: The paas_security_zone_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
    ...
    def paas_security_zone_uuid(self, paas_security_zone_uuid):
        """Sets the paas_security_zone_uuid of this TaskEventsPaasPaasSecurityZoneAdd.


        :param paas_security_zone_uuid: The paas_security_zone_uuid of this TaskEventsPaasPaasSecurityZoneAdd.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAddStorageUuid
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsPaasPaasSecurityZoneAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsPaasPaasSecurityZoneAdd):
            return False
