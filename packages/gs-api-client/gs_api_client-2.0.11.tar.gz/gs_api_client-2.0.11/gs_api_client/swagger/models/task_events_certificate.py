...
from gs_api_client.swagger.models.task_events_certificate_certificate_remove import TaskEventsCertificateCertificateRemove  # noqa: F401,E501


class TaskEventsCertificate(object):
    ...
    """
    swagger_types = {
        'certificate_add': 'object',
        'certificate_remove': 'TaskEventsCertificateCertificateRemove'
    }
    ...
    def __init__(self, certificate_add=None, certificate_remove=None):  # noqa: E501
        """TaskEventsCertificate - a model defined in Swagger"""  # noqa: E501

        self._certificate_add = None
        self._certificate_remove = None
        self.discriminator = None

        if certificate_add is not None:
            self.certificate_add = certificate_add
        if certificate_remove is not None:
            self.certificate_remove = certificate_remove

    @property
    def certificate_add(self):
        """Gets the certificate_add of this TaskEventsCertificate.  # noqa: E501


        :return: The certificate_add of this TaskEventsCertificate.  # noqa: E501
        :rtype: object
        """
        return self._certificate_add

    @certificate_add.setter
    def certificate_add(self, certificate_add):
        """Sets the certificate_add of this TaskEventsCertificate.


        :param certificate_add: The certificate_add of this TaskEventsCertificate.  # noqa: E501
        :type: object
        """

        self._certificate_add = certificate_add

    @property
    def certificate_remove(self):
        """Gets the certificate_remove of this TaskEventsCertificate.  # noqa: E501


        :return: The certificate_remove of this TaskEventsCertificate.  # noqa: E501
        :rtype: TaskEventsCertificateCertificateRemove
        """
        return self._certificate_remove

    @certificate_remove.setter
    def certificate_remove(self, certificate_remove):
        """Sets the certificate_remove of this TaskEventsCertificate.


        :param certificate_remove: The certificate_remove of this TaskEventsCertificate.  # noqa: E501
        :type: TaskEventsCertificateCertificateRemove
        """

        self._certificate_remove = certificate_remove
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsCertificate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsCertificate):
            return False
