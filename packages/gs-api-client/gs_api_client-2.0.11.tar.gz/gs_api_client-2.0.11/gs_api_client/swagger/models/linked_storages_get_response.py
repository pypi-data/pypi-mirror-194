...
from gs_api_client.swagger.models.linked_storage_brief import LinkedStorageBrief  # noqa: F401,E501


class LinkedStoragesGetResponse(object):
    ...
    """
    swagger_types = {
        'storage_relations': 'list[LinkedStorageBrief]'
    }
    ...
    def __init__(self, storage_relations=None):  # noqa: E501
        """LinkedStoragesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._storage_relations = None
        self.discriminator = None

        if storage_relations is not None:
            self.storage_relations = storage_relations

    @property
    def storage_relations(self):
        """Gets the storage_relations of this LinkedStoragesGetResponse.  # noqa: E501


        :return: The storage_relations of this LinkedStoragesGetResponse.  # noqa: E501
        :rtype: list[LinkedStorageBrief]
        """
        return self._storage_relations

    @storage_relations.setter
    def storage_relations(self, storage_relations):
        """Sets the storage_relations of this LinkedStoragesGetResponse.


        :param storage_relations: The storage_relations of this LinkedStoragesGetResponse.  # noqa: E501
        :type: list[LinkedStorageBrief]
        """

        self._storage_relations = storage_relations
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedStoragesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedStoragesGetResponse):
            return False
