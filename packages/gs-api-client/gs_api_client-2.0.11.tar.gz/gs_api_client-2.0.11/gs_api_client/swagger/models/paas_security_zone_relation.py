...
from gs_api_client.swagger.models.servicein_paas_security_zone import ServiceinPaasSecurityZone  # noqa: F401,E501


class PaasSecurityZoneRelation(object):
    ...
    """
    swagger_types = {
        'services': 'ServiceinPaasSecurityZone'
    }
    ...
    def __init__(self, services=None):  # noqa: E501
        """PaasSecurityZoneRelation - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def services(self):
        """Gets the services of this PaasSecurityZoneRelation.  # noqa: E501


        :return: The services of this PaasSecurityZoneRelation.  # noqa: E501
        :rtype: ServiceinPaasSecurityZone
        """
        return self._services

    @services.setter
    def services(self, services):
        """Sets the services of this PaasSecurityZoneRelation.


        :param services: The services of this PaasSecurityZoneRelation.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasSecurityZoneRelation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasSecurityZoneRelation):
            return False
