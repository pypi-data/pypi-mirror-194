...
class NetworkinFirewallInner(object):
    ...
    def __init__(self, mac=None, network_uuid=None, network_type=None, network_name=None, server_uuid=None, server_name=None, object_name=None):  # noqa: E501
        """NetworkinFirewallInner - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def mac(self):
        """Gets the mac of this NetworkinFirewallInner.  # noqa: E501

        The mac adress of the network  # noqa: E501

        :return: The mac of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
        return self._mac
    ...
    @mac.setter
    def mac(self, mac):
        """Sets the mac of this NetworkinFirewallInner.

        The mac adress of the network  # noqa: E501

        :param mac: The mac of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def network_uuid(self):
        """Gets the network_uuid of this NetworkinFirewallInner.  # noqa: E501

        The UUID of the network you're requesting.  # noqa: E501

        :return: The network_uuid of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this NetworkinFirewallInner.

        The UUID of the network you're requesting.  # noqa: E501

        :param network_uuid: The network_uuid of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def network_type(self):
        """Gets the network_type of this NetworkinFirewallInner.  # noqa: E501

        The type of the network.  # noqa: E501

        :return: The network_type of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
    ...
    def network_type(self, network_type):
        """Sets the network_type of this NetworkinFirewallInner.

        The type of the network.  # noqa: E501

        :param network_type: The network_type of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def network_name(self):
        """Gets the network_name of this NetworkinFirewallInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The network_name of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
    ...
    def network_name(self, network_name):
        """Sets the network_name of this NetworkinFirewallInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param network_name: The network_name of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def server_uuid(self):
        """Gets the server_uuid of this NetworkinFirewallInner.  # noqa: E501

        The UUID of the server is always unique, and refers to a specific object.  # noqa: E501

        :return: The server_uuid of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
    ...
    def server_uuid(self, server_uuid):
        """Sets the server_uuid of this NetworkinFirewallInner.

        The UUID of the server is always unique, and refers to a specific object.  # noqa: E501

        :param server_uuid: The server_uuid of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def server_name(self):
        """Gets the server_name of this NetworkinFirewallInner.  # noqa: E501

        The human-readable name of the server. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The server_name of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
    ...
    def server_name(self, server_name):
        """Sets the server_name of this NetworkinFirewallInner.

        The human-readable name of the server. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param server_name: The server_name of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def object_name(self):
        """Gets the object_name of this NetworkinFirewallInner.  # noqa: E501

        The human-readable name of the firewall. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The object_name of this NetworkinFirewallInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this NetworkinFirewallInner.

        The human-readable name of the firewall. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this NetworkinFirewallInner.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworkinFirewallInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkinFirewallInner):
            return False
