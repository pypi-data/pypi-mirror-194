...
class StorageCreateTemplatePassword(object):
    ...
    def __init__(self, template_uuid=None, hostname=None, password=None, password_type=None):  # noqa: E501
        """StorageCreateTemplatePassword - a model defined in Swagger"""  # noqa: E501
    ...
    def template_uuid(self):
        """Gets the template_uuid of this StorageCreateTemplatePassword.  # noqa: E501

        The UUID of a template (public or private).  # noqa: E501

        :return: The template_uuid of this StorageCreateTemplatePassword.  # noqa: E501
        :rtype: str
        """
    ...
    def template_uuid(self, template_uuid):
        """Sets the template_uuid of this StorageCreateTemplatePassword.

        The UUID of a template (public or private).  # noqa: E501

        :param template_uuid: The template_uuid of this StorageCreateTemplatePassword.  # noqa: E501
        :type: str
        """
        if template_uuid is None:
            raise ValueError("Invalid value for `template_uuid`, must not be `None`")  # noqa: E501

        self._template_uuid = template_uuid

    @property
    def hostname(self):
        """Gets the hostname of this StorageCreateTemplatePassword.  # noqa: E501

        Hostname to set for the installed storage. The running server will use this as its hostname. Valid only for public Linux and Windows templates.  # noqa: E501

        :return: The hostname of this StorageCreateTemplatePassword.  # noqa: E501
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this StorageCreateTemplatePassword.

        Hostname to set for the installed storage. The running server will use this as its hostname. Valid only for public Linux and Windows templates.  # noqa: E501

        :param hostname: The hostname of this StorageCreateTemplatePassword.  # noqa: E501
        :type: str
        """
    ...
    @property
    def password(self):
        """Gets the password of this StorageCreateTemplatePassword.  # noqa: E501

        The root (Linux) or Administrator (Windows) password to set for the installed storage. Valid only for public templates. The password has to be either plaintext or a crypt string (modular crypt format - MCF).  # noqa: E501

        :return: The password of this StorageCreateTemplatePassword.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this StorageCreateTemplatePassword.

        The root (Linux) or Administrator (Windows) password to set for the installed storage. Valid only for public templates. The password has to be either plaintext or a crypt string (modular crypt format - MCF).  # noqa: E501

        :param password: The password of this StorageCreateTemplatePassword.  # noqa: E501
        :type: str
        """
        if password is None:
    ...
    def password_type(self):
        """Gets the password_type of this StorageCreateTemplatePassword.  # noqa: E501

        Password type (one of plain, crypt).  # noqa: E501

        :return: The password_type of this StorageCreateTemplatePassword.  # noqa: E501
        :rtype: str
        """
    ...
    def password_type(self, password_type):
        """Sets the password_type of this StorageCreateTemplatePassword.

        Password type (one of plain, crypt).  # noqa: E501

        :param password_type: The password_type of this StorageCreateTemplatePassword.  # noqa: E501
        :type: str
        """
        if password_type is None:
            raise ValueError("Invalid value for `password_type`, must not be `None`")  # noqa: E501
        allowed_values = ["plain", "crypt"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageCreateTemplatePassword, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageCreateTemplatePassword):
            return False
