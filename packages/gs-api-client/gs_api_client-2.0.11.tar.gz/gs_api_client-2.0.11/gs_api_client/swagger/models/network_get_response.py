...
from gs_api_client.swagger.models.network import Network  # noqa: F401,E501


class NetworkGetResponse(object):
    ...
    def __init__(self, network=None):  # noqa: E501
        """NetworkGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def network(self):
        """Gets the network of this NetworkGetResponse.  # noqa: E501


        :return: The network of this NetworkGetResponse.  # noqa: E501
        :rtype: Network
        """
    ...
    def network(self, network):
        """Sets the network of this NetworkGetResponse.


        :param network: The network of this NetworkGetResponse.  # noqa: E501
        :type: Network
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NetworkGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NetworkGetResponse):
            return False
