...
from gs_api_client.swagger.models.storage_backup_schedule_index import StorageBackupScheduleIndex  # noqa: F401,E501


class StorageBackupSchedulesGetResponse(object):
    ...
    """
    swagger_types = {
        'schedule_storage_backups': 'StorageBackupScheduleIndex'
    }

    attribute_map = {
        'schedule_storage_backups': 'schedule_storage_backups'
    }

    def __init__(self, schedule_storage_backups=None):  # noqa: E501
        """StorageBackupSchedulesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._schedule_storage_backups = None
        self.discriminator = None

        if schedule_storage_backups is not None:
            self.schedule_storage_backups = schedule_storage_backups

    @property
    def schedule_storage_backups(self):
        """Gets the schedule_storage_backups of this StorageBackupSchedulesGetResponse.  # noqa: E501


        :return: The schedule_storage_backups of this StorageBackupSchedulesGetResponse.  # noqa: E501
        :rtype: StorageBackupScheduleIndex
        """
        return self._schedule_storage_backups

    @schedule_storage_backups.setter
    def schedule_storage_backups(self, schedule_storage_backups):
        """Sets the schedule_storage_backups of this StorageBackupSchedulesGetResponse.


        :param schedule_storage_backups: The schedule_storage_backups of this StorageBackupSchedulesGetResponse.  # noqa: E501
        :type: StorageBackupScheduleIndex
        """

        self._schedule_storage_backups = schedule_storage_backups
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupSchedulesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupSchedulesGetResponse):
            return False
