...
from gs_api_client.swagger.models.paas_service_template import PaasServiceTemplate  # noqa: F401,E501


class PaasServiceTemplateIndex(dict):
    ...
    def __init__(self):  # noqa: E501
        """PaasServiceTemplateIndex - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceTemplateIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceTemplateIndex):
            return False
