...
from gs_api_client.swagger.models.snapshot_index import SnapshotIndex  # noqa: F401,E501


class DeletedSnapshotsGetResponse(object):
    ...
    def __init__(self, deleted_snapshots=None):  # noqa: E501
        """DeletedSnapshotsGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def deleted_snapshots(self):
        """Gets the deleted_snapshots of this DeletedSnapshotsGetResponse.  # noqa: E501


        :return: The deleted_snapshots of this DeletedSnapshotsGetResponse.  # noqa: E501
        :rtype: SnapshotIndex
        """
    ...
    def deleted_snapshots(self, deleted_snapshots):
        """Sets the deleted_snapshots of this DeletedSnapshotsGetResponse.


        :param deleted_snapshots: The deleted_snapshots of this DeletedSnapshotsGetResponse.  # noqa: E501
        :type: SnapshotIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletedSnapshotsGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletedSnapshotsGetResponse):
            return False
