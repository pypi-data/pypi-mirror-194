...
class LinkedNetworkBrief(object):
    ...
    def __init__(self, network_type=None, l3security=None, bootdevice=None, network_uuid=None, l2security=None, server_uuid=None, mac=None, ordering=None, firewall=None, firewall_template_uuid=None, object_name=None, dhcp_ip=None, create_time=None, object_uuid=None, public_net=None):  # noqa: E501
    ...
    @property
    def dhcp_ip(self):
        """Gets the dhcp_ip of this LinkedNetworkBrief.  # noqa: E501

        IP of this server in DHCP network, in case DHCP is configured.  # noqa: E501

        :return: The dhcp_ip of this LinkedNetworkBrief.  # noqa: E501
        :rtype: str
        """
        return self._dhcp_ip

    @dhcp_ip.setter
    def dhcp_ip(self, dhcp_ip):
        """Sets the dhcp_ip of this LinkedNetworkBrief.

        IP of this server in DHCP network, in case DHCP is configured.  # noqa: E501

        :param dhcp_ip: The dhcp_ip of this LinkedNetworkBrief.  # noqa: E501
        :type: str
        """

        self._dhcp_ip = dhcp_ip
