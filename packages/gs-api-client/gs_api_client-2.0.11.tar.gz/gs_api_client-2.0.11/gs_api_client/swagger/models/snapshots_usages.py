...
from gs_api_client.swagger.models.snapshots_usage import SnapshotsUsage  # noqa: F401,E501


class SnapshotsUsages(object):
    ...
    def __init__(self, snapshots=None):  # noqa: E501
        """SnapshotsUsages - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def snapshots(self):
        """Gets the snapshots of this SnapshotsUsages.  # noqa: E501


        :return: The snapshots of this SnapshotsUsages.  # noqa: E501
        :rtype: list[SnapshotsUsage]
        """
        return self._snapshots

    @snapshots.setter
    def snapshots(self, snapshots):
        """Sets the snapshots of this SnapshotsUsages.


        :param snapshots: The snapshots of this SnapshotsUsages.  # noqa: E501
        :type: list[SnapshotsUsage]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotsUsages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotsUsages):
            return False
