...
class StorageRollback(object):
    ...
    def __init__(self, rollback=None):  # noqa: E501
        """StorageRollback - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def rollback(self):
        """Gets the rollback of this StorageRollback.  # noqa: E501


        :return: The rollback of this StorageRollback.  # noqa: E501
        :rtype: bool
        """
    ...
    def rollback(self, rollback):
        """Sets the rollback of this StorageRollback.


        :param rollback: The rollback of this StorageRollback.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageRollback, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageRollback):
            return False
