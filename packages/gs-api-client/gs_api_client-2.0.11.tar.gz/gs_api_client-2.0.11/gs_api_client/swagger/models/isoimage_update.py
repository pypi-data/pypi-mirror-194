...
class IsoimageUpdate(object):
    ...
    def __init__(self, name=None, labels=None):  # noqa: E501
        """IsoimageUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IsoimageUpdate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this IsoimageUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this IsoimageUpdate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this IsoimageUpdate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this IsoimageUpdate.

        List of labels.  # noqa: E501

        :param labels: The labels of this IsoimageUpdate.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IsoimageUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsoimageUpdate):
            return False
