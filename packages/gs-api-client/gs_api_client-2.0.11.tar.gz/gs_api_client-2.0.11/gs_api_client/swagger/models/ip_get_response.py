...
from gs_api_client.swagger.models.ip import Ip  # noqa: F401,E501


class IpGetResponse(object):
    ...
    def __init__(self, ip=None):  # noqa: E501
        """IpGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def ip(self):
        """Gets the ip of this IpGetResponse.  # noqa: E501


        :return: The ip of this IpGetResponse.  # noqa: E501
        :rtype: Ip
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        """Sets the ip of this IpGetResponse.


        :param ip: The ip of this IpGetResponse.  # noqa: E501
        :type: Ip
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IpGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpGetResponse):
            return False
