...
from gs_api_client.swagger.models.task_events_schedules_schedule_snapshot_add import TaskEventsSchedulesScheduleSnapshotAdd  # noqa: F401,E501
...
from gs_api_client.swagger.models.task_events_schedules_schedule_snapshot_remove import TaskEventsSchedulesScheduleSnapshotRemove  # noqa: F401,E501


class TaskEventsSchedules(object):
    ...
    """
    swagger_types = {
        'schedule_snapshot_add': 'TaskEventsSchedulesScheduleSnapshotAdd',
        'schedule_snapshot_perform': 'TaskEventsSchedulesScheduleSnapshotPerform',
        'schedule_snapshot_update': 'TaskEventsSchedulesScheduleSnapshotAdd',
        'schedule_snapshot_remove': 'TaskEventsSchedulesScheduleSnapshotRemove'
    }

    attribute_map = {
        'schedule_snapshot_add': 'schedule_snapshot_add',
        'schedule_snapshot_perform': 'schedule_snapshot_perform',
        'schedule_snapshot_update': 'schedule_snapshot_update',
        'schedule_snapshot_remove': 'schedule_snapshot_remove'
    }

    def __init__(self, schedule_snapshot_add=None, schedule_snapshot_perform=None, schedule_snapshot_update=None, schedule_snapshot_remove=None):  # noqa: E501
        """TaskEventsSchedules - a model defined in Swagger"""  # noqa: E501

        self._schedule_snapshot_add = None
        self._schedule_snapshot_perform = None
        self._schedule_snapshot_update = None
        self._schedule_snapshot_remove = None
        self.discriminator = None

        if schedule_snapshot_add is not None:
            self.schedule_snapshot_add = schedule_snapshot_add
        if schedule_snapshot_perform is not None:
            self.schedule_snapshot_perform = schedule_snapshot_perform
        if schedule_snapshot_update is not None:
            self.schedule_snapshot_update = schedule_snapshot_update
        if schedule_snapshot_remove is not None:
            self.schedule_snapshot_remove = schedule_snapshot_remove

    @property
    def schedule_snapshot_add(self):
        """Gets the schedule_snapshot_add of this TaskEventsSchedules.  # noqa: E501


        :return: The schedule_snapshot_add of this TaskEventsSchedules.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAdd
        """
        return self._schedule_snapshot_add

    @schedule_snapshot_add.setter
    def schedule_snapshot_add(self, schedule_snapshot_add):
        """Sets the schedule_snapshot_add of this TaskEventsSchedules.


        :param schedule_snapshot_add: The schedule_snapshot_add of this TaskEventsSchedules.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAdd
        """

        self._schedule_snapshot_add = schedule_snapshot_add

    @property
    def schedule_snapshot_perform(self):
        """Gets the schedule_snapshot_perform of this TaskEventsSchedules.  # noqa: E501


        :return: The schedule_snapshot_perform of this TaskEventsSchedules.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotPerform
        """
        return self._schedule_snapshot_perform

    @schedule_snapshot_perform.setter
    def schedule_snapshot_perform(self, schedule_snapshot_perform):
        """Sets the schedule_snapshot_perform of this TaskEventsSchedules.


        :param schedule_snapshot_perform: The schedule_snapshot_perform of this TaskEventsSchedules.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotPerform
        """

        self._schedule_snapshot_perform = schedule_snapshot_perform

    @property
    def schedule_snapshot_update(self):
        """Gets the schedule_snapshot_update of this TaskEventsSchedules.  # noqa: E501


        :return: The schedule_snapshot_update of this TaskEventsSchedules.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotAdd
        """
        return self._schedule_snapshot_update

    @schedule_snapshot_update.setter
    def schedule_snapshot_update(self, schedule_snapshot_update):
        """Sets the schedule_snapshot_update of this TaskEventsSchedules.


        :param schedule_snapshot_update: The schedule_snapshot_update of this TaskEventsSchedules.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotAdd
        """

        self._schedule_snapshot_update = schedule_snapshot_update

    @property
    def schedule_snapshot_remove(self):
        """Gets the schedule_snapshot_remove of this TaskEventsSchedules.  # noqa: E501


        :return: The schedule_snapshot_remove of this TaskEventsSchedules.  # noqa: E501
        :rtype: TaskEventsSchedulesScheduleSnapshotRemove
        """
        return self._schedule_snapshot_remove

    @schedule_snapshot_remove.setter
    def schedule_snapshot_remove(self, schedule_snapshot_remove):
        """Sets the schedule_snapshot_remove of this TaskEventsSchedules.


        :param schedule_snapshot_remove: The schedule_snapshot_remove of this TaskEventsSchedules.  # noqa: E501
        :type: TaskEventsSchedulesScheduleSnapshotRemove
        """

        self._schedule_snapshot_remove = schedule_snapshot_remove
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSchedules, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSchedules):
            return False
