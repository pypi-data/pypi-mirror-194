...
class PaasServiceUpdate(object):
    ...
    def __init__(self, name=None, labels=None, parameters=None, resource_limits=None, network_uuid=None, service_template_uuid=None):  # noqa: E501
    ...
    def network_uuid(self):
        """Gets the network_uuid of this PaasServiceUpdate.  # noqa: E501

        The UUID of the private network to which the service should be connected  # noqa: E501

        :return: The network_uuid of this PaasServiceUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this PaasServiceUpdate.

        The UUID of the private network to which the service should be connected  # noqa: E501

        :param network_uuid: The network_uuid of this PaasServiceUpdate.  # noqa: E501
        :type: str
        """
