...
from gs_api_client.swagger.models.backup_schedulesin_storage_inner import BackupSchedulesinStorageInner  # noqa: F401,E501


class BackupSchedulesinStorage(object):
    ...
    def __init__(self):  # noqa: E501
        """BackupSchedulesinStorage - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BackupSchedulesinStorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupSchedulesinStorage):
            return False
