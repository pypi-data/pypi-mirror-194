...
from gs_api_client.swagger.models.sshkey_index import SshkeyIndex  # noqa: F401,E501


class SshkeysGetResponse(object):
    ...
    def __init__(self, sshkeys=None):  # noqa: E501
        """SshkeysGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def sshkeys(self):
        """Gets the sshkeys of this SshkeysGetResponse.  # noqa: E501


        :return: The sshkeys of this SshkeysGetResponse.  # noqa: E501
        :rtype: SshkeyIndex
        """
    ...
    def sshkeys(self, sshkeys):
        """Sets the sshkeys of this SshkeysGetResponse.


        :param sshkeys: The sshkeys of this SshkeysGetResponse.  # noqa: E501
        :type: SshkeyIndex
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SshkeysGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SshkeysGetResponse):
            return False
