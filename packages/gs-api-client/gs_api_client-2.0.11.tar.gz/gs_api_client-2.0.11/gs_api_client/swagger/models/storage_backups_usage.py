...
class StorageBackupsUsage(object):
    ...
    def __init__(self, object_uuid=None, name=None, create_time=None, change_time=None, current_usage_per_minute=None, usage_per_interval=None):  # noqa: E501
        """StorageBackupsUsage - a model defined in Swagger"""  # noqa: E501
    ...
    def object_uuid(self):
        """Gets the object_uuid of this StorageBackupsUsage.  # noqa: E501

        The UUID of a backup is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this StorageBackupsUsage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this StorageBackupsUsage.

        The UUID of a backup is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this StorageBackupsUsage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this StorageBackupsUsage.  # noqa: E501

        The name of the backup equals schedule name plus backup uuid.  # noqa: E501

        :return: The name of this StorageBackupsUsage.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageBackupsUsage.

        The name of the backup equals schedule name plus backup uuid.  # noqa: E501

        :param name: The name of this StorageBackupsUsage.  # noqa: E501
        :type: str
        """
    ...
    def create_time(self):
        """Gets the create_time of this StorageBackupsUsage.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this StorageBackupsUsage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this StorageBackupsUsage.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this StorageBackupsUsage.  # noqa: E501
        :type: datetime
        """
    ...
    def change_time(self):
        """Gets the change_time of this StorageBackupsUsage.  # noqa: E501

        Defines the date and time when the last time the object was updated.  # noqa: E501

        :return: The change_time of this StorageBackupsUsage.  # noqa: E501
        :rtype: datetime
        """
    ...
    def change_time(self, change_time):
        """Sets the change_time of this StorageBackupsUsage.

        Defines the date and time when the last time the object was updated.  # noqa: E501

        :param change_time: The change_time of this StorageBackupsUsage.  # noqa: E501
        :type: datetime
        """
    ...
    def current_usage_per_minute(self):
        """Gets the current_usage_per_minute of this StorageBackupsUsage.  # noqa: E501


        :return: The current_usage_per_minute of this StorageBackupsUsage.  # noqa: E501
    ...
    def current_usage_per_minute(self, current_usage_per_minute):
        """Sets the current_usage_per_minute of this StorageBackupsUsage.


        :param current_usage_per_minute: The current_usage_per_minute of this StorageBackupsUsage.  # noqa: E501
    ...
    def usage_per_interval(self):
        """Gets the usage_per_interval of this StorageBackupsUsage.  # noqa: E501


        :return: The usage_per_interval of this StorageBackupsUsage.  # noqa: E501
    ...
    def usage_per_interval(self, usage_per_interval):
        """Sets the usage_per_interval of this StorageBackupsUsage.


        :param usage_per_interval: The usage_per_interval of this StorageBackupsUsage.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageBackupsUsage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageBackupsUsage):
            return False
