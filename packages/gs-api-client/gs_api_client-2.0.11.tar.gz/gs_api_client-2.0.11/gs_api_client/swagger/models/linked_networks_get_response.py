...
from gs_api_client.swagger.models.linked_network_brief import LinkedNetworkBrief  # noqa: F401,E501


class LinkedNetworksGetResponse(object):
    ...
    """
    swagger_types = {
        'network_relations': 'list[LinkedNetworkBrief]'
    }
    ...
    def __init__(self, network_relations=None):  # noqa: E501
        """LinkedNetworksGetResponse - a model defined in Swagger"""  # noqa: E501

        self._network_relations = None
        self.discriminator = None

        if network_relations is not None:
            self.network_relations = network_relations

    @property
    def network_relations(self):
        """Gets the network_relations of this LinkedNetworksGetResponse.  # noqa: E501


        :return: The network_relations of this LinkedNetworksGetResponse.  # noqa: E501
        :rtype: list[LinkedNetworkBrief]
        """
        return self._network_relations

    @network_relations.setter
    def network_relations(self, network_relations):
        """Sets the network_relations of this LinkedNetworksGetResponse.


        :param network_relations: The network_relations of this LinkedNetworksGetResponse.  # noqa: E501
        :type: list[LinkedNetworkBrief]
        """

        self._network_relations = network_relations
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedNetworksGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedNetworksGetResponse):
            return False
