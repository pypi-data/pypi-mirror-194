...
from gs_api_client.swagger.models.servicein_paas_security_zone_inner import ServiceinPaasSecurityZoneInner  # noqa: F401,E501


class ServiceinPaasSecurityZone(object):
    ...
    def __init__(self):  # noqa: E501
        """ServiceinPaasSecurityZone - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceinPaasSecurityZone, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceinPaasSecurityZone):
            return False
