...
from gs_api_client.swagger.models.storage_type import StorageType  # noqa: F401,E501
from gs_api_client.swagger.models.storage_variant import StorageVariant  # noqa: F401,E501


class StorageCreate(object):
    ...
    def __init__(self, name=None, capacity=None, labels=None, storage_type=None, storage_variant=None, template=None):  # noqa: E501
        """StorageCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this StorageCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def capacity(self):
        """Gets the capacity of this StorageCreate.  # noqa: E501

        Required (integer - minimum: 1 - maximum: 4096).  # noqa: E501

        :return: The capacity of this StorageCreate.  # noqa: E501
        :rtype: int
        """
    ...
    def capacity(self, capacity):
        """Sets the capacity of this StorageCreate.

        Required (integer - minimum: 1 - maximum: 4096).  # noqa: E501

        :param capacity: The capacity of this StorageCreate.  # noqa: E501
        :type: int
        """
        if capacity is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this StorageCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this StorageCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this StorageCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this StorageCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def storage_type(self):
        """Gets the storage_type of this StorageCreate.  # noqa: E501


        :return: The storage_type of this StorageCreate.  # noqa: E501
        :rtype: StorageType
        """
    ...
    def storage_type(self, storage_type):
        """Sets the storage_type of this StorageCreate.


        :param storage_type: The storage_type of this StorageCreate.  # noqa: E501
        :type: StorageType
        """
    ...
    def storage_variant(self):
        """Gets the storage_variant of this StorageCreate.  # noqa: E501


        :return: The storage_variant of this StorageCreate.  # noqa: E501
    ...
    def storage_variant(self, storage_variant):
        """Sets the storage_variant of this StorageCreate.


        :param storage_variant: The storage_variant of this StorageCreate.  # noqa: E501
        :type: StorageVariant
        """
    ...
    @property
    def template(self):
        """Gets the template of this StorageCreate.  # noqa: E501

        An object holding important values such as hostnames, passwords, and SSH keys. Creating a storage with a template is required sshkey and/or password. Windows template is only accepted password  # noqa: E501

        :return: The template of this StorageCreate.  # noqa: E501
        :rtype: object
        """
    ...
    def template(self, template):
        """Sets the template of this StorageCreate.

        An object holding important values such as hostnames, passwords, and SSH keys. Creating a storage with a template is required sshkey and/or password. Windows template is only accepted password  # noqa: E501

        :param template: The template of this StorageCreate.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageCreate):
            return False
