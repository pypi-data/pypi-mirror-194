...
from gs_api_client.swagger.models.task_events_sshkey_sshkey_add_sshkey import TaskEventsSshkeySshkeyAddSshkey  # noqa: F401,E501


class TaskEventsSshkeySshkeyAdd(object):
    ...
    """
    swagger_types = {
        'sshkey': 'TaskEventsSshkeySshkeyAddSshkey',
        'sshkey_uuid': 'TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid',
    ...
    def __init__(self, sshkey=None, sshkey_uuid=None, labels=None, name=None):  # noqa: E501
        """TaskEventsSshkeySshkeyAdd - a model defined in Swagger"""  # noqa: E501

        self._sshkey = None
        self._sshkey_uuid = None
        self._labels = None
        self._name = None
        ...
        if sshkey is not None:
            self.sshkey = sshkey
        if sshkey_uuid is not None:
            self.sshkey_uuid = sshkey_uuid
    ...
    @property
    def sshkey(self):
        """Gets the sshkey of this TaskEventsSshkeySshkeyAdd.  # noqa: E501


        :return: The sshkey of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :rtype: TaskEventsSshkeySshkeyAddSshkey
        """
        return self._sshkey

    @sshkey.setter
    def sshkey(self, sshkey):
        """Sets the sshkey of this TaskEventsSshkeySshkeyAdd.


        :param sshkey: The sshkey of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :type: TaskEventsSshkeySshkeyAddSshkey
        """

        self._sshkey = sshkey

    @property
    def sshkey_uuid(self):
        """Gets the sshkey_uuid of this TaskEventsSshkeySshkeyAdd.  # noqa: E501


        :return: The sshkey_uuid of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """
        return self._sshkey_uuid

    @sshkey_uuid.setter
    def sshkey_uuid(self, sshkey_uuid):
        """Sets the sshkey_uuid of this TaskEventsSshkeySshkeyAdd.


        :param sshkey_uuid: The sshkey_uuid of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateRemoveTemplateUuid
        """

        self._sshkey_uuid = sshkey_uuid

    @property
    def labels(self):
        """Gets the labels of this TaskEventsSshkeySshkeyAdd.  # noqa: E501


        :return: The labels of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsSshkeySshkeyAdd.


        :param labels: The labels of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsSshkeySshkeyAdd.  # noqa: E501


        :return: The name of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsSshkeySshkeyAdd.


        :param name: The name of this TaskEventsSshkeySshkeyAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsSshkeySshkeyAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsSshkeySshkeyAdd):
            return False
