...
class TaskEventsServerServerAddHardwareProfile(object):
    ...
    def __init__(self, allowed=None, type=None):  # noqa: E501
        """TaskEventsServerServerAddHardwareProfile - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def allowed(self):
        """Gets the allowed of this TaskEventsServerServerAddHardwareProfile.  # noqa: E501


        :return: The allowed of this TaskEventsServerServerAddHardwareProfile.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed(self, allowed):
        """Sets the allowed of this TaskEventsServerServerAddHardwareProfile.


        :param allowed: The allowed of this TaskEventsServerServerAddHardwareProfile.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this TaskEventsServerServerAddHardwareProfile.  # noqa: E501


        :return: The type of this TaskEventsServerServerAddHardwareProfile.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TaskEventsServerServerAddHardwareProfile.


        :param type: The type of this TaskEventsServerServerAddHardwareProfile.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsServerServerAddHardwareProfile, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsServerServerAddHardwareProfile):
            return False
