...
class LocationUpdate(object):
    ...
    def __init__(self, name=None, labels=None, cpunode_count=None):  # noqa: E501
        """LocationUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LocationUpdate.

        The human-readable name of the object. It supports the full UTF-8 charset, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this LocationUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this LocationUpdate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this LocationUpdate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this LocationUpdate.

        List of labels.  # noqa: E501

        :param labels: The labels of this LocationUpdate.  # noqa: E501
        :type: list[str]
        """
    ...
    def cpunode_count(self):
        """Gets the cpunode_count of this LocationUpdate.  # noqa: E501

        The number of dedicated cpunodes to assigne to the private location.  # noqa: E501

        :return: The cpunode_count of this LocationUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def cpunode_count(self, cpunode_count):
        """Sets the cpunode_count of this LocationUpdate.

        The number of dedicated cpunodes to assigne to the private location.  # noqa: E501

        :param cpunode_count: The cpunode_count of this LocationUpdate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationUpdate):
            return False
