...
class FirewallCreate(object):
    ...
    def __init__(self, name=None, labels=None, rules=None):  # noqa: E501
        """FirewallCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this FirewallCreate.  # noqa: E501


        :return: The name of this FirewallCreate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FirewallCreate.


        :param name: The name of this FirewallCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def labels(self):
        """Gets the labels of this FirewallCreate.  # noqa: E501


        :return: The labels of this FirewallCreate.  # noqa: E501
        :rtype: str
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this FirewallCreate.


        :param labels: The labels of this FirewallCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rules(self):
        """Gets the rules of this FirewallCreate.  # noqa: E501


        :return: The rules of this FirewallCreate.  # noqa: E501
        :rtype: FirewallRules
        """
        return self._rules
    ...
    def rules(self, rules):
        """Sets the rules of this FirewallCreate.


        :param rules: The rules of this FirewallCreate.  # noqa: E501
        :type: FirewallRules
        """
        if rules is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FirewallCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FirewallCreate):
            return False
