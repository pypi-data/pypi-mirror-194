...
from gs_api_client.swagger.models.task_events_loadbalancer_loadbalancer_update_forwarding_rule_schema_schema_letsencrypt_ssl import TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaLetsencryptSsl  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_loadbalancer_loadbalancer_update_forwarding_rule_schema_schema_mode import TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaMode  # noqa: F401,E501
...
class TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema(object):
    ...
    """
    swagger_types = {
        'target_port': 'TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps',
        'letsencrypt_ssl': 'TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaLetsencryptSsl',
        'certificate_uuid': 'TaskEventsSchedulesScheduleSnapshotPerform',
        'mode': 'TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaMode',
        'listen_port': 'TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps'
    }

    attribute_map = {
        'target_port': 'target_port',
        'letsencrypt_ssl': 'letsencrypt_ssl',
        'certificate_uuid': 'certificate_uuid',
        'mode': 'mode',
        'listen_port': 'listen_port'
    }

    def __init__(self, target_port=None, letsencrypt_ssl=None, certificate_uuid=None, mode=None, listen_port=None):  # noqa: E501
        """TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema - a model defined in Swagger"""  # noqa: E501

        self._target_port = None
        self._letsencrypt_ssl = None
        ...
        if letsencrypt_ssl is not None:
            self.letsencrypt_ssl = letsencrypt_ssl
    ...
    def target_port(self):
        """Gets the target_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501


        :return: The target_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
    ...
    def target_port(self, target_port):
        """Sets the target_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.


        :param target_port: The target_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
    ...
    @property
    def letsencrypt_ssl(self):
        """Gets the letsencrypt_ssl of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501


        :return: The letsencrypt_ssl of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaLetsencryptSsl
        """
        return self._letsencrypt_ssl

    @letsencrypt_ssl.setter
    def letsencrypt_ssl(self, letsencrypt_ssl):
        """Sets the letsencrypt_ssl of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.


        :param letsencrypt_ssl: The letsencrypt_ssl of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaLetsencryptSsl
        """

        self._letsencrypt_ssl = letsencrypt_ssl

    @property
    def certificate_uuid(self):
        """Gets the certificate_uuid of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501


        :return: The certificate_uuid of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
    ...
    def certificate_uuid(self, certificate_uuid):
        """Sets the certificate_uuid of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.


        :param certificate_uuid: The certificate_uuid of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
    ...
    @property
    def mode(self):
        """Gets the mode of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501


        :return: The mode of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaMode
        """
        return self._mode

    @mode.setter
    def mode(self, mode):
        """Sets the mode of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.


        :param mode: The mode of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchemaMode
        """
    ...
    def listen_port(self):
        """Gets the listen_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501


        :return: The listen_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
        :rtype: TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps
        """
    ...
    def listen_port(self, listen_port):
        """Sets the listen_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.


        :param listen_port: The listen_port of this TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema.  # noqa: E501
        :type: TaskEventsLoadbalancerLoadbalancerUpdateRedirectHttpToHttps
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsLoadbalancerLoadbalancerUpdateForwardingRuleSchemaSchema):
            return False
