...
from gs_api_client.swagger.models.location import Location  # noqa: F401,E501


class LocationGetResponse(object):
    ...
    def __init__(self, location=None):  # noqa: E501
        """LocationGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def location(self):
        """Gets the location of this LocationGetResponse.  # noqa: E501


        :return: The location of this LocationGetResponse.  # noqa: E501
        :rtype: Location
        """
    ...
    def location(self, location):
        """Sets the location of this LocationGetResponse.


        :param location: The location of this LocationGetResponse.  # noqa: E501
        :type: Location
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationGetResponse):
            return False
