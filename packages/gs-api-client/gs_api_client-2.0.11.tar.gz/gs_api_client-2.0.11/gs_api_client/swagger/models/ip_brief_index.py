...
from gs_api_client.swagger.models.ip_brief import IpBrief  # noqa: F401,E501


class IpBriefIndex(dict):
    ...
    def __init__(self):  # noqa: E501
        """IpBriefIndex - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IpBriefIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpBriefIndex):
            return False
