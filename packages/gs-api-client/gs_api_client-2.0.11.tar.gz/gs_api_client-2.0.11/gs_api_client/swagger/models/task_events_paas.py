...
from gs_api_client.swagger.models.task_events_paas_paas_security_zone_add import TaskEventsPaasPaasSecurityZoneAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_security_zone_remove import TaskEventsPaasPaasSecurityZoneRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_security_zone_update import TaskEventsPaasPaasSecurityZoneUpdate  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_service_add import TaskEventsPaasPaasServiceAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_service_remove import TaskEventsPaasPaasServiceRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_paas_paas_service_update import TaskEventsPaasPaasServiceUpdate  # noqa: F401,E501


class TaskEventsPaas(object):
    ...
    """
    swagger_types = {
        'paas_service_remove': 'TaskEventsPaasPaasServiceRemove',
        'paas_security_zone_remove': 'TaskEventsPaasPaasSecurityZoneRemove',
        'paas_security_zone_add': 'TaskEventsPaasPaasSecurityZoneAdd',
        'paas_security_zone_update': 'TaskEventsPaasPaasSecurityZoneUpdate',
        'paas_service_add': 'TaskEventsPaasPaasServiceAdd',
        'paas_service_update': 'TaskEventsPaasPaasServiceUpdate'
    }

    attribute_map = {
        'paas_service_remove': 'paas_service_remove',
        'paas_security_zone_remove': 'paas_security_zone_remove',
        'paas_security_zone_add': 'paas_security_zone_add',
        'paas_security_zone_update': 'paas_security_zone_update',
        'paas_service_add': 'paas_service_add',
        'paas_service_update': 'paas_service_update'
    }

    def __init__(self, paas_service_remove=None, paas_security_zone_remove=None, paas_security_zone_add=None, paas_security_zone_update=None, paas_service_add=None, paas_service_update=None):  # noqa: E501
        """TaskEventsPaas - a model defined in Swagger"""  # noqa: E501

        self._paas_service_remove = None
        self._paas_security_zone_remove = None
        self._paas_security_zone_add = None
        self._paas_security_zone_update = None
        self._paas_service_add = None
        self._paas_service_update = None
        self.discriminator = None

        if paas_service_remove is not None:
            self.paas_service_remove = paas_service_remove
        if paas_security_zone_remove is not None:
            self.paas_security_zone_remove = paas_security_zone_remove
        if paas_security_zone_add is not None:
            self.paas_security_zone_add = paas_security_zone_add
        if paas_security_zone_update is not None:
            self.paas_security_zone_update = paas_security_zone_update
        if paas_service_add is not None:
            self.paas_service_add = paas_service_add
        if paas_service_update is not None:
            self.paas_service_update = paas_service_update

    @property
    def paas_service_remove(self):
        """Gets the paas_service_remove of this TaskEventsPaas.  # noqa: E501


        :return: The paas_service_remove of this TaskEventsPaas.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceRemove
        """
        return self._paas_service_remove

    @paas_service_remove.setter
    def paas_service_remove(self, paas_service_remove):
        """Sets the paas_service_remove of this TaskEventsPaas.


        :param paas_service_remove: The paas_service_remove of this TaskEventsPaas.  # noqa: E501
        :type: TaskEventsPaasPaasServiceRemove
        """

        self._paas_service_remove = paas_service_remove

    @property
    def paas_security_zone_remove(self):
        """Gets the paas_security_zone_remove of this TaskEventsPaas.  # noqa: E501


        :return: The paas_security_zone_remove of this TaskEventsPaas.  # noqa: E501
        :rtype: TaskEventsPaasPaasSecurityZoneRemove
        """
        return self._paas_security_zone_remove

    @paas_security_zone_remove.setter
    def paas_security_zone_remove(self, paas_security_zone_remove):
        """Sets the paas_security_zone_remove of this TaskEventsPaas.


        :param paas_security_zone_remove: The paas_security_zone_remove of this TaskEventsPaas.  # noqa: E501
        :type: TaskEventsPaasPaasSecurityZoneRemove
        """

        self._paas_security_zone_remove = paas_security_zone_remove

    @property
    def paas_security_zone_add(self):
        """Gets the paas_security_zone_add of this TaskEventsPaas.  # noqa: E501


        :return: The paas_security_zone_add of this TaskEventsPaas.  # noqa: E501
        :rtype: TaskEventsPaasPaasSecurityZoneAdd
        """
        return self._paas_security_zone_add

    @paas_security_zone_add.setter
    def paas_security_zone_add(self, paas_security_zone_add):
        """Sets the paas_security_zone_add of this TaskEventsPaas.


        :param paas_security_zone_add: The paas_security_zone_add of this TaskEventsPaas.  # noqa: E501
        :type: TaskEventsPaasPaasSecurityZoneAdd
        """

        self._paas_security_zone_add = paas_security_zone_add

    @property
    def paas_security_zone_update(self):
        """Gets the paas_security_zone_update of this TaskEventsPaas.  # noqa: E501


        :return: The paas_security_zone_update of this TaskEventsPaas.  # noqa: E501
        :rtype: TaskEventsPaasPaasSecurityZoneUpdate
        """
        return self._paas_security_zone_update

    @paas_security_zone_update.setter
    def paas_security_zone_update(self, paas_security_zone_update):
        """Sets the paas_security_zone_update of this TaskEventsPaas.


        :param paas_security_zone_update: The paas_security_zone_update of this TaskEventsPaas.  # noqa: E501
        :type: TaskEventsPaasPaasSecurityZoneUpdate
        """

        self._paas_security_zone_update = paas_security_zone_update

    @property
    def paas_service_add(self):
        """Gets the paas_service_add of this TaskEventsPaas.  # noqa: E501


        :return: The paas_service_add of this TaskEventsPaas.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceAdd
        """
        return self._paas_service_add

    @paas_service_add.setter
    def paas_service_add(self, paas_service_add):
        """Sets the paas_service_add of this TaskEventsPaas.


        :param paas_service_add: The paas_service_add of this TaskEventsPaas.  # noqa: E501
        :type: TaskEventsPaasPaasServiceAdd
        """

        self._paas_service_add = paas_service_add

    @property
    def paas_service_update(self):
        """Gets the paas_service_update of this TaskEventsPaas.  # noqa: E501


        :return: The paas_service_update of this TaskEventsPaas.  # noqa: E501
        :rtype: TaskEventsPaasPaasServiceUpdate
        """
        return self._paas_service_update

    @paas_service_update.setter
    def paas_service_update(self, paas_service_update):
        """Sets the paas_service_update of this TaskEventsPaas.


        :param paas_service_update: The paas_service_update of this TaskEventsPaas.  # noqa: E501
        :type: TaskEventsPaasPaasServiceUpdate
        """

        self._paas_service_update = paas_service_update
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsPaas, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsPaas):
            return False
