...
from gs_api_client.swagger.models.serverin_strorage_inner import ServerinStrorageInner  # noqa: F401,E501


class ServerinStrorage(object):
    ...
    def __init__(self):  # noqa: E501
        """ServerinStrorage - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerinStrorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerinStrorage):
            return False
