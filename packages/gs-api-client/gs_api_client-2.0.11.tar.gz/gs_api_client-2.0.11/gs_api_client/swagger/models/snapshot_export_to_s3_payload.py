...
from gs_api_client.swagger.models.snapshot_export_to_s3_payload_s3auth import SnapshotExportToS3PayloadS3auth  # noqa: F401,E501
from gs_api_client.swagger.models.snapshot_export_to_s3_payload_s3data import SnapshotExportToS3PayloadS3data  # noqa: F401,E501


class SnapshotExportToS3Payload(object):
    ...
    """
    swagger_types = {
        's3auth': 'SnapshotExportToS3PayloadS3auth',
        's3data': 'SnapshotExportToS3PayloadS3data'
    }
    ...
    def __init__(self, s3auth=None, s3data=None):  # noqa: E501
        """SnapshotExportToS3Payload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def s3auth(self):
        """Gets the s3auth of this SnapshotExportToS3Payload.  # noqa: E501


        :return: The s3auth of this SnapshotExportToS3Payload.  # noqa: E501
        :rtype: SnapshotExportToS3PayloadS3auth
        """
        return self._s3auth

    @s3auth.setter
    def s3auth(self, s3auth):
        """Sets the s3auth of this SnapshotExportToS3Payload.


        :param s3auth: The s3auth of this SnapshotExportToS3Payload.  # noqa: E501
        :type: SnapshotExportToS3PayloadS3auth
        """
    ...
    @property
    def s3data(self):
        """Gets the s3data of this SnapshotExportToS3Payload.  # noqa: E501


        :return: The s3data of this SnapshotExportToS3Payload.  # noqa: E501
        :rtype: SnapshotExportToS3PayloadS3data
        """
        return self._s3data

    @s3data.setter
    def s3data(self, s3data):
        """Sets the s3data of this SnapshotExportToS3Payload.


        :param s3data: The s3data of this SnapshotExportToS3Payload.  # noqa: E501
        :type: SnapshotExportToS3PayloadS3data
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotExportToS3Payload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotExportToS3Payload):
            return False
