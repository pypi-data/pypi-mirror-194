...
from gs_api_client.swagger.models.task_events_template_template_add import TaskEventsTemplateTemplateAdd  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_template_template_remove import TaskEventsTemplateTemplateRemove  # noqa: F401,E501
from gs_api_client.swagger.models.task_events_template_template_update import TaskEventsTemplateTemplateUpdate  # noqa: F401,E501


class TaskEventsTemplate(object):
    ...
    """
    swagger_types = {
        'template_add': 'TaskEventsTemplateTemplateAdd',
        'template_update': 'TaskEventsTemplateTemplateUpdate',
        'template_remove': 'TaskEventsTemplateTemplateRemove'
    }
    ...
    def __init__(self, template_add=None, template_update=None, template_remove=None):  # noqa: E501
        """TaskEventsTemplate - a model defined in Swagger"""  # noqa: E501

        self._template_add = None
        self._template_update = None
        self._template_remove = None
        self.discriminator = None

        if template_add is not None:
            self.template_add = template_add
        if template_update is not None:
            self.template_update = template_update
        if template_remove is not None:
            self.template_remove = template_remove

    @property
    def template_add(self):
        """Gets the template_add of this TaskEventsTemplate.  # noqa: E501


        :return: The template_add of this TaskEventsTemplate.  # noqa: E501
        :rtype: TaskEventsTemplateTemplateAdd
        """
        return self._template_add

    @template_add.setter
    def template_add(self, template_add):
        """Sets the template_add of this TaskEventsTemplate.


        :param template_add: The template_add of this TaskEventsTemplate.  # noqa: E501
        :type: TaskEventsTemplateTemplateAdd
        """
    ...
    def template_update(self):
        """Gets the template_update of this TaskEventsTemplate.  # noqa: E501


        :return: The template_update of this TaskEventsTemplate.  # noqa: E501
        :rtype: TaskEventsTemplateTemplateUpdate
        """
        return self._template_update

    @template_update.setter
    def template_update(self, template_update):
        """Sets the template_update of this TaskEventsTemplate.


        :param template_update: The template_update of this TaskEventsTemplate.  # noqa: E501
        :type: TaskEventsTemplateTemplateUpdate
        """
    ...
    def template_remove(self):
        """Gets the template_remove of this TaskEventsTemplate.  # noqa: E501


        :return: The template_remove of this TaskEventsTemplate.  # noqa: E501
        :rtype: TaskEventsTemplateTemplateRemove
        """
        return self._template_remove

    @template_remove.setter
    def template_remove(self, template_remove):
        """Sets the template_remove of this TaskEventsTemplate.


        :param template_remove: The template_remove of this TaskEventsTemplate.  # noqa: E501
        :type: TaskEventsTemplateTemplateRemove
        """

        self._template_remove = template_remove
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsTemplate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsTemplate):
            return False
