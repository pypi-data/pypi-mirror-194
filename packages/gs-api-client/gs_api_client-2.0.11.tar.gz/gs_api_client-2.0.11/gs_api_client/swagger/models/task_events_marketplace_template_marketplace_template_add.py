...
from gs_api_client.swagger.models.task_events_marketplace_template_marketplace_template_add_object_storage_path import TaskEventsMarketplaceTemplateMarketplaceTemplateAddObjectStoragePath  # noqa: F401,E501
...
class TaskEventsMarketplaceTemplateMarketplaceTemplateAdd(object):
    ...
    swagger_types = {
        ...
        'name': 'TaskEventName',
        'template_uuid': 'TaskEventsSchedulesScheduleSnapshotAddStorageUuid',
        'capacity': 'TaskEventsMarketplaceTemplateMarketplaceTemplateAddCapacity',
        'object_storage_path': 'TaskEventsMarketplaceTemplateMarketplaceTemplateAddObjectStoragePath'
    }
    ...
    def __init__(self, labels=None, name=None, template_uuid=None, capacity=None, object_storage_path=None):  # noqa: E501
        """TaskEventsMarketplaceTemplateMarketplaceTemplateAdd - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def labels(self):
        """Gets the labels of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501


        :return: The labels of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
    ...
    def labels(self, labels):
        """Sets the labels of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.


        :param labels: The labels of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
        :type: TaskEventLabel
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501


        :return: The name of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
        :rtype: TaskEventName
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.


        :param name: The name of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
        :type: TaskEventName
        """
    ...
    def template_uuid(self):
        """Gets the template_uuid of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501


        :return: The template_uuid of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
    ...
    def template_uuid(self, template_uuid):
        """Sets the template_uuid of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.


        :param template_uuid: The template_uuid of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
    ...
    @property
    def capacity(self):
        """Gets the capacity of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501


        :return: The capacity of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
    ...
    def capacity(self, capacity):
        """Sets the capacity of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.


        :param capacity: The capacity of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
    ...
    def object_storage_path(self):
        """Gets the object_storage_path of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501


        :return: The object_storage_path of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
        :rtype: TaskEventsMarketplaceTemplateMarketplaceTemplateAddObjectStoragePath
        """
        return self._object_storage_path

    @object_storage_path.setter
    def object_storage_path(self, object_storage_path):
        """Sets the object_storage_path of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.


        :param object_storage_path: The object_storage_path of this TaskEventsMarketplaceTemplateMarketplaceTemplateAdd.  # noqa: E501
        :type: TaskEventsMarketplaceTemplateMarketplaceTemplateAddObjectStoragePath
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskEventsMarketplaceTemplateMarketplaceTemplateAdd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskEventsMarketplaceTemplateMarketplaceTemplateAdd):
            return False
