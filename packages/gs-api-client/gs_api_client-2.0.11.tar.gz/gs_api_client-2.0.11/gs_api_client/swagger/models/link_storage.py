...
class LinkStorage(object):
    ...
    def __init__(self, object_uuid=None, bootdevice=None):  # noqa: E501
        """LinkStorage - a model defined in Swagger"""  # noqa: E501
    ...
    def object_uuid(self):
        """Gets the object_uuid of this LinkStorage.  # noqa: E501

        The UUID of the storage you are requesting. If server's hardware profile is default, nested, q35 or q35_nested, you are allowed to attached 8 servers. only 2 storage are allowed to be attached to server with other hardware profile  # noqa: E501

        :return: The object_uuid of this LinkStorage.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this LinkStorage.

        The UUID of the storage you are requesting. If server's hardware profile is default, nested, q35 or q35_nested, you are allowed to attached 8 servers. only 2 storage are allowed to be attached to server with other hardware profile  # noqa: E501

        :param object_uuid: The object_uuid of this LinkStorage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def bootdevice(self):
        """Gets the bootdevice of this LinkStorage.  # noqa: E501

        Whether the server will boot from this storage device or not.  # noqa: E501

        :return: The bootdevice of this LinkStorage.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootdevice(self, bootdevice):
        """Sets the bootdevice of this LinkStorage.

        Whether the server will boot from this storage device or not.  # noqa: E501

        :param bootdevice: The bootdevice of this LinkStorage.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkStorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkStorage):
            return False
