...
class PaasServiceCredentialsInner(object):
    ...
    def __init__(self, kubeconfig=None, expiration_time=None, password=None, username=None, type=None):  # noqa: E501
        """PaasServiceCredentialsInner - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def kubeconfig(self):
        """Gets the kubeconfig of this PaasServiceCredentialsInner.  # noqa: E501

        The kubeconfig of the gsk Service.  # noqa: E501

        :return: The kubeconfig of this PaasServiceCredentialsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def kubeconfig(self, kubeconfig):
        """Sets the kubeconfig of this PaasServiceCredentialsInner.

        The kubeconfig of the gsk Service.  # noqa: E501

        :param kubeconfig: The kubeconfig of this PaasServiceCredentialsInner.  # noqa: E501
        :type: str
        """
    ...
    def expiration_time(self):
        """Gets the expiration_time of this PaasServiceCredentialsInner.  # noqa: E501

        The kubeconfig's expiration time of the gsk Service  # noqa: E501

        :return: The expiration_time of this PaasServiceCredentialsInner.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiration_time(self, expiration_time):
        """Sets the expiration_time of this PaasServiceCredentialsInner.

        The kubeconfig's expiration time of the gsk Service  # noqa: E501

        :param expiration_time: The expiration_time of this PaasServiceCredentialsInner.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def password(self):
        """Gets the password of this PaasServiceCredentialsInner.  # noqa: E501

        The initial username to authenticate the Service.  # noqa: E501

        :return: The password of this PaasServiceCredentialsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this PaasServiceCredentialsInner.

        The initial username to authenticate the Service.  # noqa: E501

        :param password: The password of this PaasServiceCredentialsInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def username(self):
        """Gets the username of this PaasServiceCredentialsInner.  # noqa: E501

        The initial password to authenticate the Service.  # noqa: E501

        :return: The username of this PaasServiceCredentialsInner.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this PaasServiceCredentialsInner.

        The initial password to authenticate the Service.  # noqa: E501

        :param username: The username of this PaasServiceCredentialsInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this PaasServiceCredentialsInner.  # noqa: E501

        The type of Service.  # noqa: E501

        :return: The type of this PaasServiceCredentialsInner.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PaasServiceCredentialsInner.

        The type of Service.  # noqa: E501

        :param type: The type of this PaasServiceCredentialsInner.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServiceCredentialsInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServiceCredentialsInner):
            return False
