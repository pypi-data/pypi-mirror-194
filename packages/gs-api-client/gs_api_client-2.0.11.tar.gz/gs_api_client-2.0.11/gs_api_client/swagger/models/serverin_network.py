...
from gs_api_client.swagger.models.serverin_network_inner import ServerinNetworkInner  # noqa: F401,E501


class ServerinNetwork(object):
    ...
    def __init__(self):  # noqa: E501
        """ServerinNetwork - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServerinNetwork, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerinNetwork):
            return False
