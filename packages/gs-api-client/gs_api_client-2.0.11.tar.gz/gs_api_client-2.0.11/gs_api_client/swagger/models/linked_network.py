...
class LinkedNetwork(object):
    ...
    def __init__(self, network_type=None, l3security=None, bootdevice=None, network_uuid=None, l2security=None, mac=None, ordering=None, firewall=None, firewall_template_uuid=None, object_name=None, create_time=None, object_uuid=None, public_net=None):  # noqa: E501
        """LinkedNetwork - a model defined in Swagger"""  # noqa: E501
    ...
    def network_type(self):
        """Gets the network_type of this LinkedNetwork.  # noqa: E501

        (one of network, network_high, network_insane)  # noqa: E501

        :return: The network_type of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def network_type(self, network_type):
        """Sets the network_type of this LinkedNetwork.

        (one of network, network_high, network_insane)  # noqa: E501

        :param network_type: The network_type of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    @property
    def l3security(self):
        """Gets the l3security of this LinkedNetwork.  # noqa: E501
        ...
        :return: The l3security of this LinkedNetwork.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def l3security(self, l3security):
        """Sets the l3security of this LinkedNetwork.

        Defines information about IP prefix spoof protection (it allows source traffic only from the IPv4/IPv4 network prefixes). If empty, it allow no IPv4/IPv6 source traffic. If set to null, l3security is disabled (default).  # noqa: E501

        :param l3security: The l3security of this LinkedNetwork.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def bootdevice(self):
        """Gets the bootdevice of this LinkedNetwork.  # noqa: E501
        ...
        :return: The bootdevice of this LinkedNetwork.  # noqa: E501
        :rtype: bool
        """
    ...
    def bootdevice(self, bootdevice):
        """Sets the bootdevice of this LinkedNetwork.

        Defines if this object is the bootdevice. Storages, Networks and ISO-Images can have a bootdevice configured, but only one bootdevice per Storage, Network or ISO-Image. The boot order is as follows => Network > ISO-Image > Storage.  # noqa: E501

        :param bootdevice: The bootdevice of this LinkedNetwork.  # noqa: E501
        :type: bool
        """
    ...
    def network_uuid(self):
        """Gets the network_uuid of this LinkedNetwork.  # noqa: E501

        The UUID of the network you're requesting.  # noqa: E501

        :return: The network_uuid of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def network_uuid(self, network_uuid):
        """Sets the network_uuid of this LinkedNetwork.

        The UUID of the network you're requesting.  # noqa: E501

        :param network_uuid: The network_uuid of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    @property
    def l2security(self):
        """Gets the l2security of this LinkedNetwork.  # noqa: E501
        ...
        :return: The l2security of this LinkedNetwork.  # noqa: E501
        :rtype: bool
        """
    ...
    def l2security(self, l2security):
        """Sets the l2security of this LinkedNetwork.

        Defines information about MAC spoofing protection (filters layer2 and ARP traffic based on MAC source). It can only be (de-)activated on a private network - the public network always has l2security enabled. It will be true if the network is public, and false if the network is private.  # noqa: E501

        :param l2security: The l2security of this LinkedNetwork.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def mac(self):
        """Gets the mac of this LinkedNetwork.  # noqa: E501

        network_mac defines the MAC address of the network interface.  # noqa: E501

        :return: The mac of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
        return self._mac
    ...
    @mac.setter
    def mac(self, mac):
        """Sets the mac of this LinkedNetwork.

        network_mac defines the MAC address of the network interface.  # noqa: E501

        :param mac: The mac of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ordering(self):
        """Gets the ordering of this LinkedNetwork.  # noqa: E501

        Defines the ordering of the network interfaces. Lower numbers have lower PCI-IDs.  # noqa: E501

        :return: The ordering of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def ordering(self, ordering):
        """Sets the ordering of this LinkedNetwork.

        Defines the ordering of the network interfaces. Lower numbers have lower PCI-IDs.  # noqa: E501

        :param ordering: The ordering of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    @property
    def firewall(self):
        """Gets the firewall of this LinkedNetwork.  # noqa: E501

          # noqa: E501

        :return: The firewall of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def firewall(self, firewall):
        """Sets the firewall of this LinkedNetwork.

          # noqa: E501

        :param firewall: The firewall of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    def firewall_template_uuid(self):
        """Gets the firewall_template_uuid of this LinkedNetwork.  # noqa: E501

        The UUID of firewall template.  # noqa: E501

        :return: The firewall_template_uuid of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def firewall_template_uuid(self, firewall_template_uuid):
        """Sets the firewall_template_uuid of this LinkedNetwork.

        The UUID of firewall template.  # noqa: E501

        :param firewall_template_uuid: The firewall_template_uuid of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this LinkedNetwork.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    def create_time(self):
        """Gets the create_time of this LinkedNetwork.  # noqa: E501

        Defines the date and time the object was initially created.  # noqa: E501

        :return: The create_time of this LinkedNetwork.  # noqa: E501
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this LinkedNetwork.

        Defines the date and time the object was initially created.  # noqa: E501

        :param create_time: The create_time of this LinkedNetwork.  # noqa: E501
        :type: datetime
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this LinkedNetwork.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this LinkedNetwork.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this LinkedNetwork.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this LinkedNetwork.  # noqa: E501
        :type: str
        """
    ...
    @property
    def public_net(self):
        """Gets the public_net of this LinkedNetwork.  # noqa: E501
        ...
        :return: The public_net of this LinkedNetwork.  # noqa: E501
        :rtype: bool
        """
    ...
    def public_net(self, public_net):
        """Sets the public_net of this LinkedNetwork.

        True if the network is public. If private it will be false. Each private network is a secure and fully transparent 2-Layer network between servers. There is no limit on how many servers can be connected to the same private network.  # noqa: E501

        :param public_net: The public_net of this LinkedNetwork.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkedNetwork, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedNetwork):
            return False
