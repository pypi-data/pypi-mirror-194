...
from gs_api_client.swagger.models.request import Request  # noqa: F401,E501


class RequestGetResponse(dict):
    ...
    def __init__(self):  # noqa: E501
        """RequestGetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RequestGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestGetResponse):
            return False
