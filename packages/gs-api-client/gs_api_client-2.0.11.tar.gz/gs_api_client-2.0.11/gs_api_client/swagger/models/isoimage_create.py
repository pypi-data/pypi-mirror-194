...
class IsoimageCreate(object):
    ...
    def __init__(self, name=None, source_url=None, labels=None):  # noqa: E501
        """IsoimageCreate - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IsoimageCreate.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param name: The name of this IsoimageCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def source_url(self):
        """Gets the source_url of this IsoimageCreate.  # noqa: E501

        The source URL from which the ISO-Image should be downloaded.  # noqa: E501

        :return: The source_url of this IsoimageCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def source_url(self, source_url):
        """Sets the source_url of this IsoimageCreate.

        The source URL from which the ISO-Image should be downloaded.  # noqa: E501

        :param source_url: The source_url of this IsoimageCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def labels(self):
        """Gets the labels of this IsoimageCreate.  # noqa: E501

        List of labels.  # noqa: E501

        :return: The labels of this IsoimageCreate.  # noqa: E501
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this IsoimageCreate.

        List of labels.  # noqa: E501

        :param labels: The labels of this IsoimageCreate.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IsoimageCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsoimageCreate):
            return False
