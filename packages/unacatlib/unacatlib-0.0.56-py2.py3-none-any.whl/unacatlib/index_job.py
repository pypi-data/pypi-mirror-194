...
from unacatlib.unacast.operator.v1 import GetIndexJobStatusRequest, IndexJobOperatorServiceStub, GetJobStatusResponse
import time
...
class IndexJob(object):
    ...
    def _fetch_status(self) -> GetJobStatusResponse:
      res = sync(
        self._index_job_operator_service.get_index_job_status(GetIndexJobStatusRequest(
          job_id = self._job_id
        ))
      )
